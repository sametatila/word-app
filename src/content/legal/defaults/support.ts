...
Hizmeti sunan, uygulamayı mağazalarda yayımlayan, destek yükümlülüğünü taşıyan ve verilerinden sorumlu olan kişi. AB ve AEA'dan veri koruma konularında GDPR m.27 kapsamındaki AB temsilcisine de ulaşabilirsin; kimliği gizlilik politikasının 1. bölümünde yazılıdır.
...
The person who provides the service, publishes the app in the stores, carries the support obligation and is responsible for your data. From the EU and EEA you can also reach the EU representative under Art. 27 GDPR on data protection matters; they are named in section 1 of the privacy policy.
...
Die Person, die den Dienst anbietet, die App in den Stores veröffentlicht, die Supportpflicht trägt und für deine Daten verantwortlich ist. Aus der EU und dem EWR erreichst du in Datenschutzfragen auch den EU-Vertreter nach Art. 27 DSGVO; er ist in Abschnitt 1 der Datenschutzerklärung genannt.
