...
- Mobil uygulamayı hesap oluşturmadan (misafir olarak) da kullanabilirsin; bu şartlar ve 18 yaş sınırı misafir kullanımına da uygulanır. Sosyal özellikler, Premium ve (tek bir deneme değerlendirmesi dışında) yapay zekâ değerlendirmesi hesap ister; hatırlatmalar yalnız o cihazda kurulur. Misafir ilerlemen o cihazdaki misafir kimliğine bağlıdır: uygulamayı silersen ya da {{sessionMaxDays}} gün kullanmazsan kaybolabilir. E-postayla hesap oluşturduğunda misafir kimliğin hesabın olur, sosyal girişle hesap oluşturduğunda ilerlemen hesabına taşınır; var olan hesabına girersen ilerlemeyi eklemek isteyip istemediğin sorulur. Misafir verilerini uygulamada Profil › Misafir verilerini sil ile silebilirsin.
...
Premium'da bu haklar beklemeden açıktır; Premium'un da kötüye kullanımı önleyen günlük üst sınırları vardır (yürüyüş modu turu, yapay zekâ değerlendirmesi ve sohbet mesajı). Bu sınırlar ürünle birlikte ayarlandığı için burada sabit bir sayı yazılmaz; **yürürlükteki değerler uygulamadaki Premium sayfasında** açıkça gösterilir ve satın almadan önce görülebilir. Bir sınır düşürülürse değişiklik aynı sayfada duyurulur. Premium hiçbir yerde “sınırsız” olarak tanıtılmaz.
...
The texts you write, the transcripts of what you say and your display name are yours. You grant us only the worldwide, non-exclusive, royalty-free license needed to provide the service: to assess your work, generate feedback and show as much as you choose (display name, progress) to other users. We do not use your content for advertising or model training; the license ends when you delete your account.

If you see content that is unlawful or breaches these terms (another user's name or behavior), you can report it with the "Report" button in the app or at {{supportEmail}}; this is also the single point of contact for notices under the EU Digital Services Act (DSA). Reports are reviewed by a human within 24 hours; the decision and the route of appeal are communicated to the reporter and to the content owner, so you learn the outcome of your report. The friend features include block and report buttons.
...
- **Renewal and cancellation:** Unless canceled at least 24 hours before the end of the term, the subscription renews for the same period. You cancel in the store you bought it from: Play Store › Payments and subscriptions{{ifIos}}, or Settings › Apple Account › Subscriptions on iOS{{/ifIos}}. Deleting your account does not cancel the subscription. If you cancel before a free trial ends, you are not charged.
...
- Die mobile App kannst du auch ohne Konto (als Gast) nutzen; diese Bedingungen und das Mindestalter von 18 Jahren gelten auch für die Nutzung als Gast. Soziale Funktionen, Premium und KI-Feedback (bis auf eine einzige Probebewertung) brauchen ein Konto; Erinnerungen werden nur auf diesem Gerät eingerichtet. Dein Gastfortschritt hängt an der Gastidentität auf diesem Gerät: Er kann verloren gehen, wenn du die App löschst oder sie {{sessionMaxDays}} Tage nicht nutzt. Erstellst du ein Konto per E-Mail, wird deine Gastidentität zu deinem Konto; bei einer sozialen Anmeldung wird dein Fortschritt übernommen; meldest du dich bei einem bestehenden Konto an, wirst du gefragt, ob du den Fortschritt hinzufügen willst. Deine Gastdaten löschst du in der App unter Profil › Gastdaten löschen.
