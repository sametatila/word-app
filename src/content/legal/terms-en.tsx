  ...
  return (
    <>
      ...
      <ul>
        ...
        <li><strong>Price changes:</strong> The subscription price can change over time. The rule is this: <strong>the price you paid holds for the period you paid for</strong> — an increase never applies retroactively and only takes effect from the next renewal. Before an increase you are notified through the store (e-mail and store notification) at least <strong>30 days</strong> in advance, with the new amount and the date it takes effect. Depending on the size of the increase and the store&apos;s rules, one of two paths applies: for small, infrequent increases the subscription renews at the new price unless you cancel; for anything beyond that <strong>your explicit consent is required</strong>, and without it the subscription simply ends instead of renewing. In both cases, if you cancel before the effective date you are not charged the new price. Amount differences caused by a change of currency, region or tax rate (for example VAT) are applied by the store and are not subject to the notice period in this clause.</li>
        <li><strong>Promotional prices and gifted time:</strong> A free trial, a discounted introductory price, a promo code and a referral reward are valid <strong>only for the stated period</strong>; when it ends the standard price applies, and this is shown at the time of purchase. Time gained from a gift or a code is not a monetary claim: it cannot be cashed out or transferred, and it does not mean future prices are fixed.</li>
      ...
      <p>
        Premium has its own daily fair-use limits too (pocket-walk rounds and AI evaluations). Because these are tuned together with the
        product, no fixed number is written here; <strong>the values in force are shown on the Premium page in the app</strong> and can be
        seen before you buy. If a limit is lowered, the change is announced on that same page. Premium is never advertised as
        &ldquo;unlimited&rdquo;.
      </p>
