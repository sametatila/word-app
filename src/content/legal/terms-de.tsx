  ...
  return (
    <>
      ...
      <ul>
        ...
        <li><strong>Preisänderung:</strong> Der Abopreis kann sich mit der Zeit ändern. Die Regel lautet: <strong>Der bezahlte Preis gilt für den bezahlten Zeitraum</strong> — eine Erhöhung wirkt nie rückwirkend und greift erst ab der nächsten Verlängerung. Vor einer Erhöhung wirst du über den Store (E-Mail und Store-Benachrichtigung) mindestens <strong>30 Tage</strong> vorher informiert, mit dem neuen Betrag und dem Datum des Inkrafttretens. Je nach Höhe der Erhöhung und den Regeln des Stores gilt einer von zwei Wegen: Bei kleinen, seltenen Erhöhungen verlängert sich das Abo zum neuen Preis, sofern du nicht kündigst; darüber hinaus ist <strong>deine ausdrückliche Zustimmung erforderlich</strong>, und ohne sie endet das Abo, statt sich zu verlängern. In beiden Fällen wird dir der neue Preis nicht berechnet, wenn du vor dem Stichtag kündigst. Betragsunterschiede durch geänderte Währung, Region oder Steuersätze (etwa die Mehrwertsteuer) setzt der Store um; sie unterliegen nicht der Frist in dieser Klausel.</li>
        <li><strong>Aktionspreise und geschenkte Laufzeit:</strong> Eine kostenlose Testphase, ein vergünstigter Einführungspreis, ein Aktionscode und eine Einladungsprämie gelten <strong>nur für den angegebenen Zeitraum</strong>; danach gilt der Standardpreis, und das wird beim Kauf angezeigt. Durch Geschenk oder Code gewonnene Laufzeit ist kein Geldanspruch: Sie ist weder auszahlbar noch übertragbar und bedeutet nicht, dass künftige Preise festgeschrieben sind.</li>
      ...
      <p>
        Auch Premium hat eigene tägliche Fair-Use-Grenzen (Geh-Runden in der Tasche und KI-Bewertungen). Da sie gemeinsam mit dem Produkt
        justiert werden, steht hier keine feste Zahl; <strong>die geltenden Werte werden auf der Premium-Seite in der App</strong> angezeigt
        und sind vor dem Kauf einsehbar. Wird eine Grenze gesenkt, wird die Änderung auf derselben Seite bekannt gegeben. Premium wird
        nirgends als &bdquo;unbegrenzt&ldquo; beworben.
      </p>
