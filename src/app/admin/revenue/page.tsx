 ...
 */
export default async function AdminRevenuePage({ searchParams }: { searchParams: Promise<{ taze?: string }> }) {
  ...
  return (
    <PanelPage title="Gelir ve huniler" description="Gelir, abonelik, deneme dönüşümü, tutma ve satın alma hunileri (uygulama içi ve web'den uygulamaya)." href="/admin/revenue" at={at} issues={panelIssues(value)}>
      <RevenueSection data={value.data} coverage={value.coverage} revenue={value.revenue} />
    </PanelPage>
  );
}
