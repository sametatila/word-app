    ...
    <LoadingRegion className="mx-auto w-full max-w-3xl space-y-4">
      <div className="card overflow-hidden">
        ...
        <div className="space-y-3 p-4">
          ...
          <div className="h-11 w-full animate-pulse rounded-tile surface-2" />
          <div className="h-13 w-full animate-pulse rounded-panel surface-2" style={{ height: 52 }} />
        </div>
      </div>
      <div className="h-4 w-32 animate-pulse rounded-full surface-2" />
