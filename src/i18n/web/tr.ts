...
export const trWeb: Record<string, string> = {
  ...
  "invitew.pitch": "Günde birkaç dakika: kelime turları, Patika'da konuşma ve beceri adımları, deneme sınavları. Ücretsiz başlıyor.",
  /*
  ...
  "quest.conversation1": "Bir konuşma tamamla",
  /*
  ...
  "ach.speak100.hint": "Yürüyüş modunda 100 kelimeyi sesli söyle",
  "ach.speak500.title": "Ağızdan çıkan",
  "ach.speak500.hint": "Yürüyüş modunda 500 kelimeyi sesli söyle",
  ...
  "ach.grammar5.hint": "5 dil bilgisi alıştırmasını geç",
  "ach.grammar12.title": "Yapı oturuyor",
  "ach.grammar12.hint": "12 dil bilgisi alıştırmasını geç",
  "ach.grammar25.title": "Dil bilgisi ustası",
  "ach.grammar25.hint": "25 dil bilgisi alıştırmasını geç",
  "ach.conversation1.title": "İlk konuşma",
  "ach.conversation1.hint": "Bir Konuşma adımını sohbetiyle birlikte bitir",
  "ach.conversation10.title": "Bir modül",
  "ach.conversation10.hint": "10 konuşma tamamla",
  "ach.conversation50.title": "Yarı yol",
  "ach.conversation50.hint": "50 konuşma tamamla",
  "ach.conversation100.title": "Bir seviye",
  "ach.conversation100.hint": "100 konuşma tamamla",
  ...
  "ach.speaking25.hint": "25 konuşma ya da sohbet değerlendirt",
  ...
  "ach.invite1.title": "İlk yoldaş",
  "ach.invite1.hint": "Davet ettiğin bir kişi üç günlük seri yapsın",
  "ach.invite3.title": "Çalışma grubu",
  "ach.invite3.hint": "Davet ettiğin üç kişi üç günlük seri yapsın",
  "ach.invite10.title": "Sınıfı topladın",
  "ach.invite10.hint": "Davet ettiğin on kişi üç günlük seri yapsın",
  ...
  "assessw.fail_quota": "Bugünlük yapay zekâ değerlendirme hakkın doldu — temel kontrol gösteriliyor.",
  ...
  */
  ...
  "conversationp.step_repeat": "tekrar",
  "conversationp.step_produce": "üret",
  "conversationp.step_truefalse": "doğru/yanlış",
  "conversationp.say_true_or_false": "Lütfen yalnızca “doğru” ya da “yanlış” de.",
  "conversationp.didnt_catch": "Tam duyamadım. Bir kez daha söyler misin:",
  "conversationp.almost_missing": "Neredeyse! Eksik kalan:",
  "conversationp.once_more": "Bir kez daha:",
  "conversationp.lets_try_again": "Bir kez daha deneyelim:",
  ...
  "conversationp.no_answer": "Cevap alınamadı. Tekrar dener misin?",
  "conversationp.no_connection": "İnternet bağlantısı kurulamadı.",
  "conversationp.answer_coming": "Cevap geliyor…",
  "conversationp.listening_take_time": "Dinliyorum — es versen de beklerim",
  "conversationp.listening_true_false": "Dinliyorum — “doğru” ya da “yanlış” de",
  "conversationp.tap_to_speak": "Konuşmak için dokun",
  "conversationp.ready_lets_start": "Hazırım, başlayalım",
  "conversationp.or_answer_aloud": "…ya da sesli cevap ver.",
  "conversationp.start_speaking": "Konuşmaya başla",
  "conversationp.close_typing": "Yazmayı kapat",
  "conversationp.no_asr_long": "Konuşma tanıma yok — yazarak devam edebilirsin.",
  "conversationp.to_chat": "Konuşmaya geç",
  "conversationp.end_conversation": "Konuşmayı bitir",
  ...
  "land.badge": "{courses} · A1 → C1 · {words} kelime · {games} oyun",
  "land.words_n": "{n} kelime",
  "land.badge_nowords": "{courses} · A1 → C1 · {games} oyun",
  "land.h1_before": "Yeni bir dili ",
  "land.h1_accent": "oynayarak",
  "land.h1_after": " öğren",
  "land.hero_sub": "{courses}: kursunu seç; {games} kelime oyunu, Patika'nın konuşma adımları ve beceri alıştırmaları tek akışta gelsin.",
  "land.cta_free": "Hemen başla — ücretsiz",
  "land.cta_continue": "Öğrenmeye devam et",
  "land.cta_skills": "Okuma · Dinleme · Yazma",
  "land.course_de": "CEFR A1–C1 için konu bazlı hazırlanmış kelimeler; her biri artikel, çoğul, örnek cümle ve cümlenin çevirisiyle.",
  "land.course_en": "A1'den C1'e kelime hazinesi; sınav formatında okuma, dinleme, yazma ve konuşma alıştırmaları.",
  ...
  "land.f_survival_body": "Tur sonunda süreye karşı oynarsın: 40 saniyeyle başlar, her doğru sana süre kazandırır, her yanlış yakar. Üst üste doğrular puanı üç katına kadar çıkarır, sorular üç dalgada sertleşir.",
  ...
  "land.games_title": "{n} oyun, tek akış",
  ...
  "land.game_translate": "Cümleyi öğrendiğin dile çevir",
  ...
  "install.installed_sub": "Lernomi'yi ana ekranından açıyorsun.",
  ...
  "pushw.allow_in_browser": "Tarayıcının site ayarlarından Lernomi'ye bildirim izni ver.",
  ...
  "del.controller": "Geliştirici ve veri sorumlusu",
  "del.play_name": "Google Play'deki geliştirici adı",
  "del.language": "Dil",
  ...
  "del.d_learning_body": "Kelime durumun ve tekrar sonuçların, serin, XP ve başarımların, Patika ve beceri ilerlemen, sınav, deneme sınavı ve seviye testi sonuçların, lig üyeliğin.",
  "del.d_texts": "Yazdıkların ve söylediklerin",
  "del.d_texts_body": "Yazma görevlerin, sınav cevapların ve bunların değerlendirmeleri, sohbet kayıtların.",
  ...
  "growth.p_answers.one": "{n} cevap",
  "growth.p_exercises": "{n} egzersiz",
  "growth.p_exercises.one": "{n} egzersiz",
  "growth.p_conversations": "{n} konuşma",
  "growth.p_conversations.one": "{n} konuşma",
  ...
  "push.rem_streak_due.one": "Bugün {n} kelimenin tekrarı var. Birkaç dakika seriyi kurtarır.",
  "push.rem_streak_due_named": "{name}, bugün {n} kelimenin tekrarı var. Birkaç dakika seriyi kurtarır.",
  "push.rem_streak_due_named.one": "{name}, bugün {n} kelimenin tekrarı var. Birkaç dakika seriyi kurtarır.",
  ...
  "push.rival_unnamed": "Bir öğrenci",
  ...
  "push.rem_due_title.one": "{n} kelime unutulmak üzere",
  ...
  "push.rem_weekly_title": "Haftalık quiz'in hazır",
  "push.rem_weekly_body": "{level} seviyesinde bu hafta ne öğrendin? On soruluk quiz'le ölç.",
  "push.rem_weekly_body_named": "{name}, {level} seviyesinde bu hafta ne öğrendin? On soruluk quiz'le ölç.",
  "weakw.round_of": "{game} turu",
  "conversationp.listen_again": "Yeniden dinle",
  ...
  "exam.module_exam_title": "Modül sınavı",
  ...
  */
  ...
  "store.cta_body": "Uygulamada aldığın Premium bu hesapta web'de de hemen açılır.",
