...
export const trWeb: Record<string, string> = {
  ...
  "ach.conversation1.hint": "Bir konuşmayı rol yapmayla birlikte bitir",
  ...
  "growth.first_conversation": "İlk konuşma rol yapmayla tamamlandı",
  ...
  */
  ...
  "land.h1_after": " öğren",
  "land.hero_sub": "{courses}: kursunu seç; {games} kelime oyunu, dersler ve beceri alıştırmaları tek akışta gelsin.",
