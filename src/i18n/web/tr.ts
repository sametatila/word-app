...
export const trWeb: Record<string, string> = {
  ...
  "socialw.quest_target": "Hedef birlikte {xp} XP",
  "socialw.quest_pending": "cevap bekleniyor",
  "socialw.quest_accept": "kabul et",
  ...
  "onb.goal_daily_desc": "Komşu, market, doktor, resmi daire — yaşadığım yerde yaşamak.",
  "onb.goal_exam": "Sınav",
  "onb.goal_exam_desc": "Resmî dil sertifikası, dil şartı.",
  "onb.goal_swiss": "İsviçre",
  "onb.goal_swiss_desc": "Zürih'te yaşam: lehçeyi anlamak, Hochdeutsch ile yazmak.",
  "onb.save_failed": "Kaydedilemedi — bağlantını kontrol edip tekrar dene.",
  "onb.step0_title": "Hoş geldin!",
  "onb.step1_title": "Neden {lang}?",
  "onb.step2_title": "Seviyen",
  "onb.step4_title": "Hazırsın",
  "onb.step_of": "Adım {n} / 5 · sonradan profilden değiştirebilirsin",
  "onb.intro": "Ben Erdi. Sana yol göstereceğim — önce adını ve hangi dili öğreneceğini söyle.",
  "onb.what_to_call_you": "Sana nasıl seslenelim?",
  "onb.your_name": "Adın",
  "onb.name_note": "Sıralamada bu isim görünecek.",
  "onb.name_required": "Sana nasıl sesleneceğimizi yaz — sıralamada bu isim görünecek.",
  "onb.which_voice": "Hangi sesi dinlemek istersin?",
  "onb.goal_intro": "Hedefin görevleri ve içerik önerilerini şekillendirir — iş için e-posta, günlük hayat için komşu sohbeti.",
  "onb.level_intro": "Seviyeni 12 dakikalık bir testle ölçebiliriz ya da kendin seçersin. İki yolda da sonradan değiştirmek serbest.",
  "onb.measure_desc": "Kelime, dilbilgisi, okuma, dinleme — en çok 15 dakika, sonunda öneri + beceri profili.",
  "onb.pick_desc": "Kendin seç; iyi gittikçe sistem yukarı taşır, zorlanırsan alta indirir.",
  "onb.continue_with": "{level} ile devam",
  "onb.pace_intro": "Her gün tekrar et, daha hızlı öğren. Hedefi sonradan Ayarlar'dan değiştirebilirsin.",
  "onb.start_test": "Teste başla",
  "onb.plan_ready": "Bugünkü planın hazır, {name}.",
  "onb.summary_goal": "hedef: {goal}. Öğren ekranında seni kısa bir kelime turu, sıradaki konuşma ve bir beceri egzersizi bekliyor.",
  ...
  "del.done_sub": "Verilerin kaldırıldı. Seni tanımak güzeldi.",
  ...
  "del.will_delete_email": "{email} hesabı kalıcı olarak silinecek.",
  "del.will_delete": "Hesabın kalıcı olarak silinecek.",
  "del.cancel_back": "Vazgeç, ayarlara dön",
  "del.item_progress": "Kelime ilerlemen, serilerin, XP ve başarımların silinir.",
  "del.item_writings": "Yazıların, konuşma kayıtların ve değerlendirmelerin silinir.",
  "del.item_social": "Arkadaşlıkların ve gelen kutun silinir.",
  "del.item_play": "Google Play aboneliğin varsa onu Play Store üzerinden ayrıca iptal etmen gerekir.",
  "del.item_irreversible": "Bu işlem geri alınamaz.",
  ...
  "listenp.hide_text": "Metni gizle",
  "listenp.show_text": "Metni göster",
  ...
  "avatarw.no_hat": "Şapkasız",
  "avatarw.no_glasses": "Gözlüksüz",
  "avatarw.mustache": "BIYIK",
  "avatarw.no_mustache": "Bıyıksız",
  ...
  "monow.speak_range": "{min}–{max} saniye konuş.",
  "monow.check": "Kontrol",
  "monow.you_spoke": "{time} konuştun.",
  "monow.items_checked": "{n} / {total} madde işaretlendi.",
