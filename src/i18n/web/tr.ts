...
export const trWeb: Record<string, string> = {
  ...
  */
  ...
  "meta.title": "Lernomi — Almanca ve İngilizce Kelime",
  "meta.tagline": "Kelimeleri oynayarak öğren",
  "meta.description": "A1–C1 kelimelerini on oyunla çalış; tekrarı uygulama planlar. Almanca (Hochdeutsch ve Zürih Almancası) ve İngilizce, Türkçe anlatımıyla.",
  "meta.og_sub": "A1–C1 · 10 oyun · tekrarı kendi planlayan sistem",
  "meta.og_badges": "Hochdeutsch|Züritüütsch|Türkçe anlatım",
};
