...
/**
 * Ayarlar dişlisi — mobil `ui/icons.tsx` `SettingsIcon` ile aynı çizim.
 *
 * Web ayarlar düğmesinde İNGİLİZ ANAHTARI çiziyordu (`WrenchIcon`) ve
 * Android aynı düğmede dişli çiziyor. Aynı denetim iki uygulamada iki farklı
 * simge taşıyordu; dişli "ayarlar"ın yerleşik işareti, anahtar "tamir".
 */
