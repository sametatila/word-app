...
export const b2U01: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Folien machen einen schlecht strukturierten Vortrag nur länger.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Ein schlecht strukturierter wird durch Folien nur länger.“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        text: "Der Autor hält steigende Kurven selten für gelogen.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Das ist selten gelogen und trotzdem selten die ganze Wahrheit.“",
      },
    ],
  },
...

  {
    ...
    questions: [
      ...
      {
        text: "Yannis leitet das Protokoll erst nach der Freigabe weiter.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Ich leite das Protokoll erst nach der Freigabe weiter.“",
      },
    ],
  },
