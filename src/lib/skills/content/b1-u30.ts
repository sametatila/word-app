...
export const b1U30: SkillExercise[] = [
  // ─────────────────────────── OKUMA ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "die Stelle", tr: "kadro", en: "position" },
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "knapp", tr: "neredeyse", en: "just under" },
      { de: "die Überschrift", tr: "başlık", en: "heading" },
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Mia", text: "Schau mal diese Annonce. Klingt gut, oder?" },
      { speaker: "Jonas", text: "Die Überschrift schon. Aber lies den zweiten Abschnitt." },
      { speaker: "Mia", text: "„Preis auf Anfrage“. Das heißt teuer." },
      { speaker: "Jonas", text: "Genau. Und da steht gar keine Einzelheit zum Zustand." },
      { speaker: "Mia", text: "Ja. In der Broschüre wäre das genauer." },
      { speaker: "Jonas", text: "Ruf einfach an und frag nach den Details." },
      { speaker: "Mia", text: "Mache ich. Wenn sie ausweichen, weiß ich Bescheid." },
      { speaker: "Jonas", text: "Genau so. Ein Hinweis fehlt nie zufällig." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Kollegin", text: "Ich suche die Mappe des Kollegen aus dem Export." },
      { speaker: "Kollege", text: "Die liegt in der Verwaltung, im blauen Ordner." },
      { speaker: "Kollegin", text: "Da habe ich schon geschaut. Der Ordner ist leer." },
      { speaker: "Kollege", text: "Dann hat sie jemand mitgenommen und nicht zurückgebracht." },
      { speaker: "Kollegin", text: "Ärgerlich. Ich brauche nur eine Seite mit Stempel." },
      { speaker: "Kollege", text: "Frag bei der Vertretung nach, die haben oft eine Kopie." },
      { speaker: "Kollegin", text: "Gute Idee. Und wenn nicht, drucke ich sie neu aus und lasse sie stempeln." },
      { speaker: "Kollege", text: "Genau. Das dauert zehn Minuten, nicht zwei Tage." },
    ],
    questions: [
      {
