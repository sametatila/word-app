...
export const b1U25: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Jonas", text: "Du redest seit Jahren von deiner Werkstatt. Wann startest du?" },
      { speaker: "Nina", text: "Ich habe Zweifel. Was, wenn es nicht läuft?" },
      { speaker: "Jonas", text: "Dann läuft es nicht. Aber du hast es zumindest versucht." },
      { speaker: "Nina", text: "Der erste Schritt macht mir am meisten Angst." },
      { speaker: "Jonas", text: "Dann mach ihn klein. Frag erst mal beim Meister nach." },
      { speaker: "Nina", text: "Das könnte ich diese Woche machen." },
      { speaker: "Jonas", text: "Genau. Niemand kämpft am ersten Tag um alles." },
      { speaker: "Nina", text: "Gut. Ich rufe ihn morgen an und erzähle dir nachher davon." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Tom", text: "Was bleibt für dich von diesem Jahr?" },
      { speaker: "Sarah", text: "Der Umzug. Der hat wirklich Spuren hinterlassen." },
      { speaker: "Tom", text: "War es gut oder schlimm?" },
      { speaker: "Sarah", text: "Beides. Ich erinnere mich an sechs schlimme Wochen und an einen guten Herbst." },
      { speaker: "Tom", text: "Und nächstes Jahr? Weiterhin dasselbe?" },
      { speaker: "Sarah", text: "Nein. Diesmal will ich früher entscheiden, nicht erst im Sommer." },
      { speaker: "Tom", text: "Das sagst du jedes Jahr." },
      { speaker: "Sarah", text: "Ich weiß. Aber diesmal habe ich es ungefähr aufgeschrieben." },
    ],
    questions: [
      {
