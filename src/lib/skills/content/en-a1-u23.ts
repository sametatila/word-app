  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        hint: "„fruit“ burada sayılamaz gibi kullanılıyor: önünde „a“ yok.",
      },
      {
        kind: "form",
        ...
        fields: [
          ...
          { label: "How long", answer: "two days", accept: ["2 days", "for two days"] },
          { label: "Pain", answer: "with cold water", accept: ["cold water"] },
          { label: "Again", answer: "in one week", accept: ["one week", "in a week"] },
        ],
      },
    ],
  },
