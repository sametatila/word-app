...
export const b1U03: SkillExercise[] = [
  ...
  },
  {
    ...
    segments: [
      { speaker: "Vermieter", text: "Kommen Sie herein. Der Flur ist etwas eng, aber die Zimmer sind hell." },
      { speaker: "Mieterin", text: "Der Boden sieht neu aus. Wurde hier renoviert?" },
      { speaker: "Vermieter", text: "Ja, letztes Jahr. Der alte Mieter ist im Mai ausgezogen." },
      { speaker: "Mieterin", text: "Können Sie mir sagen, wie hoch die Kosten für das Heizen sind?" },
      { speaker: "Vermieter", text: "Etwa hundert Euro im Monat, zusätzlich zur Miete." },
      { speaker: "Mieterin", text: "Und wann könnte ich einziehen?" },
      { speaker: "Vermieter", text: "Ab dem Ersten des nächsten Monats." },
      { speaker: "Mieterin", text: "Gut. Ich überlege es mir und melde mich morgen." },
    ],
    questions: [
      {
