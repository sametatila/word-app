...
export const enC1U15: SkillExercise[] = [
  // ─────────────────────────── OKUMA ───────────────────────────
  {
    ...
    text:
      ...
      "The intergenerational contract promises twilight years, the job self-fulfillment. One more, with a single verb doing double duty across two subjects and two objects.\n" +
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 0,
        explain: "„Elite formation has people in it… A competitive logic has none…“",
      },
      {
        kind: "truefalse",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Where the operational responsibility is ___, the performance indicator does not help.",
        options: [],
        answer: 0,
        accept: ["unclear"],
