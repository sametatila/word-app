...
export const c1U12: SkillExercise[] = [
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "differenzieren", tr: "ayrım yapmak", en: "to differentiate" },
      { de: "halbieren", tr: "yarıya indirmek", en: "to halve" },
      { de: "relativ", tr: "nispeten", en: "relatively" },
      { de: "erkranken", tr: "hastalanmak", en: "to fall ill" },
      { de: "genau", tr: "tam olarak", en: "exactly" },
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "aufzeigen", tr: "ortaya koymak", en: "to demonstrate" },
      { de: "kommunal", tr: "yerel", en: "municipal" },
      ...
      { de: "schulisch", tr: "okulla ilgili", en: "school-related" },
    ],
    minutes: 12,
    tasks: [
      {
