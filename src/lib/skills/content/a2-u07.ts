...
export const a2U07: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Man soll Tabletten mit einem großen Glas Wasser nehmen.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „mit einem großen Glas Wasser, nicht mit Kaffee“.",
      },
    ],
  },
  {
    ...
    gloss: [
      ...
      { de: "berechtigt", tr: "hak sahibi", en: "entitled" },
