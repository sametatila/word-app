...
export const b1U22: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Eva", text: "Hast du die Wettervorhersage gesehen? Es wird noch heißer." },
      { speaker: "Paul", text: "Wie hoch soll die Temperatur denn gehen?" },
      { speaker: "Eva", text: "Sechsunddreißig am Donnerstag. Das ist zu viel für die Kinder." },
      { speaker: "Paul", text: "So heiße Wochen nehmen zu. Früher gab es das einmal im Sommer." },
      { speaker: "Eva", text: "Der Wetterbericht sagt, es bleibt bis Sonntag so." },
      { speaker: "Paul", text: "Dann machen wir den Garten morgens um sieben." },
      { speaker: "Eva", text: "Gute Idee. Bei der Hitze am Mittag arbeitet sowieso niemand." },
      { speaker: "Paul", text: "Und wir geben den Pflanzen abends Wasser, sonst ist es sofort weg." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Nina", text: "Wir suchen noch Leute für den Dienst am Samstag." },
      { speaker: "Jan", text: "Ist das freiwillig oder eine Pflicht für Mitglieder?" },
      { speaker: "Nina", text: "Ganz freiwillig. Niemand muss, aber es hilft sehr." },
      { speaker: "Jan", text: "Wie viel Verantwortung ist das denn?" },
      { speaker: "Nina", text: "Du machst die Tür auf und bleibst zwei Stunden da. Mehr nicht." },
      { speaker: "Jan", text: "Das klingt machbar. Ich habe wenig Zeit, aber zwei Stunden gehen." },
      { speaker: "Nina", text: "Perfekt. Es kommen meistens viele Kinder, dann wird es lebendig." },
      { speaker: "Jan", text: "Dann trage mich ein. Sinnvoll ist es auf jeden Fall." },
    ],
    questions: [
      {
