...
export const b1U05: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Sarah", text: "Also, morgen um acht. Was machen wir zuerst?" },
      { speaker: "Tom", text: "Bevor der Wagen kommt, tragen wir alle Kisten in den Flur." },
      { speaker: "Sarah", text: "Gut. Und während du unten packst, reinige ich die Küche." },
      { speaker: "Tom", text: "Solange die Küche nicht fertig ist, können wir den Schlüssel nicht abgeben." },
      { speaker: "Sarah", text: "Sobald alles unten ist, fahren wir los." },
      { speaker: "Tom", text: "Wer erledigt das mit dem Amt?" },
      { speaker: "Sarah", text: "Das mache ich am Montag. Schließlich muss die neue Adresse gemeldet werden." },
      { speaker: "Tom", text: "Sehr gut. Dann bringe ich am Abend etwas zu essen mit." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Vermieterin", text: "Das Zimmer ist möbliert. Bett, Regal und ein Sessel sind da." },
      { speaker: "Mieter", text: "Und Decken oder Kissen?" },
      { speaker: "Vermieterin", text: "Zwei Decken sind im Regal. Kissen bringst du bitte selbst mit." },
      { speaker: "Mieter", text: "Wie lange kann ich bleiben?" },
      { speaker: "Vermieterin", text: "Von Oktober bis Februar. Danach kommt die Studentin zurück." },
      { speaker: "Mieter", text: "Zwar ist das kurz, aber für mich passt es genau." },
      { speaker: "Vermieterin", text: "Gut. Der Spiegel im Flur gehört auch dazu." },
      { speaker: "Mieter", text: "Dann würde ich es gern nehmen. Wann kann ich einziehen?" },
    ],
    questions: [
      {
