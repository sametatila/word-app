...
export const b2U25: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "komplex", tr: "karmaşık", en: "complex" },
      { de: "das Fach", tr: "ders", en: "subject" },
      { de: "besonders", tr: "özellikle", en: "especially" },
      { de: "ausnahmslos", tr: "istisnasız", en: "without exception" },
      { de: "solche", tr: "böyle", en: "such" },
      { de: "der Fall", tr: "durum", en: "case" },
      ...
      { de: "hinwegzugehen", tr: "geçiştirmek", en: "to gloss over" },
      { de: "abzuschließen", tr: "tamamlamak", en: "to complete" },
    ],
    minutes: 6,
    text:
...

  {
    ...
    gloss: [
      ...
      { de: "sich verabschieden", tr: "vedalaşmak", en: "to say goodbye" },
      { de: "beste", tr: "en iyi", en: "best" },
...

  {
    ...
    gloss: [
      ...
      { de: "sich einprägen", tr: "aklına kazımak", en: "to memorize" },
      { de: "aufholen", tr: "açığı kapatmak", en: "to catch up" },
      { de: "erlernen", tr: "öğrenip edinmek", en: "to acquire" },
      { de: "sich spezialisieren", tr: "uzmanlaşmak", en: "to specialize" },
      { de: "fortgeschritten", tr: "ileri düzey", en: "advanced" },
      { de: "also", tr: "yani", en: "so" },
      { de: "breit", tr: "geniş", en: "broad" },
      { de: "genau", tr: "tam olarak", en: "exactly" },
      { de: "die Stufe", tr: "seviye", en: "level" },
      { de: "genügen", tr: "yetmek", en: "to be enough" },
      { de: "lesen", tr: "okumak", en: "to read" },
      { de: "das Fach", tr: "uzmanlık alanı", en: "field" },
    ],
    minutes: 5,
    segments: [
...

  {
    ...
    tasks: [
      {
        kind: "build",
        tr: "Onun yaptığı iş iki ara raporu kapsıyordu.",
...

  {
    ...
    gloss: [
      ...
      { de: "jeweils", tr: "her biri", en: "each" },
      { de: "rund", tr: "yaklaşık", en: "around" },
      { de: "innerhalb", tr: "içinde", en: "within" },
      { de: "vormittags", tr: "öğleden önce", en: "before noon" },
      { de: "selbstständig", tr: "kendi başına", en: "on his own" },
      { de: "das Studium", tr: "üniversite eğitimi", en: "studies" },
    ],
    minutes: 12,
    tasks: [
