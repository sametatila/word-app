...
export const enB2U24: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Ege", text: "In the preparatory work section, where the sentences are not a sequence. Three participles there would tell the reader that unrelated things happened in order." },
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["a claim", "it carries a claim", "the claim"],
