    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Früher war der Winter für mich zu lang. Jetzt finde ich ihn schön.“",
          ...
          {
        kind: "gapfill",
        text: "Der ___ kommt nach dem Winter.",
        options: [],
        answer: 0,
        accept: ["Frühling"],
        explain: "„Der Frühling kommt nach dem Winter.“",
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Weiter machen, jeden Tag ein bisschen!“",
          ...
          {
        kind: "gapfill",
        text: "Aber ich habe jeden Tag ein bisschen ___ — zehn Minuten, manchmal zwanzig.",
        options: [],
        answer: 0,
        accept: ["gelernt"],
        explain: "„Aber ich habe jeden Tag ein bisschen gelernt — zehn Minuten, manchmal zwanzig.“",
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Es war sehr gemütlich.“",
          ...
          {
        kind: "gapfill",
        text: "Ich bin um sieben ___ und habe Tee getrunken.",
        options: [],
        answer: 0,
        accept: ["aufgestanden"],
        explain: "„Ich bin um sieben aufgestanden und habe Tee getrunken.“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Das Wetter war wunderbar.“",
          ...
          {
        kind: "gapfill",
        text: "Ich bin nach Hamburg gefahren und habe meinen Bruder ___.",
        options: [],
        answer: 0,
        accept: ["besucht"],
        explain: "„Ich bin nach Hamburg gefahren und habe meinen Bruder besucht.“",
      },
],
  },
  {
