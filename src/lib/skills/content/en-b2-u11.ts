...
export const enB2U11: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Selma", text: "The faculty wants the number, the thesis wants the number, and the innovation office wants the number in the first line. The people are in the acknowledgments." },
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["in the acknowledgments", "the acknowledgments", "at the end"],
        explain: "„The people are in the acknowledgments.“",
      },
    ],
  },
  {
