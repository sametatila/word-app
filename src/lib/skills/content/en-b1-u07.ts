...
export const enB1U07: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Can", text: "We have a note. I wrote it down: earlier, to be fixed. Those four words are on record now." },
  ...
  },
  {
    ...
    gloss: [
      { de: "lost and found", tr: "kayıp eşya" },
      { de: "zipper", tr: "fermuar" },
    ...
    minutes: 6,
    segments: [
      { speaker: "Office", text: "Lost and found, good afternoon." },
      { speaker: "Ela", text: "I left a bag on the number two bus yesterday evening." },
      ...
      { speaker: "Office", text: "I have a brown bag with one red handle here. The zipper on the front is broken." },
      { speaker: "Ela", text: "That is it. The zipper broke in March." },
    ...
    questions: [
      ...
      {
        kind: "truefalse",
        text: "The zipper broke yesterday.",
        options: ["True", "False"],
        answer: 1,
        explain: "„That is it. The zipper broke in March.“",
      },
      {
        kind: "gapfill",
  ...
  },
  {
    ...
    gloss: [
      { de: "By the time", tr: "-dığında çoktan" },
