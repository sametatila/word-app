...
export const b1U39: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Chef", text: "Ist die Präsentation für morgen fertig?" },
      { speaker: "Mitarbeiterin", text: "Fast. Die Zahlen fehlen noch, die kommen um vier." },
      { speaker: "Chef", text: "Gut. Die Konferenz beginnt um neun im großen Raum." },
      { speaker: "Mitarbeiterin", text: "Kommt die Praktikantin mit?" },
      { speaker: "Chef", text: "Ja, sie schreibt mit. Das hilft ihr mehr als ein Seminar." },
      { speaker: "Mitarbeiterin", text: "Kann jemand der Sekretärin ausrichten, dass wir den Raum brauchen?" },
      { speaker: "Chef", text: "Mache ich gleich. Soll ich auch Getränke bestellen?" },
      { speaker: "Mitarbeiterin", text: "Ja, bitte. Und das Kabel für den Monitor nicht vergessen." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Chefin", text: "Sie wollten mir etwas vorschlagen?" },
      { speaker: "Frau Wolf", text: "Ja. Ich möchte das kleine Projekt im Herbst selbst leiten." },
      { speaker: "Chefin", text: "Interessant. Warum Sie?" },
      { speaker: "Frau Wolf", text: "Ich kenne die Kunden, und die Mitarbeiterin dort arbeitet gern mit mir." },
      { speaker: "Chefin", text: "Das stimmt, das habe ich auch gehört." },
      { speaker: "Frau Wolf", text: "Wenn es gut läuft, könnten wir danach jemanden anstellen." },
      { speaker: "Chefin", text: "Langsam. Erst das Projekt, dann die Leitung, dann neue Leute." },
      { speaker: "Frau Wolf", text: "Einverstanden. Ich teile Ihnen bis Freitag einen Plan mit." },
    ],
    questions: [
      {
