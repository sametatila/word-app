...
export const enB2U02: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Tuna", text: "It is the third one and the only one that is not about evidence. Someone should have raised the alert. That is not a guess about what happened; it is a judgment about what did not." },
