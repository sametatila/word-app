...
export const a2U05: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Die neue Arbeit ist nicht leichter als die alte.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Die neue Arbeit ist nicht leichter“ — ama ilerleme sağlıyor.",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        text: "Die Großeltern waren nicht reich.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Reich waren sie nicht.“ Beş çocuğu tek başlarına büyütmüşler.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "weitermachen", tr: "devam etmek", en: "to keep going" },
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["siebzig", "70", "siebzig Jahre", "70 Jahre"],
    ...
    tasks: [
      {
        ...
        minWords: 40,
        phrases: [
          { de: "Ich habe lange dafür trainiert.", tr: "bunun için uzun süre çalıştım", en: "I trained for it for a long time" },
