...
export const b1U43: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Eva", text: "Hast du das Programm gesehen? Was spielen sie zuerst?" },
      { speaker: "Paul", text: "Etwas Kurzes zur Eröffnung, dann eine Stunde Orchester." },
      { speaker: "Eva", text: "Und nach der Pause?" },
      { speaker: "Paul", text: "Ein Stück aus einer Oper, mit zwei Sängerinnen." },
      { speaker: "Eva", text: "Meine Tochter spielt Flöte, sie sitzt ganz hinten." },
      { speaker: "Paul", text: "Dann setzen wir uns lieber auf die Galerie." },
      { speaker: "Eva", text: "Gute Idee. Von dort sieht man das ganze Orchester." },
      { speaker: "Paul", text: "Und wir stören niemanden, wenn wir früher gehen müssen." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Nina", text: "Die Bilder von der Katastrophe sind schwer zu sehen. So ein Unglück trifft immer die Ärmsten." },
      { speaker: "Jonas", text: "Ja. Wir sammeln ab morgen im Gemeindehaus." },
      { speaker: "Nina", text: "Was wird gebraucht? Kleidung?" },
      { speaker: "Jonas", text: "Nein, vor allem Geld. Kleidung liegt schon in den Hallen." },
      { speaker: "Nina", text: "Verstehe. Dann sage ich es den Nachbarn weiter." },
      { speaker: "Jonas", text: "Sehr gut. Und sag dazu, wofür genau das Geld ist." },
      { speaker: "Nina", text: "Mache ich. Die Leute geben sowieso nichts, ohne zu fragen." },
      { speaker: "Jonas", text: "Genau. Traditionell hilft hier jeder — aber jeder will wissen, wem. Erst dann haben alle ihren Frieden." },
    ],
    questions: [
      {
