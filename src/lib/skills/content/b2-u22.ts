...
export const b2U22: SkillExercise[] = [
    ...
    questions: [
      {
        ...
        answer: 0,
        accept: ["indem", "wenn"],
        explain: "indem yöntemi bildirir: alışkanlık kararla değil tekrarla kurulur. „wenn“ de dilbilgisel ve anlamca doğrudur.",
      },
      {
...

  {
    ...
    gloss: [
      { de: "das Mitgefühl", tr: "duygudaşlık", en: "compassion" },
      { de: "die Empathie", tr: "empati", en: "empathy" },
      { de: "mitfühlen", tr: "empati kurmak", en: "to empathize" },
...

  {
    ...
    tasks: [
      {
        kind: "build",
        tr: "Onun yerinde olsaydım aynı şeyi söylerdim.",
        answer: "An seiner Stelle hätte ich dasselbe gesagt",
        alternatives: ["Ich hätte an seiner Stelle dasselbe gesagt"],
      ...
      {
        kind: "build",
        tr: "Ne patlamak ne de susmak bir yere götürür.",
...

  {
    ...
    gloss: [
      ...
      { de: "die Fürsorge", tr: "şefkat", en: "care" },
      { de: "die Einsamkeit", tr: "yalnızlık", en: "loneliness" },
      { de: "nachsichtig", tr: "hoşgörülü", en: "gentle" },
    ],
    minutes: 12,
    tasks: [
      {
