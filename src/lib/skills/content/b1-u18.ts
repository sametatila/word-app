...
export const b1U18: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Moderatorin", text: "Ich begrüße Sie zur zweiten Runde. Jeder hat zwei Minuten." },
      { speaker: "Herr Brandt", text: "Erstens: Die Zahlen sind gestiegen. Das ist eine Tatsache." },
      { speaker: "Herr Brandt", text: "Zweitens ist der Weg zu weit für viele ältere Leute." },
      { speaker: "Frau Keller", text: "Dem möchte ich widersprechen. Es gibt zwei neue Buslinien." },
  ...
  },
  {
    ...
    segments: [
      { speaker: "Ärztin", text: "Guten Morgen. Die Operation ist für morgen um acht geplant." },
      { speaker: "Patient", text: "Darf ich vorher noch etwas essen?" },
      { speaker: "Ärztin", text: "Nein, ab Mitternacht nichts mehr essen und trinken." },
      { speaker: "Patient", text: "Und mein Herz? Der Hausarzt hat da etwas geschrieben." },
      { speaker: "Ärztin", text: "Das haben wir gelesen. Wir lassen Sie vorher noch untersuchen." },
      { speaker: "Patient", text: "Gut. Und wie lange bleibe ich danach?" },
      { speaker: "Ärztin", text: "Zwei Nächte. Die Krankenschwester zeigt Ihnen gleich das Zimmer." },
      { speaker: "Patient", text: "Danke. Wenn ich schlecht atme, sage ich sofort Bescheid." },
    ],
    questions: [
      {
