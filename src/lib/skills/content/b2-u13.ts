...
export const b2U13: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "ortsüblich", tr: "yörede alışılmış", en: "locally customary" },
      { de: "das Bußgeld", tr: "para cezası", en: "fine" },
      { de: "ahnden", tr: "cezalandırmak", en: "to penalize" },
      { de: "der Antrag", tr: "başvuru", en: "application" },
      { de: "richten an", tr: "bir makama yöneltmek", en: "to address to" },
    ...
    questions: [
      {
        ...
        answer: 0,
        accept: ["Aufgrund"],
        explain: "Resmî dilde neden aufgrund + genitif ile verilir; günlük dilde wegen olurdu.",
      },
      {
...

  {
    ...
    gloss: [
      ...
      { de: "das Endgerät", tr: "cihaz", en: "device" },
      ...
      { de: "die Maus", tr: "fare", en: "mouse" },
      { de: "vermuten", tr: "sanmak", en: "to suspect" },
      { de: "unbekannt", tr: "bilinmeyen", en: "unknown" },
    ],
    minutes: 5,
    segments: [
      { speaker: "Anrufer", text: "Das Programm stürzt seit dem Update jedes Mal beim Speichern ab. Das nervt." },
      { speaker: "Support", text: "Verstehe. Passiert das auf einem Endgerät oder auf allen?" },
      { speaker: "Anrufer", text: "Auf dem Laptop. Auf dem Tablet läuft es." },
      { speaker: "Support", text: "Dann liegt es wahrscheinlich am Virenschutz. Der blockiert seit dem Update den Schreibzugriff." },
      { speaker: "Anrufer", text: "Und wie löse ich das?" },
      { speaker: "Support", text: "Man löst es, indem man den Ordner im Virenschutz freischaltet. Zwei Klicks." },
      { speaker: "Anrufer", text: "Warum macht das Update das überhaupt?" },
      { speaker: "Support", text: "Weil sich der Speicherort geändert hat. Der neue Pfad ist dem Virenschutz unbekannt." },
      { speaker: "Anrufer", text: "Gut. Noch etwas: Der Laptop geht manchmal einfach aus." },
      { speaker: "Support", text: "Das ist ein anderes Thema. Hängt er dabei am Ladegerät?" },
      { speaker: "Anrufer", text: "Meistens nicht. Ich arbeite kabellos, auch die Maus." },
      { speaker: "Support", text: "Dann prüfen wir zuerst die Stromversorgung, bevor wir etwas anderes vermuten." },
    ],
    questions: [
      {
        kind: "dictation",
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["der Speicherort hat sich geändert", "neuer Pfad", "wegen des neuen Pfads", "weil sich der Speicherort geändert hat"],
...

  {
    ...
    gloss: [
      ...
      { de: "dicht", tr: "geçirimsiz", en: "impermeable" },
      { de: "genau", tr: "tam olarak", en: "exactly" },
    ...
    tasks: [
      {
        ...
        alternatives: ["Wir müssen wegen des Unwetters umplanen"],
      ...
      },
      {
        ...
        alternatives: ["Wir spielen trotz des Regens draußen"],
      ...
      },
      {
        ...
        alternatives: ["Die Entnahme wird infolge der niedrigen Pegelstände ausgesetzt"],
        hint: "infolge sonucu vurgular ve resmî kayda aittir.",
      },
      {
        kind: "build",
        tr: "Klasöre virüs korumasında izin verilerek çözülür.",
      ...
      },
      {
        ...
        source: "Wegen der Trockenheit nehmen wir kein Wasser mehr aus den Bächen.",
        ...
        why: "Kayıt değişimi tek kelimeyle olmuyor: wegen aufgrund olurken fiil de edilgene geçiyor ve gündelik 'kein Wasser mehr nehmen' yerine terim 'die Entnahme aussetzen' geliyor. Resmî Almanca faili söylemeyip işlemi adlandırır — üç değişiklik birlikte yürür.",
      },
    ],
  },
