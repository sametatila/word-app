...
export const enC1U17: SkillExercise[] = [
  ...
  },
  {
    ...
    segments: [
      ...
      { speaker: "Berna", text: "To call it knowledge transfer is not to call it agronomic advice. Twelve words that a farmer needs and a seller does not want written down." },
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        facts: "„No“ ismin önünde durup türü yadsıyor; „not“ cümleyi, yani bu tek durumu olumsuzluyor ve yardımcı fiile gerek duyuyor; Almanca tek belirleyiciyle geçiyor; hata eksik sözcük değil, bir beden fazla yüksek sözcük.",
        fields: [
