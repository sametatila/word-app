...
export const a2U02: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Der Chef hat nichts gesagt.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Mein Chef hat nichts gesagt.“ Metinde kızgınlıktan söz edilmiyor.",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        text: "Frau Bergmann findet die alten Möbel gar nicht altmodisch.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „die Möbel von damals findet Frau Bergmann gar nicht altmodisch“.",
      },
    ],
  },
  {
