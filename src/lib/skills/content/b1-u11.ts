...
export const b1U11: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Antragsteller", text: "Guten Tag. Ich möchte ein neues Visum beantragen." },
      { speaker: "Sachbearbeiterin", text: "Gern. Welche Unterlagen haben Sie dabei?" },
      { speaker: "Antragsteller", text: "Den Ausweis, den Vertrag und die letzten drei Abrechnungen." },
      { speaker: "Sachbearbeiterin", text: "Gut. Ein Dokument wird noch benötigt: die Anmeldung der Wohnung." },
      { speaker: "Antragsteller", text: "Die habe ich zu Hause. Kann ich sie später schicken?" },
      { speaker: "Sachbearbeiterin", text: "Ja, per Post oder online. Erst danach wird der Antrag geprüft. Die Behörde meldet sich dann bei Ihnen." },
      { speaker: "Antragsteller", text: "Und mit welcher Dauer muss ich etwa rechnen?" },
      { speaker: "Sachbearbeiterin", text: "Etwa acht Wochen. Der Bescheid wird Ihnen dann zugeschickt." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Lukas", text: "Der Bescheid ist da. Mein Antrag wurde abgelehnt." },
      { speaker: "Eva", text: "Warum denn? Steht ein Grund drin?" },
      { speaker: "Lukas", text: "Ja, angeblich fehlt ein Beweis für meine Wohnzeit." },
      { speaker: "Eva", text: "Dann hast du rechtlich einen Anspruch auf Widerspruch." },
      { speaker: "Lukas", text: "Ich habe vier Wochen Zeit, oder?" },
      { speaker: "Eva", text: "Genau. Und du musst ihn schriftlich begründen." },
      { speaker: "Lukas", text: "Die alten Verträge habe ich noch. Die lege ich als Anlage bei." },
      { speaker: "Eva", text: "Sehr gut. Wenn du so entschlossen bist, schreib ihn am besten heute." },
    ],
    questions: [
      {
