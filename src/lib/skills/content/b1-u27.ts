...
export const b1U27: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Tim", text: "Wir haben viel zu viel gekocht. Was machen wir mit dem Rest? So viel bleibt übrig." },
      { speaker: "Lena", text: "Das Gemüse kommt in eine Büchse, das hält vier Tage." },
      { speaker: "Tim", text: "Und das Fleisch? Das ist noch fast roh in der Mitte." },
      { speaker: "Lena", text: "Dann brate es kurz fertig, sonst wird es nichts." },
      { speaker: "Tim", text: "Gut. Und das Brot? Es ist schon von gestern." },
      { speaker: "Lena", text: "Schneide es in Scheiben und friere es in einer Tüte ein." },
      { speaker: "Tim", text: "So einfach? Ich habe immer alles weggeworfen." },
      { speaker: "Lena", text: "Am besten machst du das direkt, nicht erst nach drei Tagen." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Clara", text: "Isst du mittags immer in der Mensa?" },
      { speaker: "Lukas", text: "Fast immer. Zwei Euro achtzig, das findest du sonst nirgends." },
      { speaker: "Clara", text: "Ich gehe lieber zum Imbiss an der Ecke." },
      { speaker: "Lukas", text: "Da zahlst du aber das Dreifache." },
      { speaker: "Clara", text: "Stimmt. Dafür ist es dort ruhiger und ich brauche nur eine Semmel." },
      { speaker: "Lukas", text: "Ich hätte danach Hunger. Mir schmeckt es in der Mensa am besten." },
      { speaker: "Clara", text: "Geschmackssache. Aber mein Konsum ist dort einfach kleiner." },
      { speaker: "Lukas", text: "Da hast du recht. Ich esse in der Mensa meistens zu viel." },
    ],
    questions: [
      {
