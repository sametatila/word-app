...
export const b2U24: SkillExercise[] = [
...

  {
    ...
    segments: [
      ...
      { speaker: "Bewerberin", text: "Ja, drei. Mich würde interessieren, wie der Ablauf in den ersten Wochen aussieht." },
      { speaker: "Frau Bode", text: "Zwei Wochen Einarbeitung, danach ein eigenes Arbeitspaket, aber mit Begleitung." },
      { speaker: "Bewerberin", text: "Und wie ist der Verantwortungsbereich abgegrenzt? In der Anzeige stand es nur allgemein." },
      { speaker: "Frau Bode", text: "Sie führen die Planung für zwei Standorte. Der Einkauf gehört ausdrücklich nicht dazu." },
      { speaker: "Bewerberin", text: "Gut, das ist klar. Und woran messen Sie den Erfolg nach der Probezeit?" },
      { speaker: "Frau Bode", text: "An zwei Meilensteinen: dem ersten Quartalsbericht und der Übergabe im Juni." },
      { speaker: "Bewerberin", text: "Das klingt anspruchsvoll, aber machbar." },
      { speaker: "Frau Bode", text: "Es ist beides. Uns ist die Auffassungsgabe wichtiger als fertige Fertigkeiten." },
      { speaker: "Bewerberin", text: "Das höre ich gern. Wann darf ich mit einer Rückmeldung rechnen?" },
      { speaker: "Frau Bode", text: "Bis Freitag nächster Woche. Wenn es später wird, melden wir uns trotzdem." },
      { speaker: "Bewerberin", text: "Vielen Dank. Dann warte ich bis Freitag." },
    ],
    questions: [
      {
        kind: "dictation",
...

  {
    ...
    gloss: [
      ...
      { de: "die Zuwendung", tr: "ilgi", en: "attentiveness" },
...

  {
    ...
    gloss: [
      ...
      { de: "die Verbundenheit", tr: "bağlılık", en: "attachment" },
      { de: "der Werdegang", tr: "meslek geçmişi", en: "career path" },
      { de: "die Durchlaufzeit", tr: "üretim süresi", en: "lead time" },
      { de: "vertretbar", tr: "savunulabilir", en: "justifiable" },
    ],
    minutes: 12,
    tasks: [
      {
