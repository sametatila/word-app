...
export const b2U04: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Ein Foto mit Datum ist laut Text kein Beweis vor Gericht.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Ein Foto mit Datum ist kein Beweis vor Gericht, aber es beendet die meisten Diskussionen.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "der Mittelwert", tr: "ortalama değer", en: "mean" },
      { de: "die Zahl", tr: "sayı", en: "number" },
      { de: "belohnen", tr: "ödüllendirmek", en: "to reward" },
      { de: "tragfähig", tr: "uygulanabilir", en: "viable" },
      { de: "mündlich", tr: "sözlü", en: "oral" },
      { de: "der Text", tr: "metin", en: "text" },
    ],
    minutes: 6,
    text:
    ...
    questions: [
      ...
      {
        text: "Die Schlichtungsstelle ist laut Text kein Gericht.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Sie ist kein Gericht und kostet fast nichts.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "sehen", tr: "görmek", en: "to see" },
      { de: "verzeichnen", tr: "kaydetmek", en: "to record" },
    ...
    questions: [
      ...
      {
        text: "Der Kundendienst erledigt die Erstattung automatisch.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Das macht der Kundendienst automatisch, Sie müssen nichts beantragen.“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        text: "Am Ende ist die Erleichterung größer als der Ärger.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Jetzt ist die Erleichterung größer als der Ärger.“",
      },
    ],
  },
