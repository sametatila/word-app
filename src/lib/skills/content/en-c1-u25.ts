...
export const enC1U25: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Duru", text: "A category denied and an instance admitted under a friendlier name. The sixth time this level has used that shape, and this is the coldest of the six." },
