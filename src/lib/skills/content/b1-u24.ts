...
export const b1U24: SkillExercise[] = [
  // ─────────────────────────── OKUMA ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "der Zeitpunkt", tr: "zamanlama", en: "timing" },
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Karin", text: "Denkst du manchmal ernsthaft über die nächsten zehn Jahre nach?" },
      { speaker: "Leon", text: "Ständig. Ich fürchte mich vor allem vor Geldsorgen." },
      { speaker: "Karin", text: "Wovor genau? Du hast doch eine sichere Stelle." },
      { speaker: "Leon", text: "Sicherheit gibt es nicht mehr so wie früher. Das weiß jeder." },
      { speaker: "Karin", text: "Da hast du wohl recht. Mich erschreckt eher eine Krankheit." },
      { speaker: "Leon", text: "Verstehe. Aber das Risiko kann man nicht wegdenken." },
      { speaker: "Karin", text: "Nein. Ich überlege mir trotzdem jeden Herbst einen Plan." },
      { speaker: "Leon", text: "Offenbar hilft dir das. Mir hilft es, nicht zu weit zu schauen." },
    ],
    questions: [
      {
        text: "Wovor fürchtet sich die zweite Person?",
        options: ["Vor Geldsorgen", "Vor Krankheit", "Vor der Arbeit"],
        answer: 0,
        explain: "„Ich fürchte mich vor allem vor Geldsorgen.“",
      },
      {
        text: "Was erschreckt die erste Person?",
        options: ["Geldsorgen", "Eine Krankheit", "Die Zukunft der Kinder"],
        answer: 1,
        explain: "„Mich erschreckt eher eine Krankheit.“",
      },
      {
        text: "Was hilft der zweiten Person?",
      ...
      {
        kind: "short_answer",
        text: "Über welchen Zeitraum denkt die zweite Person ständig nach?",
        options: [],
        answer: 0,
        accept: ["die nächsten zehn Jahre", "zehn Jahre", "über die nächsten zehn Jahre", "die nächsten 10 Jahre", "10 Jahre"],
        explain: "„Denkst du manchmal ernsthaft über die nächsten zehn Jahre nach?“ — „Ständig.“",
      },
    ],
  },
  {
    ...
    segments: [
      { speaker: "Lena", text: "Und? Hat er es gesagt?" },
      { speaker: "Mia", text: "Ja. Nach zwei Jahren hat er endlich gestanden, dass er verliebt ist." },
      { speaker: "Lena", text: "Zwei Jahre! Wo war denn der Mut?" },
      { speaker: "Mia", text: "Er hatte Angst, die Freundschaft zu verlieren." },
      { speaker: "Lena", text: "Verstehe ich. Und sie?" },
      { speaker: "Mia", text: "Sie hat nur gelächelt und gesagt: Das weiß ich seit Monaten." },
      { speaker: "Lena", text: "Also wusste sie es die ganze Zeit?" },
      { speaker: "Mia", text: "Offenbar. Sie kennt ihn eben besser als er sich selbst." },
    ],
    questions: [
      {
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    gloss: [
      { de: "versäumen", tr: "kaçırmak", en: "to miss" },
      { de: "ärgerlich", tr: "kızgın / can sıkıcı", en: "annoyed / annoying" },
    ...
    tasks: [
      ...
      {
        kind: "build",
        tr: "Orada kimseyi tanımıyordum ve fırsatı kaçırdım; bu bugün hâlâ canımı sıkıyor.",
