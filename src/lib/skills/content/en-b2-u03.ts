...
export const enB2U03: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Kaan", text: "„Rather slow“ is weaker than „slow“ in meaning and softer in sound, and that is an odd pair: the sentence admits more by saying less. Half of these words are volume controls and the other half are direction signs." },
