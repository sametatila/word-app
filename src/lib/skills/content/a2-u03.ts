...
export const a2U03: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 0,
        explain: "Doğru: „Wenigstens war das Wochenende ruhig.“ İki gün hiçbir şey yapmamış.",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        text: "Er hat in einer kleinen Stadt gewohnt.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Ich habe in einer kleinen Stadt gewohnt, nicht in der Hauptstadt.“",
      },
    ],
  },
  {
