...
export const b2U11: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "die Intelligenz", tr: "zekâ", en: "intelligence" },
    ...
    questions: [
      ...
      {
        text: "Rechenleistung ersetzt kein Ziel.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Rechenleistung ersetzt kein Ziel … das muss jemand vorher definieren.“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Es handelt sich also um eine Meinungsumfrage, nicht um eine Messung des Verhaltens.“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        text: "Ruth zahlt nicht für eine Neuerung um der Neuerung willen.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „…eine Neuerung um der Neuerung willen zahle ich nicht.“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        text: "Die Konvertierung ist noch nicht standardmäßig eingeschaltet.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Noch nicht. Genau das schlage ich für die nächste Version vor.“",
      },
    ],
  },
