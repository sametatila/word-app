...
export const b1U37: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Teilnehmer", text: "Können Sie die Grafik kurz vergrößern? Ich sehe die Zeilen nicht." },
      { speaker: "Referentin", text: "Natürlich. So besser?" },
      { speaker: "Teilnehmer", text: "Ja, danke. Was bedeutet das Kreuz oben rechts?" },
      { speaker: "Referentin", text: "Das Symbol steht für fehlende Werte, nicht für null." },
      { speaker: "Teilnehmer", text: "Gut zu wissen. Das ist ein wichtiger Unterschied." },
      { speaker: "Referentin", text: "Genau. Und die Darstellung zeigt nur die letzten fünf Jahre." },
      { speaker: "Teilnehmer", text: "Also nicht die ganze Zeit. Gibt es auch eine Abbildung für die Zeit davor?" },
      { speaker: "Referentin", text: "Ja, auf der nächsten Seite. Die zeigt zwanzig Jahre." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Paul", text: "Im Keller stehen noch zwei Kisten mit Kassetten." },
      { speaker: "Nina", text: "Wirklich? Kann man die mittlerweile überhaupt noch hören?" },
      { speaker: "Paul", text: "Mit dem alten Gerät schon. Es funktioniert sogar noch." },
      { speaker: "Nina", text: "Was ist denn darauf?" },
      { speaker: "Paul", text: "Musik aus dem Radio. Ich habe damals den Sender aufgenommen." },
      { speaker: "Nina", text: "Auch die Stimme der Moderatorin?" },
      { speaker: "Paul", text: "Ja, und die Werbung. Das ist heute fast das Beste." },
      { speaker: "Nina", text: "Ganz anders als früher: Damals hat die Werbung nur gestört." },
    ],
    questions: [
      {
