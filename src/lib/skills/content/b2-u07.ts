...
export const b2U07: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "verpacken", tr: "ambalajlamak", en: "to package" },
      { de: "das Etikett", tr: "etiket", en: "label" },
      { de: "sortenrein", tr: "türüne göre ayrılmış", en: "sorted by type" },
      { de: "recyceln", tr: "geri dönüştürmek", en: "to recycle" },
    ],
    minutes: 6,
    text:
    ...
    questions: [
      ...
      {
        text: "Die neue Verpackung war teurer als die alte.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Das war teurer, hat uns aber zwei große Kunden gebracht.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "modernisieren", tr: "modernleştirmek", en: "to modernize" },
    ...
    questions: [
      ...
      {
        text: "Das Innere der Häuser ist konsequent modernisiert worden.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „…das Innere dagegen ist konsequent modernisiert worden.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "leicht", tr: "hafif", en: "slight" },
      { de: "dicht", tr: "kapalı", en: "closed" },
      { de: "also", tr: "yani", en: "so" },
      { de: "die Staatsanwaltschaft", tr: "savcılık", en: "prosecutor's office" },
    ],
    minutes: 5,
    segments: [
      { speaker: "Reporterin", text: "Guten Morgen, können Sie mir sagen, was gestern auf der B31 passiert ist?" },
      { speaker: "Sprecher", text: "Gegen 16:40 Uhr wurden wir alarmiert. Drei Fahrzeuge waren beteiligt." },
      { speaker: "Reporterin", text: "Ist jemand verunglückt?" },
      { speaker: "Sprecher", text: "Zwei Personen wurden leicht verletzt, eine schwer. Alle drei sind ansprechbar." },
      { speaker: "Reporterin", text: "Wie schnell waren Sie vor Ort?" },
      { speaker: "Sprecher", text: "Die ersten Einsatzkräfte waren nach neun Minuten an der Unfallstelle." },
      { speaker: "Reporterin", text: "Und bis dahin?" },
      { speaker: "Sprecher", text: "Zwei Ersthelfer aus dem nachfolgenden Wagen haben sofort geholfen. Das war entscheidend." },
      { speaker: "Reporterin", text: "Die Straße war lange dicht." },
      { speaker: "Sprecher", text: "Sie wurde bis 21 Uhr gesperrt. Die Fahrbahn musste gereinigt werden." },
      { speaker: "Reporterin", text: "Steht die Ursache schon fest?" },
      { speaker: "Sprecher", text: "Ermittelt wird noch. Der Sicherheitsabstand war offenbar deutlich zu klein." },
      { speaker: "Reporterin", text: "Also fahrlässig?" },
      { speaker: "Sprecher", text: "Das entscheidet die Staatsanwaltschaft, nicht ich. Zeugen werden weiterhin gesucht." },
    ],
    questions: [
      {
        kind: "dictation",
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["bis 21 Uhr", "21 Uhr", "bis einundzwanzig Uhr", "bis 21:00 Uhr"],
      ...
      {
        text: "Der Sprecher überlässt die Entscheidung der Staatsanwaltschaft.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Das entscheidet die Staatsanwaltschaft, nicht ich.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "die Spezialität", tr: "özel yemek", en: "specialty" },
      { de: "herzhaft", tr: "tuzlu", en: "savory" },
      { de: "doppelt", tr: "iki kat", en: "double" },
    ],
    minutes: 5,
    segments: [
      { speaker: "Koch", text: "Willkommen. Drei Regeln, dann kannst du anfangen." },
      { speaker: "Azubi", text: "Ich höre." },
      { speaker: "Koch", text: "Erstens: Jede Zutat wird bei uns frisch geschnitten, nichts kommt aus der Dose." },
      { speaker: "Azubi", text: "Auch die Soßen?" },
      { speaker: "Koch", text: "Auch die. Zweitens: Gewürzt wird erst am Schluss, und nie von zwei Leuten." },
      { speaker: "Azubi", text: "Warum nie von zwei Leuten?" },
      { speaker: "Koch", text: "Weil dann doppelt gewürzt wird und niemand es merkt. Das darf nicht passieren." },
      { speaker: "Azubi", text: "Verstanden. Und drittens?" },
      { speaker: "Koch", text: "Der Hauptgang muss heiß serviert werden, der Nachtisch muss vorher abkühlen." },
      { speaker: "Azubi", text: "Wie lange kühlt der Nachtisch?" },
      { speaker: "Koch", text: "Mindestens vierzig Minuten. Wird er warm serviert, kommt er zurück." },
      { speaker: "Azubi", text: "Und was ist eure Spezialität?" },
      { speaker: "Koch", text: "Ein herzhafter Kuchen mit Käse und Zwiebeln. Der wird nur samstags gemacht." },
    ],
    questions: [
      {
        kind: "dictation",
      ...
      {
        text: "Nichts kommt aus der Dose.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Jede Zutat wird bei uns frisch geschnitten, nichts kommt aus der Dose.“ — soslar da dâhil.",
      },
    ],
  },
    ...
    tasks: [
      {
        ...
        alternatives: ["In vier Schritten wird der Rohstoff verarbeitet"],
      ...
      },
      {
        ...
        alternatives: ["In zwölf Jahren ist die Altstadt saniert worden"],
        hint: "Edilgen Perfekt: ist + ortaç + worden.",
      },
      {
        kind: "build",
        tr: "Yol saat 21.00'e kadar kapatıldı.",
        answer: "Die Straße wurde bis 21 Uhr gesperrt",
        alternatives: ["Bis 21 Uhr wurde die Straße gesperrt"],
...

  {
    ...
    gloss: [
      ...
      { de: "das Etikett", tr: "etiket", en: "label" },
      { de: "verladen", tr: "yüklemek", en: "to load" },
      { de: "abgekühlt", tr: "soğumuş", en: "cooled" },
    ],
    minutes: 12,
    tasks: [
      {
        ...
        sample:
          ...
          "Zuerst wird das Obst angeliefert und gewogen. Es wird sortiert, gewaschen und geprüft; was nicht in Ordnung ist, wird aussortiert. Für die Lagerung wird es nach Lieferung getrennt, damit später nachvollzogen werden kann, woher eine Charge stammt.\n\n" +
          "Anschließend wird das Obst in der Fertigung gepresst, der Saft wird erhitzt und wieder abgekühlt. Danach wird abgefüllt — vierhundert Flaschen in der Stunde, langsamer als bei den Großen, weil in kleinen Chargen gearbeitet wird.\n\n" +
          "Zum Schluss werden Verschluss und Etikett angebracht, dann wird verpackt. Die Kartons werden am selben Tag verladen.\n\n" +
          "Am schwierigsten ist die Sortierung: Sie wird von Hand gemacht, und ein Fehler, der dort übersehen wird, wird später von niemandem mehr gefunden.",
      },
    ],
  },
];
