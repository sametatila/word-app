...
export const enB1U13: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["read the folder", "read it to him", "read the folder to him"],
  ...
  },
  {
    ...
    gloss: [
      { de: "proctor", tr: "gözetmen" },
      { de: "the score", tr: "puan" },
    ...
    segments: [
      ...
      { speaker: "Tutor", text: "You must bring your card to the exam. Without it you do not enter, and the proctor cannot make an exception." },
      ...
      { speaker: "Tutor", text: "Even when it is off. Leave it at the door with the proctor." },
      ...
      { speaker: "Tutor", text: "It is. It is also the only thing that moves the score. Reading feels like work and practice is work." },
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["True", "False"],
        answer: 1,
        explain: "„Even when it is off. Leave it at the door with the proctor.“",
      },
      {
        kind: "gapfill",
    ...
    tasks: [
      ...
      },
      {
        ...
        fields: [
          ...
          { label: "Original brought", answer: "the twenty-first", accept: ["21", "the 21st", "21st"] },
