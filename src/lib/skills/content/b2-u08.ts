...
export const b2U08: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "tauschen", tr: "değiştirmek", en: "to swap" },
      ...
      { de: "austauschen", tr: "değiştirmek", en: "to exchange" },
    ],
    minutes: 6,
    text:
    ...
    questions: [
      ...
      {
        text: "Die Liste wird jedes Jahr ergänzt.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Die Liste wird jedes Jahr aus diesen Einträgen ergänzt — deshalb ist sie inzwischen vier Seiten lang.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "der Stadtrat", tr: "şehir meclisi", en: "city council" },
      { de: "strittig", tr: "ihtilaflı", en: "disputed" },
      { de: "das Chaos", tr: "karmaşa", en: "chaos" },
    ...
    questions: [
      ...
      {
        text: "Boulevardzeitungen schreiben grammatisch dasselbe wie Wochenzeitungen.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „…schreibt grammatisch dasselbe wie eine Wochenzeitung; der Unterschied liegt in der Wortwahl.“",
      },
    ],
  },
