    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Aber am Mittwoch bin ich sicher wieder da.“",
          ...
          {
        kind: "gapfill",
        text: "Ich habe ___ und liege im Bett.",
        options: [],
        answer: 0,
        accept: ["Fieber"],
        explain: "„Ich habe Fieber und liege im Bett.“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Es ist sehr dringend.“ — bu sözcük daha erken bir yer açtırır.",
          ...
          {
        kind: "gapfill",
        text: "Es ist sehr ___.",
        options: [],
        answer: 0,
        accept: ["dringend"],
        explain: "„Es ist sehr dringend.“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Vielleicht rufe ich morgen die Praxis an.“ — ayrılabilen fiil: rufe … an.",
          ...
          {
        kind: "gapfill",
        text: "Du sollst ins ___ und viel trinken.",
        options: [],
        answer: 0,
        accept: ["Bett"],
        explain: "„Du sollst ins Bett und viel trinken.“",
