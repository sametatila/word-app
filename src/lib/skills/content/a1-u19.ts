    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Das Fitnessstudio im Haus ist von 8 bis 22 Uhr auf.“",
          ...
          {
        kind: "gapfill",
        text: "Fußball: Wir suchen Spieler für unsere ___.",
        options: [],
        answer: 0,
        accept: ["Mannschaft"],
        explain: "„Fußball: Wir suchen Spieler für unsere Mannschaft.“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Ich spiele auch Gitarre, aber nicht so gut.“ — artikel YOK.",
          ...
          {
        kind: "gapfill",
        text: "In meiner ___ spielen wir zusammen und schreiben Lieder.",
        options: [],
        answer: 0,
        accept: ["Band"],
        explain: "„In meiner Band spielen wir zusammen und schreiben Lieder.“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Und Popcorn kaufe ich!“ — cevap veren kişi.",
          ...
          {
        kind: "gapfill",
        text: "Wann fängt der ___ an?",
        options: [],
        answer: 0,
        accept: ["Film"],
        explain: "„Wann fängt der Film an?“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Am Samstag will ich draußen sein.“",
          ...
          {
        kind: "gapfill",
        text: "Am ___ will ich draußen sein.",
        options: [],
        answer: 0,
        accept: ["Samstag"],
        explain: "„Am Samstag will ich draußen sein.“",
