...
export const b2U05: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Die Kündigung gilt auch ohne Antwort des Anbieters.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Dann gilt die Kündigung trotzdem, sofern sie nachweislich zugegangen ist.“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        text: "Die Gemeinde kommt erst im dritten Schritt ins Spiel.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Erst im dritten Schritt kommt die Gemeinde ins Spiel, und zwar nur bei wiederholter Ruhestörung.“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        text: "Deniz hat den Kaufbeleg dabei.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Ja, und die beiden Reparaturbelege.“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        text: "Sonja sagt, Wertschätzung sei kein Vorwort.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Wertschätzung ist kein Vorwort.“",
      },
    ],
  },
