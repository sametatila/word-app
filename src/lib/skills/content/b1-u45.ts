...
export const b1U45: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Sarah", text: "Ich habe gestern hinter dem Haus eine Schlange entdeckt." },
      { speaker: "Jan", text: "War sie giftig?" },
      { speaker: "Sarah", text: "Nein. Hier gibt es nur eine giftige Art, und die sieht anders aus." },
      { speaker: "Jan", text: "Trotzdem: Mir wäre das nicht angenehm." },
      { speaker: "Sarah", text: "Sie frisst Mäuse. Eigentlich hilft sie uns." },
      { speaker: "Jan", text: "Das schon. Aber ich lasse den Garten trotzdem prüfen." },
      { speaker: "Sarah", text: "Kannst du machen. Das kostet nichts, wenn du beim Amt fragst." },
      { speaker: "Jan", text: "Gut zu wissen. Dann rufe ich morgen dort an." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Lehrerin", text: "Das war die letzte Stunde. Wie geht es bei euch weiter?" },
      { speaker: "Jonas", text: "Ich mache im Herbst B2. Vorher brauche ich eine Pause." },
      { speaker: "Lehrerin", text: "Verständlich. Und du?" },
      { speaker: "Mia", text: "Ich weiß es noch nicht endgültig. Erst mal weiterlesen." },
      { speaker: "Jonas", text: "Wir könnten uns einmal im Monat verabreden und nur reden." },
      { speaker: "Lehrerin", text: "Gute Idee. Ihr könnt mich jederzeit fragen, ich helfe gern." },
      { speaker: "Mia", text: "Danke nochmals für alles. Wirklich." },
      { speaker: "Lehrerin", text: "Gleichfalls. Es hat mir mit euch Spaß gemacht." },
    ],
    questions: [
      {
