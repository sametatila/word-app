...
export const b1U17: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Leon", text: "Das Ende hat mich total überrascht. Damit hatte ich nicht gerechnet." },
      { speaker: "Mia", text: "Mir gefällt die Serie immer besser." },
      { speaker: "Leon", text: "Mir auch. Vor allem die Stimmung, alles ist so ruhig und dunkel." },
      { speaker: "Mia", text: "Ich freue mich schon auf die Fortsetzung im Herbst." },
      { speaker: "Leon", text: "Ich weiß nicht. Manchmal ist eine Fortsetzung schlechter." },
      { speaker: "Mia", text: "Kann sein. Aber über diese Überraschung habe ich mich echt gefreut." },
      { speaker: "Leon", text: "Gut, dann schauen wir noch eine Folge. Aber wirklich nur eine." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      ...
      { speaker: "Jonas", text: "Ruhe. Alles war laut, von der ersten Minute an." },
      { speaker: "Clara", text: "Dann gefällt dir das nächste Konzert besser. Da wird nur Klavier gespielt." },
    ],
    questions: [
      {
