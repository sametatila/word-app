...
export const enB2U15: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Kerem", text: "Does the union use these?" },
      { speaker: "Nesrin", text: "The union uses the mixed one and the lawyers use the closed ones, and that difference is not a style. A closed sentence is about a termination. A mixed one is about a town." },
    ...
    questions: [
      ...
      {
        kind: "truefalse",
        text: "The union uses the mixed sentence and the lawyers use the closed ones.",
        options: ["True", "False"],
        answer: 0,
        explain: "„The union uses the mixed one and the lawyers use the closed ones…“",
      },
      {
        kind: "gapfill",
