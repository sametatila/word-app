...
export const a2U23: SkillExercise[] = [
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "vorbeigehen", tr: "önünden geçmek", en: "to walk past" },
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 0,
        accept: ["ausprobiert"],
        explain: "Ayrılabilen fiilin Perfekt biçimi: ausprobiert; -ieren ile biten probieren ge- almaz, bu yüzden aus-ge-probiert değil.",
      },
      {
