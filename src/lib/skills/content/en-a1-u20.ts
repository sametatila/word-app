  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„And on the weekend? Maybe the movies, maybe the park. I can decide later.“",
      },
    ],
  },
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        hint: "Olumsuzu tek sözcük: „can't“ (uzun biçimi „cannot“).",
      },
      {
        kind: "build",
        tr: "Yüzebilir misin?",
      ...
      },
      {
        ...
        alternatives: ["Every evening I watch series."],
      ...
      },
      {
        ...
        fields: [
          ...
          { label: "How often", answer: "every week", accept: ["each week"] },
