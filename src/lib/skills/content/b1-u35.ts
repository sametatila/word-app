...
export const b1U35: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Friseurin", text: "Guten Tag. Was darf es sein?" },
      { speaker: "Kunde", text: "Nur schneiden bitte, nicht zu kurz." },
      { speaker: "Friseurin", text: "Wie viel etwa? Zwei Finger?" },
      { speaker: "Kunde", text: "Ein Finger reicht. Die Frisur soll gleich bleiben." },
      { speaker: "Friseurin", text: "Verstanden. Und der Bart?" },
      { speaker: "Kunde", text: "Den mache ich selber, danke." },
      { speaker: "Friseurin", text: "Gut. Waschen ist im Preis, das dauert fünf Minuten. Der Friseur nebenan nimmt dafür mehr, bei uns im Salon nicht." },
      { speaker: "Kunde", text: "Gern. Ich habe sowieso Zeit, ich bin seit Mai Pensionist." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Lena", text: "Ich mache mir Sorgen um meinen Bruder." },
      { speaker: "Frank", text: "Warum? Ist etwas passiert?" },
      { speaker: "Lena", text: "Er kommt oft betrunken nach Hause, dreimal die Woche." },
      { speaker: "Frank", text: "Hast du mit ihm geredet?" },
      { speaker: "Lena", text: "Ich habe es versucht. Er sagt, er kann jederzeit aufhören." },
      { speaker: "Frank", text: "Das sagen fast alle. Aufhalten kannst du ihn nicht. Achtung, das gilt auch für jede andere Droge." },
      { speaker: "Lena", text: "Was mache ich dann?" },
      { speaker: "Frank", text: "Sag einmal ruhig, was du siehst. Und dann bleib da." },
    ],
    questions: [
      {
