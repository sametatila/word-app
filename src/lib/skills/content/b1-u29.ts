...
export const b1U29: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Verkäufer", text: "Gern. Welche Größe haben Sie?" },
      { speaker: "Kundin", text: "Achtunddreißig. Und bitte nichts aus Kunststoff." },
      { speaker: "Verkäufer", text: "Verstehe. Dieses hier ist aus Wolle, das trägt sich angenehm." },
      { speaker: "Kundin", text: "Der Stoff gefällt mir. Gibt es das auch in Blau?" },
      { speaker: "Verkäufer", text: "In Blau leider nur eine Nummer größer." },
      { speaker: "Kundin", text: "Dann probiere ich das graue. Und dazu vielleicht Strümpfe?" },
      { speaker: "Verkäufer", text: "Die liegen im Kasten am Eingang, gleich neben den Socken." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Verkäufer", text: "Diese Schüssel gibt es aus Holz, aus Metall und aus Plastik." },
      { speaker: "Kundin", text: "Was halten Sie für das Beste?" },
      { speaker: "Verkäufer", text: "Kommt darauf an. Metall hält am längsten, ist aber schwer." },
      { speaker: "Kundin", text: "Und Holz?" },
      { speaker: "Verkäufer", text: "Sieht am schönsten aus, darf aber nicht in die Maschine." },
      { speaker: "Kundin", text: "Dann lieber Metall. Bei Plastik habe ich kein gutes Gefühl." },
      { speaker: "Verkäufer", text: "Verstehe ich. Brauchen Sie sonst noch etwas?" },
      { speaker: "Kundin", text: "Ja, eine Batterie und einen Stecker für das kleine Teil hier." },
    ],
    questions: [
      {
