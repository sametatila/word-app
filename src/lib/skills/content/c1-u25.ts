...
export const c1U25: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "klagen", tr: "yakınmak", en: "to complain of" },
      { de: "lesen", tr: "okumak", en: "to read" },
      { de: "das Jahrhundert", tr: "yüzyıl", en: "century" },
      { de: "das Trottoir", tr: "kaldırım", en: "sidewalk" },
      { de: "der Pass", tr: "pasaport", en: "passport" },
      { de: "grob", tr: "kaba", en: "coarse" },
      { de: "innerhalb", tr: "içinde", en: "within" },
      { de: "der Text", tr: "metin", en: "text" },
      { de: "die Epoche", tr: "çağ", en: "era" },
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "überwiegen", tr: "ağır basmak", en: "to outweigh" },
