...
export const b1U04: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Lisa", text: "Schön, dass du da bist. Wir sind zu dritt in der WG." },
      { speaker: "Tim", text: "Danke. Wie ist das mit der Küche und dem Bad?" },
      { speaker: "Lisa", text: "Jeder reinigt eine Woche lang alles Gemeinsame. Danach ist der Nächste dran." },
      { speaker: "Tim", text: "Das finde ich gut. Und darf man ein Haustier haben?" },
      { speaker: "Lisa", text: "Eine Katze wäre möglich, aber wir müssten uns vorher alle einigen." },
      { speaker: "Tim", text: "Verstehe. Wann ist bei euch Ruhe?" },
      { speaker: "Lisa", text: "Ab elf. Wenn du länger arbeitest, ist das kein Problem — sag nur Bescheid." },
      { speaker: "Tim", text: "Gut. Ich würde gern nächste Woche einziehen." },
    ],
    questions: [
      {
