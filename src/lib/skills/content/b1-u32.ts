...
export const b1U32: SkillExercise[] = [
  ...
  },
  {
    ...
    segments: [
      { speaker: "Ben", text: "Im Gebirge kann das Wetter in einer Stunde umschlagen." },
      { speaker: "Sarah", text: "Heute soll es aber ruhig bleiben, oder?" },
      { speaker: "Ben", text: "Am Vormittag ja. Ab drei kommt Nebel, vielleicht sogar Sturm." },
      { speaker: "Sarah", text: "Dann gehen wir früh los und sind um zwei wieder im Tal." },
      { speaker: "Ben", text: "Genau. Und wir bleiben auf dem Weg, nicht auf der Wiese." },
      { speaker: "Sarah", text: "Klar. Im Nebel findet man auf dem Gras keine Spur mehr." },
      { speaker: "Ben", text: "Ich nehme trotzdem die Jacke mit. Oben ist es immer kälter." },
      { speaker: "Sarah", text: "Gute Idee. In zwei Stunden sind wir oben, wenn es gut läuft." },
    ],
    questions: [
      {
