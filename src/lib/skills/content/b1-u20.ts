...
export const b1U20: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Arzt", text: "Sie bekommen heute die Impfung. Haben Sie noch Fragen?" },
      { speaker: "Patientin", text: "Wie lange schützt sie denn?" },
      { speaker: "Arzt", text: "Etwa fünf Jahre. Danach kommen Sie zur Kontrolle, damit der Schutz gegen das Virus bleibt." },
      { speaker: "Patientin", text: "Und was kann danach auftreten?" },
      { speaker: "Arzt", text: "Die Haut wird an der Stelle rot, manchmal für zwei Tage." },
      { speaker: "Patientin", text: "Ist das gefährlich?" },
      { speaker: "Arzt", text: "Nein, harmlos. Wenn Sie Fieber bekommen, rufen Sie an." },
      { speaker: "Patientin", text: "Gut. Ich konnte letztes Jahr nicht kommen, deshalb bin ich froh, dass es jetzt klappt." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Lena", text: "Gute Besserung! Wir haben dir etwas zu lesen mitgebracht." },
      { speaker: "Jonas", text: "Danke, das ist lieb. Setzt euch." },
      { speaker: "Lena", text: "Wie war die Nacht?" },
      { speaker: "Jonas", text: "Kurz. Um sechs wurde schon Blut abgenommen. Auf der Station wird man früh geweckt." },
      { speaker: "Lena", text: "Und heute? Musstest du wieder zur Untersuchung?" },
      { speaker: "Jonas", text: "Ja, um zehn. Danach hatte ich keine Kraft mehr." },
      { speaker: "Lena", text: "Dann bleiben wir nicht lang. Wir wollten dich nur aufmuntern." },
      { speaker: "Jonas", text: "Das hat schon geholfen. Kommt zumindest am Wochenende wieder." },
    ],
    questions: [
      {
