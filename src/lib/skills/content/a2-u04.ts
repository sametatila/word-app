...
export const a2U04: SkillExercise[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        text: "Tobias hat zuvor in einem Dorf gewohnt.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Zuvor habe ich in einem Dorf gewohnt, mit dreihundert Leuten.“",
      },
    ],
  },
  {
    ...
    gloss: [
      { de: "der Kofferraum", tr: "araba bagajı", en: "car trunk" },
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "verabredet sein", tr: "randevulaşmak", en: "to have a date" },
    ...
    tasks: [
      {
        ...
        alternatives: ["Seit drei Jahren wohne ich hier", "Ich wohne hier seit drei Jahren"],
      ...
      },
      {
        ...
        answer: "Vor drei Jahren bin ich hierhergekommen",
        alternatives: ["Ich bin vor drei Jahren hierhergekommen"],
      ...
      },
      {
        ...
        alternatives: ["Seit fünf Jahren sind wir befreundet"],
      ...
      },
      {
        ...
        alternatives: ["Ich wohne seit einem Jahr hier", "Seit einem Jahr wohne ich hier", "Ich wohne hier seit einem Jahr"],
