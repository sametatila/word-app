...
export const enA1U14: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Station", text: "The bus to the airport leaves from the street behind the station." },
      { speaker: "Station", text: "The taxis are in front of the station, on the square." },
    ],
    questions: [
      {
      ...
      {
        kind: "gapfill",
        text: "The bus to the airport leaves from the street ___ the station.",
        options: [],
        answer: 0,
        accept: ["behind"],
        explain: "„The bus to the airport leaves from the street behind the station.“",
      },
      {
        kind: "dictation",
      ...
      {
        kind: "short_answer",
        text: "Where are the taxis?",
        options: [],
        answer: 0,
        accept: ["in front of the station", "on the square", "in front of the station, on the square"],
        explain: "„The taxis are in front of the station, on the square.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "short_answer",
        text: "How long does it take to get to the airport by taxi?",
        options: [],
        answer: 0,
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        alternatives: ["Stop here, please."],
        hint: "Emirde özne yok; „please“ başta ya da sonda durabilir.",
      },
      {
        kind: "form",
        prompt: "Bilet formunu doldur.",
        facts: "Londra; gidiş-dönüş; peron dört; kırk sterlin.",
        fields: [
          { label: "To", answer: "London" },
          { label: "Ticket", answer: "round-trip", accept: ["round trip", "a round-trip ticket"] },
          { label: "Platform", answer: "four", accept: ["4"] },
          { label: "Price", answer: "forty pounds", accept: ["40 pounds", "forty"] },
        ],
      },
    ],
  },
