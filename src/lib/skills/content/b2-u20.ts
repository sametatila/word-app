...
export const b2U20: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "gesetzlich", tr: "yasal", en: "statutory" },
      { de: "messen", tr: "ölçmek", en: "to measure" },
      { de: "rechnen", tr: "hesaplamak", en: "to calculate" },
      { de: "dramatisieren", tr: "dramatize etmek", en: "to dramatize" },
      { de: "das Produkt", tr: "ürün", en: "product" },
      { de: "der Arbeitgeber", tr: "işveren", en: "employer" },
      { de: "abrufen", tr: "talep edip almak", en: "to retrieve" },
      { de: "nirgendwo", tr: "hiçbir yerde", en: "nowhere" },
      { de: "unbequem", tr: "rahatsız", en: "uncomfortable" },
      { de: "statistisch", tr: "istatistiksel", en: "statistical" },
...

  {
    ...
    gloss: [
      ...
      { de: "die Anzeige", tr: "bildirim", en: "notification" },
      { de: "verboten", tr: "yasak", en: "forbidden" },
      { de: "zählen", tr: "saymak", en: "to count" },
      { de: "gesetzlich", tr: "yasal", en: "statutory" },
      { de: "rechnen", tr: "hesaplamak", en: "to calculate" },
      { de: "die Nebentätigkeit", tr: "yan iş", en: "side job" },
    ],
    minutes: 6,
    text:
...

  {
    ...
    segments: [
      ...
      { speaker: "Levin", text: "Wann hast du die Stelle angetreten?" },
...

  {
    ...
    tasks: [
      ...
      },
      {
        ...
        alternatives: ["Er macht trotz der Belastung weiter"],
        hint: "trotz genitifli bir ad öbeği ister, yan cümle değil.",
      },
      {
        kind: "build",
        tr: "Son net gelire göre emekli maaşı muhtemelen daha düşük olacak.",
        answer: "Gemessen am letzten Nettoeinkommen dürfte die Rente niedriger sein",
        alternatives: ["Die Rente dürfte niedriger sein, gemessen am letzten Nettoeinkommen"],
