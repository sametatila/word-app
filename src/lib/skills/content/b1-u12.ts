...
export const b1U12: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Arzthelferin", text: "Guten Tag, hier Praxis Berger. Ihr Termin morgen fällt leider aus. Wir müssen ihn absagen." },
      { speaker: "Patient", text: "Oh. Ist etwas passiert?" },
      { speaker: "Arzthelferin", text: "Die Kollegin ist krank geworden. Es tut uns leid." },
      { speaker: "Patient", text: "Kein Problem. Wann geht es denn sonst?" },
      { speaker: "Arzthelferin", text: "Donnerstag um zehn? Freitag ist Feiertag, da haben wir zu." },
      { speaker: "Patient", text: "Donnerstag passt. Können Sie mir das schriftlich bestätigen?" },
      { speaker: "Arzthelferin", text: "Natürlich, ich schicke Ihnen gleich eine Nachricht." },
      { speaker: "Patient", text: "Danke. Dann muss ich mich Donnerstag früh beeilen, aber das geht." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Tim", text: "Ich mache das zum ersten Mal. Was kann ich überhaupt angeben?" },
      { speaker: "Karin", text: "Alles, was mit der Arbeit zu tun hat. Fahrten, Kurse, Werkzeug." },
      { speaker: "Tim", text: "Auch den Sprachkurs vom letzten Jahr?" },
      { speaker: "Karin", text: "Wenn er beruflich war, ja. Hast du die Quittung noch?" },
      { speaker: "Tim", text: "Ich glaube schon. Ich bin damals nur dafür hingefahren." },
      { speaker: "Karin", text: "Gut, dann gib auch die Fahrten an. Sammle möglichst alles." },
      { speaker: "Tim", text: "Und meine Einnahmen aus dem Nebenjob?" },
      { speaker: "Karin", text: "Die musst du sowieso angeben. Da hast du keine Wahl." },
    ],
    questions: [
      {
