...
export const enA1U15: SkillExercise[] = [
  ...
  },
  {
    ...
    minutes: 4,
    segments: [
      { speaker: "Visitor", text: "Excuse me, I have a question. When does the museum open?" },
      { speaker: "Clerk", text: "The museum opens at ten. It closes at six." },
    ...
    questions: [
      {
        ...
        answer: 0,
        explain: "„The museum opens at ten. It closes at six.“ — üç, kursun saati.",
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          "Can I take photos?",
          "How do I get to the church from here?",
        ],
        explain: "Önce saat, sonra süre, sonra izin, en son yol.",
      },
      {
        kind: "short_answer",
        ...
        explain: "„It is five minutes on foot.“ — araçta „by“, yürümekte „on“.",
      },
    ],
  },
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        alternatives: ["Today the museum is open."],
