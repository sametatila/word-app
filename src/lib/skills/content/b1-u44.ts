...
export const b1U44: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Lena", text: "Ich will wieder anfangen, aber ich weiß nicht, welche Sportart." },
      { speaker: "Tim", text: "Was hast du früher gemacht?" },
      { speaker: "Lena", text: "Ich bin geklettert. Aber das ist mir jetzt zu viel." },
      { speaker: "Tim", text: "Dann geh ins Hallenbad. Schwimmen kann man jeden Tag." },
      { speaker: "Lena", text: "Ich schwimme nicht gern lang. Nach zehn Minuten ist mir langweilig." },
      { speaker: "Tim", text: "Dann tauch mal. Da ist die Zeit ganz anders." },
      { speaker: "Lena", text: "Stimmt, das habe ich als Kind gern gemacht." },
      { speaker: "Tim", text: "Fang klein an. Zwanzig Minuten lang reicht am Anfang." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Ben", text: "Wollen wir am Wochenende zelten?" },
      { speaker: "Clara", text: "Gern. Aber nicht auf dem Rasen im Park, das ist verboten." },
      { speaker: "Ben", text: "Nein, hinter dem Feld beim Hof von Familie Klein." },
      { speaker: "Clara", text: "Haben die das erlaubt?" },
      { speaker: "Ben", text: "Ja, ich habe gestern gefragt. Zwei Nächte lang dürfen wir." },
      { speaker: "Clara", text: "Perfekt. Um diese Zeit blüht dort alles." },
      { speaker: "Ben", text: "Genau. Und morgens um sechs ist es noch ganz still." },
      { speaker: "Clara", text: "Dann packe ich heute Abend. Es ist erst Mittwoch, wir haben Zeit." },
    ],
    questions: [
      {
