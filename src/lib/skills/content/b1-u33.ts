...
export const b1U33: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Tim", text: "Erzähl noch mal von der Nacht am Ozean." },
      { speaker: "Lisa", text: "Als wir ankamen, war das Lager schon voll." },
      { speaker: "Tim", text: "Und dann?" },
      { speaker: "Lisa", text: "Wir haben oben am Hügel geschlafen, ohne Zelt. Das war ein echtes Abenteuer." },
      { speaker: "Tim", text: "Ohne Zelt? War das nicht kalt?" },
      { speaker: "Lisa", text: "Sehr. Aber als der Mond weg war, sah man jeden Stern." },
      { speaker: "Tim", text: "Hast du Fotos gemacht?" },
      { speaker: "Lisa", text: "Ein Video. Für eine gute Fotografie war es viel zu dunkel." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Arzt", text: "Was ist passiert?" },
      { speaker: "Patientin", text: "Ich bin auf der Treppe gefallen und mir tut das Knie weh." },
      { speaker: "Arzt", text: "Können Sie es bewegen?" },
      { speaker: "Patientin", text: "Ja, aber nur langsam. Die Schulter geht besser." },
      { speaker: "Arzt", text: "Gut. Steckt etwas in der Wunde?" },
      { speaker: "Patientin", text: "Ich glaube nicht. Ich habe sie zu Hause gewaschen." },
      { speaker: "Arzt", text: "Richtig so. Dann bekommen Sie keine Spritze, nur ein Pflaster." },
      { speaker: "Patientin", text: "Und wenn es morgen schlimmer wird?" },
    ],
    questions: [
      {
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    tasks: [
      ...
      {
        kind: "build",
        tr: "Dizim iki gündür ağrıyor, sinir tahriş olmuş.",
        answer: "Mir tut das Knie seit zwei Tagen weh, der Nerv ist gereizt.",
        alternatives: ["Das Knie tut mir seit zwei Tagen weh, der Nerv ist gereizt."],
