...
export const b2U10: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Eine Auswahl von Themen ist nie objektiv.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Eine Auswahl ist nie objektiv — schon die Entscheidung, worüber berichtet wird, ist eine Wertung.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "die Eigenschaft", tr: "özellik", en: "characteristic" },
      { de: "die Bilanz", tr: "bilanço", en: "track record" },
      { de: "der Text", tr: "metin", en: "text" },
      { de: "gelesene", tr: "okunmuş", en: "read" },
      { de: "unscharf", tr: "bulanık", en: "blurred" },
    ],
    minutes: 6,
    text:
    ...
    questions: [
      ...
      {
        text: "Wer ein Produkt geschenkt bekommt, muss trotzdem kennzeichnen.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „…muss nach der geltenden Rechtsprechung trotzdem kennzeichnen, sobald ein Gegenwert im Spiel ist.“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["Leute zwischen 25 und 40", "Erstumziehende", "junge Menschen beim Umzug", "Leute, die zum ersten Mal umziehen", "zwischen 25 und 40"],
      ...
      {
        text: "Die Folge soll unter dreißig Minuten bleiben.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Und wir bleiben unter dreißig Minuten, das war der andere Wunsch.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "lesen", tr: "okumak", en: "to read" },
      { de: "belasten", tr: "kirletmek", en: "to contaminate" },
      { de: "sehen", tr: "görmek", en: "to see" },
      ...
      { de: "die Verallgemeinerung", tr: "genelleme", en: "generalization" },
    ],
    minutes: 5,
    segments: [
      ...
      { speaker: "Ferit", text: "Und aus einem Einzelwert wird eine Falschmeldung für die ganze Stadt." },
...

  {
    ...
    tasks: [
      ...
      {
        kind: "build",
        tr: "Raporda birkaç hata varmış.",
        answer: "Der Bericht soll mehrere Fehler enthalten",
        hint: "sollen başkasının iddiasını işaretler: bilgi yazana değil, başkalarına ait.",
      },
      {
        kind: "build",
...

  {
    ...
    gloss: [
      ...
      { de: "der Grenzwert", tr: "sınır değer", en: "limit value" },
      { de: "die Baustelle", tr: "şantiye", en: "construction site" },
      { de: "der Prüfbericht", tr: "test raporu", en: "test report" },
