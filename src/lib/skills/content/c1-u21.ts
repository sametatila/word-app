...
export const c1U21: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "die Übertreibung", tr: "abartma", en: "exaggeration" },
      { de: "meiste", tr: "çoğu", en: "most" },
      { de: "erschließen", tr: "çıkarsamak", en: "to infer" },
      { de: "der Text", tr: "metin", en: "text" },
      { de: "mehrdeutig", tr: "çok anlamlı", en: "ambiguous" },
      { de: "eindeutig", tr: "net", en: "unambiguous" },
      { de: "solche", tr: "böyle", en: "such" },
      { de: "normal", tr: "normal", en: "normal" },
      { de: "unmarkiert", tr: "işaretsiz", en: "unmarked" },
    ],
    minutes: 7,
    text:
      "WENN DER TON FEHLT\n\n" +
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "die Verteidigung", tr: "savunma", en: "defense" },
      { de: "entwerten", tr: "değersizleştirmek", en: "to devalue" },
      { de: "wahr", tr: "gerçek", en: "true" },
      { de: "leicht", tr: "kolayca", en: "easily" },
      ...
      { de: "der Text", tr: "metin", en: "text" },
      { de: "unpassend", tr: "uygunsuz", en: "unsuitable" },
    ],
    minutes: 7,
    text:
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "genau", tr: "tam olarak", en: "exactly" },
      { de: "das Verbrechen", tr: "suç", en: "crime" },
      { de: "die Erklärung", tr: "açıklama", en: "explanation" },
