...
export const b1U16: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Karin", text: "Wir reden seit einer Stunde und alles ist durcheinander." },
      { speaker: "Jan", text: "Das liegt daran, dass jeder von etwas anderem spricht." },
      { speaker: "Karin", text: "Da stimme ich dir zu. Sollen wir kurz sammeln, worum es geht?" },
      { speaker: "Jan", text: "Gute Idee. Ich schreibe die Punkte auf." },
      { speaker: "Mira", text: "Ich möchte hier widersprechen: Das Geld ist nicht das Problem." },
      { speaker: "Karin", text: "Vorsicht — vielleicht ist es für andere Teilnehmer doch eins." },
      { speaker: "Mira", text: "Einverstanden. Dann suchen wir einen Kompromiss." },
      { speaker: "Jan", text: "Wenn wir miteinander statt gegeneinander reden, geht das schnell." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Lena", text: "Ich lese seit einem Monat nur noch morgens Nachrichten." },
      { speaker: "Paul", text: "Und? Fehlt dir etwas?" },
      { speaker: "Lena", text: "Nein. Am Abend waren es sowieso immer dieselben Neuigkeiten." },
      { speaker: "Paul", text: "Bei mir hängt das davon ab, wie der Tag war." },
      { speaker: "Lena", text: "Verstehe. Ich habe vor allem die Werbung reduziert." },
      { speaker: "Paul", text: "Ich lese lieber einmal pro Woche ein Magazin. Das reicht mir." },
      { speaker: "Lena", text: "Das ist bewusster. Kurze Meldungen machen mich nur unruhig." },
      { speaker: "Paul", text: "Genau. Und man erinnert sich am Ende an fast nichts davon." },
    ],
    questions: [
      {
