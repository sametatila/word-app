...
export const c1U16: SkillExercise[] = [
  ...
  },
  {
    ...
    segments: [
      ...
      { speaker: "Frau Lenz", text: "Es wäre kürzer und schwächer. „Wir müssen“ lädt zur Diskussion ein: Wer sagt, dass wir müssen? „Das zu lösende Problem“ macht es zu einer Eigenschaft der Sache." },
    ...
    questions: [
      {
        ...
        answer: 1,
        explain: "„‚Wir müssen‘ lädt zur Diskussion ein: Wer sagt, dass wir müssen?“",
      },
      {
        kind: "gapfill",
