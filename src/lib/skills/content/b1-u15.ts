...
export const b1U15: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Petra", text: "Du, in der Abrechnung von gestern sind zwei Zahlen falsch." },
      { speaker: "Jan", text: "Oh nein. Das ist mir peinlich." },
      { speaker: "Petra", text: "Muss es nicht. Ich weise dich darauf hin, damit du es korrigieren kannst." },
      { speaker: "Jan", text: "Danke. Ich ärgere mich trotzdem über mich selbst." },
      { speaker: "Petra", text: "Das bringt nichts. Wichtig ist nur, dass es niemand weitergibt." },
      { speaker: "Jan", text: "Verzeihung, ich mache das sofort." },
      { speaker: "Petra", text: "Kein Stress. Und nimm dir zehn Minuten, bevor du es abschickst." },
      { speaker: "Jan", text: "Einverstanden. Beim nächsten Mal lese ich alles noch einmal." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Frank", text: "Ich begleite dich jetzt seit sechs Monaten. Wie siehst du das?" },
      { speaker: "Lea", text: "Besser als am Anfang. Aber ich weiß nicht, in welche Richtung es geht." },
      { speaker: "Frank", text: "Das ist normal. Was hast du in dieser Zeit erlebt?" },
      { speaker: "Lea", text: "Dass ich gern erkläre. Der Vortrag im März hat mir Spaß gemacht." },
      { speaker: "Frank", text: "Dann ist mein Ratschlag: Geh in diese Richtung." },
      { speaker: "Lea", text: "Meinst du wirklich? Ich habe keine Erfahrung im Unterrichten." },
      { speaker: "Frank", text: "Noch nicht. Meine Empfehlung wäre eine Weiterbildung nebenher." },
      { speaker: "Lea", text: "Von deinem Standpunkt aus ist das klar. Ich denke darüber nach." },
    ],
    questions: [
      {
