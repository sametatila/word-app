    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Mit der Bahn dauert es 20 Minuten.“",
          ...
          {
        kind: "gapfill",
        text: "Wir ___: Leihen Sie ein Fahrrad!",
        options: [],
        answer: 0,
        accept: ["empfehlen"],
        explain: "„Wir empfehlen: Leihen Sie ein Fahrrad!“",
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Der Ausgang zur Stadt ist hinten links.“ Taksiler karşıda.",
          ...
          {
        kind: "gapfill",
        text: "Sie müssen nicht ___.",
        options: [],
        answer: 0,
        accept: ["umsteigen"],
        explain: "„Sie müssen nicht umsteigen.“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "Yanlış: „Nein, zehn Minuten zu Fuß.“",
          ...
          {
        kind: "gapfill",
        text: "Gehen Sie geradeaus bis zur ___.",
        options: [],
        answer: 0,
        accept: ["Ampel"],
        explain: "„Gehen Sie geradeaus bis zur Ampel.“",
      },
],
  },
  {
