...
export const b1U09: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Jonas", text: "Und? In welchem Bezirk suchst du jetzt?" },
      { speaker: "Mia", text: "Im Osten. Da ist die Umgebung ruhiger." },
      { speaker: "Jonas", text: "Aber der öffentliche Verkehr, auf den du angewiesen bist, ist dort schlecht." },
      { speaker: "Mia", text: "Der Bus, mit dem ich zur Arbeit fahre, kommt alle zehn Minuten." },
      { speaker: "Jonas", text: "Wirklich? Dann nehme ich das zurück." },
      { speaker: "Mia", text: "Wichtig ist mir eine Wohnung, in der ich mich wohlfühle." },
      { speaker: "Jonas", text: "Verstehe. Und die Lage zum Park?" },
      { speaker: "Mia", text: "Fünf Minuten. Das Gebiet, von dem ich rede, ist ziemlich grün." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Nina", text: "Hast du kurz Zeit? Ich möchte über gestern reden." },
      { speaker: "Tim", text: "Ja. Ich habe mich inzwischen beruhigt." },
      { speaker: "Nina", text: "Das war mein Fehler. Ich hätte nicht so laut werden sollen." },
      { speaker: "Tim", text: "Die Schuld liegt nicht nur bei dir. Ich war auch nicht höflich." },
      { speaker: "Nina", text: "Ich hatte das Gefühl, dass du mir nicht mehr vertraust." },
      { speaker: "Tim", text: "Doch. Der Mensch, dem ich am meisten vertraue, bist du." },
      { speaker: "Nina", text: "Dann verzeihst du mir?" },
      { speaker: "Tim", text: "Schon lange. Lass uns das einfach akzeptieren und weitermachen." },
    ],
    questions: [
      {
