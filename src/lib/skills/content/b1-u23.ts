...
export const b1U23: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Ben", text: "Was würdest du machen, wenn du plötzlich reich wärst?" },
      { speaker: "Lisa", text: "Ich würde die Hälfte verteilen. Wirklich." },
      { speaker: "Ben", text: "Das sagen alle. Und die andere Hälfte?" },
      { speaker: "Lisa", text: "Ein kleines Boot. Kein Gold, kein großes Haus." },
      { speaker: "Ben", text: "Ein Boot wäre auch mein Vergnügen. Aber ich könnte nicht aufhören zu arbeiten." },
      { speaker: "Lisa", text: "Warum nicht? Wenn ich nicht müsste, würde ich sofort aufhören." },
      { speaker: "Ben", text: "Nach zwei Monaten wäre mir langweilig. Das ist kein Wunder." },
      { speaker: "Lisa", text: "Dann arbeite eben vier Stunden am Tag. So schwer ist das nicht." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Petra", text: "Ich habe mich entschlossen. Ab Januar arbeite ich nur noch vier Tage." },
      { speaker: "Tom", text: "Wirklich? Das ist eine große Änderung." },
      { speaker: "Petra", text: "Ich wünsche mir das seit Jahren. Jetzt reicht es mir." },
      { speaker: "Tom", text: "Hättest du das früher gemacht, wärst du nicht so erschöpft gewesen." },
      { speaker: "Petra", text: "Ich weiß. Aber ich hatte immer Angst vor dem Beginn." },
      { speaker: "Tom", text: "Verstehe ich. Sag es aber der Chefin selbst, nicht über andere." },
      { speaker: "Petra", text: "Natürlich. Es ist ja kein Geheimnis." },
      { speaker: "Tom", text: "Gut. Zukünftig hast du dann drei Tage für dich." },
    ],
    questions: [
      {
