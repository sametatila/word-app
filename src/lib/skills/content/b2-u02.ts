...
export const b2U02: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Der Text hält eine höfliche Rückfrage nicht für eine Störung.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Eine höfliche Rückfrage ist keine Störung, sondern der einzige Weg, ein Missverständnis zu klären.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "parallel", tr: "paralel", en: "parallel" },
      { de: "abgeschlossen sein", tr: "tamamlanmış olmak", en: "to be completed" },
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "Metinde aynen geçiyor: sorumluluk alanı ancak sınırı belliyse birinin yükünü hafifletir.",
      },
      {
      ...
      {
        text: "Der Text hält klare Ansagen für freundlicher als vage.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Klare Ansagen sind freundlicher als vage.“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        text: "Frau Brandt hört nicht zum ersten Mal von dem Problem.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Das höre ich nicht zum ersten Mal.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "gefährden", tr: "tehlikeye atmak", en: "to endanger" },
    ...
    questions: [
      ...
      {
        text: "Der Kunde hält die Dringlichkeit am Ende eher für gefühlt.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Die Dringlichkeit war ohnehin eher gefühlt als echt.“",
      },
    ],
  },
