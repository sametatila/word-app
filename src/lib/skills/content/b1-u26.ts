...
export const b1U26: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Kundin", text: "Guten Morgen. Was kostet das Kilo Pflaumen?" },
      { speaker: "Verkäufer", text: "Heute drei Euro. Sonderangebot, sonst vier. Die Früchte sind gerade reif." },
      { speaker: "Kundin", text: "Dann nehme ich zwei Kilo. Und vier Karotten." },
      { speaker: "Verkäufer", text: "Gern. Soll ich die Pilze auch wiegen?" },
      { speaker: "Kundin", text: "Ja, dreihundert Gramm bitte." },
      { speaker: "Verkäufer", text: "Sind Sie sicher? Die sind heute sehr frisch, nehmen Sie fünfhundert." },
      { speaker: "Kundin", text: "Gut, überzeugt. Legen Sie alles in eine Tasche." },
      { speaker: "Verkäufer", text: "Macht zusammen elf Euro vierzig." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Gastgeberin", text: "Kommt herein! Stellt die Sachen einfach auf den Tisch." },
      { speaker: "Gast", text: "Wir haben Gebäck mitgebracht und eine Konfitüre." },
      { speaker: "Gastgeberin", text: "Das wäre nicht nötig gewesen. Aber danke, sehr lieb." },
      { speaker: "Gast", text: "Es riecht wunderbar. Was gibt es denn?" },
      { speaker: "Gastgeberin", text: "Erst eine Suppe, dann Gemüse mit Reis." },
      { speaker: "Gast", text: "Und zur Nachspeise?" },
      { speaker: "Gastgeberin", text: "Etwas Süßes mit Sahne und Honig. Die Kanne mit Tee steht schon da." },
      { speaker: "Gast", text: "Perfekt. Dann setzen wir uns. Eine Mahlzeit mit Freunden schmeckt am besten." },
    ],
    questions: [
      {
