...
export const a2U12: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "betonen", tr: "vurgulamak", en: "to emphasize" },
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "die Handynummer", tr: "cep telefonu numarası", en: "cell phone number" },
    ],
    minutes: 3,
    segments: [
      ...
      { speaker: "Timo", text: "Gut, das notiere ich. Können Sie mir bitte Ihre Handynummer geben?" },
  ...
  },
  {
    ...
    gloss: [
      { de: "der Urlaubstag", tr: "izin günü", en: "vacation day" },
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["vom zweiten bis zum fünften", "vom 2. bis zum 5.", "zweiten bis fünften", "vom zweiten bis fünften", "vom 2. bis 5.", "2. bis 5."],
    ...
    tasks: [
      {
        ...
        minWords: 45,
        phrases: [
          { de: "Hiermit beantrage ich Urlaub vom … bis …", tr: "…-den …-e izin talep ediyorum", en: "I hereby request vacation from … to …" },
