...
export const c1U20: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "verklagen", tr: "dava açmak", en: "to sue" },
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "genau", tr: "tam olarak", en: "exactly" },
      { de: "der Rentner", tr: "emekli", en: "retiree" },
      ...
      { de: "egoistisch", tr: "bencil", en: "selfish" },
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "genau", tr: "tam olarak", en: "exactly" },
      { de: "rückwärts", tr: "geriye doğru", en: "backward" },
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "die Intervention", tr: "müdahale", en: "intervention" },
      { de: "abgrenzen", tr: "sınırını çizmek", en: "to delimit" },
      { de: "das Merkmal", tr: "nitelik", en: "characteristic" },
