...
export const a2U22: SkillExercise[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 1,
        explain: "„Die Software installiert ein Update im Hintergrund, deshalb ist alles langsam.“",
      },
      {
        kind: "dictation",
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "blättern", tr: "sayfa çevirmek", en: "to leaf through" },
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Welches gefällt dir eigentlich ___ besten?",
        options: [],
        answer: 0,
        accept: ["am"],
      ...
      },
      {
        ...
        answer: 1,
        explain: "„Der Hut war ihr zu auffällig, sie hat ihn nach einer Stunde abgenommen.“",
      },
      {
        kind: "short_answer",
  ...
  },
  {
    ...
    tasks: [
      ...
      {
        kind: "build",
        tr: "Sorumu lütfen cevaplayabilir misiniz?",
        answer: "Können Sie meine Frage bitte beantworten",
        alternatives: ["Können Sie bitte meine Frage beantworten"],
