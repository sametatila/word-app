...
export const enC1U03: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    minutes: 8,
    segments: [
      { speaker: "Ulaş", text: "Granted, there is little leeway, albeit some. That is the first line of the minutes and it took longer than the meeting." },
      { speaker: "Peri", text: "Because of „albeit some“." },
      { speaker: "Ulaş", text: "Because of „albeit some“. Without it the sentence closes the question, and minutes that close a question nobody agreed to close get rewritten by somebody else." },
      ...
      { speaker: "Ulaş", text: "It is fair only if the objection is named somewhere. „Much as I acknowledge the snag“ with no snag written down is the most common dishonest sentence in the minutes." },
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["the last one", "the last line", "the one with „whereas“", "the third"],
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        fields: [
          { label: "Not exactly cheap", answer: "expensive", accept: ["not cheap"] },
