...
export const b1U02: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Kollege", text: "Du fängst immer so früh an. Arbeitest du flexibel?" },
      { speaker: "Kollegin", text: "Ja, ich komme um sieben und gehe um vier. Das passt gut zu meiner Familie." },
      { speaker: "Kollege", text: "Und wenn du länger bleiben musst?" },
      { speaker: "Kollegin", text: "Dann sind das Überstunden. Die schreibe ich auf und nehme später frei." },
      { speaker: "Kollege", text: "Bei mir geht das nicht. Ich arbeite in Vollzeit mit festen Zeiten." },
      { speaker: "Kollegin", text: "Hast du schon einen Antrag gestellt?" },
      { speaker: "Kollege", text: "Noch nicht. Aber wenn die neue Regel gilt, versuche ich es." },
      { speaker: "Kollegin", text: "Mach das. Regelmäßige Erholung ist wichtiger als ein bisschen mehr Lohn." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Personaler", text: "Kommen wir zum Gehalt. Was stellen Sie sich vor?" },
      { speaker: "Bewerberin", text: "Ich hätte gern etwas mehr als an meiner alten Stelle." },
      { speaker: "Personaler", text: "Wie viel war das denn?" },
      { speaker: "Bewerberin", text: "Mein Einkommen lag bei dreitausend im Monat, vor Steuern." },
      { speaker: "Personaler", text: "Wir könnten mit dreitausendzweihundert anfangen." },
      { speaker: "Bewerberin", text: "Wäre es möglich, das nach einem Jahr zu erhöhen?" },
      { speaker: "Personaler", text: "Das ist bei uns normal, wenn die Arbeit gut läuft." },
      { speaker: "Bewerberin", text: "Dann bin ich einverstanden. Vielen Dank." },
    ],
    questions: [
      {
