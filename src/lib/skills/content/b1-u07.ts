...
export const b1U07: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Ben", text: "Wann wollen wir los?" },
      { speaker: "Nina", text: "Bevor der Verkehr schlimm wird. Also etwa um sechs." },
      { speaker: "Ben", text: "Gut. Während du packst, hole ich das Auto raus." },
      { speaker: "Nina", text: "Kannst du gleichzeitig die Karte holen? Dann sparen wir Zeit." },
      { speaker: "Ben", text: "Mache ich. Nimm bitte etwas zu trinken mit." },
      { speaker: "Nina", text: "Ist dabei. Nachdem wir gestern eingekauft hatten, habe ich alles bereitgelegt." },
      { speaker: "Ben", text: "Klasse. Dann sind wir vor dem Stau draußen." },
      { speaker: "Nina", text: "Hoffentlich. Übrigens fährt meine Schwester auch hin." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Eva", text: "Sag mal, wirst du jemals völlig flüssig sprechen?" },
      { speaker: "Lukas", text: "Keine Ahnung. Aber je mehr ich rede, desto weniger denke ich nach." },
      { speaker: "Eva", text: "Das kann sein. Bei mir ist es anders." },
      { speaker: "Lukas", text: "Wieso denn?" },
      { speaker: "Eva", text: "Je länger ich lerne, desto unsicherer werde ich." },
      { speaker: "Lukas", text: "Dann lernst du eben zu viel allein. Such dir jemanden." },
      { speaker: "Eva", text: "Vielleicht. Ich bin sehr interessiert, aber ich traue mich nicht." },
      { speaker: "Lukas", text: "Fang klein an. Nach zwei Wochen merkst du den Unterschied." },
    ],
    questions: [
      {
