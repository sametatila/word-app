...
export const c1U09: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "İki alanın mantığı dışına çıktığı için ayrıca akılda kalıyor.",
      },
      {
        kind: "short_answer",
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "zeichnen", tr: "çizmek", en: "to draw" },
      { de: "verwenden", tr: "kullanmak", en: "to use" },
      { de: "der Vertragsbruch", tr: "sözleşme ihlali", en: "breach of contract" },
      { de: "ungleich", tr: "eşitsiz", en: "unequal" },
      { de: "ernten", tr: "hasat etmek", en: "to harvest" },
      { de: "überwiegend", tr: "ağırlıklı olarak", en: "predominantly" },
      { de: "der Text", tr: "metin", en: "text" },
      { de: "genau", tr: "tam olarak", en: "exactly" },
      { de: "bezeichnen", tr: "adlandırmak", en: "to call" },
    ],
    minutes: 7,
    text:
