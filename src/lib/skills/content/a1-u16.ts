    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Es gibt große Fenster im Wohnzimmer und im Schlafzimmer.“",
          ...
          {
        kind: "gapfill",
        text: "Die ___ ist hell und ruhig.",
        options: [],
        answer: 0,
        accept: ["Wohnung"],
        explain: "„Die Wohnung ist hell und ruhig.“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Klopfen Sie einfach!“",
          ...
          {
        kind: "gapfill",
        text: "herzlich ___ im Haus!",
        options: [],
        answer: 0,
        accept: ["willkommen"],
        explain: "„herzlich willkommen im Haus!“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Der Tisch steht in der Mitte.“",
          ...
          {
        kind: "gapfill",
        text: "Das Sofa steht gut in der ___, beim Fenster.",
        options: [],
        answer: 0,
        accept: ["Ecke"],
        explain: "„Das Sofa steht gut in der Ecke, beim Fenster.“",
