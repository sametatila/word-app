    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Wir essen um halb acht.“ — 19:30.",
          ...
          {
        kind: "gapfill",
        text: "Mein Tag beginnt um ___ sieben.",
        options: [],
        answer: 0,
        accept: ["halb"],
        explain: "„Mein Tag beginnt um halb sieben.“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "Yanlış: „Mein Kurs beginnt gleich.“ — henüz başlamadı.",
          ...
          {
        kind: "gapfill",
        text: "Entschuldigung, wie ___ ist es?",
        options: [],
        answer: 0,
        accept: ["spät"],
        explain: "„Entschuldigung, wie spät ist es?“",
      },
],
  },
  {
