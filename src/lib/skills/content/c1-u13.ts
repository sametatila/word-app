...
export const c1U13: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "die Redundanz", tr: "gereksiz tekrar", en: "redundancy" },
      { de: "entfernen", tr: "kaldırmak", en: "to remove" },
      ...
      { de: "bemisst", tr: "ölçer", en: "measures" },
    ],
    minutes: 7,
    text:
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "lesen", tr: "okumak", en: "to read" },
      { de: "gewichten", tr: "ağırlık vermek", en: "to weight" },
      { de: "gesamt", tr: "bütün", en: "entire" },
      { de: "die Absichtserklärung", tr: "niyet beyanı", en: "declaration of intent" },
      ...
      { de: "der Text", tr: "metin", en: "text" },
      { de: "sprachlich", tr: "dil açısından", en: "linguistically" },
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "die Absichtserklärung", tr: "niyet beyanı", en: "declaration of intent" },
      { de: "die Beschaffung", tr: "tedarik", en: "procurement" },
