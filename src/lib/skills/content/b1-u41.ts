...
export const b1U41: SkillExercise[] = [
  // ─────────────────────────── OKUMA ───────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["zwei ganze Zuhause", "ein ganzes Zuhause", "zwei Sprachen"],
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["in einem Forum", "im Forum", "nicht im Land"],
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Antragstellerin", text: "Teilweise. Der Rest wird noch geprüft." },
      { speaker: "Beamter", text: "Dann brauchen wir davon eine Kopie." },
      { speaker: "Antragstellerin", text: "Die habe ich dabei. Wie lange dauert die Bestätigung?" },
      { speaker: "Beamter", text: "Etwa zehn Tage. Wir sagen Ihnen den Termin schriftlich zu." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Mia", text: "Im Kurs duzen sich alle. Im Betrieb nicht. Warum eigentlich?" },
      { speaker: "Paul", text: "Es hängt von der Gruppe ab, nicht vom Alter. Nur Verwandte duzen sich immer." },
      { speaker: "Mia", text: "Bei uns duzt der Chef alle, aber niemand duzt ihn zurück." },
      { speaker: "Paul", text: "Das ist seltsam. Dann lieber niemanden duzen." },
      { speaker: "Mia", text: "Ich weiß nicht. Am liebsten fragt man einfach." },
      { speaker: "Paul", text: "Genau. Ein Wörterbuch hilft da gar nicht." },
      { speaker: "Mia", text: "Nein. Das steht in keinem Buch, das lernt man nur so." },
      { speaker: "Paul", text: "Wie das Alphabet: Man lernt es einmal und denkt nie mehr daran." },
    ],
    questions: [
      {
