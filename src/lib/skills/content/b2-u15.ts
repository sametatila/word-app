...
export const b2U15: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "der Haushalt", tr: "bütçe", en: "budget" },
      { de: "die Schule", tr: "okul", en: "school" },
      { de: "die Zahl", tr: "sayı", en: "number" },
      { de: "fließen", tr: "akmak", en: "to flow" },
      { de: "bezuschussen", tr: "maddi destek vermek", en: "to subsidize" },
...

  {
    ...
    gloss: [
      ...
      { de: "der Text", tr: "metin", en: "text" },
      { de: "uneinheitlich", tr: "tutarsız", en: "inconsistent" },
    ],
    minutes: 6,
    text:
      "STADT ODER LAND?\n\n" +
...

  {
    ...
    gloss: [
      ...
      { de: "geklagt", tr: "şikâyet etmiş", en: "complained" },
    ],
    minutes: 5,
    segments: [
...

  {
    ...
    gloss: [
      ...
      { de: "der Wahlkreis", tr: "seçim bölgesi", en: "electoral district" },
    ],
    minutes: 5,
    segments: [
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["unter fünfzig Prozent", "unter 50 Prozent", "weniger als fünfzig Prozent"],
...

  {
    ...
    gloss: [
      { de: "erheben", tr: "tahsil etmek", en: "to levy" },
      { de: "der Ballungsraum", tr: "yığılma bölgesi", en: "metropolitan area" },
      { de: "umsetzen", tr: "hayata geçirmek", en: "to implement" },
      { de: "die Gerechtigkeit", tr: "adalet", en: "fairness" },
    ],
    minutes: 9,
    tasks: [
      ...
      {
        kind: "build",
        tr: "Yığılma bölgesi ne kadar büyürse şehir merkezi o kadar pahalılaşır.",
        answer: "Je größer der Ballungsraum wird, desto teurer wird die Innenstadt",
      ...
      },
      {
        ...
        why: "weder … noch yapısının kendisi olumsuzdur, içine ikinci bir nicht girmez. Türkçe konuşan bu hatayı sık yapar, çünkü günlük Türkçede 'ne o ne bu yapılmadı' gibi çift olumsuz cümleler yaygındır ve kulağa yanlış gelmez; Almancada ise weder … noch'un yanına ikinci bir olumsuzluk giremez.",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "genau", tr: "tam olarak", en: "exactly" },
      { de: "die Auslastung", tr: "kapasite kullanımı", en: "utilization" },
      { de: "leicht", tr: "kolay", en: "easy" },
      { de: "zählen", tr: "saymak", en: "to count" },
      { de: "ausgelastet", tr: "dolu", en: "at capacity" },
    ],
    minutes: 12,
    tasks: [
      {
