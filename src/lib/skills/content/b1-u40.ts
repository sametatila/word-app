...
export const b1U40: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Mitarbeiter", text: "Wie lange habe ich morgen für die Präsentation?" },
      { speaker: "Chefin", text: "Zwölf Minuten, danach Fragen." },
      { speaker: "Mitarbeiter", text: "Dann zeige ich nur drei Zahlen und ein Bild." },
      { speaker: "Chefin", text: "Gut. Sag aber dazu, was wir wirklich produzieren können." },
      { speaker: "Mitarbeiter", text: "Klar. Ich garantiere nichts, was wir nicht schaffen." },
      { speaker: "Chefin", text: "Genau das meine ich. Letztes Jahr war das anders." },
      { speaker: "Mitarbeiter", text: "Ich weiß. Diesmal sage ich lieber eine kleinere Zahl." },
      { speaker: "Chefin", text: "Richtig. Und die weltweite Aktion lässt du besser weg." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Nina", text: "Ich überlege, im Frühling etwas Eigenes zu gründen." },
      { speaker: "Jan", text: "Ganz oder nebenbei?" },
      { speaker: "Nina", text: "Erst nebenbei. Ich kann nicht sofort alles aufgeben." },
      { speaker: "Jan", text: "Klug. Und die Steuer? Die ist im ersten Jahr fällig." },
      { speaker: "Nina", text: "Das weiß ich. Ich habe mich schon um eine Beratung bemüht." },
      { speaker: "Jan", text: "Sehr gut. Und wie lange willst du beides machen?" },
      { speaker: "Nina", text: "Ein Jahr. Wenn es dann nicht läuft, höre ich damit auf." },
      { speaker: "Jan", text: "Klingt ehrlich. Die meisten setzen sich diese Grenze nicht." },
    ],
    questions: [
      {
