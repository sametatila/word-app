...
export const b2U14: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "bundesweit", tr: "ülke çapında", en: "nationwide" },
...

  {
    ...
    gloss: [
      ...
      { de: "begeistern", tr: "hayran bırakmak", en: "to thrill" },
      ...
      { de: "der Zeitmangel", tr: "zaman darlığı", en: "lack of time" },
    ],
    minutes: 6,
    text:
...

  {
    ...
    gloss: [
      ...
      { de: "also", tr: "yani", en: "so" },
      { de: "genau", tr: "tam olarak", en: "exactly" },
      { de: "variabel", tr: "değişken faizli", en: "at a variable rate" },
      { de: "die Teuerung", tr: "hayat pahalılığı", en: "inflation" },
    ],
    minutes: 5,
    segments: [
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["der Einkaufskorb ist anders", "der Index mittelt", "andere Waren", "die Preise schwanken stärker", "weil der Einkaufskorb anders ist"],
...

  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["was andere zahlen", "die Konkurrenz", "der Marktpreis", "was zwei Straßen weiter gezahlt wird"],
...

  {
    ...
    gloss: [
      { de: "der Wohnraum", tr: "konut", en: "housing" },
      { de: "die Inflation", tr: "enflasyon", en: "inflation" },
      { de: "sich engagieren", tr: "katkıda bulunmak", en: "to get involved" },
      { de: "die Fachkraft", tr: "nitelikli eleman", en: "skilled worker" },
    ],
    minutes: 9,
    tasks: [
      {
        kind: "build",
        tr: "Konut ne kadar azalırsa yeni inşaattan o kadar yüksek sesle söz edilir.",
      ...
      },
      {
        ...
        alternatives: ["Die Zunahme der Preise ist gesunken, nicht das Preisniveau"],
      ...
      {
        kind: "build",
        tr: "İnsanlar salı akşamı gelerek katkıda bulunuyor.",
