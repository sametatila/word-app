    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Meine Schwester heißt Nora und sie ist ein Baby.“",
          ...
          {
        kind: "gapfill",
        text: "Ich habe zwei ___.",
        options: [],
        answer: 0,
        accept: ["Geschwister"],
        explain: "„Ich habe zwei Geschwister.“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "Yanlış: „Familienstand: verheiratet“ — evli.",
          ...
          {
        kind: "gapfill",
        text: "Adresse: Lindenstraße 8, ___ 28203 Bremen",
        options: [],
        answer: 0,
        accept: ["Postleitzahl"],
        explain: "„Adresse: Lindenstraße 8, Postleitzahl 28203 Bremen“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "Yanlış: Jonas zwanzig, kardeşi zehn. İki sayıyı karıştırmamak gerek.",
          ...
          {
        kind: "gapfill",
        text: "Ich habe einen ___ und eine Schwester.",
        options: [],
        answer: 0,
        accept: ["Bruder"],
        explain: "„Ich habe einen Bruder und eine Schwester.“",
      },
],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "Doğru, ilk cümle: „Füllen Sie bitte das Formular aus.“",
          ...
          {
        kind: "gapfill",
        text: "Füllen Sie bitte das ___ aus.",
        options: [],
        answer: 0,
        accept: ["Formular"],
        explain: "„Füllen Sie bitte das Formular aus.“",
      },
],
  },
  {
