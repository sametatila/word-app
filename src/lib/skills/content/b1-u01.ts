...
export const b1U01: SkillExercise[] = [
  ...
  },
  {
    ...
    segments: [
      { speaker: "Lena", text: "Und? Wie war das Vorstellungsgespräch?" },
      { speaker: "Jonas", text: "Ganz gut, glaube ich. Aber eine Frage war schwierig." },
      { speaker: "Lena", text: "Welche denn?" },
      { speaker: "Jonas", text: "Sie haben nach meiner Schwäche gefragt." },
      { speaker: "Lena", text: "Und was hast du gesagt?" },
      { speaker: "Jonas", text: "Ich war ehrlich. Ich habe gesagt, dass ich manchmal zu langsam bin, obwohl ich ordentlich arbeite." },
      { speaker: "Lena", text: "Das war gut. Ehrlichkeit überzeugt mehr als eine schöne Antwort." },
      { speaker: "Jonas", text: "Hoffentlich. In zwei Wochen weiß ich, ob es ein Erfolg war." },
    ],
    questions: [
      {
