...
export const b1: SkillExercise[] = [
  ...
  // ── Okuma ──────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Etwa ___ Prozent der Geräte funktionieren nach der Reparatur wieder.",
        options: [],
        answer: 0,
        accept: ["siebzig", "70"],
        explain: "„Etwa siebzig Prozent der Geräte … funktionieren danach wieder.“",
      },
      {
        kind: "short_answer",
        text: "Wann trifft sich das Repair-Café?",
        options: [],
        answer: 0,
        accept: ["jeden ersten Samstag im Monat", "am ersten Samstag im Monat", "einmal im Monat"],
        explain: "„Jeden ersten Samstag im Monat treffen sich dort …“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Laut ihrer Handy-Statistik verbrachte sie täglich fast ___ Stunden in sozialen Netzwerken.",
        options: [],
        answer: 0,
        accept: ["drei", "3"],
        explain: "„… verbrachte ich täglich fast drei Stunden in sozialen Netzwerken …“",
      },
      {
        kind: "short_answer",
        text: "Nach wie langer Zeit wurde es besser?",
        options: [],
        answer: 0,
        accept: ["nach etwa einer Woche", "nach einer Woche", "eine Woche"],
        explain: "„Nach etwa einer Woche wurde es besser.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Das Praktikum beginnt am 1. März und dauert ___ Wochen.",
        options: [],
        answer: 0,
        accept: ["acht", "8"],
        explain: "„Das Praktikum beginnt am 1. März und dauert acht Wochen.“",
      },
      {
        kind: "short_answer",
        text: "Wer betreut Frau Yılmaz in den ersten zwei Wochen?",
        options: [],
        answer: 0,
        accept: ["Frau Sommer", "die Redakteurin Frau Sommer", "Sommer"],
        explain: "„In den ersten zwei Wochen werden Sie von unserer Redakteurin Frau Sommer betreut.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Eine Flasche ___ auf dem Schreibtisch hilft, daran zu denken.",
        options: [],
        answer: 0,
        accept: ["Wasser"],
        explain: "„Eine Flasche Wasser auf dem Schreibtisch hilft, daran zu denken.“",
      },
      {
        kind: "short_answer",
        text: "Wann soll man die Mahlzeiten planen?",
        options: [],
        answer: 0,
        accept: ["am Wochenende", "Wochenende"],
        explain: "„Erstens: Planen Sie Ihre Mahlzeiten am Wochenende.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Ich wohne seit ___ Jahren in dieser Straße.",
        options: [],
        answer: 0,
        accept: ["fünfzehn", "15"],
        explain: "„Ich wohne seit fünfzehn Jahren in dieser Straße …“",
      },
      {
        kind: "short_answer",
        text: "Was befürchten einige Geschäftsleute?",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Die Beschäftigten arbeiten vier Tage, bekommen aber das ___ Gehalt wie vorher.",
        options: [],
        answer: 0,
        accept: ["gleiche"],
        explain: "„… bekommen aber das gleiche Gehalt wie vorher.“",
      },
      {
        kind: "short_answer",
        text: "Seit wann bietet die Agentur „Kolibri“ das Modell an?",
        options: [],
        answer: 0,
        accept: ["seit zwei Jahren", "zwei Jahre"],
        explain: "„… die das Modell seit zwei Jahren anbietet.“",
      },
    ],
  },
  ...
  //    fikir → resmî işlem → banka → açılış sırası takip edilir.
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Ich habe ___ Euro Ersparnisse.",
        options: [],
        answer: 0,
        accept: ["18.000", "18000", "achtzehntausend"],
        explain: "„Ich habe 18.000 Euro Ersparnisse.“",
      },
      {
        kind: "short_answer",
        text: "Wie hoch ist die Miete für den Laden?",
        options: [],
        answer: 0,
        accept: ["1.400 Euro", "1400 Euro", "vierzehnhundert Euro"],
        explain: "„Ein Laden im Viertel kostet 1.400 Euro Miete.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Sie brauchen den Ausweis, das Formular und ___ Euro Gebühr.",
        options: [],
        answer: 0,
        accept: ["26", "sechsundzwanzig"],
        explain: "„… das ausgefüllte Formular und 26 Euro Gebühr.“",
      },
      {
        kind: "short_answer",
        text: "Wie lange dauert die Belehrung vom Gesundheitsamt?",
        options: [],
        answer: 0,
        accept: ["etwa eine Stunde", "eine Stunde"],
        explain: "„… die dauert etwa eine Stunde und gilt lebenslang.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "short_answer",
        text: "Wo wäre Duzen laut Text ein Fehler?",
        options: [],
        answer: 0,
        accept: ["in einer Bank", "bei einer Behörde", "beim Arzt"],
        explain: "„In einer Bank, bei einer Behörde oder beim Arzt wäre das dagegen ein Fehler.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Die Zahl der Fahrraddiebstähle ist um ___ Prozent gesunken.",
        options: [],
        answer: 0,
        accept: ["18", "achtzehn"],
        explain: "„Die Zahl der Fahrraddiebstähle ist im letzten Jahr um 18 Prozent gesunken.“",
      },
      {
        kind: "short_answer",
        text: "Wohin geht das Geld vom Stadtfest?",
        options: [],
        answer: 0,
        accept: ["an das Frauenhaus", "ans Frauenhaus", "Frauenhaus"],
        explain: "„Das Geld geht an das Frauenhaus …“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Beantragt: 45.000 Euro. Die Bank bietet ___ Euro an.",
        options: [],
        answer: 0,
        accept: ["30.000", "30000", "dreißigtausend"],
        explain: "„Wir bieten Ihnen 30.000 Euro an.“",
      },
      {
        kind: "short_answer",
        text: "Wie viel eigenes Geld bringt Herr Haddad mit?",
        options: [],
        answer: 0,
        accept: ["18.000 Euro", "18000 Euro", "achtzehntausend"],
        explain: "„Sie bringen 18.000 Euro eigenes Geld mit, das ist gut.“",
      },
    ],
  },
  {
    ...
    gloss: [
      ...
      { de: "die Zufriedenheit", tr: "memnuniyet", en: "satisfaction" },
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Ein Arbeitszeugnis muss ___ formuliert sein.",
        options: [],
        answer: 0,
        accept: ["wohlwollend"],
        explain: "„… und dieses Zeugnis muss wohlwollend formuliert sein.“",
      },
      {
        kind: "short_answer",
        text: "Was bedeutet „stets zur vollsten Zufriedenheit“?",
        options: [],
        answer: 0,
        accept: ["sehr gut"],
        explain: "„„… stets zur vollsten Zufriedenheit“ = sehr gut“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Das Eintrittsband kostet ___ Euro, ermäßigt 12 Euro.",
        options: [],
        answer: 0,
        accept: ["17", "siebzehn"],
        explain: "„Das Eintrittsband kostet 17 Euro, ermäßigt 12 Euro …“",
      },
      {
        kind: "short_answer",
        text: "Wie viele Museen und Galerien öffnen?",
        options: [],
        answer: 0,
        accept: ["mehr als vierzig", "vierzig", "über 40"],
        explain: "„… öffnen mehr als vierzig Museen und Galerien ihre Türen.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Herr Weber fährt ___ pro Woche mit dem Kühlwagen zu den Märkten.",
        options: [],
        answer: 0,
        accept: ["zweimal", "2 mal"],
        explain: "„Ich fahre zweimal pro Woche mit dem Kühlwagen zu den Märkten …“",
      },
      {
        kind: "short_answer",
        text: "Seit wann engagiert sich Herr Weber bei der Tafel?",
        options: [],
        answer: 0,
        accept: ["seit fünf Jahren", "fünf Jahre"],
        explain: "„… der sich seit fünf Jahren ehrenamtlich bei der Heidelberger Tafel engagiert.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Nächsten Samstag um ___ gibt es ein erstes Treffen.",
        options: [],
        answer: 0,
        accept: ["zehn", "10"],
        explain: "„Nächsten Samstag um zehn gibt es ein erstes Treffen.“",
      },
      {
        kind: "short_answer",
        text: "Wer will den Anfängern helfen?",
        options: [],
        answer: 0,
        accept: ["Frau Behrens", "Behrens", "die Nachbarin"],
        explain: "„Frau Behrens aus dem dritten Stock war früher Gärtnerin, sie will Anfängern helfen.“",
      },
    ],
  },
  {
    ...
    genre: "Sesli rehber",
    intro: "Hamburg Liman Müzesi'ndeki sesli rehberi sırayla dinle: Speicherstadt bölümü.",
    minutes: 3,
    segments: [
      {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Die Speicherstadt wurde zwischen 1883 und ___ gebaut.",
        options: [],
        answer: 0,
        accept: ["1927"],
        explain: "„Die Speicherstadt wurde zwischen 1883 und 1927 gebaut.“",
      },
      {
        kind: "short_answer",
        text: "Seit wann gehört sie zum Weltkulturerbe?",
        options: [],
        answer: 0,
        accept: ["seit 2015", "2015"],
        explain: "„Seit 2015 gehört die Speicherstadt zum Weltkulturerbe der UNESCO.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Wer sich heute anmeldet, erhält ___ Prozent Rabatt auf die Kursgebühr.",
        options: [],
        answer: 0,
        accept: ["zehn", "10"],
        explain: "„Wer sich heute für einen Kurs anmeldet, erhält zehn Prozent Rabatt …“",
      },
      {
        kind: "short_answer",
        text: "Wie viele Kurse werden insgesamt angeboten?",
        options: [],
        answer: 0,
        accept: ["über vierhundert", "vierhundert", "mehr als 400"],
        explain: "„Insgesamt werden über vierhundert Kurse angeboten …“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Jugendliche nutzen ihr Smartphone im Durchschnitt ___ Stunden täglich.",
        options: [],
        answer: 0,
        accept: ["dreieinhalb", "3,5"],
        explain: "„… nutzen ihr Smartphone im Durchschnitt dreieinhalb Stunden täglich.“",
      },
      {
        kind: "short_answer",
        text: "Wie viele Jugendliche wünschen sich weniger Zeit am Handy?",
        options: [],
        answer: 0,
        accept: ["zwei Drittel", "2/3"],
        explain: "„Zwei Drittel wünschen sich, weniger Zeit am Handy zu verbringen.“",
      },
    ],
  },
  ...
  // ── Yazma ──────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Bei Essen im Café sind es 19 Prozent, zum Mitnehmen ___.",
        options: [],
        answer: 0,
        accept: ["7", "sieben"],
        explain: "„Bei Essen im Café sind das 19 Prozent, zum Mitnehmen 7.“",
      },
      {
        kind: "short_answer",
        text: "Bis zu welchem Umsatz gilt die Kleinunternehmerregelung?",
        options: [],
        answer: 0,
        accept: ["bis 22.000 Euro", "22.000 Euro", "22000"],
        explain: "„Die gilt bis 22.000 Euro Umsatz im Jahr.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Wir sind bis Mitte ___ ausgebucht.",
        options: [],
        answer: 0,
        accept: ["Oktober"],
        explain: "„Wir sind bis Mitte Oktober ausgebucht.“",
      },
      {
        kind: "short_answer",
        text: "Wie groß schätzt der Kunde den Auftrag?",
        options: [],
        answer: 0,
        accept: ["zwei bis drei Tage", "zwei bis drei", "2-3 Tage"],
        explain: "„Ich schätze zwei bis drei Tage.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Mein Umsatz ist um ___ Prozent gestiegen.",
        options: [],
        answer: 0,
        accept: ["sieben", "7"],
        explain: "„Aber mein Umsatz ist um sieben Prozent gestiegen.“",
      },
      {
        kind: "short_answer",
        text: "Wie lange ist die Königstraße schon gesperrt?",
        options: [],
        answer: 0,
        accept: ["seit drei Monaten", "drei Monate"],
        explain: "„Seit drei Monaten ist die Königstraße für Autos gesperrt …“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Wenn niemand etwas vorbereitet hat, sind ___ Minuten kein Problem.",
        options: [],
        answer: 0,
        accept: ["fünfzehn", "15"],
        explain: "„Wenn nicht, sind fünfzehn Minuten kein Problem.“",
      },
      {
        kind: "short_answer",
        text: "Was ist bei einer Verspätung am wichtigsten?",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Ich habe ___ Tage daran gearbeitet.",
        options: [],
        answer: 0,
        accept: ["drei", "3"],
        explain: "„Ich habe drei Tage daran gearbeitet.“",
      },
      {
        kind: "short_answer",
        text: "Vor wie vielen Leuten fiel der Satz?",
        options: [],
        answer: 0,
        accept: ["vor sieben Leuten", "sieben", "7"],
        explain: "„Aber vor sieben Leuten wirkt so ein Satz anders als unter uns.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "Ich habe für ___ Frühstücke eingekauft.",
        options: [],
        answer: 0,
        accept: ["vierzig", "40"],
        explain: "„Ich habe für vierzig Frühstücke eingekauft.“",
      },
      {
        kind: "short_answer",
        text: "Wie lange hat der ganze Weg gedauert?",
...

  {
    ...
    tasks: [
      ...
      {
        kind: "rewrite",
        prompt: "Resmî hitapta büyük harfleri düzelt.",
        source: "Ich möchte sie um Erlaubnis bitten und ihnen im Voraus danken.",
        answer: "Ich möchte Sie um Erlaubnis bitten und Ihnen im Voraus danken.",
        why: "Türkçede hitap biçimi yazımla işaretlenmez ('sizi' her zaman aynı yazılır), o yüzden Almancada küçük harf bırakılıyor. Almancada resmî hitabın BÜTÜN biçimleri büyük harfle yazılır: Sie, Ihnen, Ihr, Ihre. Küçük 'sie' başka bir şeydir — 'o (kadın)' ya da 'onlar'. Yani bu bir yazım değil, ANLAM ayrımı.",
      },
    ],
  },
  {
    ...
    tasks: [
      ...
      {
        kind: "rewrite",
        prompt: "Zaman için doğru fiili seç.",
        source: "Viele Menschen geben zu viel Zeit im Internet aus.",
        answer: "Viele Menschen verbringen zu viel Zeit im Internet.",
        why: "Türkçede 'harcamak' hem para hem zaman için kullanılır ('para harcamak', 'zaman harcamak'), o yüzden Almancada da tek fiil seçiliyor. Almanca ayırır: PARA için Geld ausgeben, ZAMAN için Zeit verbringen. 'Zeit ausgeben' Almancada hiç kullanılmaz.",
      },
    ],
  },
  {
    ...
    tasks: [
      ...
      {
        kind: "rewrite",
        prompt: "Ayrılabilen fiilin önekini yerine koy.",
        source: "Ich kann leider nicht teilnehmen am Kurs am Freitag.",
        answer: "Ich kann leider am Freitag nicht am Kurs teilnehmen.",
        why: "Türkçede fiil zaten sondadır ve tümleçler ondan önce gelir ('cuma günü kursa katılamıyorum'), ama öğrenci Almancada mastarı öne alıp tümleci arkaya atıyor. Almancada kipli fiilden sonra ÖNCE tümleçler gelir, mastar EN SONDA durur: am Freitag nicht am Kurs teilnehmen.",
      },
    ],
  },
  {
    ...
    tasks: [
      ...
      {
        kind: "rewrite",
        prompt: "Öneri kipini düzelt.",
        source: "Meiner Meinung nach soll die Innenstadt gesperrt werden.",
        answer: "Meiner Meinung nach sollte die Innenstadt gesperrt werden.",
        why: "Türkçede '-meli' tek biçimdir ve kimin istediğini söylemez, o yüzden Almancada 'soll' seçiliyor. Almanca ayırır: soll = BAŞKASI böyle istiyor ya da öyle deniyor; sollte = KONUŞAN öneriyor. Kendi görüşünü yazarken sollte gelir, yoksa cümle 'birileri öyle diyor' anlamına kayar.",
      },
    ],
  },
  {
    ...
    tasks: [
      ...
      {
        kind: "rewrite",
        prompt: "Tarihten önceki artikeli ekle.",
        source: "Die Heizung funktioniert seit 3. Januar nicht und ich warte bis 15. Januar.",
        answer: "Die Heizung funktioniert seit dem 3. Januar nicht und ich warte bis zum 15. Januar.",
        why: "Türkçede tarih doğrudan ek alır ('3 Ocak'tan beri'), araya bir sözcük girmez. Almancada sıra sayısıyla verilen tarih edattan sonra ARTİKEL ister: seit dem 3. Januar, bis zum 15. Januar, ab dem 1. März. Artikelsiz biçim yalnız 'am 3. Januar' kalıbında görünür, orada da 'am' zaten 'an dem'dir.",
      },
    ],
  },
  {
    ...
    tasks: [
      ...
      {
        kind: "rewrite",
        prompt: "Cümle başındaki öbekten sonraki sırayı düzelt.",
        source: "Meiner Meinung nach Schulen sollten klare Regeln haben.",
        answer: "Meiner Meinung nach sollten Schulen klare Regeln haben.",
        why: "Türkçede 'bence' cümlenin sırasını hiç değiştirmez, o yüzden özne olduğu yerde bırakılıyor. Almancada cümle başına konan HER öbek birinci öğedir ve ikinci sıra fiile aittir — özne üçüncüye kayar. Bu, B1 sınavının en sık cümle başlangıcıdır, o yüzden hatası da en görünür olanıdır.",
      },
    ],
  },
  {
    ...
    tasks: [
      ...
      {
        kind: "rewrite",
        prompt: "„duzen“ fiilinin nesnesini düzelt.",
        source: "Am Anfang habe ich zu allen du gesagt und ihnen geduzt.",
        answer: "Am Anfang habe ich alle geduzt.",
        why: "Türkçede 'ona sen demek' yönelme hâli ister, o yüzden Almancada da Dativ seçiliyor. Almanca 'duzen' ve 'siezen' fiilleri doğrudan NESNE alır (Akkusativ) ve tek başına yeterlidir: jemanden duzen, jemanden siezen. 'zu jemandem du sagen' anlaşılır ama uzun ve Almanca değildir.",
      },
    ],
  },
  {
    ...
    tasks: [
      ...
      {
        kind: "rewrite",
        prompt: "„jeder“ ve „alle“ sonrası fiili düzelt.",
        source: "Jeder sind herzlich willkommen und alle ist eingeladen.",
        answer: "Jeder ist herzlich willkommen und alle sind eingeladen.",
        why: "Türkçede 'herkes' ve 'hepsi' fiili aynı biçimde çeker, o yüzden Almancada ikisi karışıyor. Almanca ayırır: jeder/jede/jedes TEKİLDİR ve tekil fiil ister (jeder ist), alle ÇOĞULDUR ve çoğul fiil ister (alle sind). Ünite 40 'die meisten'in çoğul olduğunu çalışmıştı; 'jeder' onun tersidir.",
      },
    ],
  },
];
