...
export const enA2U15: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    questions: [
      ...
      {
        text: "What did the second store give for free?",
        options: ["the cable", "a discount", "three years"],
        answer: 0,
        explain: "„They said no, but they gave me the cable for free.“",
      },
      {
        kind: "truefalse",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„The part comes on Wednesday. It will be ready on Thursday afternoon.“",
      },
    ],
  },
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        fields: [
          { label: "First store", answer: "two hundred and ten", accept: ["210", "two hundred ten"] },
          { label: "Second store", answer: "two hundred and fifty", accept: ["250", "two hundred fifty"] },
