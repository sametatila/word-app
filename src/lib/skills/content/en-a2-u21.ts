...
export const enA2U21: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    minutes: 5,
    segments: [
      { speaker: "Deniz", text: "Have you seen the new series? Everybody at work is talking about it." },
      ...
      { speaker: "Deniz", text: "True. But this time it's true. What is it about? A family, a house, and forty years." },
      ...
      { speaker: "Ela", text: "Then I'll watch it tonight. Two episodes, not more." },
      { speaker: "Deniz", text: "Everybody says two. Nobody stops at two." },
      { speaker: "Ela", text: "I don't believe you." },
      { speaker: "Deniz", text: "Text me at midnight." },
    ],
    questions: [
      {
      ...
      },
      {
        ...
        explain: "„Then I'll watch it tonight. Two episodes, not more.“",
      },
    ],
  },
  {
    ...
    segments: [
      ...
      { speaker: "Nil", text: "I don't believe it's true. Two weeks ago I saw the same photo online, with the name of a city in Italy under it." },
      { speaker: "Can", text: "Then let's look. The newspaper says nothing. The city website says nothing." },
