...
export const b1U28: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Eva", text: "So, das war ein schöner Abend. Aber es ist kein richtiger Abschied." },
      { speaker: "Frank", text: "Genau. Machen wir gleich eine Verabredung für den Sommer." },
      { speaker: "Eva", text: "Ein Picknick? Am Fluss ist es im Juli am schönsten." },
      { speaker: "Frank", text: "Gute Idee. Als Treffpunkt nehmen wir die Brücke." },
      { speaker: "Eva", text: "Ich bringe Tücher und eine Vase mit, für den Tisch." },
      { speaker: "Frank", text: "Eine Vase beim Picknick? Das ist typisch du." },
      { speaker: "Eva", text: "Alles, was schön aussieht, gehört dazu. Auch draußen." },
      { speaker: "Frank", text: "Einverstanden. Dann bis Juli — und diesmal wirklich." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Kundin", text: "Guten Tag, ich möchte das hier umtauschen." },
      { speaker: "Verkäuferin", text: "Gern. Haben Sie den Beleg dabei?" },
      { speaker: "Kundin", text: "Ja, hier. Der Kauf war vor zehn Tagen." },
      { speaker: "Verkäuferin", text: "Das passt. Was ist denn das Problem?" },
      { speaker: "Kundin", text: "Es funktioniert nur, wenn man das Kabel festhält." },
      { speaker: "Verkäuferin", text: "Dann ist das ein Fall für die Garantie, nicht für den Umtausch." },
      { speaker: "Kundin", text: "Was heißt das für mich?" },
      { speaker: "Verkäuferin", text: "Sie bekommen als Ersatz ein neues Gerät. Das dauert zwei Wochen." },
    ],
    questions: [
      {
