...
export const b1U31: SkillExercise[] = [
  // ─────────────────────────── OKUMA ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "die Strecke", tr: "mesafe", en: "distance" },
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Mitarbeiterin", text: "Meine Damen und Herren, wir beginnen mit der Landung." },
      { speaker: "Reisender", text: "Entschuldigung, wie lange dauert es noch?" },
      { speaker: "Mitarbeiterin", text: "Etwa zwanzig Minuten. Bitte bleiben Sie sitzen." },
      { speaker: "Reisender", text: "Ich habe einen Anschluss. Fahre ich besser mit dem Zug weiter?" },
      { speaker: "Mitarbeiterin", text: "Mit dem Zug sind Sie in einer Stunde in der Stadt." },
      { speaker: "Reisender", text: "Und mit dem Bus?" },
      { speaker: "Mitarbeiterin", text: "Länger, aber billiger. Der Steward am Notausgang kennt die Zeiten. Er hilft jedem Passagier gern." },
      { speaker: "Reisender", text: "Danke. Dann frage ich ihn, sobald die Kabine offen ist." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Jan", text: "Hörst du das? Die Bremse macht seit der Kurve ein Geräusch." },
      { speaker: "Karin", text: "Ja. Wir fahren zur nächsten Werkstatt, nicht nach Hause." },
      { speaker: "Jan", text: "Und das Benzin? Wir haben noch knapp ein Viertel." },
      { speaker: "Karin", text: "Das reicht. Die Tankstelle ist auf dem Weg." },
      { speaker: "Jan", text: "Sollen wir bei der Umleitung trotzdem in die Stadt fahren?" },
      { speaker: "Karin", text: "Nein. Erst in die Werkstatt, dann sehen wir weiter." },
      { speaker: "Jan", text: "Gut. Fahr im zweiten Gang los, das ist ruhiger." },
      { speaker: "Karin", text: "Mache ich. Und wenn es schlimmer wird, halten wir sofort." },
    ],
    questions: [
      {
