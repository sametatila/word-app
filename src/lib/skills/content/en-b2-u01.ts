...
export const enB2U01: SkillExercise[] = [
  ...
  },
  {
    ...
    segments: [
      ...
      { speaker: "Emre", text: "I use the perfect one in a timeline and the continuous one in a planner, and mixing them is how a plan starts sounding more certain than it is." },
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["in a planner", "in a timeline", "in a budget"],
        answer: 0,
        explain: "„I use the perfect one in a timeline and the continuous one in a planner…“",
      },
      {
        kind: "truefalse",
