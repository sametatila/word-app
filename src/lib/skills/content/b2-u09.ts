...
export const b2U09: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Der Bürgermeister war jeden Tag im Rathaus.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Der Bürgermeister war in diesen Wochen jeden Tag im Rathaus.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "fragwürdig", tr: "şüpheli", en: "questionable" },
      { de: "einzige", tr: "tek", en: "only" },
      { de: "die Zahl", tr: "sayı", en: "number" },
      { de: "die Erhebung", tr: "veri toplama", en: "data collection" },
    ...
    questions: [
      ...
      {
        text: "Der Leser findet die Zeitung nicht schlecht.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „…nicht, weil ich Ihre Zeitung schlecht finde, sondern weil ich sie brauche.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "der Rundfunk", tr: "yayıncılık", en: "broadcasting" },
    ...
    questions: [
      ...
      {
        text: "Deniz hat die Aufnahme und kann wörtlich zitieren.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Ja, ich habe die Aufnahme.“ Sorun alıntıda değil, haberi çıkarmakta.",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        text: "Jo hat die Hälfte des Films gesehen.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Die Hälfte. Danach bin ich eingeschlafen.“",
      },
    ],
  },

  {
    ...
    tasks: [
      ...
      },
      {
        ...
        alternatives: ["Er ist auf die Frage, ob die Stelle gestrichen wird, ausgewichen"],
      ...
      },
      {
        ...
        alternatives: ["Ich mag zwar die Kolumne, jedoch nicht den Leitartikel"],
