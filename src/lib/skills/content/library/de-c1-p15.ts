...
export const deC1P15: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    minutes: 10,
    segments: [
      { speaker: "Reporter", text: "In Lindenau hängen an über dreihundert Balkonen kleine weiße Kästen. Sie messen Feinstaub, und zwar rund um die Uhr, inzwischen seit vier Jahren und ohne einen Cent aus der Stadtkasse." },
      ...
      { speaker: "Reporter", text: "Die Daten der Sensoren werden alle fünf Minuten auf eine öffentliche Karte übertragen. Jeder kann sehen, wo und wann die Werte steigen, auch die Stadtverwaltung." },
      ...
      { speaker: "Reporter", text: "Die Initiative hat darauf reagiert: Seit zwei Jahren wird jeder Sensor einmal im Jahr neben einer amtlichen Station geprüft und bei Bedarf korrigiert." },
      ...
      { speaker: "Reporter", text: "Genau solche Beobachtungen haben das Umweltamt überzeugt. An drei Straßen, die in keiner offiziellen Messung vorkamen, gelten inzwischen Tempo dreißig und ein Lkw-Verbot." },
