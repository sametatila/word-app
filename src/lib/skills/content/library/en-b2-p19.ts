...
export const enB2P19: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "unhappiest", tr: "en mutsuz" },
      { de: "furniture", tr: "mobilya" },
      { de: "temporary", tr: "geçici" },
      { de: "indoor", tr: "ev içinde yaşayan" },
      { de: "occasionally", tr: "arada bir" },
      { de: "rescue centers", tr: "hayvan barınağı" },
      { de: "necessarily", tr: "mutlaka" },
      { de: "manageable", tr: "idare edilebilir" },
      { de: "adopting", tr: "sahiplenmek" },
    ],
    minutes: 8,
    segments: [
