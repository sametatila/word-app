    ...
    tasks: [
      {
        ...
        confusions: [
          { heard: ["Dı answer is at dı end"], fix: "Ünlüden önce „the“ uzun i ile okunur ve sonraki kelimeye bağlanır.", expected: "the answer" },
        ],
      },
      {
        ...
        confusions: [
          { heard: ["Dii book is on dii table"], fix: "Sessizden önce „the“ zayıf bir ı taşır; uzun söylemek yapay duyulur.", expected: "the book" },
        ],
      },
      {
      ...
      },
      {
        ...
        confusions: [
          { heard: ["Dı office next to dii university"], fix: "„university“ yu- ile başlar; bu bir sessiz sayılır.", expected: "the university" },
        ],
      },
      {
        ...
        confusions: [
          { heard: ["Dı other one"], fix: "Ünlüden önce uzun i gelir ve araya küçük bir y sesi girer.", expected: "the other" },
        ],
      },
      {
        ...
        confusions: [
          { heard: ["Dı answer, not an answer"], fix: "Vurgulu „the“ uzun i taşır; bu bilinçli bir seçimdir.", expected: "THE answer" },
        ],
      },
    ],
  },
