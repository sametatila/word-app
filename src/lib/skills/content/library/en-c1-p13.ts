...
export const enC1P13: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Tom", text: "I would. I coach a youth soccer club, and from November we lose every weekday session because it's dark by half past four. Permanent summer time gives us that hour back." },
      ...
      { speaker: "Sarah", text: "Schools could, but buses, shifts and parents' jobs don't move with them. You'd be asking a whole region to rearrange its day so that the rest can play soccer." },
