...
export const enC1P2: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    genre: "monologue",
    intro: "Bir üniversite dersinin ilk bölümünü dinleyeceksin: hangi altyapı hiçbir strateji belgesinde geçmiyor ve yokluğu kimin şehrini küçültüyor.",
    gloss: [
      ...
      { de: "lecture", tr: "üniversite dersi" },
      { de: "medical", tr: "tıbbi" },
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["responsibility", "who is responsible", "having somebody responsible", "somebody responsible", "someone responsible", "a person who is responsible"],
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "category", tr: "kategori" },
      { de: "frequent", tr: "sık" },
      { de: "round", tr: "yuvarlak" },
      { de: "distribute", tr: "dağıtmak" },
