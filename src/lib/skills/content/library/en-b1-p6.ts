...
export const enB1P6: SkillExercise[] = [
  ...
  // ─────────────────────────── DİL BİLGİSİ ───────────────────────────
  {
    ...
    questions: [
      ...
      {
        kind: "gapfill",
        text: "She didn't ___ like coffee. (use / used)",
        options: [],
        answer: 0,
        accept: ["use to"],
        explain: "„did“ varsa biçim „use to“ olur.",
      },
      {
        kind: "gapfill",
        text: "Every summer we ___ drive to the coast. (would / used)",
        options: [],
        answer: 0,
        accept: ["would"],
        explain: "Tekrarlanan bir eylem; „would“ kullanılabilir.",
      },
      {
        kind: "gapfill",
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        items: ["You'll", "get used to", "the shifts", "soon"],
