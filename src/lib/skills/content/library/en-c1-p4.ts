...
export const enC1P4: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["they are always open", "always open", "they never close", "open all the time", "they are open all the time"],
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "exclude", tr: "dışlamak" },
      { de: "sustainable", tr: "sürdürülebilir" },
      { de: "behavioral", tr: "davranışsal" },
    ],
    minutes: 14,
    tasks: [
      {
