...
export const enB2P15: SkillExercise[] = [
  // ─────────────────────────── OKUMA ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "precise", tr: "net" },
      { de: "guaranteed", tr: "garanti" },
      { de: "subscription", tr: "abonelik" },
      { de: "membership", tr: "üyelik" },
      { de: "cancellation", tr: "iptal" },
      { de: "responsible", tr: "sorumlu" },
      { de: "considerably", tr: "epey" },
    ],
    minutes: 8,
    text:
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "poor", tr: "kötü" },
      { de: "recipe box", tr: "tarif kutusu" },
      { de: "confirmation", tr: "onay" },
      { de: "agent", tr: "temsilci" },
    ],
    minutes: 8,
    segments: [
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "consumer organization", tr: "tüketici derneği" },
      { de: "membership", tr: "üyelik" },
      { de: "cancellation", tr: "iptal" },
      { de: "responsible", tr: "sorumlu" },
    ],
