...
export const enB2P20: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Mr. Halloran", text: "So they'd simply guessed. Does that really matter, if it's only used for coupons?" },
      { speaker: "Ms. Quinn", text: "That's the thing: it isn't only coupons. The privacy notice says profiles can be shared with “carefully selected partners”. It doesn't say who they are, or what they pay for it." },
