...
export const enB2P14: SkillExercise[] = [
  // ─────────────────────────── OKUMA ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "banned", tr: "yasaklanmak" },
      { de: "scooters", tr: "scooter" },
      { de: "rental", tr: "kiralık" },
      { de: "familiar", tr: "tanıdık" },
      { de: "injured", tr: "yaralı" },
      { de: "distributed", tr: "dağılmak" },
      { de: "involved", tr: "kapsamak" },
      { de: "wheelchair", tr: "tekerlekli sandalye" },
      { de: "operators", tr: "işletmeci" },
      { de: "noticeable", tr: "kayda değer" },
    ],
    minutes: 8,
    text:
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "misunderstanding", tr: "yanlış anlama" },
      { de: "operator", tr: "işletmeci" },
      { de: "intends", tr: "niyetinde olmak" },
    ],
    minutes: 8,
    segments: [
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "stroller", tr: "puset" },
      { de: "scooter", tr: "scooter" },
      { de: "sidewalk", tr: "kaldırım" },
      { de: "disabled", tr: "engelli" },
      { de: "editor", tr: "editör" },
    ],
    minutes: 14,
    tasks: [
