  ...
  // ─────────────────────────── DİL BİLGİSİ ───────────────────────────
  {
    ...
    explanation: [
      ...
      },
      {
        ...
        tr: "Sıranın adı TeKaMoLo: temporal (wann?), kausal (warum?), modal (wie?), lokal (wo? wohin?). Sebep bilgisi A2'de çoğunlukla „deshalb“tır. Hepsi bir cümlede nadiren bulunur; ama hangileri varsa bu sırayla gelir.",
        examples: [
          { de: "Ich fahre heute deshalb mit dem Bus zur Arbeit.", tr: "Bugün bu yüzden otobüsle işe gidiyorum.", note: "Te – Ka – Mo – Lo" },
    ...
    questions: [
      ...
      {
        text: "Sie fährt ___ zur Arbeit.",
        options: ["jeden Tag mit dem Rad", "mit dem Rad jeden Tag", "mit jeden Tag dem Rad"],
        answer: 0,
        explain: "Zaman tarzdan önce gelir: jeden Tag mit dem Rad; yer (zur Arbeit) zaten sonda.",
      },
      {
        text: "Wir gehen ___.",
        options: ["zu Fuß am Abend nach Hause", "nach Hause am Abend zu Fuß", "am Abend zu Fuß nach Hause"],
        answer: 2,
