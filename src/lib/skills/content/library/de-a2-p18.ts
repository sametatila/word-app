...
export const deA2P18: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Dilek", text: "Kannst du dafür an einem Samstag für mich arbeiten? Am einundzwanzigsten heiratet meine Cousine." },
      { speaker: "Hanna", text: "Am einundzwanzigsten? Ja, das passt, da habe ich sowieso frei." },
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Am einundzwanzigsten heiratet meine Cousine.“",
      },
      {
        kind: "short_answer",
