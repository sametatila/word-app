...
export const enC1P9: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Ms Idrissi", text: "Organisations resist this because it looks like distrust. In practice it protects the people making the decisions, who otherwise have to remember why they said yes eighteen months ago." },
    ...
    questions: [
      ...
      {
        kind: "short_answer",
        text: "Why do organisations resist the log?",
        options: [],
        answer: 0,
