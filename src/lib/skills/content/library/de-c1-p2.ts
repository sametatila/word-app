...
export const deC1P2: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "verordnen", tr: "zorunlu kılmak", en: "to decree" },
    ],
    minutes: 10,
    segments: [
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Richtig", "Falsch"],
        answer: 1,
        explain: "Kulübün gürültüsünü inkâr etmiyor; kapıya iki kişi koyduklarından beri şikâyetlerin yarıya indiğini anlatarak sorunu dolaylı olarak kabul ediyor.",
      },
      {
        kind: "short_answer",
        ...
        options: [],
        answer: 0,
        accept: ["zwei Leute vor der Tür", "zwei Personen vor der Tür", "Personal vor der Tür", "eine besetzte Tür", "Türsteher"],
        explain: "„Seit wir zwei Leute vor der Tür haben, sind die Beschwerden um die Hälfte zurückgegangen.“",
      },
      {
        kind: "dictation",
        text: "Frau Idrissi'nin son uyarısındaki ikinci cümleyi duyduğun gibi yaz.",
        options: [],
        answer: 0,
