...
export const enB2P2: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Ines", text: "A system where you have to write a letter is not the same as one where you check a box when you renew your driver's license." },
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          "the rules for driver's licenses",
        ],
        answer: 0,
