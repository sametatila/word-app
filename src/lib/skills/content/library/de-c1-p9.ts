...
export const deC1P9: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    minutes: 10,
    segments: [
      { speaker: "Moderator", text: "Wer ein persönliches Archiv aufbaut, macht fast immer denselben Fehler: Er beginnt mit der Struktur." },
      { speaker: "Moderator", text: "Ordner werden angelegt, Kategorien erfunden, und nach drei Monaten passt die Hälfte des Materials in keine davon." },
      ...
      { speaker: "Moderator", text: "Der zweite Fehler ist die Vollständigkeit. Wer alles aufhebt, hebt nichts auf, weil das Wiederfinden am Volumen scheitert." },
      { speaker: "Moderator", text: "Empfohlen wird deshalb ein umgekehrtes Vorgehen: erst sammeln, dann drei Monate warten, dann ordnen — und zwar nur das, was in dieser Zeit tatsächlich gesucht wurde." },
      ...
      { speaker: "Moderator", text: "Drittens: Ein einziges Suchfeld schlägt jede Ordnerhierarchie, sofern die Dateinamen brauchbar sind. Der Name ist die eigentliche Ablage." },
      { speaker: "Moderator", text: "Und schließlich: Auf Versionen kann man fast immer verzichten, auf das Datum im Dateinamen nie." },
