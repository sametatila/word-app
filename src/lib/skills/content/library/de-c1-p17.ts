...
export const deC1P17: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    minutes: 10,
    segments: [
      { text: "Die meisten Streitigkeiten ums Erbe entstehen nicht aus Gier, sondern aus Missverständnissen, und viele davon hätten sich mit wenigen Sätzen vermeiden lassen, hätte man sie rechtzeitig aufgeschrieben." },
      ...
      { text: "Ein handschriftliches Testament ist gültig, wenn es vollständig mit der Hand geschrieben und unterschrieben ist. Ein am Computer geschriebener Text mit Unterschrift reicht dagegen nicht." },
      ...
      { text: "Der zweite Fehler betrifft die Pflege. Wenn ein Kind die Eltern jahrelang gepflegt hat, wird das im Nachlass nur unter bestimmten Bedingungen berücksichtigt." },
      ...
      { text: "Drittens: Auch wer enterbt wird, geht meistens nicht leer aus. Kinder haben Anspruch auf einen Pflichtteil, der die Hälfte ihres gesetzlichen Erbteils beträgt." },
      ...
      { text: "Und schließlich, ganz praktisch: Das Testament sollte dort liegen, wo es auch gefunden wird. Beim Amtsgericht kann man es gegen eine geringe Gebühr hinterlegen." },
