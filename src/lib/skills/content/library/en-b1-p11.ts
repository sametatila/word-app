...
export const enB1P11: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Amina", text: "We left the car at a garage and walked the last kilometre. He was the only child in his class who arrived that day, and he's still proud of it." },
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["kilometre", "kilometer"],
        explain: "„walked the last kilometre“ — arabayı bir servise bırakıp yürümüşler.",
      },
      {
        kind: "short_answer",
