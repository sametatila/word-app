...
export const enC1P10: SkillExercise[] = [
  // ─────────────────────────── OKUMA ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "property", tr: "mülk" },
      { de: "efficient", tr: "enerji verimli" },
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["True", "False"],
        answer: 1,
        explain: "„It has not.“ — kazandığı tartışmaları kaybediyor.",
      },
      {
        kind: "gapfill",
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    minutes: 10,
    segments: [
      { text: "There is a version of admitting a mistake that repairs the damage, and a version that doubles it. The difference is almost entirely structural." },
      { text: "The first mistake is burying it. A correction that appears in the fourth paragraph, after three paragraphs of context, reads as an attempt to be seen to have corrected without being read." },
      ...
      { text: "The second mistake is the grudging form: “while the broad point stands, one figure may have been imprecise.”" },
      ...
      { text: "The third is over-correction, which sounds like the opposite but has the same root. Announcing that you can no longer be trusted on anything invites your audience to agree with you." },
      ...
      { text: "One further point, which people find harder than all of the above: say it in the same place and at the same volume as the original claim." },
