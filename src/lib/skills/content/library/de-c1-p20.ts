...
export const deC1P20: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    minutes: 10,
    segments: [
      { text: "Nachtzüge sind wieder gefragt, und mit der Nachfrage wachsen die Beschwerden. Die Verbraucherzentrale hat die häufigsten Fragen gesammelt und beantwortet." },
      { text: "Zunächst zur Buchung: Es gibt drei Kategorien, den Sitzwagen, den Liegewagen mit vier oder sechs Betten und das Schlafabteil mit eigenem Waschbecken." },
      ...
      { text: "Die Plätze werden meist erst drei bis sechs Monate vor der Fahrt freigegeben. Wer früher sucht, findet oft nichts und hält den Zug fälschlich für ausgebucht." },
      ...
      { text: "Bei Verspätungen gelten die europäischen Fahrgastrechte. Ab sechzig Minuten Verspätung am Ziel gibt es ein Viertel des Fahrpreises zurück, ab zwei Stunden die Hälfte." },
      ...
      { text: "Fällt ein Nachtzug ganz aus, muss das Unternehmen eine Alternative anbieten oder die Übernachtung in einem Hotel bezahlen." },
      ...
      { text: "Die Entschädigung wird nicht automatisch ausgezahlt. Man muss sie innerhalb von drei Monaten beantragen, am besten über das Formular des Unternehmens." },
