...
export const enA1: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Officer", text: "Thank you, Nadia. We'll call you when we find the bag." },
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["He will call Nadia when they find the bag.", "He gives Nadia a new bag.", "He sends Nadia to the library."],
        answer: 0,
        explain: "„We'll call you when we find the bag.“",
      },
    ],
  },
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        alternatives: ["On Sunday we are visiting you."],
  ...
  // ─────────────────────────── KONUŞMA ───────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        confusions: [{ heard: ["dirty tree", "dirty three", "thirty free"], fix: "Her iki th'de dil dişlerin arasında; „tree“ (ağaç) ve „free“ (bedava) başka kelimeler.", expected: "thirty-three" }],
      },
      {
        de: "The weather is good on Thursday.",
        tr: "Perşembe hava güzel.",
        hint: "„the“ ve „weather“: sesli th. „Thursday“: sessiz th.",
        confusions: [{ heard: ["Tuesday"], fix: "„the“ d ile değil, dişler arasında titreşimle. „Thursday“ Tuesday ile karışmasın: th üfle.", expected: "Thursday" }],
      },
      {
      ...
      },
      {
        ...
        confusions: [{ heard: ["boat of them", "bot of them"], fix: "„both“ kelime sonunda dişler arasından üfle; „boat“ (tekne) olmasın.", expected: "both" }],
      },
      {
        de: "My mother has three brothers.",
        tr: "Annemin üç erkek kardeşi var.",
