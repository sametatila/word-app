...
export const deC1P10: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    minutes: 10,
    segments: [
      { speaker: "Moderator", text: "Seit der Gesetzesänderung muss jede größere Organisation eine interne Meldestelle unterhalten. Was das praktisch heißt, ist weniger bekannt." },
      { speaker: "Moderator", text: "Entscheidend sind drei Punkte, und keiner davon betrifft den Inhalt der Meldung." },
      ...
      { speaker: "Moderator", text: "Der zweite ist die Frist für die Rückmeldung zum Stand des Verfahrens: drei Monate, gerechnet ab der Bestätigung, nicht ab der Meldung." },
      ...
      { speaker: "Moderator", text: "Der dritte Punkt ist die Vertraulichkeit der Identität. Sie gilt auch gegenüber der eigenen Leitung, und das ist der Punkt, an dem die meisten Verfahren in der Praxis scheitern." },
      ...
      { speaker: "Moderator", text: "Wichtig ist außerdem die Form: Eine mündliche Meldung ist zulässig, aber der Meldende sollte auf einem Protokoll bestehen und eine Kopie verlangen." },
