    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          "testing the water every day",
        ],
        answer: 0,
        explain: "„No, the water is not made softer here. That is done in your house, or not at all.“ Klor kurak yazlarda ekleniyor, test her gün yapılıyor.",
      },
    ],
  },
