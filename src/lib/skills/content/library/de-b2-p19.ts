...
export const deB2P19: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    gloss: [
      ...
      { de: "buchstabieren", tr: "hecelemek", en: "to spell" },
    ...
    segments: [
      ...
      { speaker: "Herr Brückner", text: "Ungefähr. In zwanzig Jahren werden wohl die ersten Namen aus den Achtzigern wieder auftauchen, aber erst, wenn die heutigen Eltern selbst Großeltern geworden sind." },
  ...
  // ─────────────────────────── KONUŞMA ───────────────────────────
  {
    ...
    genre: "monologue",
    intro: "Bir dakikadan uzun tek başına konuşacaksın: anne babanın hakkını ve çocuğun çıkarını tart, sınırını çiz ve geleceğe bak.",
    gloss: [],
    minutes: 7,
    monologue: {
      promptTr:
