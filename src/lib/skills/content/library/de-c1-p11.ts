...
export const deC1P11: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    minutes: 10,
    segments: [
      { speaker: "Moderatorin", text: "Alle fünf Jahre suchen die Gemeinden Menschen, die als Schöffinnen und Schöffen an Strafverfahren mitwirken. Viele wissen nicht einmal, dass es dieses Amt gibt." },
      { speaker: "Moderatorin", text: "Der Weg dorthin hat zwei Stufen: Die Gemeinde stellt eine Vorschlagsliste auf, und ein Ausschuss am Amtsgericht wählt daraus aus." },
      ...
      { speaker: "Moderatorin", text: "Voraussetzungen sind die deutsche Staatsangehörigkeit und ein Alter zwischen fünfundzwanzig und neunundsechzig Jahren. Juristische Kenntnisse werden ausdrücklich nicht erwartet." },
      ...
      { speaker: "Moderatorin", text: "Ablehnen kann man das Amt nur aus bestimmten Gründen, etwa wegen des Alters, wegen der Pflege von Angehörigen oder wenn man schon in der vorigen Amtszeit tätig war." },
      { speaker: "Moderatorin", text: "Der Arbeitgeber muss Schöffen für die Sitzungstage freistellen und darf ihnen daraus keine Nachteile entstehen lassen. Den Verdienstausfall ersetzt das Gericht in Form einer Entschädigung." },
      ...
      { speaker: "Moderatorin", text: "Eine Grenze gibt es allerdings. Wer ein Verfahren nicht unvoreingenommen verfolgen kann, etwa weil er Beteiligte kennt, muss das melden. Die Unparteilichkeit geht jedem persönlichen Wunsch vor." },
      ...
      { speaker: "Moderatorin", text: "Die nächste Wahl findet im kommenden Jahr statt; Vorschläge nehmen die Gemeinden bis Ende März entgegen." },
    ],
    questions: [
      {
