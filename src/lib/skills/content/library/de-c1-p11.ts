...
export const deC1P11: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { text: "Der Arbeitgeber muss für die Sitzungstage freistellen und darf daraus keine Nachteile ableiten. Den Verdienstausfall ersetzt das Gericht in Form einer Entschädigung." },
