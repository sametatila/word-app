...
export const b1U13: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Lena", text: "Ich muss am Freitag arbeiten. Kannst du mich beim Amt vertreten?" },
      { speaker: "Jonas", text: "Klar. Was brauche ich dafür?" },
      { speaker: "Lena", text: "Eine Vollmacht von mir und eine Kopie meines Ausweises." },
      { speaker: "Jonas", text: "Reicht eine Kopie? Verlangen die nicht das Original?" },
      { speaker: "Lena", text: "Nein. Das Original bleibt bei mir, du nimmst nur die Kopie mit." },
      { speaker: "Jonas", text: "Gut. Ich kopiere das heute Abend." },
      { speaker: "Lena", text: "Danke. Wenn sich jemand weigert, ruf mich einfach an." },
      { speaker: "Jonas", text: "Mache ich. Du musst mich nicht überreden, das ist kein Problem." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Tom", text: "Was hast du für dieses Jahr vor?" },
      { speaker: "Nina", text: "Ich will die Prüfung schaffen. Aber ohne Plan geht das nicht." },
      { speaker: "Tom", text: "Hast du schon etwas festgelegt?" },
      { speaker: "Nina", text: "Ja. Jeden Tag zwanzig Minuten. Lieber kurz als dauernd nichts." },
      { speaker: "Tom", text: "Das ist gut. Und wie merkst du den Fortschritt?" },
      { speaker: "Nina", text: "Ich überprüfe am Monatsende, was ich wirklich verstanden habe." },
      { speaker: "Tom", text: "Gute Idee. Bei mir ist das Problem die Gewohnheit." },
      { speaker: "Nina", text: "Dann fang klein an. Der Sinn ist nicht, perfekt zu sein." },
    ],
    questions: [
      {
