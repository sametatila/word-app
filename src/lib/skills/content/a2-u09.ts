...
export const a2U09: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Die Brille ist drinnen.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Aber sie ist drinnen, nicht auf dem Balkon.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        text: "Draußen findet man leichter einen Parkplatz.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: dışarıda hemen park edilebiliyor, „Im Zentrum sucht man dafür eine halbe Stunde“.",
      },
    ],
  },
  {
