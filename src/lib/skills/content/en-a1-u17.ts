...
export const enA1U17: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Son", text: "OK. Then I start with the trash. It is fast." },
    ],
    questions: [
      {
      ...
      },
      {
        ...
        explain: "„OK. Then I start with the trash. It is fast.“",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: 0,
        explain: "„six hundred euros for two rooms“ — doksan elektrik, on merdiven temizliği.",
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          "I pay at the bank.",
          "Each person in the building pays for cleaning the stairs.",
        ],
        explain: "Önce kira, sonra dâhil olan ve olmayan, sonra ödeme yeri, en son ortak gider.",
      },
      {
        kind: "short_answer",
        text: "How much does each person pay for cleaning the stairs?",
        options: [],
        answer: 0,
