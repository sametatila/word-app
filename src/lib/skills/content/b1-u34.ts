...
export const b1U34: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Jonas", text: "Wie geht es dir in der Schwangerschaft?" },
      { speaker: "Clara", text: "Besser als im dritten Monat. Ich schlafe wieder." },
      { speaker: "Jonas", text: "Und wann ist die Geburt?" },
      { speaker: "Clara", text: "Mitten im März. Wir sind fast fertig mit dem Zimmer. Der Nachwuchs bekommt das kleine Zimmer." },
      { speaker: "Jonas", text: "Arbeitet ihr beide weiter?" },
      { speaker: "Clara", text: "Erst mal nicht. Ich bleibe ein Jahr zu Hause, mein Mann sechs Monate." },
      { speaker: "Jonas", text: "Das ist gut. Erziehung ist nicht die Arbeit von einer Person." },
      { speaker: "Clara", text: "Genau. Wir schaffen das, indem wir uns abwechseln." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Eva", text: "Wer kommt am Sonntag alles?" },
      { speaker: "Leon", text: "Meine Tante, mein Onkel und die beiden Enkel." },
      { speaker: "Eva", text: "Und die Kinder deiner Schwester?" },
      { speaker: "Leon", text: "Meinen Neffen bringe ich mit, die Nichte ist krank." },
      { speaker: "Eva", text: "Schade. Und deine Cousine aus Wien?" },
      { speaker: "Leon", text: "Die kommt nicht, sie hat sowieso nie Zeit." },
      { speaker: "Eva", text: "Dann sind wir elf. Ich sage der Küche Bescheid." },
      { speaker: "Leon", text: "Zwölf. Meinen Cousin habe ich vergessen." },
    ],
    questions: [
      {
