...
export const b2U16: SkillExercise[] = [
...

  {
    ...
    gloss: [
      ...
      { de: "der Liter", tr: "litre", en: "liter" },
...

  {
    ...
    gloss: [
      ...
      { de: "gewöhnen", tr: "alışmak", en: "to get used to" },
    ],
    minutes: 5,
    segments: [
    ...
    questions: [
      {
        ...
        explain: "dessen eril ve nötr sahipler içindir: biçimi sahip olunan öbeğe göre değil, sahibe göre seçilir.",
      },
      {
...

  {
    ...
    segments: [
      ...
      { speaker: "Falk", text: "Man hat gemerkt, dass sie lange geprobt haben. Jeder Text saß." },
...

  {
    ...
    gloss: [
      ...
      { de: "der Dirigent", tr: "orkestra şefi", en: "conductor" },
      { de: "die Besetzung", tr: "oyuncu kadrosu", en: "cast" },
      { de: "umgestalten", tr: "dönüştürmek", en: "to convert" },
      { de: "komplett", tr: "eksiksiz", en: "complete" },
      { de: "die Mitternacht", tr: "gece yarısı", en: "midnight" },
    ],
    minutes: 9,
    tasks: [
      ...
      {
        kind: "build",
        tr: "Orkestrasını dinlediğimiz şef mayısta geliyor.",
        answer: "Im Mai kommt der Dirigent, dessen Orchester wir gehört haben",
        alternatives: ["Der Dirigent, dessen Orchester wir gehört haben, kommt im Mai"],
      ...
      },
      {
        ...
        alternatives: ["Nach dem Krieg wurde der Saal zum Ausstellungsraum umgestaltet"],
...

  {
    ...
    gloss: [
      ...
      { de: "anwesend", tr: "hazır bulunan", en: "present" },
