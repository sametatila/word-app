    ...
    questions: [
      {
        ...
        answer: 0,
        explain: "„My flight was delayed and I've missed my connection.“ — aktarma birdeydi, uçak iki buçukta indi.",
      },
      {
      ...
      },
      {
        ...
        answer: 0,
        accept: ["five", "5"],
        explain: "„Seven? That is almost five hours.“",
      },
      {
        kind: "dictation",
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["on the plane", "the plane", "in the plane"],
        explain: "„Did you leave it on the plane? — I think so.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["after the main course", "after the check", "before the soup"],
        answer: 0,
        explain: "„Dessert comes after the main course here, and it takes twenty minutes.“",
      },
      {
        kind: "truefalse",
        text: "They want two checks.",
        options: ["True", "False"],
        answer: 1,
