...
export const b1U42: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Zeugin", text: "Guten Tag. Ich möchte etwas melden." },
      { speaker: "Beamter", text: "Setzen Sie sich. Wann war das Ereignis?" },
      { speaker: "Zeugin", text: "Gestern gegen zehn Uhr abends, vor meinem Haus." },
      { speaker: "Beamter", text: "Haben Sie jemanden gesehen?" },
      { speaker: "Zeugin", text: "Zwei Personen, aber nur von hinten. Ich kann nichts Genaues sagen." },
      { speaker: "Beamter", text: "Das ist in Ordnung. Erfundene Angaben helfen niemandem." },
      { speaker: "Zeugin", text: "Was passiert jetzt?" },
      { speaker: "Beamter", text: "Ich nehme das auf, dann geht es an die Kriminalpolizei. Eine Polizistin meldet sich bei Ihnen, wenn wir den Verbrecher finden." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Karin", text: "In der Theorie ist das neue Gesetz gerecht." },
      { speaker: "Ben", text: "Und in der Wirklichkeit?" },
      { speaker: "Karin", text: "Da hängt es davon ab, wer eine Anwältin bezahlen kann." },
      { speaker: "Ben", text: "Also gilt es nicht für alle gleich." },
      { speaker: "Karin", text: "Auf dem Papier schon. In der Praxis nicht immer." },
      { speaker: "Ben", text: "Was war die Reaktion der Politiker?" },
      { speaker: "Karin", text: "Die meisten sagen, das sei ein Einzelfall." },
      { speaker: "Ben", text: "Ein oft genannter Einzelfall ist keiner mehr." },
    ],
    questions: [
      {
