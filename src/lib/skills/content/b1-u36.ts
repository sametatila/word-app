...
export const b1U36: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Kunde", text: "Seit heute Morgen habe ich keine Verbindung." },
      { speaker: "Mitarbeiterin", text: "Einen Moment. Ja, bei Ihnen ist die Leitung unterbrochen." },
      { speaker: "Kunde", text: "Weshalb denn? Gestern war alles normal." },
      { speaker: "Mitarbeiterin", text: "Es gibt eine Störung im ganzen Netzwerk, seit vier Uhr." },
      { speaker: "Kunde", text: "Und wie lange dauert das noch?" },
      { speaker: "Mitarbeiterin", text: "Bis heute Abend, sagen die Kollegen." },
      { speaker: "Kunde", text: "Kann ich in der Zeit etwas machen?" },
      { speaker: "Mitarbeiterin", text: "Verbinden Sie das Gerät mit dem Telefon, das geht meistens." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Nachbarin", text: "Du, hast du zufällig eine Leiter?" },
      { speaker: "Nachbar", text: "Klar. Wofür brauchst du sie?" },
      { speaker: "Nachbarin", text: "Ich will oben im Flur eine Lampe anschließen." },
      { speaker: "Nachbar", text: "Dann nimm auch die Zange mit, die brauchst du sowieso." },
      { speaker: "Nachbarin", text: "Stimmt. Und einen Hammer für den Nagel." },
      { speaker: "Nachbar", text: "Das Loch ist schon da, oder?" },
      { speaker: "Nachbarin", text: "Ja, vom Vormieter. Ich habe mir viel Mühe gespart." },
      { speaker: "Nachbar", text: "Gut. Bring alles zurück, wenn du fertig bist." },
    ],
    questions: [
      {
