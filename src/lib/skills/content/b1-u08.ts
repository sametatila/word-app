...
export const b1U08: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Tom", text: "Also, entweder gehen wir heute ins Kino oder wir lassen es ganz." },
      { speaker: "Lisa", text: "Wieso denn? Nächste Woche geht doch auch." },
      { speaker: "Tom", text: "Nächste Woche läuft der Film nicht mehr. Eine andere Alternative gibt es nicht." },
      { speaker: "Lisa", text: "Dann heute. Aber eher spät, ich habe bis sechs zu tun." },
      { speaker: "Tom", text: "Um neun? Das Kino ist dann genauso voll wie am Wochenende, aber wir bekommen noch Plätze." },
      { speaker: "Lisa", text: "Gut, einverstanden." },
      { speaker: "Tom", text: "Ich hatte den Eindruck, du wolltest gar nicht." },
      { speaker: "Lisa", text: "Doch, ich hatte nur viel zu tun. Treffen wir uns um zehn vor neun?" },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Petra", text: "Und? Wie fandest du das Stück?" },
      { speaker: "Frank", text: "Die Szene am Ende hat mich wirklich berührt." },
      { speaker: "Petra", text: "Mich auch. Die Schauspielerin, die die Mutter spielt, ist unglaublich." },
      { speaker: "Frank", text: "Ja. Die Rolle, die sie da hat, ist gar nicht einfach." },
      { speaker: "Petra", text: "Das Publikum war übrigens sehr still. Das sagt schon viel." },
      { speaker: "Frank", text: "Ja. Nur der Anfang war mir zu lang." },
      { speaker: "Petra", text: "Mir auch. Aber die Geschichte kommt aus einem Roman, den ich gelesen habe." },
      { speaker: "Frank", text: "Dann leihst du ihn mir mal. Ich bin neugierig." },
    ],
    questions: [
      {
