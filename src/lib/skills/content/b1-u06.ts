...
export const b1U06: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Kollegin", text: "Du siehst müde aus. Willst du dich nicht mal erholen?" },
      { speaker: "Kollege", text: "Ich kann nicht. Die Arbeit muss rechtzeitig fertig sein." },
      { speaker: "Kollegin", text: "Gib mir einen Teil davon, damit du heute früher gehen kannst." },
      { speaker: "Kollege", text: "Wirklich? Das würde mir sehr helfen." },
      { speaker: "Kollegin", text: "Klar. Dafür bist du nächste Woche dran." },
      { speaker: "Kollege", text: "Einverstanden. Ich schicke dir die Zahlen, damit du sofort anfangen kannst." },
      { speaker: "Kollegin", text: "Gut. Und ruf den Kunden an, um den Termin zu ändern." },
      { speaker: "Kollege", text: "Mache ich. Wenn das gelingt, sind wir am Freitag fertig." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Mia", text: "Schau mal, das Foto. Weißt du noch?" },
      { speaker: "Paul", text: "Natürlich. Das war damals in den Ferien." },
      { speaker: "Mia", text: "Als wir dort ankamen, hatte ich eine Erkältung." },
      { speaker: "Paul", text: "Ja, richtig. Du bist drei Tage im Zimmer geblieben." },
      { speaker: "Mia", text: "Eigentlich wollte ich schwimmen. Es war nämlich sehr warm." },
      { speaker: "Paul", text: "Jedes Mal, wenn ich das Foto sehe, muss ich lachen." },
      { speaker: "Mia", text: "Ich auch. Es war ein Zufall, dass wir uns dort trafen." },
      { speaker: "Paul", text: "Ein schöner Augenblick. Wir sollten wieder dorthin fahren." },
    ],
    questions: [
      {
