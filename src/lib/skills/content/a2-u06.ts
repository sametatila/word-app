...
export const a2U06: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Die Praxis untersucht Patienten vor der Behandlung.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Vor einer Behandlung untersuchen wir Sie immer zuerst.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        text: "Der Autor weiß nicht, ob kalte Füße krank machen.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Ob das stimmt, weiß ich nicht — aber schaden kann es nicht.“",
      },
    ],
  },
  {
    ...
    genre: "dialogue",
    intro: "İş yerinde bir sohbet: belirtiler neler, ne yapması öneriliyor?",
    gloss: [
      { de: "sich fühlen", tr: "kendini hissetmek", en: "to feel" },
      { de: "schwindlig", tr: "başı dönen", en: "dizzy" },
      { de: "übel", tr: "midesi bulanan", en: "nauseous" },
    ...
    questions: [
      ...
      {
        kind: "dictation",
        text: "İş arkadaşının son sözlerindeki ilk cümleyi yaz: „Und wenn wir …“",
        options: [],
        answer: 0,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [],
        answer: 0,
        accept: ["zwei Tassen", "zwei Tassen am Tag", "2 Tassen", "2 Tassen am Tag"],
    ...
    tasks: [
      {
        ...
        alternatives: ["Sie sollen abends zwei Tabletten nehmen"],
      ...
      },
      {
        ...
        why: "Almancada belirtiyi yaşayan kişi özne olmaz, yönelme hâlinde durur: „Mir ist schwindlig“. „Ich bin schwindlig“ yaygın bir hatadır.",
      },
    ],
  },
  {
