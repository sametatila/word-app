...
export const b1U19: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Patientin", text: "Seit zwei Wochen tut mir der Rücken weh, vor allem morgens." },
      { speaker: "Arzt", text: "Sitzen Sie viel? Wie ist Ihre Haltung am Rechner?" },
      { speaker: "Patientin", text: "Vermutlich schlecht. Ich merke es erst, wenn es wehtut." },
      { speaker: "Arzt", text: "Stellen Sie den Bildschirm höher. Das ist der erste Schritt. Dazu eine kurze Übung am Morgen." },
      { speaker: "Patientin", text: "Soll ich mich mehr ausruhen oder mich mehr bewegen?" },
      { speaker: "Arzt", text: "Bewegen. Liegen hilft nur am Anfang, danach macht es alles schlechter." },
      { speaker: "Patientin", text: "Laufen mag ich nicht besonders." },
      { speaker: "Arzt", text: "Dann eine Wanderung am Wochenende. Das ist entspannend und reicht." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Tom", text: "Ich wache jede Nacht um drei auf und bin dann eine Stunde wach." },
      { speaker: "Sarah", text: "Schaust du dann auf die Uhr?" },
      { speaker: "Tom", text: "Immer. Und dann rechne ich, wie viel Schlaf noch bleibt." },
      { speaker: "Sarah", text: "Genau das ist das Problem. Dreh den Wecker um." },
      { speaker: "Tom", text: "Meinst du, das hilft?" },
      { speaker: "Sarah", text: "Bei mir schon. Ich war jeden Morgen erschöpft, jetzt geht es." },
      { speaker: "Tom", text: "Ich probiere es. Meine Laune ist im Moment wirklich schlecht." },
      { speaker: "Sarah", text: "Und iss abends früher, weil du sonst schlecht einschlafen kannst." },
    ],
    questions: [
      {
