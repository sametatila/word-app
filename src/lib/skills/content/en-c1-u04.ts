...
export const enC1U04: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Aylin", text: "That one is the sharpest, because „hardly“ is already a negative and the sentence has no „not“ anywhere. It reads as a defense of the other side and lands as the opposite." },
