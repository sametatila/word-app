...
export const b1U14: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Sarah", text: "Ich überlege, ob ich die Weiterbildung machen soll." },
      { speaker: "Ben", text: "Wie lange dauert die denn?" },
      { speaker: "Sarah", text: "Ein Jahr, in Teilzeit. Zwei Abende pro Woche." },
      { speaker: "Ben", text: "Und wer finanziert das?" },
      { speaker: "Sarah", text: "Die Firma zahlt einen Teil, wenn ich danach zwei Jahre bleibe." },
      { speaker: "Ben", text: "Das ist gut. Lohnt es sich denn für deinen Beruf?" },
      { speaker: "Sarah", text: "Ich glaube schon. Ich könnte danach selbst unterrichten." },
      { speaker: "Ben", text: "Dann mach das. Du hast Talent dafür, das sieht man." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Interessent", text: "Guten Tag, ich möchte mich über das Studium erkundigen." },
      { speaker: "Beraterin", text: "Gern. Welcher Bereich interessiert Sie?" },
      { speaker: "Interessent", text: "Wissenschaft, aber ich weiß noch nicht, ob ich das schaffe." },
      { speaker: "Beraterin", text: "Das erste Semester ist für alle schwer. Danach wird es besser. Das ist an jeder Hochschule so." },
      { speaker: "Interessent", text: "Wie viele Prüfungen gibt es pro Semester?" },
      { speaker: "Beraterin", text: "Meistens drei, dazu ein Referat. Der Professor sagt es am Anfang." },
      { speaker: "Interessent", text: "Und wenn ich arbeite? Geht das nebenher?" },
      { speaker: "Beraterin", text: "Viele Studierende arbeiten nebenher. Die Auswahl der Kurse hilft dabei." },
    ],
    questions: [
      {
