...
export const enC1U07: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      ...
      { speaker: "Emre", text: "Could you write that in the minutes of a meeting?" },
      { speaker: "Nilay", text: "You could, once. Twice and the minutes have borrowed a voice from somewhere else, and a reader who wanted a neutral record will notice." },
