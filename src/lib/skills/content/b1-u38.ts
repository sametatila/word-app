...
export const b1U38: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Kollegin", text: "Der Kopierer geht wieder nicht. Immer am Montag." },
      { speaker: "Kollege", text: "Hast du ihn schon aus- und wieder eingeschaltet?" },
      { speaker: "Kollegin", text: "Zweimal. Das hat nichts genützt." },
      { speaker: "Kollege", text: "Dann liegt es diesmal wohl am Laufwerk." },
      { speaker: "Kollegin", text: "Ich lasse ihn morgen reparieren. Heute teste ich noch das Papier." },
      { speaker: "Kollege", text: "Gute Idee. Manchmal ist es nur falsch eingestellt." },
      { speaker: "Kollegin", text: "Bis dahin gehe ich unten kopieren." },
      { speaker: "Kollege", text: "Mach das. Und schreib einen Zettel dran, sonst probiert es jeder." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Sarah", text: "Ich finde, die neue Technologie macht uns abhängig." },
      { speaker: "Tim", text: "Abhängig wovon genau?" },
      { speaker: "Sarah", text: "Vom Gerät. Ohne Handy findet heute niemand mehr eine Adresse." },
      { speaker: "Tim", text: "Das stimmt. Aber früher hat uns die Karte auch beeinflusst." },
      { speaker: "Sarah", text: "Das ist etwas anderes. Eine Karte macht niemanden süchtig." },
      { speaker: "Tim", text: "Da hast du recht. Ich bin auch kritisch, aber nicht so streng." },
      { speaker: "Sarah", text: "Die Medien sagen dazu jede Woche etwas Unterschiedliches." },
      { speaker: "Tim", text: "Eben. Deshalb höre ich lieber zu, statt sofort zu antworten." },
    ],
    questions: [
      {
