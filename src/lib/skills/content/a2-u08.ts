...
export const a2U08: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Eine Massage löst das Problem nicht.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Eine Massage ist schön, aber sie löst das Problem nicht.“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        text: "Die Vorsorge ist auch für gesunde Menschen.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „auch wenn man sich gesund fühlt und fit ist“.",
      },
    ],
  },
  {
