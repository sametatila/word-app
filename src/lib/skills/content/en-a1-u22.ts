  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explain: "„Then call me on Sunday and tell me!“",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["nine one one", "one one two", "nine one two"],
        answer: 0,
        explain: "„Call an ambulance! The number is nine one one.“",
      },
      {
        kind: "truefalse",
        ...
        options: ["True", "False"],
        answer: 1,
        explain: "„Don't move him! That is dangerous.“",
      },
      {
        kind: "gapfill",
        text: "The man gives her his ___.",
        options: [],
        answer: 0,
        accept: ["jacket"],
  ...
  // ─────────────────────────── YAZMA ───────────────────────────
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        alternatives: ["Today I can't come to work."],
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        hint: "„call“ burada telefon etmek; „ambulance“ sesli harfle başladığı için „an“.",
      },
      {
        kind: "build",
