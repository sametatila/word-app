...
export const a2U17: SkillExercise[] = [
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "die Raststätte", tr: "dinlenme tesisi", en: "rest stop" },
    ...
    questions: [
      {
        ...
        options: ["Sie machen eine Bootsfahrt", "Sie gehen in den Zoo", "Sie bleiben zu Hause"],
        answer: 1,
      ...
      },
      {
        ...
        accept: [
          ...
          "durch die Altstadt bummeln und Kaffee trinken",
        ],
  ...
  },
  {
    ...
    segments: [
      ...
      { speaker: "Platzwart", text: "Ja, im weißen Haus in der Mitte. Warmes Wasser kostet einen Euro, Sie brauchen also Kleingeld." },
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 1,
        explain: "„Nur an der festen Feuerstelle beim Bach, nicht am Zelt.“ Saat 22.00'ye kadar.",
      },
      {
        kind: "short_answer",
    ...
    tasks: [
      {
        ...
        alternatives: ["Es wird morgen sonnig"],
      ...
      },
      {
        ...
        alternatives: ["Wir machen eine Bootsfahrt, wenn das Wetter gut ist"],
      ...
      },
      {
        ...
        alternatives: ["Hier war früher ein Markt"],
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "nachmittags", tr: "öğleden sonra", en: "in the afternoon" },
      { de: "also", tr: "yani", en: "so" },
    ],
    minutes: 8,
    tasks: [
