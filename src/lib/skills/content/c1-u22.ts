...
export const c1U22: SkillExercise[] = [
  {
    ...
    gloss: [
      ...
      { de: "die Justiz", tr: "yargı", en: "judiciary" },
      { de: "die Medizin", tr: "tıp", en: "medicine" },
      { de: "automatisch", tr: "otomatik", en: "automatic" },
      { de: "einheitlich", tr: "tek tip", en: "uniform" },
      { de: "der Zwischenfall", tr: "olay", en: "incident" },
      { de: "versehentlich", tr: "yanlışlıkla", en: "by mistake" },
  ...
  },
  {
    ...
    gloss: [
      ...
      { de: "überschätzen", tr: "olduğundan fazla görmek", en: "to overestimate" },
      ...
      { de: "demonstrativ", tr: "göstere göstere", en: "pointedly" },
