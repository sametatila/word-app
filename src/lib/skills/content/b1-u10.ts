...
export const b1U10: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Paul", text: "Die Fernbedienung geht nicht mehr. Ich habe alles probiert." },
      { speaker: "Sarah", text: "Welcher Knopf funktioniert denn nicht?" },
      { speaker: "Paul", text: "Gar keiner. Das kleine rote Licht kommt auch nicht." },
      { speaker: "Sarah", text: "Dann sind wohl die Batterien leer. Hast du neue?" },
      { speaker: "Paul", text: "Nein. Kann man das Ding nicht einfach aufladen?" },
      { speaker: "Sarah", text: "Diese hier nicht. Bei der neuen Marke geht das mit einem Kabel." },
      { speaker: "Paul", text: "Gute Idee. Dann ersetzen wir sie irgendwann." },
      { speaker: "Sarah", text: "Ich hole heute Batterien. Das reicht erst mal." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Lena", text: "Du hast doch dieses Gericht gemacht. Wie geht das?" },
      { speaker: "Ben", text: "Ganz einfach. Es ist leicht zuzubereiten, sogar am Abend." },
      { speaker: "Lena", text: "Was brauche ich?" },
      { speaker: "Ben", text: "Kartoffeln, Gemüse und Wasser. Das ist schon fast alles." },
      { speaker: "Lena", text: "Und die Pfanne?" },
      { speaker: "Ben", text: "Das Gemüse mische ich zuerst in der Pfanne. Statt Butter nehme ich Öl." },
      { speaker: "Lena", text: "Wie ist der Geschmack?" },
      { speaker: "Ben", text: "Ausgezeichnet, wenn du zum Schluss etwas Salz nimmst. Wirklich lecker." },
    ],
    questions: [
      {
