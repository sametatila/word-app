...
export const b2U12: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Für einen Widerspruch muss kein Grund angegeben werden.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „…eine E-Mail genügt; ein Grund muss nicht angegeben werden.“",
      },
    ],
  },

  {
    ...
    gloss: [
      ...
      { de: "der Text", tr: "metin", en: "text" },
      { de: "gejagt", tr: "avlanmış", en: "hunted" },
    ],
    minutes: 6,
    text:
    ...
    questions: [
      ...
      {
        text: "„Nachhaltigkeit“ stammt ursprünglich aus der Forstwirtschaft.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Ursprünglich stammt es aus der Forstwirtschaft.“",
      },
    ],
  },

  {
    ...
    minutes: 5,
    segments: [
      { speaker: "Lehrerin", text: "Erklärt mir bitte, wie ihr das gemessen habt. Nicht das Ergebnis, den Weg." },
      { speaker: "Lin", text: "Wir haben die Proben vermessen, indem wir jede dreimal gewogen haben." },
      { speaker: "Lehrerin", text: "Warum dreimal?" },
      { speaker: "Lin", text: "Weil das Messgerät eine Toleranz von zwei Milligramm hat. Einmal sagt wenig." },
      { speaker: "Lehrerin", text: "Gut. Und wie habt ihr die Werte erfasst?" },
      ...
      { speaker: "Lehrerin", text: "Und eure Fehlerquote?" },
      { speaker: "Ben", text: "Bei knapp vier Prozent. Zwei Proben mussten wir wiederholen." },
      { speaker: "Lehrerin", text: "Was habt ihr unter dem Mikroskop betrachtet?" },
      { speaker: "Lin", text: "Die Zellen der zweiten Probe. Einzelne Moleküle sieht man damit natürlich nicht." },
      { speaker: "Lehrerin", text: "Richtig, das ist eine andere Größenordnung. Was würdet ihr nächstes Mal ändern?" },
    ...
    questions: [
      ...
      {
        text: "Einzelne Moleküle sieht man damit nicht.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Einzelne Moleküle sieht man damit natürlich nicht.“",
      },
    ],
  },

  {
    ...
    minutes: 5,
    segments: [
      { speaker: "Patientin", text: "In der Zeitung stand, das sei ein Durchbruch. Stimmt das?" },
      { speaker: "Apotheker", text: "Es ist ein Fortschritt. Ein Durchbruch wäre etwas anderes." },
      { speaker: "Patientin", text: "Was heißt das konkret?" },
      { speaker: "Apotheker", text: "Der Wirkstoff ist an gut zweitausend Patienten erprobt worden. Das ist solide, aber nicht riesig." },
      { speaker: "Patientin", text: "Und zugelassen ist es?" },
      { speaker: "Apotheker", text: "Seit April, ja. Zugelassen worden ist es allerdings nur für eine bestimmte Gruppe." },
      { speaker: "Patientin", text: "Gehöre ich dazu?" },
      { speaker: "Apotheker", text: "Das entscheidet Ihre Ärztin. Die Dosierung hängt außerdem vom Gewicht ab." },
      { speaker: "Patientin", text: "Und die Nebenwirkungen? Meine Nachbarin sagt, es sei harmlos." },
      { speaker: "Apotheker", text: "Harmlos ist kein Arzneimittel. Beobachtet worden sind vor allem Magenbeschwerden, bei etwa einem von zwölf." },
      { speaker: "Patientin", text: "Hilft es denn gegen die Schmerzen?" },
      { speaker: "Apotheker", text: "Es lindert sie, es beseitigt sie nicht. Wer mehr verspricht, verkauft etwas." },
      { speaker: "Patientin", text: "Und diese Früherkennung, von der alle reden?" },
      { speaker: "Apotheker", text: "Das ist ein anderes Thema und ehrlich gesagt das wichtigere." },
    ],
    questions: [
      {
        kind: "dictation",
      ...
      },
      {
        ...
        explain: "„Beobachtet worden sind vor allem Magenbeschwerden, bei etwa einem von zwölf.“",
      },
      {
      ...
      {
        text: "Der Apotheker sagt, kein Arzneimittel sei harmlos.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Harmlos ist kein Arzneimittel.“",
      },
    ],
  },

  {
    ...
    tasks: [
      {
        kind: "build",
        tr: "Numunelerin her birini üç kez tartarak ölçtük.",
      ...
      },
      {
        ...
        alternatives: ["Seit April ist das Arzneimittel zugelassen"],
