...
export const b1U21: SkillExercise[] = [
  ...
  // ─────────────────────────── DİNLEME ───────────────────────────
  {
    ...
    segments: [
      { speaker: "Reporterin", text: "Seit Mai ist die Marktstraße eine Fußgängerzone. Wie finden Sie das?" },
      { speaker: "Passantin", text: "Sehr gut. Ich gehe hier mit den Kindern zu Fuß, statt mit dem Auto zu fahren." },
      { speaker: "Reporterin", text: "Und Sie?" },
      { speaker: "Passant", text: "Für mich ist die Strecke jetzt länger. Ich muss zwei Ausfahrten weiter fahren." },
      { speaker: "Passantin", text: "Aber die Luft ist besser geworden, das merkt man." },
      { speaker: "Passant", text: "Das schon. Nur die Radfahrer fahren zu schnell durch." },
      { speaker: "Passantin", text: "Da kommt bald ein Verkehrszeichen hin, hat die Stadt gesagt." },
      { speaker: "Passant", text: "Dann bin ich zufrieden. Statt zu streiten, sollten wir es probieren." },
    ],
    questions: [
      {
  ...
  },
  {
    ...
    segments: [
      { speaker: "Kundin", text: "Entschuldigung, woher kommen diese Kartoffeln?" },
      { speaker: "Verkäufer", text: "Vom Bauernhof meiner Schwester, dreißig Kilometer von hier." },
      { speaker: "Kundin", text: "Also wirklich regional. Steht die Herkunft irgendwo?" },
      { speaker: "Verkäufer", text: "Auf dem Schild hinten. Wir schreiben es bei jeder Ware dazu." },
      { speaker: "Kundin", text: "Sehr gut. Ich versuche, lange Strecken zu vermeiden." },
      { speaker: "Verkäufer", text: "Dann nehmen Sie die hier statt der Ware aus dem Laden." },
      { speaker: "Kundin", text: "Mache ich. Ist das auch Bio?" },
      { speaker: "Verkäufer", text: "Nein, aber ohne Chemie. Fragen Sie ruhig, das machen nur wenige Kunden." },
    ],
    questions: [
      {
