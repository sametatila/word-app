...
export const b2U03: SkillExercise[] = [
  {
    ...
    questions: [
      ...
      {
        text: "Die Richtlinie sagt nichts darüber, wie oft sich ein Team trifft.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Sie sagt nichts darüber, wie oft ein Team sich sieht. Das bleibt Sache der Teams.“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        text: "Der Absender schreibt nicht zum ersten Mal.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: Şubattaki şikâyete ve kasımdan beri süren yazışmaya atıf yapıyor, ayrıca iki kez ihtar göndermiş.",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        text: "Frank hat keine Karte dabei und schreibt am Abend.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Ich habe leider keine Karte dabei, aber ich schreibe Ihnen heute Abend.“",
      },
    ],
  },

  {
    ...
    questions: [
      ...
      {
        text: "Petra hat das ursprüngliche Angebot nie für überteuert gehalten.",
        options: ["Richtig", "Falsch"],
        answer: 0,
        explain: "Doğru: „Überteuert war Ihr Angebot ohnehin nie, das war nie mein Punkt.“",
      },
    ],
  },
