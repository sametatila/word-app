    ...
    /* ── LISTENING ─────────────────────────────────────────────────────── */
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          format: "truefalse",
          goal: "instruction",
          prompt: "You hear an announcement for new staff. Are sentences 7 to 10 true or false? The announcement plays twice.",
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Lisa", text: "How was the computer course?" },
                { speaker: "Tom", text: "Two hours, and I only understood the first ten minutes." },
                { speaker: "Lisa", text: "Really?" },
                { speaker: "Tom", text: "I go again on Thursday. It is better the second time." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Is the soup free?" },
                { speaker: "Woman", text: "Yes, for staff." },
                { speaker: "Man", text: "I start on Monday." },
                { speaker: "Woman", text: "Then it is free for you too. Welcome!" },
              ],
            },
          ],
          items: [
...
Eyup`,
    ...
    /* ── SPEAKING ──────────────────────────────────────────────────────── */
    {
      skill: "speaking",
      minutes: 15,
      instruction: "There are three tasks in this part: you talk about work, you ask and answer questions, and you do a role play at a reception desk.",
