      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Why a proportion rather than the distribution?" },
                { speaker: "Man", text: "Because you can say it. Eighty-four percent inside eight minutes is a sentence. A distribution is a shape, and a shape does not survive being read aloud in a chamber." },
                { speaker: "Woman", text: "Is that not slightly cynical?" },
                { speaker: "Man", text: "It is descriptive. The computation is trivial and the data has been there since 2006. Nothing technical has ever stood in the way, and pretending the obstacle is technical wastes everybody's time." },
                { speaker: "Woman", text: "So the fix is presentational." },
                { speaker: "Man", text: "The fix is presentational and that is exactly why it has not happened." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Host", text: "You are not defending the eight-minute figure." },
                { speaker: "Economist", text: "I am not. I am objecting to the comparison being made against a service that never existed. The alternative was not a well-run system. It was regional allocation, defended by nobody and compared with nothing." },
                { speaker: "Host", text: "And that was worse?" },
                { speaker: "Economist", text: "On the evidence we have, considerably. The variation between districts before 2004 was larger than anything the target produced, and nobody outside the districts could see it, which is the part that matters." },
                { speaker: "Host", text: "So we keep the target." },
                { speaker: "Economist", text: "We keep counting. Whether we keep this particular number is a separate question and I would answer it differently." },
              ],
            },
          ],
          items: [
          ...
          texts: [
            {
              ...
              segments: [
                ...
                { speaker: "Tarek", text: "I am saying it is priced. A known distortion of a known size is a cost you can carry deliberately. An unknown one is not a smaller cost; it is an uncounted one, and the two get confused constantly in this debate." },
                { speaker: "Chair", text: "Second question: what would you actually change?" },
                { speaker: "Tarek", text: "One thing, and it is unglamorous. Publish the distribution, not the proportion. The moment there is no threshold, there is no edge to concentrate effort at, and about half of the behavior we have been calling gaming simply has nowhere to go." },
                { speaker: "Chair", text: "Last question: why has that not been done?" },
                { speaker: "Tarek", text: "Because a distribution cannot be said in a sentence, and public accountability in this country is conducted almost entirely in sentences. That is not a technical obstacle and it is the only real one." },
              ],
            },
          ],
          items: [
