    ...
    /* ── LISTENING ─────────────────────────────────────────────────────── */
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear information about a family day. Complete the notes, questions 6 to 10. Write ONE or TWO words or a number in each gap. The information plays twice.",
          promptTr:
...
Please bring a plate and a {{10}}`,
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear five people, questions 16 to 20. Why did each person not go to the party? The options are a to h. No answer is used twice. The recordings play twice.",
          promptTr:
