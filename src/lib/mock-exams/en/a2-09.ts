          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Mr. Vance", text: "Is my radio ready?" },
                { speaker: "Assistant", text: "The name, please?" },
                { speaker: "Mr. Vance", text: "Kiro Vance." },
                { speaker: "Assistant", text: "Yes, it is ready. Twenty-two euros. We close at six." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Customer", text: "How much is a new screen?" },
                { speaker: "Assistant", text: "Thirty-five euros, twenty minutes." },
                { speaker: "Customer", text: "And a new phone?" },
                { speaker: "Assistant", text: "From ninety. But your phone is fine; it is only the screen." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Fifty euros to tell me the cable was loose." },
                { speaker: "Woman", text: "Did you look at the cable first?" },
                { speaker: "Man", text: "No." },
                { speaker: "Woman", text: "Then it is fifty euros for the lesson." },
              ],
            },
          ],
          items: [
