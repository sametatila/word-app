          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Customer", text: "Is the fish fresh today?" },
                { speaker: "Waiter", text: "Yes, it came this morning. But we only have four left." },
                { speaker: "Customer", text: "Then two, please." },
                { speaker: "Waiter", text: "And to drink?" },
                { speaker: "Customer", text: "Water for both of us." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Caller", text: "Hello, I would like to join the bread course." },
                { speaker: "Assistant", text: "The Tuesday one is full until March. I can put you on the list." },
                { speaker: "Caller", text: "And the Saturday course?" },
                { speaker: "Assistant", text: "That starts in two weeks and there are places. It is ten euros more." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Did you make this cake?" },
                { speaker: "Woman", text: "My son made it. He is nine." },
                { speaker: "Man", text: "It is very good." },
                { speaker: "Woman", text: "He put too much sugar in, but nobody says that to a boy of nine." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Customer", text: "How much are the tomatoes?" },
                { speaker: "Seller", text: "Three euros a kilo, or five for two kilos." },
                { speaker: "Customer", text: "I only need one kilo." },
                { speaker: "Seller", text: "Then three. The small ones at the back are two euros and they are good for soup." },
              ],
            },
            {
              kind: "audio",
...
You must bring:        an {{10}}`,
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear five people, questions 16 to 20. Why did each person stop going to a restaurant? The options are a to h. No answer is used twice. The recordings play twice.",
          promptTr:
