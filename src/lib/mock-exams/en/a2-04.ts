        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              answer: "e",
              explain:
                "İlan zamanı kullanıcıya bırakıyor: «Six short videos, do them when you want». Kodlama saati ücretsiz ama cumartesi ondan on ikiye sabit; Ferda'nın istediği tam olarak sabit saatin olmaması.",
            },
            {
              kind: "match",
              id: "en-a2-04-l2-10",
...
And do not eat alone. Lunch {{19}} the others is the fastest way into a team.`,
        ...
        },
        {
          ...
          format: "gap",
          goal: "structure",
          prompt: "Read the review and complete gaps 20 to 24. Each gap takes exactly one word.",
    ...
    /* ── LISTENING ─────────────────────────────────────────────────────── */
    {
      ...
      tasks: [
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Sarah", text: "Is the meeting at two still on?" },
                { speaker: "Daniel", text: "Yes, but not in the office. Ferda booked the small room in the library because our room has no screen today." },
                { speaker: "Sarah", text: "Then I will take the bus at half past one." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Hello, I would like to change from the morning group to the evening group." },
                { speaker: "Man", text: "That is possible, but the evening group is full until January. I can put you on the list." },
                { speaker: "Woman", text: "All right. And do I pay again?" },
                { speaker: "Man", text: "No, you pay nothing more; you keep the same place." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Ella", text: "Did you get my file?" },
                { speaker: "Sam", text: "No, nothing came." },
                { speaker: "Ella", text: "Strange. I sent it to your old address, the one from last year." },
                { speaker: "Sam", text: "Ah, that one is closed. Send it again to the new one and I will read it tonight." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Nora", text: "The online training must be finished before the end of the month." },
                { speaker: "Marc", text: "I know, but it is six hours." },
                { speaker: "Nora", text: "Do it in parts. The system remembers where you stopped, so you can do half an hour a day." },
              ],
            },
            {
              kind: "audio",
          ...
          items: [
            {
              ...
              answer: 1,
              explain:
                "Sebep kaydın içinde: «our room has no screen today». Ferda odayı ayırtan kişi, kütüphanede çalışan kişi değil; otobüs de yalnız birinci konuşmacının kendi yol planı.",
            },
            {
              kind: "mcq",
              id: "en-a2-04-h1-2",
            ...
            },
            {
              ...
              no: 4,
              ref: "a4",
              text: "What does the first speaker suggest?",
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear information about a summer course. Complete the notes, questions 6 to 10. Write ONE or TWO words or a number in each gap. The information plays twice.",
          promptTr:
...
Do the level test:       {{10}}`,
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear five people, questions 16 to 20. What helped each person most? The options are a to h. No answer is used twice. The recordings play twice.",
          promptTr:
      ...
      tasks: [
        {
          ...
          format: "speaking",
          goal: "interaction",
          prompt: "I am going to ask you some questions about work and learning. Answer in full sentences.",
          ...
          exchange: [
            ...
            { who: "partner", de: "Interesting. Tell me about a course or some training you did.", tr: "İlginç. Katıldığın bir kursu ya da eğitimi anlat." },
