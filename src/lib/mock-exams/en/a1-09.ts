...
export const EN_A1_09: MockPaper = {
  ...
  parts: [
    /* ── READING ───────────────────────────────────────────────────────── */
    {
      skill: "reading",
      minutes: 30,
      instruction: "There are four tasks in this part. You read messages, notices, signs and a short text with gaps.",
      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "I would like a card, please." },
                { speaker: "Clerk", text: "Do you have your passport?" },
                { speaker: "Woman", text: "I have a photo of it on my phone." },
                { speaker: "Clerk", text: "I am sorry. We need the passport itself." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Is the Spanish course on Monday?" },
                { speaker: "Man", text: "It was on Monday. Now it is on Wednesday, same time." },
                { speaker: "Woman", text: "Seven o'clock?" },
                { speaker: "Man", text: "Yes, seven." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Visitor", text: "How much is one hour?" },
                { speaker: "Assistant", text: "The first hour is free. After that it is two euros." },
                { speaker: "Visitor", text: "And printing?" },
                { speaker: "Assistant", text: "Ten cents a page." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          format: "truefalse",
          goal: "instruction",
          prompt: "You hear an announcement in a library. Are sentences 7 to 10 true or false? The announcement plays twice.",
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Visitor", text: "I lost my library card." },
                { speaker: "Clerk", text: "A new one is three euros." },
                { speaker: "Visitor", text: "Three? The first one was free." },
                { speaker: "Clerk", text: "The first one is free. The second one is not." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Father", text: "Can I take six books?" },
                { speaker: "Woman", text: "Four books, please." },
                { speaker: "Father", text: "My son also has a card." },
                { speaker: "Woman", text: "Then he can take four too." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Do you go to the course tonight?" },
                { speaker: "Woman", text: "No. I work until eight." },
                { speaker: "Man", text: "The course is at seven." },
                { speaker: "Woman", text: "I know. I go on Thursday now." },
              ],
            },
          ],
          items: [
...
Lenn`,
    ...
    /* ── SPEAKING ──────────────────────────────────────────────────────── */
    {
      skill: "speaking",
      minutes: 15,
      instruction: "There are three tasks in this part: you talk about learning, you ask and answer questions, and you do a role play in a library.",
