      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Hana", text: "Did you book the night train?" },
                { speaker: "Tomas", text: "A seat, not a bed." },
                { speaker: "Hana", text: "Twelve hours in a seat?" },
                { speaker: "Tomas", text: "It is nine hours and it is twenty euros. I sleep badly in a bed on a train anyway." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear a talk for new volunteer guides. Complete the notes, questions 14 to 19. Write ONE or TWO words or a number in each gap. The talk plays twice.",
          promptTr:
...
New guides walk with an experienced guide for: {{19}} tours`,
        ...
        },
        {
          ...
          format: "mcq",
          goal: "opinion",
          prompt: "You hear an interview with a man who reduced the size of his guest house. Questions 20 to 25: pick one answer, a, b or c. The interview plays twice.",
