          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "You gave him a yellow, and you gave nothing for the same thing at the other end." },
                { speaker: "Man", text: "I gave what I saw. The other one I did not see, and I am not going to pretend that I did." },
                { speaker: "Woman", text: "The camera saw it." },
                { speaker: "Man", text: "The camera is not part of my decision in this competition, and you argued against its being part of it, which I have not forgotten." },
                { speaker: "Woman", text: "That is a fair hit." },
                { speaker: "Man", text: "It is also not an answer to your complaint. Your complaint is legitimate, and the remedy you rejected is the one that would have fixed it." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "The offense is down a third since we doubled the penalty." },
                { speaker: "Man", text: "Down a third in the returns." },
                { speaker: "Woman", text: "Meaning?" },
                { speaker: "Man", text: "Meaning we changed the sanction and the reporting form in the same window, and I cannot separate them. I would rather say that I do not know than let somebody put a third on a slide." },
                { speaker: "Woman", text: "The committee will not enjoy that." },
                { speaker: "Man", text: "The committee will enjoy it a great deal less in three years, when somebody else separates them." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "It is designed on the assumption that people will fiddle it." },
                { speaker: "Host", text: "Which sounds cynical." },
                { speaker: "Man", text: "It is the opposite of cynical. Assuming honesty and then hunting for exceptions is what produces suspicion. This assumes the incentive and then arranges for it to be inconvenient." },
                { speaker: "Host", text: "Does it work?" },
                { speaker: "Man", text: "Inside a club, extremely well. Outside one, not at all, and nobody has ever pretended otherwise. It runs on people knowing each other, and that is a resource rather than a rule." },
              ],
            },
          ],
          items: [
          ...
          texts: [
            {
              ...
              segments: [
                ...
                { speaker: "Vesna", text: "I have, and I want to be precise about why. Not because intention does not matter, since it obviously does, but because a referee cannot see it and a panel three days later can only guess at it. A law that requires a finding nobody can make will be applied by prejudice." },
                { speaker: "Chair", text: "Kiro?" },
                { speaker: "Kiro", text: "Every legal system in the world manages this. We infer intention from conduct, and we do it in criminal courts with a great deal more at stake than a four-match suspension. The claim that it cannot be done is not a claim about intention. It is a claim about the quality of sports tribunals, and I would rather fix those." },
                { speaker: "Chair", text: "Aras, from the philosophical side?" },
                { speaker: "Aras", text: "I would say that both of them are right about different questions. Kiro is right that intention is inferable. Vesna is right that in this institution it is not being inferred; it is being asserted. Whether that is a reason to remove intention from the law depends on whether you believe the institution is improvable, and on that I have no view." },
                { speaker: "Chair", text: "Vesna, does the comparison with the courts move you?" },
                { speaker: "Vesna", text: "It weakens my argument and it does not defeat it. A court has disclosure, evidence, a defense lawyer and months. A disciplinary panel has a video clip, twenty minutes and a chairman who watched the incident live on television. The analogy imports the conclusion and leaves the machinery behind." },
                { speaker: "Chair", text: "Kiro, is that fair?" },
                { speaker: "Kiro", text: "It is fair about the machinery, and it is an argument for building the machinery rather than for abandoning the distinction. If we take intention out, we punish the clumsy exactly as we punish the malicious, and the players will notice inside a season." },
                { speaker: "Chair", text: "Aras, is there a middle position?" },
                { speaker: "Aras", text: "There is one, and I distrust it. You keep intention as an aggravating factor rather than as an element, so that it raises the penalty without being required to establish the offense. It is what most codes already do, and it has the property of looking like a compromise while transferring the entire difficulty to the sentencing stage, where nobody is watching." },
                { speaker: "Chair", text: "So where does that leave us?" },
                { speaker: "Kiro", text: "Where we started, but with the disagreement in the right place. It is not about whether intention matters." },
                { speaker: "Vesna", text: "It is about whether this particular body can be trusted to find it. Kiro thinks that can be fixed and I think it cannot." },
                { speaker: "Chair", text: "And that is the question we have not answered." },
              ],
            },
          ],
          items: [
