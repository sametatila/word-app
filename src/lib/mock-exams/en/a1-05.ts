      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Is this the bus to the hospital?" },
                { speaker: "Man", text: "No, this is number nine. You need number twelve." },
                { speaker: "Woman", text: "When does it come?" },
                { speaker: "Man", text: "In ten minutes, from the other side of the street." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          format: "truefalse",
          goal: "instruction",
          prompt: "You hear an announcement at a station. Are sentences 7 to 10 true or false? The announcement plays twice.",
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Passenger", text: "Two tickets to Cork, please." },
                { speaker: "Clerk", text: "Today or tomorrow?" },
                { speaker: "Passenger", text: "Today, at four." },
                { speaker: "Clerk", text: "That is sixteen euros." },
                { speaker: "Passenger", text: "Here is twenty." },
                { speaker: "Clerk", text: "And four back. Thank you." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Passenger", text: "To the airport, please." },
                { speaker: "Driver", text: "Which one?" },
                { speaker: "Passenger", text: "The small one, in the north." },
                { speaker: "Driver", text: "Twenty-five minutes at this time." },
                { speaker: "Passenger", text: "Good. My plane is at nine." },
              ],
            },
          ],
          items: [
...
Alma`,
    ...
    /* ── SPEAKING ──────────────────────────────────────────────────────── */
    {
      skill: "speaking",
      minutes: 15,
      instruction: "There are three tasks in this part: you talk about your journeys, you ask and answer questions about travel, and you do a role play at a ticket office.",
