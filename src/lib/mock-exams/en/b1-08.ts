      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "How long did you study yesterday?" },
                { speaker: "Man", text: "Six hours." },
                { speaker: "Woman", text: "Six?" },
                { speaker: "Man", text: "Well, I was at the desk for six hours. If you ask me what I finished, the answer is one page and a very clean desk." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Did you see my message at eleven last night?" },
                { speaker: "Man", text: "I did, and I answered it at seven this morning." },
                { speaker: "Woman", text: "You did not have to wait." },
                { speaker: "Man", text: "I know. But if I answer at midnight, you will answer at midnight, and then everybody does." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Caller", text: "Is there a place on the typing course?" },
                { speaker: "Clerk", text: "The Tuesday one is full. There is a new group on Thursdays from the fourth." },
                { speaker: "Caller", text: "Same teacher?" },
                { speaker: "Clerk", text: "Same teacher, same six weeks, and it is the same twenty euros." },
              ],
            },
            {
              kind: "audio",
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "I read forty pages last night." },
                { speaker: "Man", text: "That is a lot for you." },
                { speaker: "Woman", text: "It is. The only thing I changed was leaving the phone in the kitchen. I have been telling myself for a year that I am too tired to read." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Host", text: "You went a whole year without a smartphone." },
                { speaker: "Woman", text: "I did." },
                { speaker: "Host", text: "Everybody says it changed their life." },
                { speaker: "Woman", text: "Mine came back almost exactly as it was, except that I now know how to get to places without being told." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Six weeks of typing lessons at my age." },
                { speaker: "Woman", text: "Why not?" },
                { speaker: "Man", text: "Because I have typed with two fingers for thirty years and it works." },
                { speaker: "Woman", text: "It works at half the speed. You told me last month that the forms take you all Friday." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "I put my phone in the other room and I still did nothing for two hours." },
                { speaker: "Man", text: "So it does not work." },
                { speaker: "Woman", text: "It works for me. But if the thing you are avoiding is the essay, the phone was never the problem." },
              ],
            },
          ],
          items: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear information about a study-skills service. Complete the notes, questions 14 to 19. Write ONE or TWO words or a number in each gap. The information plays twice.",
          promptTr:
...
The room is on the {{19}} floor`,
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear an interview with a man who spent a year without a smartphone. Questions 20 to 25: pick one answer, a, b or c. The interview plays twice.",
          promptTr:
          ...
          texts: [
            {
              ...
              segments: [
                ...
                { speaker: "Ondrej", text: "Less than the books promise. I read three more books than the year before, which is not nothing, but it is not a new person either. The real change is that I can find my way around this city now." },
