    ...
    /* ── LISTENING ─────────────────────────────────────────────────────── */
    {
      ...
      tasks: [
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Historian", text: "You spent six weeks on four hundred words." },
                { speaker: "Speechwriter", text: "On about eleven of them. The rest were agreed in an afternoon." },
                { speaker: "Historian", text: "Which eleven?" },
                { speaker: "Speechwriter", text: "The verbs. Whether the sentence says mistakes were made or says we made them. That choice is the whole document and everybody in the room knows it." },
                { speaker: "Historian", text: "And who wins that argument?" },
                { speaker: "Speechwriter", text: "Nobody wins it. It is settled by whoever is still in the meeting at seven o'clock, which is not a principle, and it is what actually happened." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "The recipients barely moved on any measure." },
                { speaker: "Woman", text: "That was in the design, though. They already believed it." },
                { speaker: "Man", text: "Exactly. The movement was in the control group, and we had no hypothesis for that at all." },
                { speaker: "Woman", text: "Which is why nobody quotes it." },
                { speaker: "Man", text: "Nobody quotes it because it is not a finding about apology. It is a finding about how much the general public did not know, and that was somebody else's paper to write." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Journalist", text: "You advised them to wait." },
                { speaker: "Lawyer", text: "I advised them that an admission is admissible. That is not the same sentence, although it produces the same delay." },
                { speaker: "Journalist", text: "Does the distinction matter?" },
                { speaker: "Lawyer", text: "It matters to me and to nobody else, which I accept. What I will not accept is being described as the reason. I was asked one question and I answered it correctly." },
                { speaker: "Journalist", text: "Who should have been asked a different one?" },
                { speaker: "Lawyer", text: "Somebody whose duty is not to the institution. There is no such person in the room, and inventing one is a policy question rather than a legal one." },
              ],
            },
          ],
          items: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear a woman reporting a review of state apologies. Complete the sentences, questions 7 to 14, with a word or a number. The report plays twice.",
          promptTr:
...
The most common word in the interviews was {{14}}.`,
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear part of a panel discussion about the timing of official apologies. Questions 15 to 22: pick one answer, a, b, c or d. The discussion plays only ONCE.",
          promptTr:
          ...
          texts: [
            {
              ...
              segments: [
                ...
                { speaker: "Ilja", text: "Because the argument for waiting is presented as caution and functions as a filter. Wait long enough and the only people who can be contradicted are dead. That is not caution; it is the removal of the one group who could correct the wording." },
                { speaker: "Chair", text: "Bexi, from the legal side?" },
                { speaker: "Bexi", text: "I would agree with the description and reject the implication. Nobody in my profession is trying to remove witnesses. We are answering a question about liability, correctly, and the delay is a consequence of the answer rather than its purpose." },
                { speaker: "Chair", text: "Noor, you have been on the receiving end." },
                { speaker: "Noor", text: "I have, and I want to say something that will not help either of them. The families I worked with did not want it earlier. They wanted it accurate, and in 1994 it would not have been accurate, because the department was still denying the documents existed." },
                { speaker: "Chair", text: "Ilja, does that change your position?" },
                { speaker: "Ilja", text: "It complicates it and it does not move it. Noor is describing one case in which delay bought accuracy. My objection is to a pattern of thirty-one, and the pattern does not correlate with anything about accuracy." },
                ...
                { speaker: "Bexi", text: "That is not quite what has happened. What we have established is that the timing argument is not a legal argument, and everybody in this room has now conceded that, including me." },
              ],
            },
          ],
          items: [
        ...
        },
        {
          ...
          goal: "gist",
          prompt:
            "You hear eight short monologues about official apologies. What is the speaker's main purpose? The options are a to j. No answer is used twice. The recordings play twice.",
          promptTr:
