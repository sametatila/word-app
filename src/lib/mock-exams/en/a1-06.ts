          ...
          items: [
            {
              ...
              id: "en-a1-06-l2-6",
              no: 6,
              text: "Your cat is sick at eleven at night.",
            ...
            },
            {
              ...
              id: "en-a1-06-l2-9",
              no: 9,
              text: "Your small bird is sick on a Wednesday afternoon.",
              options: ["Animal Doctor", "Pet Shop Nova", "Park Walking Group"],
              answer: 0,
              explain:
...
Do not give food to the animals in the store.`,
            },
            {
              kind: "text",
              id: "s3",
...
Children: only with an adult.`,
          ...
          items: [
            ...
            },
            {
              ...
              no: 12,
              ref: "s2",
              text: "Your dog waits outside the store.",
              answer: true,
              explain:
      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Emma", text: "Is this your cat?" },
                { speaker: "Tom", text: "No, my cat is black. This one is gray." },
                { speaker: "Emma", text: "She sits here every day." },
                { speaker: "Tom", text: "I think she is from the house on the corner." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Do you have food for a small dog?" },
                { speaker: "Woman", text: "Yes, the small boxes are on the left, under the beds." },
                { speaker: "Man", text: "How much is one box?" },
                { speaker: "Woman", text: "Six euros. Two boxes are ten." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          format: "truefalse",
          goal: "instruction",
          prompt: "You hear an announcement in a park. Are sentences 7 to 10 true or false? The announcement plays twice.",
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Good morning. My dog has a bad leg." },
                { speaker: "Man", text: "Since when?" },
                { speaker: "Woman", text: "Since Saturday." },
                { speaker: "Man", text: "The doctor is free at half past eleven. Can you wait?" },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Lisa", text: "Is the walking group at ten on Sunday?" },
                { speaker: "Ben", text: "Yes, at the big gate, not at the café." },
                { speaker: "Lisa", text: "Good. I'll come with my sister." },
                { speaker: "Ben", text: "Bring a warm coat. It is cold at the lake." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Rosa", text: "Is that your bird in the window?" },
                { speaker: "Sam", text: "No, it is my mother's. She is at my house for three weeks." },
                { speaker: "Rosa", text: "It sings very well." },
                { speaker: "Sam", text: "Yes, but only in the morning." },
              ],
            },
          ],
          items: [
            ...
            },
            {
              ...
              no: 14,
              ref: "c4",
              text: "How long does the store keep the bed?",
...
Vito`,
    ...
    /* ── SPEAKING ──────────────────────────────────────────────────────── */
    {
      skill: "speaking",
      minutes: 15,
      instruction: "There are three tasks in this part: you talk about animals and your street, you ask and answer questions, and you do a role play at the pet store.",
      ...
      tasks: [
        {
          ...
          format: "speaking",
          goal: "production",
          prompt: "Talk about animals and your street. Speak about these words: an animal at home — a park near you — children in the street — a store — the weekend — something you do not like.",
          ...
          rubric: {
            ...
            points: [
              ...
              { de: "a park and a store near you", tr: "Yakındaki bir park ve bir dükkân" },
              { de: "your street on the weekend", tr: "Hafta sonu sokağın" },
              { de: "one thing you do not like", tr: "Sevmediğin bir şey" },
            ],
            sample:
              "We have a small dog. His name is Bruno and he is four. There is a park behind our house. I walk there every morning at seven. On our street there are many children. The small store on the corner is open every day. On the weekend the street is very quiet. I do not like the trash cans on Monday.",
            criteria: [
        ...
        },
        {
          ...
          goal: "interaction",
          prompt:
            "You are at the pet store. Situations: you say what you need. — You ask about the price. — You ask when the store is open.",
          promptTr:
