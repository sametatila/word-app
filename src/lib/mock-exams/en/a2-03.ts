        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              id: "en-a2-03-l2-7",
              no: 7,
              text: "Kiran wants to change the color of his living room but he has no time on the weekend.",
              answer: "e",
              explain:
            ...
            },
            {
              ...
              id: "en-a2-03-l2-10",
              no: 10,
              text: "Piotr is new in the city and would like to work together with other people outdoors on the weekend.",
              answer: "d",
              explain:
...
And the last rule: {{19}} you take the last milk, buy new milk on the same day.`,
        ...
        },
        {
          ...
          format: "gap",
          goal: "structure",
          prompt: "Read the letter and complete gaps 20 to 24. Each gap takes exactly one word.",
          promptTr: "Mektubu oku ve 20–24. boşlukları tamamla. Her boşluğa TEK bir sözcük yaz.",
          texts: [
            {
              kind: "text",
              id: "t5",
              genre: "Letter to the neighbors",
      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Did you hear the party last night?" },
                { speaker: "Woman", text: "Of course, until three! But I did not want to call the police. I spoke to them this morning. They said sorry and it was the last time: they are moving out in April." },
                { speaker: "Man", text: "Good. The office sent a letter last month and nothing changed." },
              ],
            },
            {
              kind: "audio",
          ...
          items: [
            {
              ...
              no: 1,
              ref: "a1",
              text: "What can the neighbors do before Wednesday?",
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear a talk at a building meeting. Complete the notes, questions 6 to 10. Write ONE or TWO words or a number in each gap. The talk plays twice.",
          promptTr:
          ...
          items: [
            {
              ...
              options: ["Complaining about a neighbor's music", "Asking for a change to a rule", "Saying sorry for the music"],
              answer: 1,
              explain:
      ...
      tasks: [
        {
          ...
          format: "speaking",
          goal: "interaction",
          prompt: "I am going to ask you some questions about your home and your neighbors. Answer in full sentences.",
        ...
        },
        {
          ...
          rubric: {
            ...
            sample:
              "This is a moving day in an old building. Two men are carrying a big sofa up the stairs and they look tired. In front of them a little girl is sitting on a box and she is eating an apple. Behind her a neighbor is watching from her door. I do not like moving day because it is always long and something always breaks.",
            criteria: [
