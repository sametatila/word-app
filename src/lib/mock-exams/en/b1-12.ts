      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Visitor", text: "Do I need to book the quiet room?" },
                { speaker: "Assistant", text: "No. First floor, behind the stairs, and it is open all week." },
                { speaker: "Visitor", text: "Do I have to be studying?" },
                { speaker: "Assistant", text: "You do not have to be doing anything. Most people bring a book and stop reading it after ten minutes, and that is fine." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "You are not coming on Saturday." },
                { speaker: "Woman", text: "I am not." },
                { speaker: "Man", text: "Is it the walk? You always liked the walk." },
                { speaker: "Woman", text: "It is not the walk. I have been out every weekend since June and I want one day with nothing in it. Ask me the week after." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Was it not a good evening?" },
                { speaker: "Woman", text: "It was one of the best evenings of the year." },
                { speaker: "Man", text: "So why do you look like that?" },
                { speaker: "Woman", text: "Because it was four hours of talking and I have nothing left for tomorrow. Both things are true and people keep telling me they cannot be." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "So the plan is a course on Tuesday, the pool on Thursday and the walk on Sunday." },
                { speaker: "Woman", text: "That is three things." },
                { speaker: "Man", text: "It is three good things." },
                { speaker: "Woman", text: "It is still three things, and the week they go into is the same length as it was this morning." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "So we are not doing the campaign." },
                { speaker: "Man", text: "No. We are opening the room and the garden instead." },
                { speaker: "Woman", text: "The campaign was cheaper." },
                { speaker: "Man", text: "It was, and a poster telling people to rest is a poster telling people they are doing it wrong. A bench does not say anything." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "It must be hard, working Saturdays." },
                { speaker: "Woman", text: "The Saturday is fine. The hard part is that my free day is Tuesday, and on a Tuesday everybody I know is at work." },
              ],
            },
          ],
          items: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear information about a new quiet room. Complete the notes, questions 14 to 19. Write ONE or TWO words or a number in each gap. The information plays twice.",
          promptTr:
...
Paid for with money left from the {{19}}`,
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear an interview with a woman who works on weekends. Questions 20 to 25: pick one answer, a, b or c. The interview plays twice.",
          promptTr:
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Host", text: "You have worked weekends for eleven years. That must be the hardest part of the job." },
                { speaker: "Yrsa", text: "It is not, and everybody asks it in that order. Saturday is a day like any other once you have done it for a month. What is hard is Tuesday." },
                { speaker: "Host", text: "Tuesday?" },
                { speaker: "Yrsa", text: "My free day. Everybody I know is at work, the swimming pool is empty and the town is quiet. It sounds ideal and it is quite lonely." },
                { speaker: "Host", text: "Does the quiet not help you rest?" },
                { speaker: "Yrsa", text: "It helps me sleep, which is not the same thing. I sleep beautifully on a Tuesday. I still arrive on Wednesday feeling as though nothing has been put back." },
                { speaker: "Host", text: "What would you change if you could?" },
                { speaker: "Yrsa", text: "Not the shifts. I would move one thing: I would have a fixed hour on a Tuesday when somebody is expecting me. That is the piece I am missing, and it is small." },
                { speaker: "Host", text: "Have you tried joining something?" },
                { speaker: "Yrsa", text: "I joined a course, and I left after six weeks. It was on a Tuesday, so that part worked. It was also a course, which means homework, and I had swapped one obligation for another." },
                { speaker: "Host", text: "So what does work?" },
                { speaker: "Yrsa", text: "Two things, and neither is organized. A friend who also works weekends, and a garden that does not close until dark. I have gone there most Tuesdays since the spring, and it is the only hour that has held." },
              ],
            },
          ],
          items: [
    ...
    /* ── WRITING ───────────────────────────────────────────────────────── */
    {
      skill: "writing",
      minutes: 50,
      instruction: "There are two tasks in this part: an email and a description.",
