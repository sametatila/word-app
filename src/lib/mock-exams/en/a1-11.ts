      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Are you better?" },
                { speaker: "Woman", text: "A little. I sleep in the afternoon." },
                { speaker: "Man", text: "And the tablets?" },
                { speaker: "Woman", text: "I take one in the morning and one at night." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Selma", text: "I have an appointment at ten." },
                { speaker: "Receptionist", text: "Your name, please?" },
                { speaker: "Selma", text: "Selma Vance." },
                { speaker: "Receptionist", text: "Yes. Please take a number and sit down. It is about twenty minutes." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Can I see the doctor today?" },
                { speaker: "Receptionist", text: "Not today. Tomorrow at eight or on Thursday at four." },
                { speaker: "Man", text: "Tomorrow, please." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "How was the hospital?" },
                { speaker: "Woman", text: "Four hours." },
                { speaker: "Man", text: "Four?" },
                { speaker: "Woman", text: "I went at seven in the evening with a cold. That was my mistake." },
              ],
            },
            {
              kind: "audio",
