      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Did you join the choir?" },
                { speaker: "Woman", text: "I went to one rehearsal." },
                { speaker: "Man", text: "And?" },
                { speaker: "Woman", text: "Everybody was better than me and nobody cared. That was the surprise. I go again on Thursday." },
              ],
            },
            {
              kind: "audio",
