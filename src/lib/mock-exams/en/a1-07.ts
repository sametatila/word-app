      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Is it cold outside?" },
                { speaker: "Man", text: "Very. Take a hat." },
                { speaker: "Woman", text: "And an umbrella?" },
                { speaker: "Man", text: "No, it isn't raining. It is only cold and dry." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Customer", text: "Two of these shirts, please." },
                { speaker: "Assistant", text: "The blue ones?" },
                { speaker: "Customer", text: "Yes." },
                { speaker: "Assistant", text: "They are twelve euros each, so twenty-four." },
                { speaker: "Customer", text: "Here is thirty." },
                { speaker: "Assistant", text: "And six back. Thank you." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Customer", text: "Do you have this coat in blue?" },
                { speaker: "Assistant", text: "Only in black and gray. Blue comes next week." },
                { speaker: "Customer", text: "Then I will come back on Tuesday." },
              ],
            },
            {
              kind: "audio",
      ...
      tasks: [
        ...
        },
        {
          ...
          rubric: {
            ...
            sample:
              "I need a warm coat, please. In black or gray. — Do you have size 50? — Can I change it, please? I am not sure about the size.",
            criteria: [
              "İstek açıkça söylendi mi? (giysi ve renk)",
              "Beden sorusu doğru kuruldu mu? (Do you have size …)",
