      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Did you write on the back?" },
                { speaker: "Man", text: "Only where I was sure." },
                { speaker: "Woman", text: "That is about six pictures." },
                { speaker: "Man", text: "Six correct is better than two hundred that somebody has to check in twenty years." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Visitor", text: "I would like to see the album from Mill Street." },
                { speaker: "Assistant", text: "Of course. You can look at it here, but it does not leave the room." },
                { speaker: "Visitor", text: "Can I photograph a page?" },
                { speaker: "Assistant", text: "With your phone, yes. Not with a flash." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Eleven hours?" },
                { speaker: "Woman", text: "Eleven." },
                { speaker: "Man", text: "Have you listened to it?" },
                { speaker: "Woman", text: "I have listened to about forty minutes. That is the whole problem in one sentence, is it not?" },
              ],
            },
            {
              kind: "audio",
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "I asked her to spell it and she laughed at me." },
                { speaker: "Woman", text: "Why?" },
                { speaker: "Man", text: "Because it is her own name and she is eighty-four. But I have got it right on paper now, and in ten years nobody will laugh and nobody will know." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Somebody wrote the names in pen on the front." },
                { speaker: "Man", text: "On the front?" },
                { speaker: "Woman", text: "Across the sky. In 1970 nobody thought a photograph was a document." },
                { speaker: "Man", text: "And now?" },
                { speaker: "Woman", text: "Now we photograph the photograph and cut the sky out." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Your father names everybody without stopping." },
                { speaker: "Man", text: "He does." },
                { speaker: "Woman", text: "Then write it down." },
                { speaker: "Man", text: "I have been saying that to myself since 2019. On Sunday I am doing it." },
              ],
            },
          ],
          items: [
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Host", text: "Four thousand photographs. How long did that take?" },
                { speaker: "Vesna", text: "Two years, about four hours a week. And I want to be careful with that number, because the sorting was not the hard part. The sorting was the part I could do while listening to the radio." },
                { speaker: "Host", text: "So what was the hard part?" },
                { speaker: "Vesna", text: "Deciding what counted as knowing. I could put a name on a face if my mother said the name. But my mother was ninety and she was pleasing me, and I could see her doing it." },
                { speaker: "Host", text: "How did you handle that?" },
                { speaker: "Vesna", text: "Badly at first. Then I started writing two lines instead of one: the name, and who told me. It doubled the work and it is the only part I would defend now." },
                { speaker: "Host", text: "Did anything surprise you?" },
                { speaker: "Vesna", text: "The gaps. There are no pictures at all from 1943 to 1949, and nobody in my family has ever mentioned that. I asked and I got a shrug, and the shrug is now in my notes too." },
