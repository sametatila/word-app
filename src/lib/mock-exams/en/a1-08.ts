      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Nora", text: "Do you play on Tuesday?" },
                { speaker: "Leo", text: "No, I work. I play on Thursday." },
                { speaker: "Nora", text: "And your brother?" },
                { speaker: "Leo", text: "He plays every day. He is nineteen." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "One tea and one water, please." },
                { speaker: "Waiter", text: "Two euros fifty." },
                { speaker: "Woman", text: "Can I eat something hot?" },
                { speaker: "Waiter", text: "Not now. Hot food is from twelve to two." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          format: "truefalse",
          goal: "instruction",
          prompt: "You hear an announcement at a sports club. Are sentences 7 to 10 true or false? The announcement plays twice.",
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "How much is the first month?" },
                { speaker: "Woman", text: "Free for new players." },
                { speaker: "Man", text: "And after that?" },
                { speaker: "Woman", text: "Twelve euros a month, or a hundred for the year." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Lena", text: "Did you win?" },
                { speaker: "Paul", text: "Two to one." },
                { speaker: "Lena", text: "Very good!" },
                { speaker: "Paul", text: "Not really. We played badly and they played worse. That is not the same as good." },
              ],
            },
          ],
          items: [
...
Juno`,
    ...
    /* ── SPEAKING ──────────────────────────────────────────────────────── */
    {
      skill: "speaking",
      minutes: 15,
      instruction: "There are three tasks in this part: you talk about sport, you ask and answer questions, and you do a role play at a club.",
