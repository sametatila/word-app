      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "How much is the lamp?" },
                { speaker: "Woman", text: "Twelve euros." },
                { speaker: "Man", text: "And the two together?" },
                { speaker: "Woman", text: "Twenty for the lamp and the clock." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Sarah", text: "Did you sell the desk?" },
                { speaker: "Dan", text: "No. Four people wrote and nobody came." },
                { speaker: "Sarah", text: "Why?" },
                { speaker: "Dan", text: "I think the photograph is bad. You cannot see the size." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Do you buy clothes?" },
                { speaker: "Man", text: "No, only books, records and small furniture." },
                { speaker: "Woman", text: "And this old radio?" },
                { speaker: "Man", text: "No electrical things, I am sorry." },
              ],
            },
            {
              kind: "audio",
