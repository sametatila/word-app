      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Her file says four months." },
                { speaker: "Man", text: "And she has been waiting nineteen. She turned down a date because her employer would not release her, and the clock restarted. Nothing in that sequence broke a rule." },
                { speaker: "Woman", text: "So the file is wrong." },
                { speaker: "Man", text: "The file is accurate. It is measuring something real, which is how easily a person can accept an appointment at ten days' notice. That is a fact about childcare and shift patterns, and we are publishing it as though it were about need." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Host", text: "You are against reordering the list." },
                { speaker: "Man", text: "I am not against it. I am against calling it a fairness reform when eleven hundred eligible people in the district have never been referred at all." },
                { speaker: "Host", text: "That was outside the review's remit." },
                { speaker: "Man", text: "It was declared outside the remit, in the final paragraph of the chapter that estimated it, which is a different thing. Reorder the four thousand two hundred by all means. Just do not describe the result as fairness, because the word is doing work the reform has not done." },
              ],
            },
          ],
          items: [
          ...
          texts: [
            {
              ...
              plays: 1,
              segments: [
                { speaker: "Host", text: "Your review found a system that is failing patients." },
                { speaker: "Hale", text: "It found a system that is doing exactly what it was designed to do, which is a more uncomfortable finding and I would rather we started there." },
                { speaker: "Host", text: "That sounds like a defense of it." },
                { speaker: "Hale", text: "It is a description. If you tell people the machinery is broken, they will ask who broke it, and the answer will be nobody, and the conversation will stop. The machinery is working. The design is the problem." },
                { speaker: "Host", text: "You must have found somebody at fault." },
                { speaker: "Hale", text: "I kept looking, and I want to be honest about that, because I began this review expecting to find one. There is no individual in the file who did anything I would not have done in the same chair with the same rules." },
                { speaker: "Host", text: "The clock resets. Somebody chose to allow that." },
                { speaker: "Hale", text: "Somebody allowed it in 1998 for a reason that was sound at the time: a service should not be penalized when an applicant declines a date. What nobody modeled was who declines dates, and the answer turns out to be people with inflexible employment and no childcare." },
                { speaker: "Host", text: "So you would abolish the reset." },
                { speaker: "Hale", text: "No, and this is where I part company with our own submissions. Abolish it and services stop offering dates at short notice, because every unaccepted offer now counts against them. You would remove a visible unfairness and create an invisible one." },
                { speaker: "Host", text: "Then what does your report recommend?" },
                { speaker: "Hale", text: "Publish the range, not the median, and report resets separately. Neither is exciting and both are checkable, and I have come to distrust any recommendation in this field that cannot be checked by somebody who dislikes me." },
                { speaker: "Host", text: "One of your members dissented." },
                { speaker: "Hale", text: "She did, and her note is the most useful thing in the volume. She is right that we wrote eleven pages on criteria and one paragraph on assessors. I would defend the order of our work and not the proportions of it." },
                { speaker: "Host", text: "Will any of this be implemented?" },
                { speaker: "Hale", text: "The publishing changes, probably, because they cost nothing. The referral work, which is the half that actually matters, requires somebody to own a problem that currently belongs to no department, and I have been in this trade long enough not to promise you that." },
              ],
            },
          ],
          items: [
