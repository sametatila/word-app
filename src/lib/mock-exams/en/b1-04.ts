...
The company has kept the system, but the founder is careful about recommending it. {{20}}`,
              gloss: [
                { de: "a timesheet", tr: "mesai çizelgesi", en: "der Stundenzettel" },
                { de: "a founder", tr: "kurucu", en: "der Gründer" },
                { de: "to record", tr: "kaydetmek", en: "aufzeichnen" },
              ],
            },
          ],
          options: [
...
If the page had existed in my first job, I {{30}} have saved two years of guessing.`,
          ...
          items: [
            ...
            },
            {
              ...
              explain:
                "Koşul yarısı `had existed`, yani gerçekleşmemiş bir geçmiş. Ana cümle bu durumda `would have`, `could have` ya da `might have` ister. `will have` gelecek zamandır ve koşulun geçmişiyle çelişir.",
            },
          ],
        },
      ],
    ...
    /* ── LISTENING ─────────────────────────────────────────────────────── */
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear a talk for new volunteers at a money advice center. Complete the notes, questions 14 to 19. Write ONE or TWO words or a number in each gap. The talk plays twice.",
          promptTr:
...
Sit with an adviser for:  {{19}} appointments`,
          ...
          items: [
            ...
            },
            {
              ...
              accept: ["training"],
              explain:
                "«We are open Monday to Thursday; Friday is for training». Cuma danışan görülen bir gün değil; yalnız açık günleri duyup cumayı boş bırakan öğrenci bu cümleyi kaçırmış olur.",
            },
            {
              kind: "gap",
              id: "en-b1-04-h3-18",
        ...
        },
        {
          ...
          format: "mcq",
          goal: "opinion",
          prompt: "You hear an interview with a man who left a well-paid job. Questions 20 to 25: pick one answer, a, b or c. The interview plays twice.",
          ...
          texts: [
            {
              ...
              gloss: [
                { de: "a job title", tr: "unvan", en: "die Berufsbezeichnung" },
                { de: "a spreadsheet", tr: "hesap tablosu", en: "die Tabelle" },
                { de: "curious", tr: "meraklı", en: "neugierig" },
              ],
            },
          ],
          items: [
