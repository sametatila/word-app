      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Caller", text: "Do you still supply the pump for this model?" },
                { speaker: "Assistant", text: "The model was discontinued four years ago. We hold parts for five years after that, so you are inside it, but only just." },
                { speaker: "Caller", text: "And after next year?" },
                { speaker: "Assistant", text: "After next year nobody makes it. Not us and not anybody else." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "So we extend the guarantee to five years." },
                { speaker: "Man", text: "And in year six the same person has the same bill, and we have congratulated ourselves for a year." },
                { speaker: "Woman", text: "It is better than nothing." },
                { speaker: "Man", text: "It moves the edge. It does not remove it, and the argument we should be having is about whether the part still exists." },
              ],
            },
            {
              kind: "audio",
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Host", text: "You hold parts for machines that are no longer made. How long do you keep them?" },
                { speaker: "Vida", text: "Five years after a model is discontinued, which is longer than the law asks for and shorter than the machines last. That sentence is the whole industry in one line." },
                { speaker: "Host", text: "Why five?" },
                { speaker: "Vida", text: "Because a shelf costs money every day and a part earns nothing until somebody asks for it. Nobody chose five for an engineering reason. It came out of a warehouse budget." },
                { speaker: "Host", text: "Could you hold them longer?" },
                { speaker: "Vida", text: "We could, and the cost is not the storage. It is the guessing. I have to decide today how many pumps I will be asked for in 2032, and if I guess high I have paid to keep metal that gets scrapped." },
                { speaker: "Host", text: "What about making parts to order?" },
                { speaker: "Vida", text: "That is the honest answer and it is slow. The tooling for a small plastic component costs more than the whole run of parts is worth, so it only works if several manufacturers share it, and they do not." },
                { speaker: "Host", text: "Do customers understand any of this?" },
                { speaker: "Vida", text: "They understand it perfectly once you tell them. What they cannot do is find it out beforehand. Nobody has ever been shown a parts availability figure at the moment they were buying a machine." },
                { speaker: "Host", text: "Would a label change your job?" },
                { speaker: "Vida", text: "It would change it completely, and I would welcome that, because at the moment the demand for my shelves is invisible until it arrives. A label makes it a number I can plan against." },
                { speaker: "Host", text: "And the criticism that firms want machines to fail?" },
                { speaker: "Vida", text: "I have worked in this trade for twenty-two years and I have never seen that decision taken. What I have seen is nobody in the room whose job it is to speak for year seven, which produces the same result and is much harder to be angry about." },
                { speaker: "Host", text: "What would you change tomorrow?" },
                { speaker: "Vida", text: "One thing. Make the discontinuation date public. Not the parts, not the price, just the date, because everything else in this argument can be worked out from it." },
              ],
            },
          ],
          items: [
