    ...
    /* ── LISTENING ─────────────────────────────────────────────────────── */
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear a woman reporting the results of a two-year review. Complete the sentences, questions 9 to 16, with a word or a number. The report plays twice.",
          promptTr:
...
The reviewers think those customers knew what to {{16}} about.`,
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear six speakers talking about insurance wording, questions 17 to 22. Choose from a to h what each speaker says. You use each letter once only. The recordings play twice.",
          promptTr:
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear an interview with a man who writes insurance wordings. Questions 23 to 30: pick one answer, a, b or c. The interview plays twice.",
          promptTr:
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Host", text: "You write the small print. Do people tell you what they think of it?" },
                { speaker: "Halvard", text: "Constantly, and they are usually attacking the wrong thing. They attack the length. Length is not the problem; a long document that says one thing clearly is fine." },
                { speaker: "Host", text: "What is the problem, then?" },
                { speaker: "Halvard", text: "The words that carry no meaning until somebody applies them. Reasonable. Adequate. Proper maintenance. Those are not descriptions; they are places where a decision has been left to be made later, by us." },
                { speaker: "Host", text: "Could you write them out?" },
                { speaker: "Halvard", text: "I have tried, twice. If you replace reasonable care with a list of six things the customer must do, the list is either too short to cover the real cases or so long that nobody reads it, and the second draft was thirty-one pages." },
                ...
                { speaker: "Halvard", text: "The people I work with know it in the way you know something you have never had to say out loud. I have been in nine meetings about clarity and none about certainty, and they are not the same subject." },
                { speaker: "Host", text: "A final question. Do you buy the policies you write?" },
                { speaker: "Halvard", text: "I do, and I read the exclusions before I buy, which puts me in a very small group. It has changed what I buy twice. It has never once changed what I write." },
              ],
            },
          ],
          items: [
