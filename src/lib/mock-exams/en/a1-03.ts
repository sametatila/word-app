        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Mom", text: "Milk, sugar and six eggs. And a cake for Sunday." },
                { speaker: "Lina", text: "Is the money in the kitchen?" },
                { speaker: "Mom", text: "No, in my bag on the chair." },
              ],
            },
          ],
          items: [
      ...
      tasks: [
        {
          ...
          format: "speaking",
          goal: "production",
          prompt: "Talk about your food and your day. Speak about these words: breakfast — lunch — favorite food — shopping day — cooking — a drink you like.",
          ...
          rubric: {
            ...
            points: [
              ...
              { de: "your favorite food", tr: "En sevdiğin yemek" },
              { de: "when you go shopping", tr: "Ne zaman alışverişe gidiyorsun" },
              { de: "one drink you like", tr: "Sevdiğin bir içecek" },
            ],
            sample:
              "For breakfast I eat bread with cheese and I drink tea. At one o'clock I eat at work. My favorite food is fish with rice. I go shopping on Saturday morning. I cook every evening. I like cold water with lemon.",
            criteria: [
