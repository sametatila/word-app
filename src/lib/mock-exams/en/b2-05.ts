      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Why is this stand so empty?" },
                { speaker: "Woman", text: "It is the most expensive one." },
                { speaker: "Man", text: "Cheaper than the one opposite?" },
                { speaker: "Woman", text: "Twelve pounds more, and the view is worse. Everybody knows and nobody changes it." },
              ],
            },
          ],
          items: [
