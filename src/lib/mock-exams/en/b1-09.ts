      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Lina", text: "I bought the oil again. Third time this month." },
                { speaker: "Tim", text: "Put it on the shared list and we split it." },
                { speaker: "Lina", text: "There is no shared list." },
                { speaker: "Tim", text: "Exactly. That is the whole problem." },
              ],
            },
            {
              kind: "audio",
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Iris", text: "I put a note on the fridge." },
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Hana", text: "The landlord says the damp is because we do not open the windows." },
                { speaker: "Tom", text: "Do you open them?" },
                { speaker: "Hana", text: "In February?" },
                { speaker: "Tom", text: "That is his answer and it will be his answer next year too. Write to him anyway and keep the date." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear information about a housing advice desk. Complete the notes, questions 14 to 19. Write ONE or TWO words or a number in each gap. The information plays twice.",
          promptTr:
...
The quietest hour starts at: {{19}}`,
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear an interview with a woman who writes household agreements. Questions 20 to 25: pick one answer, a, b or c. The interview plays twice.",
          promptTr:
          ...
          texts: [
            {
              ...
              segments: [
                ...
                { speaker: "Host", text: "So now you write agreements. What is in one?" },
                { speaker: "Juno", text: "Less than people expect. Four lines about money, one about guests, one about noise after eleven, and a date to read it again. It fits on a fridge door." },
                { speaker: "Host", text: "Does it work?" },
                { speaker: "Juno", text: "It works for money and noise, which are the two things you can write down. It does nothing at all for the person who is quietly unhappy, and that is who actually leaves." },
                { speaker: "Host", text: "How do you know when somebody has reached that point?" },
                { speaker: "Juno", text: "I do not, and anybody who says they can is selling a workshop. What I do instead is put a date in the agreement. Six weeks after somebody moves in, everybody sits down for twenty minutes whether there is a problem or not." },
                { speaker: "Host", text: "That sounds awkward." },
                { speaker: "Juno", text: "It is awkward the first time and dull every time after that. Dull is the aim. If the meeting is interesting, you left it too late." },
                { speaker: "Host", text: "Would you change anything about the way you do it?" },
                { speaker: "Juno", text: "I have already changed one thing: I put the money lines first. For two years I put the friendly parts first, so it read like a promise. Now it reads like an invoice, and people take it seriously in a way they did not before." },
              ],
            },
          ],
          items: [
