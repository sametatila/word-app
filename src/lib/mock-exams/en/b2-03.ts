      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Sarah", text: "Did the audit find anything?" },
                { speaker: "Daniel", text: "Nothing on the animals, nothing on the records. One line about the fence by the stream." },
                { speaker: "Sarah", text: "That is the third year running for that fence." },
                { speaker: "Daniel", text: "I know. It is cheaper to be written up than to build it." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Why is this loaf two pounds more than that one?" },
                { speaker: "Woman", text: "Different flour. That one is milled forty kilometers away and we pay about double for it." },
                { speaker: "Man", text: "Does anybody notice?" },
                { speaker: "Woman", text: "About one customer in ten asks. The rest buy the cheaper one and I understand why." },
              ],
            },
          ],
          items: [
