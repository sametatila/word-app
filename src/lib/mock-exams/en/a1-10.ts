      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Eva", text: "Is the post office open on Saturday?" },
                { speaker: "Dan", text: "Yes, but only until one." },
                { speaker: "Eva", text: "Not until five?" },
                { speaker: "Dan", text: "Five is Monday to Friday." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Can I pay this bill with my card?" },
                { speaker: "Woman", text: "Not here. We take cash only." },
                { speaker: "Man", text: "And in the bank?" },
                { speaker: "Woman", text: "Yes, the bank takes cards." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          format: "truefalse",
          goal: "instruction",
          prompt: "You hear an announcement at a post office. Are sentences 7 to 10 true or false? The announcement plays twice.",
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "I would like ten stamps, please." },
                { speaker: "Man", text: "For this country?" },
                { speaker: "Woman", text: "Yes." },
                { speaker: "Man", text: "Nine euros, please." },
              ],
            },
            {
              kind: "audio",
