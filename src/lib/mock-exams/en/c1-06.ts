...
{{34}}`,
    ...
    /* ── LISTENING ─────────────────────────────────────────────────────── */
    {
      ...
      minutes: 40,
      instruction:
        "There are four tasks in this part. You hear short extracts, a report, a panel discussion and eight monologues. Read each instruction carefully: not every recording is played twice.",
      instructionTr:
      ...
      tasks: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear a man reporting the results of a translation funding program. Complete the sentences, questions 7 to 14, with a word, a number or a short phrase. The report plays only ONCE.",
          promptTr:
...
{{14}} percent of the budget comes from one ministry.`,
        ...
        },
        {
          ...
          format: "mcq",
          goal: "opinion",
          prompt: "You hear part of a panel discussion about funding translations. Questions 15 to 22: pick one answer, a, b, c or d. The discussion plays only ONCE.",
        ...
        },
        {
          ...
          goal: "gist",
          prompt:
            "You hear eight short monologues about translation and publishing. What is the speaker's main purpose? The options are a to j. No answer is used twice. The recordings play twice.",
          promptTr:
