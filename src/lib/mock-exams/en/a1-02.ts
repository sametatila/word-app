      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Pia", text: "Are we eating in the cafeteria today?" },
                { speaker: "Jonas", text: "The cafeteria is closed. There is a market in the square with hot food." },
                { speaker: "Pia", text: "Good. I'll get some soup there." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Ida", text: "Are you coming to the lake on Saturday?" },
                { speaker: "Lars", text: "I work on Saturday morning. I can come in the afternoon." },
          ...
          items: [
            ...
            },
            {
              ...
              options: ["In the cafeteria", "At the market in the square", "At home"],
              answer: 1,
              explain:
                "Yemekhane kapalı («The cafeteria is closed») ve Jonas meydandaki pazarı öneriyor; Pia oradan çorba alacağını söylüyor. Kayıtta yemekhane geçiyor ama olumsuzlanmış hâlde.",
            },
            {
              kind: "mcq",
              id: "en-a1-02-h1-3",
            ...
            },
            {
              ...
              no: 5,
              ref: "a5",
              text: "When does Lars come to the lake?",
              options: ["On Saturday afternoon", "On Saturday morning, before work", "On Sunday"],
              answer: 0,
              explain:
                "Lars cumartesi sabahı çalışıyor ve «I can come in the afternoon» diyor. Sabah kayıtta geçiyor ama çalışma zamanı olarak; madde iki zaman dilimini ayırmayı ölçüyor.",
            },
            {
              kind: "mcq",
              id: "en-a1-02-h1-6",
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              situation: "Bir ziyaretçi müze bileti alıyor.",
              plays: 2,
              segments: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Nina", text: "Come for dinner on Friday. I'm cooking fish." },
                { speaker: "Omar", text: "I do not eat fish, sorry." },
                { speaker: "Nina", text: "No problem, then I'll make pasta." },
              ],
            },
            {
              kind: "audio",
              ...
              segments: [
                ...
                { speaker: "Customer", text: "Then I'll take the blue one." },
              ],
            },
          ],
          items: [
            ...
            },
            {
              ...
              answer: 0,
              explain:
                "İlk plan balık ama Omar balık yemiyor, bu yüzden Nina «then I'll make pasta» diyor. Kayıttaki ilk yemek adı iptal edilmiş plandır.",
            },
            {
              kind: "mcq",
              id: "en-a1-02-h3-15",
              ...
              answer: 2,
              explain:
                "Büyük beden yalnız mavide var; müşteri «Then I'll take the blue one» diyor. Kırmızı kayıtta geçiyor ama yalnız mevcut olmayan beden için.",
            },
          ],
        },
      ],
...
Group:              Tuesday`,
        ...
        },
        {
          ...
          goal: "interaction",
          prompt:
            "Your neighbor has your key while you are away. Write a short message to your neighbor. Write one or two sentences about each point (about 25 words). Do not forget the greeting at the start and at the end.",
          promptTr:
            "Sen yokken anahtarın komşunda olacak. Komşuna kısa bir ileti yaz. Her maddeye bir-iki cümle yaz (yaklaşık 25 kelime). Baştaki hitabı ve sondaki veda cümlesini unutma.",
          items: [],
          rubric: {
            minWords: 25,
            points: [
              { de: "Say when you are away.", tr: "Ne zaman şehir dışında olacağını söyle." },
              { de: "Ask your neighbor to water the plants.", tr: "Komşundan bitkileri sulamasını iste." },
      ...
      tasks: [
        ...
        },
        {
          ...
          exchange: [
            ...
            { who: "partner", de: "On the weekend I usually walk in the park with my dog. Your next word is: sport.", tr: "Hafta sonları genelde köpeğimle parkta yürüyorum. Sıradaki sözcüğün: spor." },
        ...
        },
        {
          ...
          rubric: {
            minutes: 3,
            points: [
              { de: "apologize and give a reason", tr: "Özür dilemek ve sebep söylemek" },
              { de: "ask for something politely", tr: "Kibarca bir şey istemek" },
              { de: "answer a request", tr: "Gelen ricaya karşılık vermek" },
            ],
            sample:
              "I am sorry, I am late. The bus did not come. — Can I have Friday off, please? I have a doctor's appointment. — Yes, of course I can help you. What time?",
            criteria: [
