      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Pia", text: "Are we eating in the canteen today?" },
                { speaker: "Jonas", text: "The canteen is closed. There is a market in the square with hot food." },
          ...
          items: [
            ...
            },
            {
              ...
              answer: 1,
              explain:
                "Yemekhane kapalı («The canteen is closed») ve Jonas meydandaki pazarı öneriyor; Pia oradan çorba alacağını söylüyor. Kayıtta yemekhane geçiyor ama olumsuzlanmış hâlde.",
            },
            {
              kind: "mcq",
              id: "en-a1-02-h1-3",
