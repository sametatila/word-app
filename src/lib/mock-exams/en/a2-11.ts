...
Please bring the:   {{10}}`,
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear five people, questions 16 to 20. What does each person find difficult? The options are a to h. No answer is used twice. The recordings play twice.",
          promptTr:
    ...
    /* ── WRITING ───────────────────────────────────────────────────────── */
    {
      skill: "writing",
      minutes: 30,
      instruction: "There are two tasks in this part: you write a message and a short text about an animal.",
