    ...
    /* ── LISTENING ─────────────────────────────────────────────────────── */
    {
      ...
      tasks: [
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Journalist", text: "So where is the boundary?" },
                { speaker: "Man", text: "That depends entirely on what you are going to do with the answer." },
                { speaker: "Journalist", text: "That sounds like an evasion." },
                { speaker: "Man", text: "It is the opposite of one. For a fence you want the markers. For a court you want the coordinates. For a conversation with a neighbor you want the hedge, and those three are about forty meters apart." },
                { speaker: "Journalist", text: "And which is the real one?" },
                { speaker: "Man", text: "The question has no answer, and the profession stopped asking it two generations ago. It is only outside the profession that people still expect there to be one." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Thirty-four years. What is actually blocking it?" },
                { speaker: "Man", text: "Nothing that anybody in the file disagrees about. Both sides accept the technical position and both sides accept the remedy." },
                { speaker: "Woman", text: "Then what?" },
                { speaker: "Man", text: "Somebody has to decide which ministry employs the surveyors, and that is a level above everyone who has ever attended. It is not a dispute. It is a vacancy." },
                { speaker: "Woman", text: "Could it not be escalated?" },
                { speaker: "Man", text: "It could, once, by somebody willing to spend the credit. Nobody has ever thought forty meters of hillside was worth that, and they are probably right, which is why it will still be open in ten years." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear a man reporting the results of a boundary review. Complete the sentences, questions 7 to 14, with a word or a number. The report plays twice.",
          promptTr:
...
Where the archive and the ground disagree, local land use follows the {{14}}.`,
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear part of a panel discussion about correcting a boundary. Questions 15 to 22: pick one answer, a, b, c or d. The discussion plays only ONCE.",
          promptTr:
          ...
          texts: [
            {
              ...
              segments: [
                ...
                { speaker: "Mira", text: "The survey does not say that. It says the posts and the archive disagree by up to ninety-four meters in places. Which of the two is out is a question the survey cannot answer, and I want that on the record before anybody quotes me." },
                { speaker: "Chair", text: "Ondrej, legally?" },
                { speaker: "Ondrej", text: "Legally the treaty text governs, and the treaty describes a watercourse that has since moved. So the law points at an object that is not where the law thinks it is, and every lawyer in this field knows it and none of us will say it in a filing." },
                { speaker: "Chair", text: "Piet, from the village?" },
                { speaker: "Piet", text: "Nobody there is confused about where the boundary is. They know exactly. It is the hedge, it has been the hedge since before the war, and the four hectares your survey has just reassigned have been farmed and taxed on one side for ninety years." },
                { speaker: "Chair", text: "Mira, does long practice count for anything technically?" },
                { speaker: "Mira", text: "Not in my report, and that is a limitation of the report rather than a judgment about the practice. I measure what is there. What weight anybody gives the hedge is a decision for somebody else, and I have been careful never to make it." },
                { speaker: "Chair", text: "Ondrej, could the practice be given legal weight?" },
                { speaker: "Ondrej", text: "In principle, yes, and doing so would open every other section of the frontier to the same argument. That is not a reason against it. It is a reason why nobody will do it for one village." },
                { speaker: "Chair", text: "Piet, would you accept a correction if compensation followed?" },
                { speaker: "Piet", text: "You are asking whether we would sell it. That is a fair question and my answer is that some would, but you would be buying the field, not the argument. The argument is about who was told and when, and no payment settles that." },
                { speaker: "Chair", text: "So we are further apart than when we started." },
                { speaker: "Piet", text: "I do not think we are apart at all. Mira has been describing the posts, Ondrej has been describing the text, and I have been describing the practice. Those are three different boundaries, and we have spent an hour assuming they were one." },
              ],
            },
          ],
          items: [
        ...
        },
        {
          ...
          goal: "gist",
          prompt:
            "You hear eight short monologues about boundaries and maps. What is the speaker's main purpose? The options are a to j. No answer is used twice. The recordings play twice.",
          promptTr:
