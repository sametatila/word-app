      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Father", text: "One pill in the morning and one in the evening." },
          ...
          items: [
            ...
            },
            {
              ...
              no: 6,
              ref: "a6",
              text: "How often does the son take the pill?",
...
No sport in:         {{5}}`,
        ...
        },
        {
          ...
          goal: "interaction",
          prompt:
            "You are sick and you cannot go to your English class. Write a short message to your teacher. Write one or two sentences about each point (about 25 words). Do not forget the greeting at the start and at the end.",
          promptTr:
...
Meral`,
    ...
    /* ── SPEAKING ──────────────────────────────────────────────────────── */
    {
      skill: "speaking",
      minutes: 15,
      instruction: "There are three tasks in this part: you talk about your week, you ask and answer questions about free time, and you do a role play at the doctor's.",
      ...
      tasks: [
        {
          ...
          rubric: {
            ...
            sample:
              "On Monday morning I get up at six. I work in a store from eight to four. On Wednesday I swim for one hour. On Friday evening I am free and I watch a good movie. On the weekend I walk in the park with my sister. I do not like the bus in the morning.",
            criteria: [
