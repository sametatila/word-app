...
export const EN_B2_07: MockPaper = {
  ...
  parts: [
    /* ── READING ───────────────────────────────────────────────────────── */
    {
      ...
      minutes: 70,
      instruction:
        "There are seven tasks in this part. You complete texts, transform sentences, read an article and match texts and sentences.",
      instructionTr:
...
That is a longer argument and a slower one. Given how few firms have ever asked a client what he actually wants, it is also the one least likely to be started. It also happens to be the only version of the problem that ends anywhere.`,
    ...
    /* ── LISTENING ─────────────────────────────────────────────────────── */
    {
      ...
      minutes: 40,
      instruction:
        "There are four tasks in this part. You hear short extracts, a report, six speakers and an interview. Each recording plays twice.",
      instructionTr:
      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Did you get the notes from the panel?" },
                { speaker: "Man", text: "I did. Three of them wrote communication and none of them wrote what they meant by it." },
                { speaker: "Woman", text: "Is that unusual?" },
                { speaker: "Man", text: "It is the most common word on the sheets and the least defined." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear a woman reporting the results of a three-year study. Complete the sentences, questions 9 to 16, with a word or a number. The report plays twice.",
          promptTr:
...
The study took {{16}} years.`,
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear six speakers talking about accent and hiring, questions 17 to 22. Choose from a to h what each speaker says. You use each letter once only. The recordings play twice.",
          promptTr:
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear an interview with a man who argued against anonymous first rounds and now runs them. Questions 23 to 30: pick one answer, a, b or c. The interview plays twice.",
          promptTr:
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Host", text: "You spent two years arguing against this. What was the argument?" },
                { speaker: "Piet", text: "That it was theater. I said, in a meeting I would like back, that we would spend a fortune in order to produce the same list with more paperwork attached to it." },
                { speaker: "Host", text: "And you were wrong." },
                { speaker: "Piet", text: "I was wrong about the list. I was right about the fortune, incidentally; it cost more than anybody had budgeted. The list changed shape in the first year and it has stayed changed." },
                { speaker: "Host", text: "What changed your mind?" },
                { speaker: "Piet", text: "Not the argument. Two of my own hiring decisions. I had turned down a candidate in 2019, and the same person came through the anonymous round three years later and I ranked her second out of sixty. Same person, same qualifications, different process. The only variable that had moved was me not hearing her first." },
                { speaker: "Host", text: "That is a strong story." },
                { speaker: "Piet", text: "It is a story, which is why I do not use it in front of the partners. I use the shortlists. But you asked what changed my mind, and the honest answer is the story." },
                { speaker: "Host", text: "What do you say to firms that tell you their clients expect a particular kind of voice?" },
                { speaker: "Piet", text: "I say that I have heard it from four firms, and that in three of them nobody had ever asked a client. The fourth had asked, and the client said he did not care, which was awkward for everybody in the room." },
