      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              genreTr: "E-posta",
              title: "Saturday",
              body: `Dear Juno, the movie starts at seven, so let us meet at half past six in front of the movie theater. I have the tickets already; you can pay me later. If you are late, go in without me and I will find you.`,
            },
            {
              kind: "text",
              id: "m4",
        ...
        },
        {
          ...
          options: [
            ...
            { key: "d", label: "Film Club", body: "One film every Monday, always in the original language with words on the screen. Four euros, students two." },
            ...
            { key: "h", label: "Soccer on Sunday Morning", body: "Nine o'clock in the park. Everybody plays, nobody counts the goals. Bring water." },
          ],
          items: [
            {
              kind: "match",
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Mia", text: "Are we going out on Saturday?" },
                { speaker: "Tom", text: "I want to, but I am working until nine." },
                { speaker: "Mia", text: "The movie starts at eight." },
                { speaker: "Tom", text: "Then not the movie. We can eat something after nine." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "Hello, is there a place in the Friday class?" },
                { speaker: "Man", text: "In the slow hour, yes. The second hour is full." },
                { speaker: "Woman", text: "The first hour is fine. Do I need a partner?" },
                { speaker: "Man", text: "No, nobody comes with a partner." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "How much are these?" },
                { speaker: "Woman", text: "Forty euros, and the black ones are twenty-five." },
                { speaker: "Man", text: "Are the black ones worse?" },
                { speaker: "Woman", text: "They are the same, but the cable is shorter." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Ben", text: "How was the concert?" },
                { speaker: "Lisa", text: "The band was good. I was too far from the front." },
                { speaker: "Ben", text: "Was it full?" },
                { speaker: "Lisa", text: "Not really. Next time I will go early and stand at the front." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { text: "Hello, this is the music school about your lesson on Thursday. Your teacher cannot come on Thursday this week, so the lesson is on Wednesday at the same time. The room is the same. Please do not come on Thursday." },
              ],
            },
          ],
          items: [
            {
              ...
              options: ["To see the movie at eight", "To stay at home on Saturday", "To meet later and eat"],
              answer: 2,
              explain:
                "Karar son cümlede: «Then not the movie. We can eat something after nine». Sinema saat sekizde, o kişi ise dokuza kadar çalışıyor.",
            },
            {
              kind: "mcq",
              id: "en-a2-08-h1-2",
            ...
            },
            {
              ...
              answer: 1,
              explain:
                "İleti tek değişikliği veriyor: «the lesson is on Wednesday at the same time». Saat ve oda aynı; öğretmen perşembe gelemiyor ama değişmiyor.",
            },
          ],
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear information about a music evening. Complete the notes, questions 6 to 10. Write ONE or TWO words or a number in each gap. The information plays twice.",
          promptTr:
...
Leave the car at the {{10}}`,
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear five people talking about their free time, questions 16 to 20. What does each person say? The options are a to h. No answer is used twice. The recordings play twice.",
          promptTr:
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { text: "I played soccer on Tuesdays for six years. Then my shifts moved and Tuesday was impossible. The same people now meet on Sunday morning, and I am there." },
              ],
            },
            {
              kind: "audio",
...
Vida`,
            criteria: [
              ...
              "Öneri somut mu, yoksa yalnız 'let's do something' mi denmiş?",
      ...
      tasks: [
        {
          ...
          format: "speaking",
          goal: "interaction",
          prompt: "I am going to ask you some questions about your free time. Answer in full sentences.",
          ...
          exchange: [
            ...
            { who: "partner", de: "Thank you. Do you prefer music or movies? Why?", tr: "Teşekkürler. Müziği mi filmleri mi tercih edersin? Neden?" },
          ...
          rubric: {
            ...
            sample:
              "After work I walk for half an hour and then I cook. Twice a week I go to a soccer group in the park. I prefer music, because I can listen while I do other things. Last month I went to a concert with my brother. We stood at the back and we came home at midnight.",
            criteria: [
