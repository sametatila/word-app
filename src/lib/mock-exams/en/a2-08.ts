          ...
          texts: [
            {
              ...
              segments: [
                ...
                { speaker: "Mia", text: "The film starts at eight." },
                { speaker: "Tom", text: "Then not the film. We can eat something after nine." },
              ],
            },
            {
              kind: "audio",
      ...
      tasks: [
        ...
        },
        {
          ...
          rubric: {
            ...
            sample:
              "I like the dance class because we sit all day and it is the only idea where we move. You are right about the money, eight euros every week is a lot for me too. But the cinema club is on Monday and I work late on Mondays. So let us choose football in the park; it is free and it is on Sunday.",
            criteria: [
