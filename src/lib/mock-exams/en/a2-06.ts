    ...
    /* ── LISTENING ─────────────────────────────────────────────────────── */
    {
      ...
      tasks: [
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Emma", text: "Is the walk still on for Sunday?" },
                { speaker: "Leo", text: "They say rain from twelve." },
                { speaker: "Emma", text: "Then we start at eight and finish before it." },
                { speaker: "Leo", text: "Good. I will bring the small tent anyway." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Woman", text: "I need boots for the winter." },
                { speaker: "Man", text: "These are warm but not waterproof. Those are both, and twenty euros more." },
                { speaker: "Woman", text: "I walk to work every day in the rain." },
                { speaker: "Man", text: "Then take the second ones." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Vera", text: "Are you going to the sea in August?" },
                { speaker: "Ken", text: "In September. It is cheaper and the water is still warm." },
                { speaker: "Vera", text: "And the weather?" },
                { speaker: "Ken", text: "Two or three degrees less. That is not a problem for me." },
              ],
            },
          ],
          items: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear information about a summer camp. Complete the notes, questions 6 to 10. Write ONE or TWO words or a number in each gap. The information plays twice.",
          promptTr:
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { text: "Hello, this is about the summer camp. My daughter is on the list for July, but we are now going away that week. Can she come in August instead, or is that group full?" },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { text: "I asked for the second week of August and my manager said no, because two other people asked first. I am taking the last week of September now." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { text: "Eleven hours in a car with a child of three is possible. It is not something you do twice. This year we are going to a place two hours away." },
              ],
            },
          ],
          items: [
      ...
      tasks: [
        {
          ...
          format: "speaking",
          goal: "interaction",
          prompt: "I am going to ask you some questions about the weather and your plans. Answer in full sentences.",
        ...
        },
        {
          ...
          goal: "production",
          prompt:
            "Describe this situation for about one minute: a park on a cold morning in January. Two people are walking with a dog and there is snow on the grass. A woman is brushing the snow off a bench. Say what you see, what the people are doing, and whether you like winter.",
          promptTr:
