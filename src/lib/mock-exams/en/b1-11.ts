      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Can I buy one carrot?" },
                { speaker: "Woman", text: "Of course. They are loose in the box." },
                { speaker: "Man", text: "Is it more expensive?" },
                { speaker: "Woman", text: "Not here. In most places it is, and I have never understood why we should charge you for wanting less." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Paul", text: "You cooked for six again." },
                { speaker: "Rosa", text: "I did." },
                { speaker: "Paul", text: "You live alone." },
                { speaker: "Rosa", text: "I know. The recipe is my grandmother's and it does not divide. Two boxes went to Halvard and I want them back." },
              ],
            },
            {
              kind: "audio",
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Ella", text: "I bought the small pan." },
                { speaker: "Sam", text: "And?" },
                { speaker: "Ella", text: "I have used it every evening for three weeks. It cost nine euros and I do not understand why I waited two years." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Nora", text: "He says he cannot cook." },
                { speaker: "Marc", text: "Can he?" },
                { speaker: "Nora", text: "He made the soup on Sunday and it was fine. What he cannot do is cook for one; he made enough for eight and he was embarrassed about it." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Clara", text: "Somebody threw away half a cabbage again." },
                { speaker: "Kai", text: "And?" },
                { speaker: "Clara", text: "It is the fourth this month. It is not that people are wasteful. It is that a cabbage is sold in a size that no one person can finish." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Zoe", text: "You cannot eat the same thing every Monday." },
                { speaker: "Tim", text: "I have done it for a year." },
                { speaker: "Zoe", text: "Does it not get boring?" },
                { speaker: "Tim", text: "Monday was the worst evening of my week and now it is not. Boring is not the word I would use." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Mia", text: "The recipe says it serves four." },
                { speaker: "Ben", text: "So make a quarter." },
                { speaker: "Mia", text: "I tried. A quarter of an egg, and twelve minutes instead of fifty. It came out raw and I ate bread." },
              ],
            },
          ],
          items: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear information about a cooking class. Complete the notes, questions 14 to 19. Write ONE or TWO words or a number in each gap. The information plays twice.",
          promptTr:
...
The next class is on the {{19}}`,
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear an interview with a woman who ran a cooking course. Questions 20 to 25: pick one answer, a, b or c. The interview plays twice.",
          promptTr:
          ...
          texts: [
            {
              ...
              segments: [
                ...
                { speaker: "Ines", text: "The recipes. I wrote thirty for a single portion, and I now think that was the least useful thing I produced. People do not want a special recipe; they want the ordinary one to be possible." },
                { speaker: "Host", text: "And the eating alone itself?" },
                { speaker: "Ines", text: "I could not touch that, and I stopped pretending I could. What I could do was make the evening shorter. A person who has decided at breakfast eats at half past seven instead of half past nine, and that turns out to matter more than company." },
              ],
            },
          ],
          items: [
    ...
    /* ── WRITING ───────────────────────────────────────────────────────── */
    {
      skill: "writing",
      minutes: 50,
      instruction: "There are two tasks in this part: a letter and an article.",
