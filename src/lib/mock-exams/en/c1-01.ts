...
I am under no illusion that conventions arrive on request. They emerge slowly, usually after enough people have been damaged by their absence. What can be said is that the technical question — can we delete this? — has absorbed nearly all the attention, while the interpretive question, which is cheaper and probably more useful, has barely been asked.`,
              gloss: [
                { de: "retentive", tr: "her şeyi tutan, unutmayan", en: "nichts vergessend" },
                { de: "revision", tr: "gözden geçirme, düzeltme", en: "die Überarbeitung" },
                { de: "evidential", tr: "kanıta ilişkin", en: "beweisbezogen" },
                { de: "a blunt instrument", tr: "kaba, ayrım gözetmeyen araç", en: "ein grobes Instrument" },
              ],
            },
          ],
          items: [
...
What is striking is how recent this discussion is. For most of the period in which modern diplomacy has existed, the question of what the interpreter contributed was not merely unanswered; it was regarded as slightly improper to ask.`,
              gloss: [
                { de: "to diverge", tr: "ayrışmak", en: "auseinandergehen" },
                { de: "a summit", tr: "zirve", en: "der Gipfel" },
                { de: "improper", tr: "uygunsuz", en: "unangemessen" },
              ],
            },
          ],
          options: [
          ...
          texts: [
            {
              ...
              gloss: [
                { de: "a backlog", tr: "birikmiş iş", en: "der Rückstau" },
                { de: "a caricature", tr: "karikatür, çarpıtılmış hâl", en: "das Zerrbild" },
                { de: "a gradient", tr: "derece, kademe", en: "die Abstufung" },
                { de: "sequencing", tr: "sıralama, öncelik düzeni", en: "die Reihenfolge" },
              ],
            },
          ],
          items: [
