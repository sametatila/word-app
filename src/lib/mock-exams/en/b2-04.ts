      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Lena", text: "How did the open day go?" },
                { speaker: "Robert", text: "Four hundred people, which is double last year." },
                { speaker: "Lena", text: "And the questions?" },
                { speaker: "Robert", text: "Almost all about one object. We had planned twelve talks and eleven of them turned out to be unnecessary." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Why is this gallery so empty?" },
                { speaker: "Woman", text: "It is the last one on the route. About one visitor in six gets this far." },
                { speaker: "Man", text: "Do they know that?" },
                { speaker: "Woman", text: "They know. The best objects were moved here two years ago and it made no difference at all." },
              ],
            },
          ],
          items: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear a man reporting the results of a provenance project. Complete the sentences, questions 9 to 16, with a word or a number. The report plays twice.",
          promptTr:
...
{{16}} percent of the funding comes from a single foundation.`,
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear six speakers talking about museums and collections, questions 17 to 22. Choose from a to h what each speaker says. You use each letter once only. The recordings play twice.",
          promptTr:
        ...
        },
        {
          ...
          format: "mcq",
          goal: "opinion",
          prompt: "You hear an interview with a man who reduced the size of a museum collection. Questions 23 to 30: pick one answer, a, b or c. The interview plays twice.",
