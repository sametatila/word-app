      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Do I need to sign up for the flood messages?" },
                { speaker: "Woman", text: "You do, and it is free. We need the address, not just the phone number, because the messages go out by street." },
                { speaker: "Man", text: "And if I move?" },
                { speaker: "Woman", text: "Tell us. A message sent to the wrong street is worse than no message at all." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Frank", text: "That is the third time and nothing has happened once." },
                { speaker: "Vera", text: "I lost a Saturday too. I still think she was right, and I would like somebody to admit that being right has a price and that I paid it." },
              ],
            },
            {
              kind: "audio",
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Hana", text: "There is no picture for the flood that did not happen." },
                { speaker: "Leo", text: "There is an empty road." },
                { speaker: "Hana", text: "An empty road is not a photograph, it is an absence. That is why we always end up running the angry families and never the working system." },
              ],
            },
            {
              kind: "audio",
          ...
          items: [
            ...
            },
            {
              ...
              no: 7,
              ref: "a7",
              text: "What is the first journalist's point?",
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Host", text: "You have been making these decisions for nine years. What does a forty percent forecast feel like?" },
                { speaker: "Lenn", text: "Like the worst number in the job. Eighty is easy and five is easy. Forty is where you find out what your service actually believes, because nothing in the manual covers it." },
                { speaker: "Host", text: "How do you decide?" },
                { speaker: "Lenn", text: "Not on the probability, which surprises people. I ask how long an action takes and how long the warning will give me. If the action is longer than the warning, the probability has stopped mattering." },
                { speaker: "Host", text: "That sounds like a way of avoiding the judgment." },
                { speaker: "Lenn", text: "It is a way of making the judgment earlier, at a point where it can still be carried out. Waiting for certainty is not caution. It is choosing to be certain and helpless at the same time." },
                { speaker: "Host", text: "You were criticized for the March closure." },
                { speaker: "Lenn", text: "I was, and the criticism had a real point in it. Eleven families spent a night in a hall for nothing, and one of them had a child of four months. I have never argued that the cost was zero." },
                { speaker: "Host", text: "Did it change what you do?" },
                { speaker: "Lenn", text: "It changed what I write down. I now record the two times, the action and the warning, in the log before I decide. Not to protect myself. So that whoever reviews it is arguing with the reasoning rather than with the outcome." },
                { speaker: "Host", text: "Does the public understand any of this?" },
                { speaker: "Lenn", text: "Individually, yes, every time. Collectively, no, and I have stopped expecting it to. The one thing I would change is the reporting: the closure that works is never a story, so people only ever read about the closures that look foolish." },
                { speaker: "Host", text: "Would publishing the probabilities help?" },
                { speaker: "Lenn", text: "It would help the people who already read carefully, which is not nothing. It would not touch the person who hears forty percent and files it as no." },
                { speaker: "Host", text: "Last question. Would you take the job again?" },
                { speaker: "Lenn", text: "Yes, and I would want somebody to tell the new person the thing nobody told me: you will be judged on outcomes and you can only control decisions, and those are different, and the gap between them is where this job is actually lived." },
              ],
            },
          ],
          items: [
