      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Ida", text: "Did you go to the meeting?" },
                { speaker: "Leo", text: "Two hours, and we decided nothing." },
                { speaker: "Ida", text: "Again?" },
                { speaker: "Leo", text: "We agreed to meet in three weeks with the same paper. I could have moved that shelf myself in ten minutes." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Man", text: "Do you have somebody who speaks Arabic on Thursday mornings?" },
                { speaker: "Woman", text: "Thursday, yes, but only until eleven." },
                { speaker: "Man", text: "My appointment is at half past eleven." },
                { speaker: "Woman", text: "Then I would move the appointment rather than the interpreter." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Nora", text: "Somebody left a bag of tomatoes on Friday." },
                { speaker: "Ben", text: "And?" },
                { speaker: "Nora", text: "They were still there on Monday and now the whole shelf smells. It is not that people are careless. It is that nobody owns the shelf between Friday and Sunday." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Ella", text: "You cannot run a group with no list." },
                { speaker: "Frank", text: "We have run it for six years." },
                { speaker: "Ella", text: "What if nobody comes?" },
                { speaker: "Frank", text: "Then whoever is there waters the beds, or nobody waters them for a week and nothing dies. A list would give us names and the same four people." },
              ],
            },
            {
              kind: "audio",
              ...
              plays: 2,
              segments: [
                { speaker: "Clara", text: "Runa said you might take over the driving." },
                { speaker: "Marc", text: "I have not said yes." },
                { speaker: "Clara", text: "She said you would." },
                { speaker: "Marc", text: "I said I would come on Tuesday and sit in the car. That is not the same sentence." },
              ],
            },
          ],
          items: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear information about a volunteer day. Complete the notes, questions 14 to 19. Write ONE or TWO words or a number in each gap. The information plays twice.",
          promptTr:
...
Tell Selma by:         {{19}}`,
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear an interview with a woman who organizes volunteers. Questions 20 to 25: pick one answer, a, b or c. The interview plays twice.",
          promptTr:
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Host", text: "You have a reputation for turning people away. Is that fair?" },
                { speaker: "Noor", text: "It is not quite fair, but it is close. Last year I said no to about a third of the people who offered." },
                { speaker: "Host", text: "That sounds like a lot." },
                { speaker: "Noor", text: "It is. In my first year I said yes to everybody, and I lost four evenings a week to people I never saw a second time. Somebody has to meet them, show them the work and check them. That work is real and nobody sees it." },
                { speaker: "Host", text: "So the cost of a new volunteer is your own time." },
                { speaker: "Noor", text: "Yes, and I can put a number on it. Three hours before the person is any use at all. If they stay only six weeks, those hours will never come back. If they stay two years, they are the best three hours I ever spent." },
                { speaker: "Host", text: "And how do you know which is which?" },
                { speaker: "Noor", text: "I do not, and anybody who says they can is selling something. What I do instead is ask for something small and exact. Two hours on a Tuesday. The people who say anything, any time, are the ones who go." },
                { speaker: "Host", text: "That seems hard on somebody who really is free all week." },
                { speaker: "Noor", text: "It is, and I get it wrong. A man last spring offered every day and I gave him Tuesdays only. He is still here, and he still tells me I was rude." },
                { speaker: "Host", text: "Would you change anything?" },
                { speaker: "Noor", text: "I would tell people why. For two years I said no and let them believe we were full. Now I say it straight: I want you for two years and not for six weeks, and the way to get two years is to start small." },
              ],
            },
          ],
          items: [
