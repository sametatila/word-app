      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Nora", text: "Her file has been open since March." },
                { speaker: "Daniel", text: "Waiting for what?" },
                { speaker: "Nora", text: "A supervisor. There are four in the region and two of them have stopped taking anybody, because they are covering nights." },
              ],
            },
            {
              kind: "audio",
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "You hear a man reporting the results of a five-year review. Complete the sentences, questions 9 to 16, with a word or a number. The report plays twice.",
          promptTr:
...
The region with the shortest wait had stopped requiring the supervised year in {{16}}.`,
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear six speakers talking about the recognition of qualifications, questions 17 to 22. Choose from a to h what each speaker says. You use each letter once only. The recordings play twice.",
          promptTr:
        ...
        },
        {
          ...
          goal: "opinion",
          prompt:
            "You hear an interview with a woman who requalified as a doctor and now advises other applicants. Questions 23 to 30: pick one answer, a, b or c. The interview plays twice.",
          promptTr:
          ...
          texts: [
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Host", text: "You finished the process. How long did it take?" },
                { speaker: "Juno", text: "Three years and two months, and I want to say the second number as well: four years of income. The year before I started, I was earning nothing at all while I studied." },
                { speaker: "Host", text: "And now you advise people who are beginning." },
                { speaker: "Juno", text: "I do, and the advice has changed. For the first two years I told everybody the same thing, which was that it is possible. That is true and it is almost useless." },
                { speaker: "Host", text: "Why useless?" },
                { speaker: "Juno", text: "Because everybody already believes it is possible. What they need is a number. So now I ask how many months they can live without a professional salary, and if the answer is under eighteen I tell them what that usually means." },
                { speaker: "Host", text: "That sounds discouraging." },
                { speaker: "Juno", text: "It is, and I would rather discourage somebody in March than watch them withdraw in the second year, having spent their savings and their confidence. About half the people I see are in that position." },
                { speaker: "Host", text: "Do you ever tell people not to start?" },
                { speaker: "Juno", text: "I tell them not to start now. That is a different sentence and I am careful to say it that way. Some of them come back in two years with a different financial situation and finish without any trouble." },
