          ...
          items: [
            {
              ...
              answer: false,
              explain:
                "Anonsta \"Das Angebot gilt nur bis achtzehn Uhr\" deniyor. Yani indirim akşam 18.00'de bitiyor, gün boyu sürmüyor.",
            },
            {
              kind: "bool",
              id: "de-a1-04-h2-8",
...
Unterschrift:             L. Novak`,
        ...
        },
        {
          ...
          goal: "interaction",
          prompt:
            "Ihre Freundin Lea hat Sie zu ihrem Geburtstag eingeladen. Sie können nicht kommen. Schreiben Sie ihr eine kurze Nachricht. Schreiben Sie zu jedem Punkt ein bis zwei Sätze (circa 30 Wörter). Denken Sie an Anrede und Grußformel.",
          promptTr:
      ...
      tasks: [
        {
          ...
          rubric: {
            ...
            sample:
              "Bei uns ist das Zuckerfest sehr wichtig. Dieses Jahr ist es im Frühling, und es dauert drei Tage. Meine Eltern, meine Schwester und viele Nachbarn kommen. Wir essen Reis, Fleisch und süße Kekse. Meine Mutter macht Musik an. Die Kinder bekommen Geld und kleine Geschenke.",
            criteria: [
        ...
        },
        {
          ...
          exchange: [
            ...
            {
              who: "you",
              hint: "Ricaya karşılık ver: uzat ya da kısa bir gerekçeyle beklemesini söyle.",
