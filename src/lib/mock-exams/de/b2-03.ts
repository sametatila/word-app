...
export const B2_03: MockPaper = {
  ...
  parts: [
    /* ── LESEN ─────────────────────────────────────────────────────────── */
    {
      ...
      minutes: 65,
      instruction:
        "In diesem Teil gibt es fünf Aufgaben. Sie lesen persönliche Berichte, einen Sachtext, einen Kommentar, Meinungsäußerungen und eine Betriebsvereinbarung.",
      instructionTr:
      ...
      tasks: [
        {
          ...
          goal: "opinion",
          prompt:
            "Vier Personen schreiben darüber, wie automatische Werkzeuge ihre Arbeit verändert haben. Lesen Sie zuerst die Texte; dazu gehören die Aufgaben 1 bis 9. Welche Person sagt das? Eine Person kann mehrmals die Antwort sein.",
          promptTr:
