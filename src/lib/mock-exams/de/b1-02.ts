...
export const B1_02: MockPaper = {
  ...
  parts: [
    /* ── LESEN ─────────────────────────────────────────────────────────── */
    {
      ...
      minutes: 65,
      instruction:
        "In diesem Teil gibt es fünf Aufgaben. Sie lesen einen Blogtext, Zeitungstexte, Anzeigen, Leserkommentare und eine Hausordnung. Die Reihenfolge ist frei.",
      instructionTr:
...
Und noch etwas übersehen viele: Der Strom nützt nur, wenn er auch verbraucht wird. Wer tagsüber nie zu Hause ist und kein Gerät laufen lässt, schickt den Strom kostenlos ins Netz.`,
        ...
        },
        {
          ...
          goal: "orientation",
          prompt:
            "Die Personen 13 bis 19 suchen ein Angebot in ihrer Stadt. Lesen Sie die Anzeigen a bis j. Finden Sie für jede Person die passende Anzeige. Keine Anzeige wird zweimal gebraucht. Drei Anzeigen bleiben übrig.",
          promptTr:
