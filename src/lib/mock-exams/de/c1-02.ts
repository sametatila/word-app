      ...
      tasks: [
        {
          ...
          rubric: {
            ...
            points: [
              ...
              { de: "Nennen Sie zwei Gründe, warum Sprachen verloren gehen.", tr: "Dillerin yok olmasının iki nedenini söyle." },
      ...
      tasks: [
        ...
        },
        {
          ...
          exchange: [
            ...
            { who: "partner", de: "Das wäre ein gangbarer Weg. Formulieren wir das gemeinsame Ergebnis, samt einer Bedingung?", tr: "Bu uygulanabilir bir yol. Ortak sonucu bir koşulla birlikte formüle edelim mi?" },
