...
Unterschrift:             T. Zielinski`,
        ...
        },
        {
          ...
          goal: "interaction",
          prompt:
            "Sie haben im Internet eine Hose bestellt. Sie ist zu klein. Schreiben Sie an den Laden. Schreiben Sie zu jedem Punkt ein bis zwei Sätze (circa 30 Wörter). Denken Sie an Anrede und Grußformel.",
          promptTr:
