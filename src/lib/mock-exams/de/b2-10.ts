...
export const B2_10: MockPaper = {
  ...
  parts: [
    /* ── LESEN ─────────────────────────────────────────────────────────── */
    {
      ...
      minutes: 65,
      instruction:
        "In diesem Teil gibt es fünf Aufgaben. Sie lesen persönliche Texte, einen Sachtext mit Lücken, einen Kommentar, Meinungsbeiträge und eine Richtlinie.",
      instructionTr:
      ...
      tasks: [
        {
          ...
          goal: "opinion",
          prompt:
            "Vier Personen schreiben darüber, wie sie beruflich mit Zahlen umgehen. Lesen Sie zuerst die Texte; dazu gehören die Aufgaben 1 bis 9. Welche Person sagt das? Eine Person kann mehrmals die Antwort sein.",
          promptTr:
...
Mein Vorschlag ist deshalb bescheiden: Wer eine Veränderung nennt, nennt den Vergleichszeitraum im selben Satz. Nicht in der Fußnote, im selben Satz.`,
        ...
        },
        {
          ...
          format: "mcq",
          goal: "instruction",
          prompt: "Lesen Sie zuerst die Richtlinie; dazu gehören die Aufgaben 28 bis 30. Kreuzen Sie a, b oder c an.",
