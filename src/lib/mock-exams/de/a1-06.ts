...
Unterschrift:             P. Nowicki`,
        ...
        },
        {
          ...
          goal: "interaction",
          prompt:
            "Sie möchten im Herbst einen Deutschkurs besuchen. Schreiben Sie an die Sprachschule Kolibri. Schreiben Sie zu jedem Punkt ein bis zwei Sätze (circa 30 Wörter). Denken Sie an Anrede und Grußformel.",
          promptTr:
