...
export const B1_10: MockPaper = {
  ...
  parts: [
    /* ── LESEN ─────────────────────────────────────────────────────────── */
    {
      ...
      minutes: 65,
      instruction:
        "In diesem Teil gibt es fünf Aufgaben. Sie lesen einen Bericht, kurze Texte, Anzeigen, Forumsbeiträge und Nutzungsregeln.",
      instructionTr:
...
Herr Yalçın: Ich bin dafür, mit einer Bedingung: Jedes Amt behält eine Stelle für Menschen ohne Zugang. Nicht als Ausnahme, sondern als feste Aufgabe mit einer Person, die dafür bezahlt wird. Ohne diese Stelle wäre ich dagegen.`,
        ...
        },
        {
          ...
          format: "mcq",
          goal: "instruction",
          prompt: "Lesen Sie zuerst die Nutzungsregeln; dazu gehören die Aufgaben 27 bis 30. Kreuzen Sie a, b oder c an.",
