        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              answer: false,
              explain:
                "«Das große Becken schließt heute schon um sechs Uhr. Das kleine Becken bleibt bis acht Uhr offen» — altıda kapanan BÜYÜK havuz; küçüğü sekize kadar açık. İki saat ve iki havuz bilerek yan yana veriliyor.",
            },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              answer: 2,
              explain:
                "«Nein, der Bahnsteig ist zu voll. Komm lieber zur Information in der Halle» — tren yanı öneriliyor ama reddediliyor. İlk söylenen seçenek çoğu zaman doğru olan değil.",
            },
            {
              kind: "mcq",
              id: "de-a1-01-h3-13",
...
Unterschrift:             A. Sarr`,
          ...
          items: [
            ...
            },
            {
              ...
              explain: "Adres yönergede tam veriliyor. Sokak adı ve kapı numarası birlikte yazılır; `-str.` kısaltması da doğrudur.",
            },
            {
              kind: "gap",
              id: "de-a1-01-s1-3",
              ...
              text: "PLZ",
              accept: ["04277", "4277"],
              explain: "Yönergede adres \"Lindenstraße 8, 04277 Leipzig\" olarak veriliyor. Posta kodu beş hanelidir ve baştaki sıfır yazılır: 04277. Şehir adı formda zaten basılı.",
            },
            {
              kind: "gap",
              id: "de-a1-01-s1-4",
        ...
        },
        {
          ...
          goal: "interaction",
          prompt:
            "Sie möchten im Juli nach Hamburg fahren. Schreiben Sie an die Touristeninformation. Schreiben Sie zu jedem Punkt ein bis zwei Sätze (circa 30 Wörter). Denken Sie an Anrede und Grußformel.",
          promptTr:
