      ...
      tasks: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              options: ["Er kann dienstags früh ohne Termin kommen.", "Er kann sich online anmelden.", "Er muss bis Mai warten."],
              answer: 0,
              explain:
        ...
        },
        {
          ...
          texts: [
            {
              ...
              segments: [
                ...
                { speaker: "Ela", text: "Jan, holst du die Schlüssel beim Vermieter ab?" },
                { speaker: "Jan", text: "Ja, klar, das mache ich." },
              ],
            },
          ],
          options: [
          ...
          items: [
            ...
            },
            {
              ...
              answer: "h",
              explain:
                "Ela soruyor, Jan kabul ediyor: \"Ja, klar, das mache ich\". Anahtarları ev sahibinden o alıyor.",
            },
          ],
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              situation: "İki arkadaş bir hediyenin parasını bölüşüyor.",
              plays: 2,
              segments: [
