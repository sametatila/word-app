      ...
      tasks: [
        {
          ...
          texts: [
            ...
            },
            {
              ...
              situation: "Bir yolcu, tren yerine çalışan otobüsü soruyor.",
              plays: 2,
              segments: [
          ...
          items: [
            ...
            },
            {
              ...
              answer: 0,
              explain:
                "\"Um zehn nach zehn\" onu on geçe demek. Yirmi dakika gecikme süresi, varış saati değil.",
            },
            {
              kind: "mcq",
              id: "de-a1-12-h1-5",
...
Unterschrift:             T. Berisha`,
        ...
        },
        {
          ...
          goal: "interaction",
          prompt:
            "Sie kommen später an als geplant. Schreiben Sie an Ihre Freundin. Schreiben Sie zu jedem Punkt ein bis zwei Sätze (circa 30 Wörter). Denken Sie an Anrede und Grußformel.",
          promptTr:
...
Teuta`,
    ...
    /* ── SPRECHEN ──────────────────────────────────────────────────────── */
    {
      skill: "speaking",
      minutes: 15,
      instruction: "In diesem Teil gibt es drei Aufgaben: von einer Reise erzählen, Fragen stellen, um etwas bitten und reagieren.",
        ...
        },
        {
          ...
          exchange: [
            ...
            { who: "you", hint: "Soruyu cevapla — sık aktarma yapıyor musun?", expect: "evet/hayır sorusuna tam bir cümleyle cevap vermek", seconds: 25 },
            {
              ...
              tr: "Teşekkürler. Son soru: Yanına ne kadar bagaj alırsın?",
            },
        ...
        },
        {
          ...
          exchange: [
            ...
            { who: "you", hint: "Cam kenarı yer iste, kibarca.", expect: "kibar bir rica kurmak (Kann ich bitte einen Platz am Fenster haben)", seconds: 20 },
            {
              ...
              tr: "Tabii, yedinci vagon, yirmi ikinci koltuk. Şimdi sana bir soru: Buradan şehre çıkış nerede?",
            },
            {
              who: "you",
