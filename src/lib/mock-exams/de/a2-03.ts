    ...
    /* ── HÖREN ─────────────────────────────────────────────────────────── */
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "Sie hören ein Gespräch. Fünf Personen übernehmen eine Aufgabe für den Umzug. Was macht wer? Ordnen Sie zu. Sie hören den Text zweimal.",
          promptTr:
            "Bir konuşma dinleyeceksin. Beş kişi taşınma için bir iş üstleniyor. Kim ne yapıyor? Eşleştir. Kaydı iki kez dinleyebilirsin.",
          texts: [
            {
              kind: "audio",
              id: "g1",
