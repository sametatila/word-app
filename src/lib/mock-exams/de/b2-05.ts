...
export const B2_05: MockPaper = {
  ...
  parts: [
    /* ── LESEN ─────────────────────────────────────────────────────────── */
    {
      ...
      minutes: 65,
      instruction:
        "In diesem Teil gibt es fünf Aufgaben. Sie lesen persönliche Berichte, einen Sachtext, einen Kommentar, Meinungsäußerungen und eine Prüfungsordnung.",
      instructionTr:
      ...
      tasks: [
        {
          ...
          goal: "opinion",
          prompt:
            "Vier Personen schreiben über ihren Bildungsweg. Lesen Sie zuerst die Texte; dazu gehören die Aufgaben 1 bis 9. Welche Person sagt das? Eine Person kann mehrmals die Antwort sein.",
          promptTr:
