...
export const C1_04: MockPaper = {
  ...
  parts: [
    /* ── LESEN ─────────────────────────────────────────────────────────── */
    {
      ...
      minutes: 70,
      instruction:
        "In diesem Teil gibt es drei Aufgaben: eine Zusammenfassung ergänzen, einen längeren Text auswerten und Lücken in einem Zeitschriftentext füllen.",
      instructionTr:
...
Gegen eine feinere Einteilung spricht, dass sie die Verständigung {{9}}. Der Text hält diesen Einwand für berechtigt, aber für weniger schwerwiegend. Zuletzt kritisiert er beide gängigen Formeln — Last und Ressource —, weil sie Menschen nach ihrem {{10}} bewerten.`,
        ...
        },
        {
          ...
          format: "mcq",
          goal: "opinion",
          prompt: "Lesen Sie zuerst den Text; dazu gehören die Aufgaben 11 bis 20. Kreuzen Sie a, b, c oder d an.",
...
Ob daraus ein dauerhaftes Modell wird, ist offen. Fest steht {{25}}, dass die Vorstellung vom Zurück zur Großfamilie an der Sache vorbeigeht: Was hier entsteht, ist keine Wiederkehr, sondern eine befristete Zweckgemeinschaft.`,
    ...
    /* ── HÖREN ─────────────────────────────────────────────────────────── */
    {
      skill: "listening",
      minutes: 40,
      instruction: "In diesem Teil gibt es zwei Aufgaben: Notizen ergänzen und eine Diskussion auswerten.",
...
Antrag auf Pflegegrad: formlos möglich; Leistungen ab {{10}}.`,
        ...
        },
        {
          ...
          format: "mcq",
          goal: "gist",
          prompt: "Sie hören eine Diskussion. Kreuzen Sie bei den Aufgaben 11 bis 25 jeweils a, b oder c an. Der Text wird zweimal abgespielt.",
          ...
          items: [
            ...
            },
            {
              ...
              answer: 2,
              explain:
                "\"Dem widerspreche ich nicht, im Gegenteil\" diyor ve rahatsız edici sonucu ekliyor: aynı kişi iki kez hesaba katılıyor.",
            },
            {
              kind: "mcq",
              id: "de-c1-04-h2-17",
            ...
            },
            {
              ...
              answer: 0,
              explain:
                "Gönüllülüğün de abartıldığını söylüyor: boşlukları kapatması beklenen genç yaşlılar grubu \"selbst schrumpft\".",
            },
            {
              kind: "mcq",
              id: "de-c1-04-h2-24",
...
Dorothea Simon`,
    ...
    /* ── SPRECHEN ──────────────────────────────────────────────────────── */
    {
      skill: "speaking",
      minutes: 15,
      instruction: "In diesem Teil gibt es zwei Aufgaben: einen Vortrag halten und eine Position im Gespräch verteidigen.",
      ...
      tasks: [
        {
          ...
          promptTr:
            "\"Yaşlılıkta bakımın yükünü kim üstlenmeli — aile mi, devlet mi, birey mi?\" konusunda yaklaşık dört dakikalık bir sunum yap. Şu sırayı izle: giriş — kavramı netleştirme — kendi ülkendeki durum — tartma — kendi konumun — kapanış.",
          minutes: 8,
          prepSeconds: 180,
          speakSeconds: 240,
          items: [],
          rubric: {
            ...
            criteria: [
              ...
              "Kendi ülkesindeki durum somut ve yalnız betimleyici değil, açıklayıcı mı?",
        ...
        },
        {
          ...
          exchange: [
            ...
            },
            {
              ...
              tr: "Bunu kabul ediyorum. Ama bunu uygulayan ülkelere bak: Bakım aileye daha çok kaymış, daha az değil. Sonuç istenenin tam tersi olmuş.",
            },
            {
              who: "you",
            ...
            },
            {
              ...
              tr: "Diyelim ki ikisini birbirine bağladık. Geriye denetim sorunu kalıyor: Bakımın gerçekten yapıldığını, aileyi gözetim altına almadan kim tespit edecek?",
            },
            {
              who: "you",
