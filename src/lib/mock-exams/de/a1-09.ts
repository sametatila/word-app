...
Unterschrift:             I. Nowicka`,
        ...
        },
        {
          ...
          goal: "interaction",
          prompt:
            "Sie können zu Ihrem Termin am 14. März nicht kommen. Schreiben Sie an das Bürgeramt. Schreiben Sie zu jedem Punkt ein bis zwei Sätze (circa 30 Wörter). Denken Sie an Anrede und Grußformel.",
          promptTr:
