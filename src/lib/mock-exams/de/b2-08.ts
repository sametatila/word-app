...
export const B2_08: MockPaper = {
  ...
  parts: [
    /* ── LESEN ─────────────────────────────────────────────────────────── */
    {
      ...
      minutes: 65,
      instruction:
        "In diesem Teil gibt es fünf Aufgaben. Sie lesen persönliche Texte, einen Sachtext mit Lücken, einen Kommentar, Meinungsbeiträge und eine Prüfungsordnung.",
      instructionTr:
      ...
      tasks: [
        {
          ...
          goal: "opinion",
          prompt:
            "Vier Personen schreiben über Sprache im Alltag. Lesen Sie zuerst die Texte; dazu gehören die Aufgaben 1 bis 9. Welche Person sagt das? Eine Person kann mehrmals die Antwort sein.",
          promptTr:
...
Mein Vorschlag ist deshalb unspektakulär: Nachweis ja, aber binnen zwölf Monaten nach der Einreise, verbunden mit einem Kursanspruch von Anfang an.`,
        ...
        },
        {
          ...
          format: "mcq",
          goal: "instruction",
          prompt: "Lesen Sie zuerst die Prüfungsordnung; dazu gehören die Aufgaben 28 bis 30. Kreuzen Sie a, b oder c an.",
