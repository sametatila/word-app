...
Der Hof ist ab 24 Uhr frei zu halten.`,
        ...
        },
        {
          ...
          goal: "orientation",
          prompt:
            "Die Personen 16 bis 20 planen ein Fest. Lesen Sie die Anzeigen a bis h. Finden Sie für jede Person die passende Anzeige. Keine Anzeige wird zweimal gebraucht. Drei Anzeigen bleiben übrig.",
          promptTr:
    ...
    /* ── HÖREN ─────────────────────────────────────────────────────────── */
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "Sie hören ein Gespräch. Fünf Personen sagen, was sie zum Fest mitbringen. Wer bringt was? Ordnen Sie zu. Drei Sachen bleiben übrig. Der Text wird zweimal abgespielt.",
          promptTr:
          ...
          texts: [
            {
              ...
              segments: [
                ...
                { speaker: "Lena", text: "Ich habe viele Stühle im Keller." },
                { speaker: "Pia", text: "Super, bring die bitte mit." },
              ],
            },
          ],
          options: [
          ...
          items: [
            ...
            },
            {
              ...
              answer: "e",
              explain:
                "Lena bodrumunda çok sandalye olduğunu söylüyor, Pia da \"bring die bitte mit\" diyor.",
            },
          ],
        },
        {
          ...
          texts: [
            ...
            },
            {
              ...
              plays: 2,
              segments: [
                { speaker: "Ida", text: "Wie fandest du es gestern?" },
      ...
      tasks: [
        {
          ...
          exchange: [
            ...
            { who: "you", hint: "«Gäste» için bir soru kur.", expect: "Gäste sözcüğüyle bir soru kurmak", seconds: 30 },
            {
              ...
              tr: "Bende ender olarak on kişiyi geçer. Şimdi sana bir soru: Misafirlerine yemeği kendin mi yaparsın?",
            },
        ...
        },
        {
          ...
          rubric: {
            ...
            sample:
              "Bei uns kommen zu einem Fest sehr viele Leute, oft die ganze Familie und die Nachbarn. Man schickt keine Einladungen, man sagt einfach Bescheid. Hier ist das anders: Man bekommt eine Einladung und antwortet vorher. Am Anfang war das für mich seltsam. Heute finde ich es praktisch, weil man weiß, wie viel man kochen muss. Das Laute und Volle vermisse ich trotzdem manchmal.",
            criteria: [
          ...
          exchange: [
            {
              ...
              tr: "Hafta sonunu birlikte planlıyoruz. Treni cuma saat 19.00'da geliyor. Onu kim karşılayacak?",
            },
