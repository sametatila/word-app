          ...
          items: [
            {
              ...
              options: [
                "Ein Jahr lang keine neue Kleidung zu kaufen.",
                "Nur noch auf dem Flohmarkt einzukaufen.",
                "Ihre alte Kleidung zu verkaufen.",
              ],
              answer: 0,
              explain:
                "İlk cümlede söz veriliyor: bir yıl boyunca yeni kıyafet almamak. Bit pazarı ve satış sonradan olan şeyler, sözün içeriği değil.",
            },
            {
              kind: "mcq",
              id: "de-a2-02-l1-2",
...
Umtausch nur mit Kassenbon, im Erdgeschoss`,
          ...
          items: [
            ...
            },
            {
              ...
              answer: 2,
              explain: "Bankamatik zemin katta, güney girişin yanında. Bodrumda market var, birinci katta giyim.",
            },
            {
              kind: "mcq",
              id: "de-a2-02-l2-8",
              ...
              answer: 1,
              explain:
                "Telefon ve tamir servisi ikinci katta. Üçüncü kat ofisler ve müşteriye kapalı.",
            },
            {
              kind: "mcq",
              id: "de-a2-02-l2-9",
            ...
            },
            {
              ...
              options: ["Den Kassenbon.", "Einen Ausweis.", "Eine Anmeldung."],
              answer: 0,
              explain: "\"Umtausch nur mit Kassenbon\" — tek koşul fiş. Kimlik ve kayıt istenmiyor.",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              options: ["Der Zug war zu voll.", "Sie haben den Anschluss verpasst.", "Sie sind falsch eingestiegen."],
              answer: 1,
              explain:
                "Gecikme yüzünden aktarma kaçıyor ve iki saat bekleniyor. Doluluk ve yanlış trene binmek metinde yok.",
            },
            {
              kind: "mcq",
              id: "de-a2-02-l3-12",
            ...
            },
            {
              ...
              options: ["Sie waren am Strand.", "Sie waren im Aquarium.", "Sie sind zu Hause geblieben."],
              answer: 1,
              explain: "Bütün gün yağmur yağdığı için akvaryuma gitmişler. Güneş bugün açtı, dün değil.",
            },
            {
              kind: "mcq",
              id: "de-a2-02-l3-14",
              ...
              options: ["Eine Fahrt an die Küste.", "Ein Besuch im Museum.", "Die Rückfahrt nach Hause."],
              answer: 0,
              explain: "\"Am Freitag fahren wir mit dem Bus an die Küste\" — dönüş yolculuğundan hiç söz edilmiyor.",
            },
            {
              kind: "mcq",
              id: "de-a2-02-l3-15",
      ...
      tasks: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              answer: 0,
              explain:
                "Alpler'de çarşambaya kadar yağmurlu. Kuzey Denizi rüzgârlı ama kuru; Akdeniz çok sıcak.",
            },
            {
              kind: "mcq",
              id: "de-a2-02-h1-4",
              ...
              answer: 1,
              explain:
                "Anons kartla ödemenin artık MÜMKÜN olduğunu, arıza yüzünden nakit alınmadığını söylüyor. İki bilgi bilerek yan yana veriliyor.",
            },
            {
              kind: "mcq",
              id: "de-a2-02-h1-5",
              ...
              options: ["Zu einem anderen Ausgang gehen.", "Ihr Ticket umtauschen.", "In der Nähe von Ausgang zwölf bleiben."],
              answer: 2,
              explain:
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              answer: "d",
              explain:
                "Salı önce yürüyüş için düşünülüyor, yağmur yüzünden iptal; ardından yüzme öneriliyor ama havuz salı kapalı. Geriye müze kalıyor.",
            },
            {
              kind: "match",
              id: "de-a2-02-h2-8",
          ...
          items: [
            {
              ...
              answer: 0,
              explain:
                "Acelesi olduğu için on iki dakika sonraki aktarmalı treni seçiyor. Direkt tren bir saat sonra.",
            },
            {
              kind: "mcq",
              id: "de-a2-02-h3-12",
              ...
              answer: 2,
              explain:
                "Fiş yanında olmadığı için para iadesi yok; fişsiz yalnız hediye çeki veriliyor. Para iadesi fişle mümkün olurdu.",
            },
            {
              kind: "mcq",
              id: "de-a2-02-h3-13",
