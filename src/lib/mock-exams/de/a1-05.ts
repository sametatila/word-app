...
Unterschrift:             R. Iversen`,
        ...
        },
        {
          ...
          goal: "interaction",
          prompt:
            "Sie sind mit Ihrer Freundin Nora um 18 Uhr am Kino verabredet. Ihr Bus hat Verspätung. Schreiben Sie ihr eine Nachricht. Schreiben Sie zu jedem Punkt ein bis zwei Sätze (circa 30 Wörter). Denken Sie an Anrede und Grußformel.",
          promptTr:
