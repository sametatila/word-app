      ...
      tasks: [
        {
          ...
          goal: "opinion",
          prompt:
            "Vier Personen schreiben über Regeln in ihrem Arbeitsalltag. Lesen Sie zuerst die Texte; dazu gehören die Aufgaben 1 bis 9. Welche Person sagt das? Eine Person kann mehrmals die Antwort sein.",
          promptTr:
...
Mein Fazit fällt entsprechend unbequem aus: Ich halte die Reform für richtig und ihren Preis für real. Wer beides nicht zusammen nennt, verkauft eine halbe Rechnung.`,
        ...
        },
        {
          ...
          format: "mcq",
          goal: "instruction",
          prompt: "Lesen Sie zuerst die Ordnung; dazu gehören die Aufgaben 28 bis 30. Kreuzen Sie a, b oder c an.",
