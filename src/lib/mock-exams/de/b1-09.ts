...
Elif Radek: Wer für die Pflicht argumentiert, denkt an gute Familien. Ich denke an die anderen. Ein Gesetz zwingt Menschen, für jemanden zu zahlen, vor dem sie als Kind weggelaufen sind. Das darf ein Staat nicht verlangen.`,
        ...
        },
        {
          ...
          format: "mcq",
          goal: "instruction",
          prompt: "Lesen Sie zuerst die Regeln; dazu gehören die Aufgaben 27 bis 30. Kreuzen Sie a, b oder c an.",
...
Deniz Kemper`,
    ...
    /* ── SPRECHEN ──────────────────────────────────────────────────────── */
    {
      skill: "speaking",
      minutes: 15,
      instruction: "In diesem Teil gibt es drei Aufgaben: gemeinsam planen, einen kurzen Vortrag halten, auf eine Sorge reagieren.",
