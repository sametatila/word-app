...
Im nächsten Jahr mache ich weiter. Aber ich frage vorher, ob eine Reparatur überhaupt möglich ist.`,
        ...
        },
        {
          ...
          goal: "orientation",
          prompt:
            "Die Personen 16 bis 20 brauchen Hilfe im Haushalt. Lesen Sie die Anzeigen a bis h. Finden Sie für jede Person die passende Anzeige. Keine Anzeige wird zweimal gebraucht. Drei Anzeigen bleiben übrig.",
          promptTr:
    ...
    /* ── HÖREN ─────────────────────────────────────────────────────────── */
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          goal: "detail",
          prompt:
            "Sie hören ein Gespräch. Fünf Personen sagen, was bei ihnen kaputt ist. Wer hat welches Problem? Ordnen Sie zu. Drei Sachen bleiben übrig. Der Text wird zweimal abgespielt.",
          promptTr:
