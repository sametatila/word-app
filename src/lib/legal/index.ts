  ...
  },
  {
    ...
    */
    ...
    changes: {
      ...
      en: [
        "These texts now cover the iOS app too. The terms gained an \"Additional terms for the Apple App Store\" section (13a): the agreement is between you and us only, we alone are responsible for the app and its support, and Apple is a third-party beneficiary of it. On iOS, buying, renewing, canceling and refunding a subscription goes through Apple; the texts point to Settings › Apple Account › Subscriptions and to reportaproblem.apple.com. Apple (App Store) was added to the table of recipients.",
