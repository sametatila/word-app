...
export const deA1B04: Lesson[] = [
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Şimdi sen: 'Hafta sonu sık sık çalışıyorum.' demek için ne dersin?")],
        expect: {
          kind: "produce",
          target: "Am Wochenende arbeite ich oft",
          hint: [
            tr("Hafta sonu başta, fiil hemen arkasında:"),
            de("Am Wochenende arbeite ich oft."),
            tr("Tekrar dene."),
          ],
        },
      },
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr("İlk kelimemiz:"),
          de("der Wecker"),
          tr("Türkçesi 'çalar saat' demek. Lütfen"),
          de("der Wecker"),
          tr("deyin."),
        ],
        expect: { kind: "repeat", target: "der Wecker" },
      },
      {
        say: [
          tr("İkinci kelimemiz:"),
          de("aufwachen"),
          tr("Türkçesi 'uyanmak' demek. Bu da ayrılabilen bir fiil. Lütfen"),
          de("aufwachen"),
          tr("deyin."),
        ],
        expect: { kind: "repeat", target: "aufwachen" },
      },
      {
        say: [
          tr("Üçüncü kelimemiz:"),
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr("İkinci kelimemiz:"),
          de("sich ausruhen"),
          tr("Türkçesi 'dinlenmek' demek. Lütfen"),
          de("sich ausruhen"),
          tr("deyin."),
        ],
        expect: { kind: "repeat", target: "sich ausruhen" },
      },
      {
        say: [
          tr("Üçüncü kelimemiz:"),
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr("İlk kelimemiz:"),
          de("die Zeit"),
          tr("Türkçesi 'vakit, zaman' demek. Lütfen"),
          de("die Zeit"),
          tr("deyin."),
        ],
