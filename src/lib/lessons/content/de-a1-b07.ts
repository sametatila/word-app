...
export const deA1B07: Lesson[] = [
  {
    ...
    focusId: "Es-gibt",
    vocab: [
      { de: "die Wohnung", tr: "daire, ev" },
      { de: "das Haus", tr: "bina, ev" },
      { de: "das Zimmer", tr: "oda" },
      { de: "hell", tr: "aydınlık" },
      { de: "ruhig", tr: "sessiz, sakin" },
    ],
    patterns: [
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          kind: "truefalse",
          statement: "Das ist die Küche.",
          answer: true,
          why: [
            tr("Doğru. Mutfak kelimesi dişildir ve doğru artikeli almış."),
          ],
        },
      },
      {
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          kind: "truefalse",
          statement: "Wir sind neu hier.",
          answer: true,
          why: [
            tr("Doğru. Birden fazla kişi için fiil bu biçimi alır ve cümle tam olarak buraya yeni taşındığını anlatır."),
          ],
        },
      },
      {
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "die Nebenkosten", tr: "aidat, ek giderler" },
    ...
    roleplay: {
      ...
      opening: "Guten Tag! Haben Sie noch Fragen zur Wohnung?",
      openingTr: "İyi günler! Daireyle ilgili sormak istediğiniz bir şey var mı?",
      minTurns: 4,
    },
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr("Üçüncü kelimemiz:"),
          de("abwaschen"),
          tr("Türkçesi 'bulaşık yıkamak' demek. Lütfen"),
          de("abwaschen"),
          tr("deyin."),
        ],
        expect: { kind: "repeat", target: "abwaschen" },
      },
      {
        say: [
          tr("Dördüncü kelimemiz:"),
      ...
      },
      {
        say: [
          tr("Son kelimemiz:"),
          de("der Staubsauger"),
          tr("Türkçesi 'elektrikli süpürge' demek. Uzun görünüyor ama iki kelimenin birleşmesinden ibaret. Lütfen"),
          de("der Staubsauger"),
          tr("deyin."),
        ],
