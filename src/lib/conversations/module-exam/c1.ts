...
export const C1_EXAMS: ModuleExamPlan[] = [
  ...
  },
  {
    ...
    index: 8,
    code: "C1.9",
    titleDe: "Humor, Ironie und Feingefühl",
    titleTr: "Mizah, ironi ve incelik",
    focus: [
      { de: "Ironie erkennen", tr: "Na, das lief ja super" },
      { de: "Untertreibung", tr: "Nicht schlecht! / Alle Achtung!" },
      { de: "Grenzen des Witzes", tr: "auf Kosten anderer" },
      { de: "Duzen und Siezen", tr: "Ich bleibe lieber beim Sie" },
    ...
    listening: {
      ...
      questions: [
        ...
        { de: "Was bedeutet „Da ist noch Luft nach oben“?", tr: "„Da ist noch Luft nach oben“ ne demek?", options: ["Es war ausgezeichnet", "Es reicht noch nicht", "Der Raum war zu warm", "Es war zu lang"], answer: 1 },
        { de: "Wie reagiert Jan auf den Hinweis zum Spruch?", tr: "Jan lafla ilgili uyarıya nasıl karşılık veriyor?", options: ["Er verteidigt sich", "Er nimmt es zurück", "Er lacht darüber", "Er wechselt das Thema"], answer: 1 },
      ],
    },
    reading: {
    ...
    writing: {
      ...
      checklist: [
        "Bir yanlış anlama örneğiyle başla",
        "Ölçülü övgüyü ve doğrudan eleştiriyi açıkla",
        "En az bir ironi örneği ver ve ne demek istediğini yaz",
        "'Sen' ve 'siz' konusuna kısaca değin",
        "Yargılamadan bitir: farklı, yanlış değil",
      ],
      minWords: 110,
      phrases: [
      ...
      sample:
        "Liebe Neue, kurz das Wichtigste\n\nIn meiner ersten Woche legte ich einen Entwurf vor und hörte: „Nicht schlecht.“ Ich war zwei Tage lang enttäuscht — bis mir jemand erklärte, dass das hier ein Lob ist.\n\nDie Regel ist einfach: Kritik kommt direkt, Lob sparsam. „Da ist noch Luft nach oben“ heißt nicht „fast perfekt“, sondern „so reicht es nicht“. Und wenn jemand nach einer schwierigen Sitzung sagt: „Na, das lief ja super“, dann meint er das Gegenteil.\n\nEine zweite Sache: Warten Sie beim Du ab. Das Angebot macht üblicherweise die ranghöhere Person; und wenn Ihnen das zu schnell geht, ist „Ich bleibe lieber beim Sie“ vollkommen in Ordnung.\n\nNichts davon ist Kälte. Es ist eine andere Dosierung — anders, nicht falsch.",
    },
  },

  {
    ...
    focus: [
      ...
      { de: "Nominalstil", tr: "Vom Prüfling werden … verlangt" },
      { de: "als ob + Konjunktiv II", tr: "Es ist, als hätte ich zwei Stimmen" },
      { de: "Metaphern", tr: "Der Gipfel ist erreicht, aber …" },
    ],
    canDo: [
      { de: "Ich kann eine Krisensitzung leiten und Aufgaben verteilen.", tr: "Bir kriz toplantısı yönetip görev dağıtabiliyorum.", en: "I can lead a crisis meeting and assign tasks." },
      { de: "Ich kann eine Zwischenlösung vorschlagen und ihre Grenzen nennen.", tr: "Ara çözüm önerip sınırlarını söyleyebiliyorum.", en: "I can propose an interim solution and state its limits." },
      { de: "Ich kann zwischen zwei Kulturen sprachlich vermitteln.", tr: "İki kültür arasında dille aracılık edebiliyorum.", en: "I can mediate linguistically between two cultures." },
      { de: "Ich kann eine Verhandlung diplomatisch abschließen.", tr: "Bir müzakereyi diplomatik biçimde kapatabiliyorum.", en: "I can close a negotiation diplomatically." },
      { de: "Ich kann meinen eigenen Lernweg reflektiert weitergeben.", tr: "Kendi öğrenme yolumu düşünerek aktarabiliyorum.", en: "I can reflectively pass on my own learning path." },
    ],
    listening: {
    ...
    reading: {
      ...
      titleTr: "Vardım — ve devam",
      genre: "Kişisel deneme",
      text: "Angekommen — und weiter\n\nEs gibt einen Moment, an den sich fast alle erinnern: Man sitzt in einer Runde, folgt dem Gespräch, antwortet — und merkt erst hinterher, dass man die ganze Zeit in der fremden Sprache gedacht hat. Der Gipfel ist erreicht, sagt man dann. Nur stimmt das nicht ganz.\n\nDenn was sich ändert, ist nicht das Können allein, sondern die Rolle. Anfangs übersetzt man; irgendwann vermittelt man. Man erklärt, warum ein Satz höflich gemeint war, obwohl er schroff klang, und warum „nicht schlecht“ ein Lob ist.\n\nEs ist, als hätte man zwei Stimmen. Je nach Sprache ist man ein wenig anders — nicht gespalten, sondern erweitert. Das ist ein Reichtum, kein Riss.\n\nUnd der Rest? Ein langer Weg ist zurückgelegt worden, die Mühe war nicht umsonst. Angekommen ist man trotzdem nicht ganz, und das ist die gute Nachricht: Der Weg geht weiter, nur trägt er einen jetzt.",
      questions: [
        { de: "Woran erinnern sich laut Text fast alle?", tr: "Metne göre neredeyse herkes neyi hatırlıyor?", options: ["An die erste Prüfung", "An den Moment, in dem man in der fremden Sprache gedacht hat", "An den ersten Fehler", "An den ersten Kurs"], answer: 1 },
        { de: "Was ändert sich laut Text vor allem?", tr: "Metne göre asıl değişen ne?", options: ["Nur das Können", "Die Rolle: vom Übersetzen zum Vermitteln", "Der Wortschatz", "Die Aussprache"], answer: 1 },
        { de: "Wie bewertet der Text die Zweisprachigkeit?", tr: "Metin iki dilliliği nasıl değerlendiriyor?", options: ["Als Riss", "Als Reichtum", "Als Übergang", "Als Verlust"], answer: 1 },
      ],
    },
    speaking: [
      { situation: "Kriz toplantısında önlem bildiriyorsun.", de: "Wir müssen umgehend Maßnahmen ergreifen und den Notfallplan in Kraft setzen.", tr: "Derhâl önlem almalı ve acil planı yürürlüğe koymalıyız." },
      { situation: "Seviyenin sonunda kendini değerlendiriyorsun.", de: "Ein langer Weg ist zurückgelegt worden — angekommen bin ich trotzdem nicht ganz.", tr: "Uzun bir yol kat edildi — yine de tam olarak varmış sayılmam." },
    ],
    writing: {
      prompt: "C1'in sonunda kendi yolunu değerlendiren kişisel bir metin yaz.",
      checklist: [
