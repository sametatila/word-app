...
export const B2_EXAMS: ModuleExamPlan[] = [
  ...
  },
  {
    ...
    index: 8,
    code: "B2.9",
    titleDe: "Beziehungen und Psychologie",
    titleTr: "İnsan ilişkileri ve psikoloji",
    focus: [
      { de: "als ob + Konjunktiv II", tr: "sanki: gerçek olmayan benzetme" },
      { de: "subjektive Modalverben", tr: "dürfte / müsste / könnte" },
      { de: "Nebensatz mit indem", tr: "…, indem man …" },
      { de: "Konjunktiv II", tr: "An seiner Stelle hätte ich …" },
      { de: "zweiteilige Konnektoren", tr: "weder … noch / einerseits … andererseits" },
    ],
    canDo: [
      { de: "Ich kann beschreiben, wie sich etwas anfühlt.", tr: "Bir şeyin nasıl hissettirdiğini anlatabiliyorum.", en: "I can describe how something feels." },
      { de: "Ich kann Vermutungen abgestuft formulieren.", tr: "Tahminlerimi derecelendirerek kurabiliyorum.", en: "I can formulate assumptions with degrees of certainty." },
      { de: "Ich kann ein Missverständnis ansprechen und richtigstellen.", tr: "Bir yanlış anlamayı dile getirip düzeltebiliyorum.", en: "I can address and correct a misunderstanding." },
      { de: "Ich kann mich in die Lage anderer versetzen.", tr: "Kendimi başkasının yerine koyabiliyorum.", en: "I can put myself in someone else's position." },
      { de: "Ich kann fair streiten und Ich-Botschaften verwenden.", tr: "Adil tartışabiliyor ve ben dilini kullanabiliyorum.", en: "I can argue fairly and use I-statements." },
    ],
    listening: {
      title: "Das Gespräch danach",
      titleTr: "Sonraki konuşma",
    ...
    reading: {
      ...
      questions: [
        ...
        { de: "Wie bewertet der Text einen ausgefallenen Tag?", tr: "Metin atlanan bir günü nasıl değerlendiriyor?", options: ["Als Scheitern", "Als Grund aufzuhören", "Als normalen Teil des Wegs", "Als Zeichen von Faulheit"], answer: 2 },
      ],
    },
    speaking: [
      { situation: "Bir duyguyu benzetmeyle anlatıyorsun.", de: "Es fühlt sich an, als ob ich hier fremd wäre.", tr: "Sanki burada yabancıymışım gibi hissettiriyor." },
      { situation: "Kendini karşındakinin yerine koyuyorsun.", de: "An deiner Stelle hätte ich vermutlich genauso reagiert.", tr: "Senin yerinde olsam muhtemelen ben de aynı tepkiyi verirdim." },
    ],
    writing: {
      prompt: "Yanlış anlaşıldığın bir konuyu açıklığa kavuşturan kişisel bir mesaj yaz.",
      checklist: [
        "Neyi konuşmak istediğini baştan söyle",
        "Nasıl duyulduğunu benzetmeyle kabul et (Es klang, als ob …)",
        "Ne kastettiğini açıkla (Gemeint war …)",
        "Kendini karşındakinin yerine koy (An deiner Stelle …)",
        "Bir dahaki sefer için somut bir öneri bırak",
      ],
      minWords: 90,
      phrases: [
        ...
        { de: "Beim nächsten Mal würde ich vorschlagen, … zu …", tr: "Bir dahaki sefere …-mesini önerirdim", en: "Next time I would suggest …" },
      ],
      sample:
        "Liebe Nora,\n\nich möchte kurz auf gestern zurückkommen, weil mir das nicht aus dem Kopf geht.\n\nEs klang, als ob ich dich vor allen hätte bloßstellen wollen. Gemeint war aber etwas anderes: Ich wollte den Punkt klären und habe dabei völlig vergessen, wie das in der Runde ankommt. An deiner Stelle hätte ich vermutlich genauso reagiert.\n\nWeder Schweigen noch eine lange Diskussion vor allen hilft uns weiter. Beim nächsten Mal würde ich vorschlagen, solche Sachen vorher unter vier Augen zu klären — und wenn mir im Gespräch etwas auffällt, sage ich es als Ich-Botschaft.\n\nEs tut mir leid. Sag mir bitte, ob das für dich so passt.\n\nViele Grüße\nKai",
    },
  },

  {
    ...
    focus: [
      ...
      { de: "indirekte Frage", tr: "Mich würde interessieren, wie …" },
      { de: "Partizipialattribute", tr: "die von ihr geleistete Arbeit" },
      { de: "Passiv Perfekt und Plusquamperfekt", tr: "ist erreicht worden / nachdem … hatten" },
    ],
    canDo: [
    ...
    reading: {
      ...
      questions: [
        ...
        { de: "Was kündigt die Antwort an?", tr: "Cevap ne bildiriyor?", options: ["Eine Absage", "Ein überarbeitetes Angebot bis Freitag", "Einen Besuch vor Ort", "Eine Preiserhöhung"], answer: 1 },
      ],
    },
    speaking: [
      { situation: "Resmî bir bilgi talebi kuruyorsun.", de: "Könnten Sie uns mitteilen, ob die Lieferzeit auch bei größerer Menge gilt?", tr: "Teslim süresinin daha büyük miktarda da geçerli olup olmadığını bildirebilir misiniz?" },
      { situation: "Mülakatın sonunda soru soruyorsun.", de: "Mich würde interessieren, wie die Probezeit geregelt ist.", tr: "Deneme süresinin nasıl düzenlendiğini merak ediyorum." },
    ],
    writing: {
      prompt: "Bir firmaya fiyat ve koşulları soran resmî bir bilgi talebi yaz.",
      stimulus: "Betreff: Anfrage zu Preis, Lieferzeit und Leistungsumfang",
      checklist: [
        "Konu satırı ve resmî hitapla başla",
        "Neye atıf yaptığını yaz (Bezug nehmend auf …)",
        "En az iki soruyu dolaylı biçimde sor (…, ob … / …, welcher …)",
        "Eklerinden söz et (Anbei / als Anlage)",
        "Kibar bir kapanış ve süre belirt",
      ],
      minWords: 90,
      phrases: [
