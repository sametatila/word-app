...
export const EN_B2_EXAMS: ModuleExamPlan[] = [
  {
    ...
    focus: [
      ...
      { de: "Nominalization", tr: "tutanak dili: the assignment of the task" },
    ],
    canDo: [
    ...
    listening: {
      ...
      questions: [
        ...
        { de: "What is recorded in the minutes?", tr: "Tutanağa ne geçiriliyor?", options: ["The milestone is moved by two weeks", "The project is stopped", "The team is made larger", "The memo is canceled"], answer: 0 },
...

  {
    ...
    index: 1,
    code: "B2.2",
    titleDe: "Negotiating and complaining",
    ...
    focus: [
      ...
      { de: "Nominalization", tr: "resmî yazı dili: the reimbursement of the cost" },
    ],
    canDo: [
    ...
    listening: {
      ...
      turns: [
        ...
        { speaker: "Representative", de: "We should have acknowledged your letter earlier, and I apologize for that.", tr: "Yazınızı daha önce teyit etmemiz gerekirdi, bunun için özür dilerim." },
      ...
      questions: [
        ...
        { de: "What is the supplier's concession?", tr: "Tedarikçinin ödünü ne?", options: ["Reimbursing the transport cost", "Canceling the invoice", "Changing the threshold", "Paying the damages in full"], answer: 0 },
...

  {
    ...
    index: 2,
    code: "B2.3",
    titleDe: "The passive in all its forms",
    ...
    focus: [
      ...
      { de: "Nominalization", tr: "the treatment of the surface" },
    ...
    canDo: [
      ...
      { de: "I can say what must have caused a fault.", tr: "Bir arızaya neyin yol açmış olması gerektiğini söyleyebiliyorum.", en: "I can say what must have caused a fault." },
...

  {
    ...
    index: 4,
    code: "B2.5",
    titleDe: "Science and technology",
    ...
    focus: [
      ...
      { de: "Nominalization", tr: "the automation of the process" },
    ...
    listening: {
      ...
      turns: [
        ...
        { speaker: "Lecturer", de: "On balance the result is arguably provisional. By June the emissions will have been measured again.", tr: "Genel olarak bakıldığında sonuç geçici sayılabilir. Hazirana kadar salımlar yeniden ölçülmüş olacak." },
      ],
      questions: [
    ...
    speaking: [
      ...
      { situation: "Temkinli bir sonuç bildiriyorsun.", de: "On balance the result is arguably provisional and a second trial is required.", tr: "Genel olarak bakıldığında sonuç geçici sayılabilir ve ikinci bir deneme gerekiyor." },
    ],
    writing: {
      ...
      phrases: [
        ...
        { de: "On balance the result seems to be …", tr: "Genel olarak bakıldığında sonuç … görünüyor", en: "On balance the result seems to be …" },
      ],
      sample:
...

  {
    ...
    focus: [
      ...
      { de: "Nominalization", tr: "the measurement of inequality" },
    ...
    listening: {
      ...
      turns: [
        ...
        { speaker: "Researcher", de: "Apparently the claim is plausible, but on balance the figure is arguably questionable.", tr: "Görünüşe göre bu iddia makul ama genel olarak bakıldığında rakam kuşku uyandırıyor denebilir." },
      ...
      questions: [
        ...
        { de: "What was never funded in the new area?", tr: "Yeni alanda hiç fonlanmayan şey ne?", options: ["The green space", "The new school", "The residential blocks", "The measurement"], answer: 0 },
    ...
    reading: {
      ...
      titleTr: "Sıkıntının bedelini kim ödüyor?",
      genre: "Gazete yorumu",
    ...
    writing: {
      ...
      stimulus: "Rents are rising because people want to live in the center — the market will solve it.",
      checklist: [
...

  {
    ...
    listening: {
      ...
      turns: [
        ...
        { speaker: "Critic", de: "I would put it more moderately: entertaining, worth seeing, but not timeless.", tr: "Ben daha ölçülü söylerdim: eğlenceli, görülmeye değer ama kalıcı bir eser değil." },
      ],
      questions: [
    ...
    reading: {
      ...
      questions: [
        ...
        { de: "What is the critic's judgment of the last act?", tr: "Eleştirmenin son perde hakkındaki yargısı ne?", options: ["It seems to have been cut at short notice", "It was the strongest part", "It repeated the first act", "It was changed by the jury"], answer: 0 },
    ...
    speaking: [
      ...
      { situation: "Beğenmediğini incelikle söylüyorsun.", de: "I would put it with more moderation: entertaining, but arguably not timeless.", tr: "Daha ölçülü söylerdim: eğlenceli ama kalıcı bir eser sayılmaz." },
    ],
    writing: {
...

  {
    ...
    index: 7,
    code: "B2.8",
    titleDe: "Money and career strategy",
    titleTr: "Para ve kariyer stratejisi",
    focus: [
      { de: "Cleft sentences", tr: "What decides a career is …" },
      { de: "Nominalization", tr: "the preparation of the cost estimate" },
    ...
    listening: {
      ...
      turns: [
        ...
        { speaker: "Manager", de: "That is fair. Profitability is expected to fall, so a raise was refused for operational reasons.", tr: "Bu haklı. Kârlılığın düşmesi bekleniyor, bu yüzden zam işletme gerekçesiyle reddedildi." },
...

  {
    ...
    listening: {
      ...
      turns: [
        ...
        { speaker: "Mediator", de: "He must have failed to empathize rather than intended the distrust.", tr: "Güvensizliği kastetmekten çok, empati kurmayı başaramamış olmalı." },
        ...
        { speaker: "Colleague", de: "In essence, yes. On balance the choice of words is arguably the part we can still change.", tr: "Özünde evet. Genel olarak bakıldığında hâlâ değiştirebileceğimiz kısım belki de sözcük seçimi." },
      ],
      questions: [
        ...
        { de: "What does the mediator suggest about the other person?", tr: "Arabulucu öteki kişi hakkında ne söylüyor?", options: ["He failed to empathize rather than intended harm", "He planned the exclusion", "He never noticed the meeting", "He apologized in March"], answer: 0 },
    ...
    reading: {
      ...
      questions: [
        ...
        { de: "What is the point of “an impulsive colleague is not the same as an unforgiving one”?", tr: "„an impulsive colleague is not the same as an unforgiving one“ ne demek istiyor?", options: ["It separates a hasty reaction from lasting ill will", "It blames the colleague", "It excuses the exclusion", "It describes two teams"], answer: 0 },
      ],
    },
    speaking: [
      ...
      { situation: "Arabuluculuk yapıyorsun.", de: "He must have failed to empathize rather than intended the distrust.", tr: "Güvensizliği kastetmekten çok empati kurmayı başaramamış olmalı." },
    ],
    writing: {
...

  {
    ...
    focus: [
      ...
      { de: "Nominalization", tr: "the filing of the enclosure" },
