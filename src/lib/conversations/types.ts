...
export type ConversationIcon = (typeof CONVERSATION_ICONS)[number];
 ...
 */
export function scoredSteps(conversation: Conversation): number {
  return conversation.lecture.filter(
