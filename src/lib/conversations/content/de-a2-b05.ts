 ...
 * yerinde bırakıldı.
 */
export const deA2B05: Conversation[] = [
  {
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Sıra sende: 'Bu kelime nasıl telaffuz ediliyor?' nasıl dersin?")],
        expect: {
          kind: "produce",
    ...
    lecture: [
      {
        say: [
          tr(
            "Geçen Konuşma adımında sebep bildiren bir bağlaç öğrendin ve o fiili sona atıyordu. Bugünkü bağlaç aynı şeyi söylüyor ama söz dizimine hiç dokunmuyor. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      {
        say: [
          tr(
            "Fark tek cümlede: bugünkü bağlaçtan sonra cümle normal kurulur, fiil ikinci sırada kalır. Geçen Konuşma adımındaki bağlaçtan sonra ise fiil en sona giderdi. Anlam ikisinde de aynı; hangisini seçeceğin sana kalmış, ama seçtiğin an söz dizimi belli oluyor. Önce sekiz kelime.",
          ),
        ],
      },
      {
      ...
      {
        say: [tr("Sıra sende: 'Seninle arabayla gelebilir miyim?' nasıl dersin?")],
        expect: {
          kind: "produce",
          target: "Darf ich mitfahren",
          accept: ["Kann ich mitfahren"],
          hint: [
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bugünkü bağlaç, düşünme ve söyleme fiillerinden sonra gelir: sanıyorum ki, umuyorum ki, söylüyor ki. Türkçede 'ki' bağlacı vardır ama çoğu zaman hiç kullanılmaz; Almancada ise atlanabilse bile bu Konuşma adımı boyunca hep kuracağız, çünkü kural fiilin yerinde. Önce sekiz kelime.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Ich denke, dass wir darüber diskutieren müssen", "Ich meine, dass wir darüber diskutieren sollten", "Ich denke, dass wir darüber diskutieren sollten"],
          hint: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Ich unterstütze diesen Vorschlag auf jeden Fall"],
          hint: [
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Mesaj iletirken geçen Konuşma adımındaki bağlaç yine karşına çıkıyor: birine bir şey söyleyeceğini anlatırken yan cümle kuruluyor ve fiil sona gidiyor. Bu cümlede üç şey aynı anda oluyor: iletilen kişi yönelme hâlinde, bağlaç ortada, fiil sonda. Önce sekiz kelime.",
          ),
        ],
      },
      {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Was gibt es heute zu essen"],
          hint: [
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "schriftlich", tr: "yazılı olarak" },
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Kararlı niyet bildiren kip fiilini bu modülün ilk Konuşma adımında görmüştün. Burada onu bir tarihle birlikte kullanacağız. Bir de zamanla ilgili dört kelime öğreneceğiz; bunlar izin ve randevu konuşmalarının belkemiği. Önce sekiz kelime.",
          ),
        ],
      },
      {
      ...
      {
        say: [tr("Sıra sende: 'Yazılı olarak kaydolmam gerekiyor.' nasıl dersin?")],
        expect: {
          kind: "produce",
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Sıra sende: 'Doktor hastalığımın bulaşıcı olduğunu söyledi.' nasıl dersin?")],
        expect: {
          kind: "produce",
          target: "Der Arzt hat gesagt, dass es ansteckend ist",
          accept: ["Der Arzt hat gesagt, dass meine Krankheit ansteckend ist", "Die Ärztin hat gesagt, dass es ansteckend ist"],
          hint: [
            tr("Yan cümlede fiil en sona gider:"),
    ...
    chat: {
      scene:
        "Sabah hastalandın ve işe haber vermek için ofisi arıyorsun. Neyin olduğunu söyle, kaç gün gelemeyeceğini belirt ve belgeyi nasıl göndereceğini konuş.",
    ...
    lecture: [
      {
        say: [
          tr(
            "Modülün son Konuşma adımında yıllık değerlendirme görüşmesindeyiz. Burada hem geri bildirimi anlaman hem de kendi isteğini söylemen gerekiyor. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      {
        say: [
          tr(
            "Bu görüşmede sebep bildirmek merkezî: her değerlendirmenin arkasında bir gerekçe vardır ve seninkini de gerekçesiyle söylemen beklenir. Modülün ikinci Konuşma adımındaki bağlacı burada iş bağlamında kullanacağız. Önce sekiz kelime.",
          ),
        ],
      },
      {
