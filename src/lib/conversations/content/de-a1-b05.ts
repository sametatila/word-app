 ...
 * hepsi bu kuralın doğal geçtiği sahneler, o yüzden kural tek konuşmada
 * anlatılıp bırakılmıyor, on konuşmaya yayılıp her seferinde başka bir kelimeyle
 * karşımıza çıkıyor.
 *
 ...
 * Aynı birkaç eşya dolaşımda kaldığı için öğrenci her konuşmada yeni kelime
 * yığınıyla değil, tanıdık bir dünyada yeni bir kalıpla karşılaşıyor.
 */
export const deA1B05: Conversation[] = [
  {
    id: "de-a1-kleidung",
    icon: "shirt",
    level: "A1",
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Ich suche einen Pullover"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Welche Größe haben Sie"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Kann ich das anprobieren"), tr("de.")],
    ...
    lecture: [
      {
        say: [
          tr(
            "Bugün renkler var. Dört renk öğreneceğiz, bir şeyin rengini söylemeyi ve aynı ürünün başka rengini sormayı çalışacağız. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      {
        say: [
          tr(
            "Renkler alışverişte en çok işine yarayacak kelimelerden. İyi haber şu: bu konuşmada öğreneceğin biçimde renk kelimeleri hiç değişmiyor. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      {
        say: [tr("Lütfen"), de("Die Jacke ist rot"), tr("de.")],
      ...
      },
      {
        say: [
          tr(
            "Dört renk ve üç kalıp cebinde: rengi söyleyebiliyor, başkasını isteyebiliyorsun. Şimdi küçük bir butiktesin: vitrindeki gömleği beğendin ama rengi tam istediğin gibi değil.",
          ),
        ],
      },
    ],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Was kostet der Pullover"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Das ist zu teuer"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Das gefällt mir"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Wie findest du das"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Ich möchte die Hose umtauschen"), tr("de.")],
      ...
      },
      {
        say: [
          tr(
            "Sebep her zaman beden olmak zorunda değil. Bir önceki konuşmadaki kalıpla başka bir sebep söyle: 'Renk hoşuma gitmiyor.'",
          ),
        ],
        expect: {
          kind: "produce",
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bu konuşmada tek bir küçük kural var ve hediyenin kime olduğunu söylerken karşına çıkıyor. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      {
        say: [tr("Lütfen"), de("Können Sie es einpacken"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Was kosten die Äpfel"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Ich brauche eine Zahnpasta"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Wo finde ich die Seife"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Ich bestelle die Jacke online"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich lege die Jacke in den Warenkorb"), tr("de.")],
