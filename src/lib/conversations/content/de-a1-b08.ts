import { de, tr, type Conversation } from "../types";
 ...
 * bir parçayla; konuşma boyunca vurgu bu farkta.
 *
 ...
 */
export const deA1B08: Conversation[] = [
  {
    id: "de-a1-hobbys",
    icon: "sport",
    level: "A1",
    ...
    vocab: [
      ...
      { de: "basteln", tr: "el işi yapmak" },
          { de: "das Spiel", tr: "oyun" },
      { de: "mitmachen", tr: "katılmak" },
      { de: "der Verein", tr: "dernek" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bu konuşmada küçük bir kelime var ki bütün boş zaman konuşmalarının anahtarı. Türkçede 'severim' diye ayrı bir fiil kullanırız; Almancada fiile dokunmadan cümleye tek bir kelime eklenir. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "basteln" },
      },
      {
        say: [
        ...
        expect: { kind: "repeat", target: "das Spiel" },
      },
      {
        say: [
        ...
        expect: { kind: "repeat", target: "mitmachen" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "der Verein" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Mein Hobby ist Musik"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich spiele gern Fußball"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("In meiner Freizeit sammle ich Bücher"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "können" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "wollen" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "gewinnen" },
      },
      {
        say: [
          tr("İlk kalıbımız:"),
      ...
      {
        say: [tr("Lütfen"), de("Ich kann gut schwimmen"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich kann nicht so gut singen"), tr("de.")],
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "Tennis spielen", tr: "tenis oynamak" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bu konuşmada iki fiil ayrımı var: bazı sporlar 'yapılır', bazılarına 'gidilir'. Bir de sıklığı söylemenin kendine has bir sırası var. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "der Fußball" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "der Basketball" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "Tennis spielen" },
      },
      {
        say: [
          tr("İlk kalıbımız:"),
      ...
      {
        say: [tr("Lütfen"), de("Ich mache Sport im Fitnessstudio"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich gehe joggen"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich mache zweimal pro Woche Sport"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Önceki konuşmalarda severek yapmayı anlatan kelimeyi öğrenmiştin. Bugün onun bir arkadaşı var: iki şey arasında tercih yaparken kullanılan biçimi. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "die Band" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "das Klavier" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "die CD" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Ich höre gern Rockmusik"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich höre lieber Jazz"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich spiele Gitarre"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "das Theater" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "die Geschichte" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
      ...
      {
        say: [tr("Lütfen"), de("Gehen wir ins Kino"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Wann treffen wir uns"), tr("de.")],
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "wunderbar", tr: "muhteşem" },
      { de: "draußen", tr: "dışarıda" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bu konuşmada küçük ama şart olan bir kelime var. Türkçede 'Soğuk.' ya da 'Yağıyor.' tek başına bir cümle olabilir; Almancada özne boş kalamaz, o yüzden hava cümlelerine hazır bir özne konur. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "hoffentlich" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "wunderbar" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "draußen" },
      },
      {
        say: [
          tr("İlk kalıbımız:"),
      ...
      {
        say: [tr("Lütfen"), de("Es ist sonnig"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Es regnet"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Türkçede 'göl var' derken 'var' tek başına yeter. Almancada bunun için iki kelimelik hazır bir kalıp kullanılır ve arkasından gelen şey nesne sayılır. Bu ayrıntı konuşmanın can alıcı noktası. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "der Wald" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "der Fluss" },
      },
      {
        say: [
          tr("İlk kalıbımız:"),
      ...
      {
        say: [tr("Lütfen"), de("Es gibt einen See"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "die Insel" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Was kostet der Eintritt"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich kann nicht tief tauchen"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bu konuşma, severek yapmayı anlatan kelimeyi bir kez daha pekiştirecek; bu sefer izlemekle. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "das Radio" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "der Comic" },
      },
      {
        say: [
          tr("İlk kalıbımız:"),
          ...
          tr(
            "Yani 'Severek dizi izlerim'. Buradaki küçük kelime hobiler konuşmasındakiyle aynı; hangi fiile eklersen ekle 'severek yaparım' anlamını veriyor.",
          ),
        ],
      },
      {
        say: [tr("Lütfen"), de("Ich schaue gern Serien"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Auf welchem Kanal läuft das"), tr("de.")],
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "einverstanden sein", tr: "hemfikir olmak" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "einverstanden sein" },
      },
      {
        say: [
          tr("İlk kalıbımız:"),
          ...
          tr(
            "Yani 'Maalesef gelemiyorum'. Bunu randevu konuşmasından hatırlıyor olabilirsin; bugün asıl derinliğine iniyoruz. Cümleye üzüntü bildiren kelimeyle başladığın için fiil hemen arkasına geçti ve sen üçüncü sıraya düştün. Almancada fiil hep ikinci sırada durur, bu cümle bunun güzel bir örneği.",
          ),
        ],
      },
      {
        say: [tr("Lütfen"), de("Leider kann ich nicht"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Vielleicht nächste Woche"), tr("de.")],
