 ...
 */
export const deA2B09: Conversation[] = [
  {
    id: "de-a2-wenn",
    icon: "calendar",
    level: "A2",
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Geçen Konuşma adımında yan cümle baştaydı ve ana cümlenin sırası bozuluyordu. Yan cümle arkaya alınırsa ana cümle hiç değişmez; yalnız yan cümlenin kendi fiili sonda kalır. Yani sıra kayması yan cümlenin yerine bağlı. Önce sekiz kelime.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Schalte bitte auf einen anderen Sender um"],
          hint: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Sie kommt wahrscheinlich später"],
          hint: [
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bugünkü iki fiil de İngilizceden gelmiş ve Almanca çekime girmiş: sonlarına Almanca ekler alıyorlar ve ortaçları da Almanca kuralına göre kuruluyor. Bu, dilin yeni kelimeleri nasıl içine aldığını gösteren iyi bir örnek. Önce sekiz kelime.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Meine Schwester likt alle meine Bilder sofort"],
          hint: [
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Samimi hitapta emir kurmak kolay: fiilin 'sen' çekimi alınır, zamir ve sondaki 'st' düşürülür. Ayrılabilen bir fiilse ön ek cümlenin sonuna gider. Türkçede emir eki fiile yapışır; Almancada ön ek uzaklaşır. Önce sekiz kelime.",
          ),
        ],
      },
      {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Der Kuchen deiner Mutter war köstlich"],
          hint: [
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "der Link", tr: "link" },
      { de: "sich eintragen", tr: "listeye adını yazmak" },
    ...
    lecture: [
      {
        say: [
          tr(
            "Modülün son Konuşma adımında telefonsuz bir günü anlatıyoruz. Modülün başında öğrendiğin her şeyi burada bir deneyim anlatısında kullanacaksın. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Am Wochenende bleiben die Kinder lange auf"],
          hint: [
