 ...
 */
export const deA2B06: Conversation[] = [
  {
    id: "de-a2-komparativ",
    icon: "chart",
    level: "A2",
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Meine Schwester ist stärker als ich"],
          hint: [
    ...
    lecture: [
      {
        say: [
          tr(
            "Geçen Konuşma adımında iki şeyi karşılaştırdık. Bugün hepsinin arasından birini seçiyoruz ve bunun kendine has bir biçimi var. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      },
      {
        ...
        expect: {
          ...
          hint: [
            tr("'Olarak' anlamındaki kelime başta olduğu için özne fiilin arkasına düşer:"),
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [
          tr("Örnek: 'Bu ceket ötekinden daha rahat.' Almancası:"),
    ...
    lecture: [
      ...
      },
      {
        say: [
          ...
          tr(
            "Kişi yönelme hâlinde ve saç belirli artikelle duruyor. Türkçedeki 'saçımı' derken kullandığımız iyelik ekinin karşılığı bu ikili.",
          ),
        ],
      },
      {
        say: [tr("Sıra sende: 'Saçımı fönleyebilir misiniz?' nasıl dersin?")],
        expect: {
          kind: "produce",
          target: "Können Sie mir die Haare föhnen",
          hint: [
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bugünkü sıfatlardan dördü ortaçtan geliyor: bir fiilin ortacı zamanla sıfat olarak kullanılır hâle gelmiş. Hepsi 'bir şey olmuş, sonucu bu' anlamını taşıyor. Önce sekiz kelime.",
          ),
        ],
      },
      {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Ist der Router inklusive", "Ist der Router inbegriffen"],
          hint: [
    ...
    lecture: [
      {
        say: [
          tr(
            "Bugün bankadayız ve hesap açıyoruz. Almanya'da hayatın her adımı bir banka hesabına bağlı, bu yüzden bu Konuşma adımı çok işine yarayacak. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      {
        say: [
          tr("Örnek: 'Hesabım tasarruf bankasında.' Almancası:"),
    ...
    lecture: [
      {
        say: [
          tr(
            "Modülün son Konuşma adımında bit pazarındayız. Almanya'da pazarlık her yerde yapılmaz ama burada yapılır ve bunun kendine has kibar bir dili vardır. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
