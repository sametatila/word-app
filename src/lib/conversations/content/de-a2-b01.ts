 ...
 */
export const deA2B01: Conversation[] = [
  {
    id: "de-a2-urlaub",
    icon: "vacation",
    level: "A2",
    ...
    vocab: [
      ...
      { de: "hinfahren", tr: "oraya araçla gitmek" },
    ...
    lecture: [
      ...
      },
      {
        say: [
          ...
          de("Ich bin … verreist."),
          tr(
            "Yer değiştiren fiiller yardımcı olarak birinci fiili alır: gitmek, gelmek, yola çıkmak. Bugünkü fiillerden dördü bu gruptan.",
          ),
        ],
      },
      {
    ...
    lecture: [
      ...
      },
      {
        say: [
          ...
          tr("Bugünkü fiillerde ise sonu, ortadaki sesli harf ya da ikisi birden değişiyor:"),
      ...
      },
      {
        ...
        expect: {
          ...
          hint: [
            de("verbrennen"),
            tr("kuralsız bir fiil; ortacı düz değil, ortadaki sesli harf değişiyor:"),
      ...
      },
      {
        say: [
          ...
          tr("Aynı grup, başka bir fiil. Bu fiilin ortacında son düz kalıyor ama sesli harf değişiyor."),
        ],
      },
      {
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bugünkü fiillerin bir kısmı kuralsız ortaç kuruyor, bir kısmı da kendine has bir şey yapıyor: vurgusuz ön ekle başlayan fiiller ortacın hecesini hiç almıyor. Bunu üç kelimede birden göreceksin.",
          ),
        ],
      },
      {
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "İki fiil geçmişte genellikle Perfekt'e girmez: olmak ve sahip olmak. Onların kendi kısa geçmiş biçimleri vardır ve konuşmada en çok duyulan geçmiş budur. Bugün onları sekiz yeni kelimeyle çalıştıracağız.",
          ),
        ],
      },
      {
      ...
      },
      {
        say: [
          tr("Son bir doğru-yanlış alıştırması:"),
          de("Damals hatte ich sehr schüchtern."),
          tr("cümlesi doğru mu, yanlış mı?"),
        ],
        expect: {
          kind: "truefalse",
          statement: "Damals hatte ich sehr schüchtern.",
          answer: false,
          why: [
            tr(
              "Bir hâli ya da huyu anlatırken sahip olmak değil, olmak fiili kullanılır. Doğrusu:",
            ),
            de("Damals war ich sehr schüchtern."),
          ],
        },
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bir önceki Konuşma adımında olmak ve sahip olmak fiillerinin kısa geçmişini gördün. Şimdi onları olumsuzla birlikte kullanacağız: 'yoktu' demek, sahip olmak fiilinin geçmişi artı olumsuzluk demek. Önce sekiz kelime.",
          ),
        ],
      },
      {
      ...
      {
        say: [
          tr("İlk kalıbımız bu Konuşma adımına adını veriyor:"),
      ...
      {
        say: [
          tr("Örnek: 'Eskiden her şey eski modaydı.' Almancası:"),
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [
          tr("Örnek: 'Kulübe ilk gittiğimde çok gergindim.' Almancası:"),
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Ich habe meinen Führerschein gemacht"],
          hint: [
    ...
    chat: {
      ...
      opening: "Erzähl mal: Woran erinnerst du dich noch, wenn du an dein erstes Konzert oder deine erste Prüfung denkst?",
      openingTr: "Anlatsana: ilk konserini ya da ilk sınavını düşününce aklına ne geliyor?",
      goal: "Bir ilk deneyim, olay ve duygusuyla birlikte anlatılmış ve arkadaşın da kendi ilk deneyiminden söz etmiş olur.",
      minTurns: 8,
    },
  },
  {
    ...
    lecture: [
      {
        say: [
          tr(
            "Bugün iyi bir haber veriyoruz. İyi bir haberi hemen söylemek yerine önce merak uyandırabilirsin; Almancada bunun için kalıplaşmış bir cümle var. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
