 ...
 */
export const deA2B10: Conversation[] = [
  {
    id: "de-a2-buergeramt",
    icon: "office",
    level: "A2",
    ...
    lecture: [
      {
        say: [
          tr(
            "Bugün nüfus dairesindeyiz. Almanya'da taşındıktan sonra iki hafta içinde adres kaydı yaptırmak zorunludur ve bu Konuşma adımı o işi anlatıyor. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Meine Kollegin ist leider immer unpünktlich"],
          hint: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Schlagen Sie das Buch bitte auf Seite zwölf auf"],
          hint: [
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Katılmak fiili kendi edatını taşır ve o edat yönelme hâlini getirir; ayrıca ayrılabilen bir fiildir. Bir de gelecek zamanı bu Konuşma adımında bir kez daha çalışacağız: yardımcı fiil ikinci sırada, asıl fiil sonda. Önce sekiz kelime.",
          ),
        ],
      },
      {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Die neue Fahrerin ist noch sehr unerfahren"],
          hint: [
  ...
  },
  {
    ...
    patterns: [
      ...
      { de: "Den Müll sammelt man hier getrennt.", tr: "genel bir âdeti anlatır" },
    ],
    lecture: [
      {
        say: [
      ...
      },
      {
        say: [
          ...
          de("Den Müll sammelt man hier getrennt."),
  ...
  },
  {
    ...
    chat: {
      ...
      openingTr: "Yarın büyük gün. Gergin misin?",
    ...
    lecture: [
      {
        say: [
          tr(
            "Son Konuşma adımı. Bugün A2 boyunca öğrendiğin yolu kendi ağzından anlatacaksın. Bunun için gereken küçük ama önemli kelimeleri öğreneceğiz. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      {
        say: [
          tr(
            "Bir dönemi özetlerken birkaç küçük kelime işini görür: neredeyse, bile, hiç değilse, ayrıca. Bunlar cümlenin anlamını değil, tonunu taşır ve bir anlatıyı düz bir listeden değerlendirmeye çevirir. Almancada bu kelimelerin yeri sabittir ve yanlış yere konursa cümle tuhaf durur. Önce sekiz kelime.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Alle waren erstaunt über ihr gutes Deutsch"],
          hint: [
      ...
      },
      {
        say: [
          tr(
            "Ve bu, A2'nin son Konuşma adımıydı. Yüz Konuşma adımında geçmişi anlatmayı, yan cümle kurmayı, hâlleri ayırmayı ve günlük hayatın her sahnesinde konuşmayı öğrendin. Şimdi geriye bak ve neler yapabildiğini kendi cümlelerinle anlat.",
          ),
        ],
      },
    ],
