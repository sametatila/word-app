import { de, tr, type LectureStep, type Conversation } from "../types";
...
export const deB1B01: Conversation[] = [
  {
    id: "de-b1-bewerbung",
    icon: "job",
    level: "B1",
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "İş görüşmesinin iki temel sorusu var: neden ve ne zamandır. İkisine de bugün öğreneceğin kalıplarla cevap vereceksin. Önce kelimeler.",
          ),
        ],
      },
    ...
    lecture: [
      ...
      },
      {
        say: [
          ...
          tr("'Baskıya dayanıklıyım ve çok sabırlıyım' demek. Lütfen"),
          de("Ich bin sehr belastbar und geduldig"),
          tr("de."),
        ],
    ...
    lecture: [
      ...
      },
      {
        say: [
          ...
          tr("'İşe alışma süreci iki hafta sürüyor' demek. Lütfen"),
          de("Die Einarbeitung dauert zwei Wochen"),
          tr("de."),
        ],
    ...
    lecture: [
      ...
      },
      {
        say: [
          ...
          tr("'Zorunlu saatler dokuzdan üçe kadar' demek. Lütfen"),
          de("Die Kernzeit ist von neun bis fünfzehn Uhr"),
          tr("de."),
        ],
  ...
  },
  {
    ...
    summary: "Maaşı kibar biçimlerle konuşmayı öğretir; nezaketin dil bilgisini gösterir.",
    minutes: 10,
    ...
    lecture: [
      {
        say: [
          tr(
            "Bugün maaş konuşmasını öğreneceğiz. Burada nezaket bir ton meselesi değil, dil bilgisi meselesi: fiilin biçimi değişiyor ve cümle yumuşuyor. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      {
        say: [tr("Sıra sende: 'Bu mümkün olur mu?' demek için ne dersin?")],
        expect: {
          kind: "produce",
      ...
      },
      {
        say: [
          ...
          tr("'Bu konuda pazarlık yapabilir miyiz?' demek. Lütfen"),
          de("Können wir darüber verhandeln"),
          tr("de."),
        ],
  ...
  },
  {
    ...
    chat: {
      scene:
        "Bir arkadaşın başvurunun sonucunu soruyor ve ret geldi. Sürecin nasıl geçtiğini sırayla anlat, ne hissettiğini söyle ve bundan sonra ne yapacağını belirt.",
      ...
      goal: "Sürecin nasıl geçtiği anlatılmış, ne hissettiğin söylenmiş ve bundan sonraki adımın belirtilmiş olur.",
      minTurns: 9,
    },
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          ...
          tr("'İstifa yazılı olmak zorunda' demek. Lütfen"),
          de("Die Kündigung muss schriftlich sein"),
          tr("de."),
        ],
    ...
    lecture: [
      {
        say: [
          tr(
            "Bu, modülün son Konuşma adımı. Bugün tanımadığın biriyle iş konuşması başlatmayı öğreneceğiz. En işe yarayan şey soruyu izin isteyerek sormak. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
