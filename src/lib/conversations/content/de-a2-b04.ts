 ...
 */
export const deA2B04: Conversation[] = [
  {
    ...
    chat: {
      ...
      openingTr: "Pardon, bana kısa süreliğine bir şey ödünç verebilir misin?",
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Dieser Kopfhörer gehört meinem Nachbarn", "Der Kopfhörer gehört meiner Nachbarin", "Dieser Kopfhörer gehört meiner Nachbarin"],
          hint: [
    ...
    lecture: [
      {
        say: [
          tr(
            "Geçen Konuşma adımında NEREDE sorusunu çalıştık. Bugün NEREYE sorusunu çalışıyoruz ve hâl değişiyor. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Sıra sende: 'Oda bana fazla karanlık geliyor.' nasıl dersin?")],
        expect: {
          kind: "produce",
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Mein bester Freund wohnt nebenan"],
          hint: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Außerhalb des Zentrums kann man gut parken"],
          hint: [
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [
          tr("Örnek: 'Bana bir dakika yardım eder misin?' cümlesinin kibar hâli:"),
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bu Konuşma adımında iki hâl yan yana duruyor: kargoyu ALAN kişi yönelme hâlinde, kargonun KENDİSİ belirtme hâlinde. Bir de kimin adına aldığını söyleyen bir edat var ve o belirtme hâlini getiriyor. Önce sekiz kelime.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Der Postbote trägt die Pakete vormittags aus", "Der Postbote trägt die Pakete morgens aus"],
          hint: [
      ...
      },
      {
        say: [
          ...
          tr("Yan cümlede fiil en sona gidiyor; bu kuralı modül 5'te ayrıntılı çalışacağız."),
        ],
      },
      {
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Sıra sende: 'Geceleri biraz sessizliğe ihtiyacım var.' nasıl dersin?")],
        expect: {
          kind: "produce",
    ...
    lecture: [
      {
        say: [
          tr(
            "Modülün son Konuşma adımında evdeki arızaları konuşuyoruz. Neyin bozulduğunu doğru söylemek, tamircinin doğru aleti getirmesi demek. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      {
        say: [
          tr(
            "Arıza bildirirken iki kalıp yeter: neyin bozuk olduğunu söylemek ve birinin gönderilmesini istemek. İkincisinde iki nesne yan yana geliyor — bana ve birini — ve modül boyunca çalıştığın sıra burada da geçerli: kişi önce, nesne sonra. Önce sekiz kelime.",
          ),
        ],
      },
      {
      ...
      {
        say: [
          tr("Örnek: 'Mutfaktaki musluk arızalı.' Almancası:"),
