 ...
 */
export const deA1B01: Conversation[] = [
  {
    id: "de-a1-hallo",
    icon: "greet",
    level: "A1",
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Wie geht es dir"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Mir geht es gut"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich bin müde"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Und dir"), tr("de.")],
    ...
    chat: {
      ...
      goal: "İkiniz de birbirinizin hâlini sormuş ve cevaplamış, günün nasıl geçeceği üzerine birkaç söz etmiş olursunuz.",
      minTurns: 6,
    },
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Wie heißt du"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Wie heißen Sie"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Türkçede fiil cümlenin sonuna gelir: 'Sen nereden geliyorsun?' Almancada ise soru kelimesi en başta durur ve hemen arkasından fiil gelir. Bu sıra hiç bozulmaz. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      {
        say: [tr("Lütfen"), de("Woher kommst du"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Wo wohnst du"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Was ist das"), tr("de.")],
        expect: { kind: "repeat", target: "Was ist das" },
      },
      {
        say: [
          tr("Cevap vermek de kolay. Nereli olduğunu"),
          de("Ich komme aus der Türkei."),
          tr("diye, nerede oturduğunu"),
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Sprichst du Deutsch"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Nein, aber ich lerne Deutsch"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("İlk beşini benimle söyle. Lütfen"), de("eins zwei drei vier fünf"), tr("de.")],
        expect: { kind: "repeat", target: "eins zwei drei vier fünf" },
      },
      {
        say: [tr("Şimdi kalan beşi. Lütfen"), de("sechs sieben acht neun zehn"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("einundzwanzig"), tr("de.")],
      ...
      },
      {
        say: [
          ...
          de("Meine Nummer ist …"),
          tr(
            "Telefon numaranı söylerken kullanılır. Rakamları tek tek de söyleyebilirsin, ama Almanlar numarayı çoğu zaman ikişerli gruplar hâlinde söyler.",
          ),
        ],
      },
      {
        say: [tr("Lütfen"), de("Meine Nummer ist siebzehn achtundzwanzig"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Wie viel kostet das"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("En zorlarını birlikte söyleyelim. Lütfen"), de("Ypsilon Zett Eszett"), tr("de.")],
      ...
      },
      {
        say: [
          ...
          de("man"),
          tr(
            "belli bir kişiyi göstermez, 'herkes' demektir; Türkçedeki 'yazılır' sözcüğündeki edilgen ekin işini görür.",
          ),
        ],
      },
      {
        say: [tr("Lütfen"), de("Wie schreibt man das"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Buchstabieren Sie bitte"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Ich bin Lehrer von Beruf"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich arbeite als Verkäuferin"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich arbeite bei Siemens"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Ich bin dreißig Jahre alt"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Wie alt bist du"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich bin in Izmir geboren"), tr("de.")],
      ...
      },
      {
        say: [
          tr(
            "Artık yaşını ve nerede doğduğunu anlatabilirsin. Şimdi bir doğum günü partisindesin ve orada yeni biriyle tanışıyorsun.",
          ),
        ],
      },
    ],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Wie ist Ihr Name"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Meine Adresse ist Gartenstraße acht"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Meine Postleitzahl ist eins null neun neun neun"), tr("de.")],
        expect: {
          kind: "repeat",
      ...
      {
        say: [tr("Lütfen"), de("Unterschreiben Sie hier bitte"), tr("de.")],
