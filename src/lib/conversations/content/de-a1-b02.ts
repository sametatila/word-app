 ...
 * cümlelere yayıyor.
 */
export const deA1B02: Conversation[] = [
  {
    id: "de-a1-familie",
    icon: "family",
    level: "A1",
    ...
    vocab: [
      ...
      { de: "die Ehefrau", tr: "eş" },
      { de: "der Ehemann", tr: "koca" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "die Ehefrau" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "der Ehemann" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Das ist mein Vater"), tr("de.")],
      ...
      },
      {
        say: [
          ...
          tr(
            "Yani 'İki çocuğum var.' Almancada 'çocuğum var' gibi cümleler 'var' ile değil, 'sahip olmak' fiiliyle kurulur.",
          ),
        ],
      },
      {
        say: [tr("Lütfen"), de("Ich habe zwei Kinder"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "beide" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Ich habe einen Bruder"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Hast du Geschwister"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Nein, ich habe keine Geschwister"), tr("de.")],
      ...
      },
      {
        say: [
          tr(
            "Bu kural bundan sonra sık sık karşına çıkacak. Şimdi kahve molasındasın ve iş arkadaşın kardeşlerinden söz ediyor.",
          ),
        ],
      },
    ],
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "nichts", tr: "hiçbir şey" },
      { de: "niemand", tr: "hiç kimse" },
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "nichts" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "niemand" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "die Entschuldigung" },
      },
      {
        say: [
          tr("Şimdi kalıbımız:"),
      ...
      {
        say: [tr("Lütfen"), de("Ich habe keine Zeit"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich habe keinen Bruder"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Kein Problem"), tr("de.")],
        expect: { kind: "repeat", target: "Kein Problem" },
      },
      {
        say: [tr("Şimdi de"), de("Keine Ahnung"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "das Tier" },
      },
      {
        say: [
          tr("İkinci kelimemiz:"),
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "der Fisch" },
      },
      {
        say: [
          tr("Beşinci kelimemiz:"),
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "das Pferd" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "der Ball" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "lieben" },
      },
      {
        say: [
          tr("Şimdi ilk kalıbımız:"),
      ...
      {
        say: [tr("Lütfen"), de("Ich habe einen Hund"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Er heißt Rocky"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Sie ist drei Jahre alt"), tr("de.")],
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "das Bild", tr: "resim" },
      { de: "der Großvater", tr: "büyükbaba" },
      { de: "der Verwandte", tr: "akraba" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "die Großmutter" },
      },
      {
        say: [
          tr("Altıncı kelimemiz:"),
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "der Großvater" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "der Verwandte" },
      },
      {
        say: [
          tr("Şimdi ilk kalıbımız:"),
      ...
      {
        say: [tr("Lütfen"), de("Wer ist das auf dem Foto"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Das ist unser Opa"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Das ist ihre Tante"), tr("de.")],
        expect: { kind: "repeat", target: "Das ist ihre Tante" },
      },
      {
        say: [tr("Şimdi sen söyle; yine bir kadından söz ediyorsun: 'Bu onun oğlu.'")],
        expect: {
          kind: "produce",
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "das Auge" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "der Fuß" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "die Tür" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Ich habe zwei Bücher"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Hier sind viele Leute"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("ein paar Kinder"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "das Haar" },
      },
      {
        say: [
          tr("Dördüncü kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "aussehen" },
      },
      {
        say: [
          tr("Beşinci kelimemiz:"),
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "hübsch" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
      ...
      {
        say: [tr("Lütfen"), de("Er ist groß"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Sie hat braune Haare"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Er trägt eine Brille"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "kennen" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "kennenlernen" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "sympathisch" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Er wohnt in Berlin"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Er arbeitet bei Aldi"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Wir treffen uns oft"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "richtig" },
      },
      {
        say: [
          tr("Dördüncü kelimemiz:"),
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "wirklich" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "der Quatsch" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Ich verstehe nicht"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Das stimmt nicht"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich schreibe nicht so gern"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Langsam, bitte"), tr("de.")],
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "die Süßigkeiten", tr: "şekerlemeler" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "die Süßigkeiten" },
      },
      {
        say: [
          tr("Şimdi ilk kalıbımız:"),
      ...
      {
        say: [tr("Lütfen"), de("Wer kommt zum Fest"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Meine Tante bringt einen Kuchen"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Wir feiern zusammen"), tr("de.")],
      ...
      },
      {
        say: [
          tr(
            "Bu modülü bitirdin: artık aileni tanıtabilir, kimin ne yaptığını anlatabilir ve gerektiğinde hayır diyebilirsin. Şimdi kuzeninle aile buluşmasını planlıyorsun.",
          ),
        ],
      },
    ],
