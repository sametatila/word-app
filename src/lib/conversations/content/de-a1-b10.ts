 ...
 * kullanıldığı iki anlatım konuşması. Modül — ve A1 — öğrencinin ne öğrendiğini
 * kendi cümleleriyle anlattığı bir konuşmayla kapanıyor; o konuşma da yeni geçmiş
 * zamanı kullanıyor.
 */
export const deA1B10: Conversation[] = [
  {
    ...
    vocab: [
      ...
      { de: "falsch", tr: "yanlış" },
          { de: "das Telefon", tr: "telefon" },
      { de: "die Vorwahl", tr: "alan kodu" },
      { de: "das Wiederhören", tr: "hoşça kalın" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "das Telefon" },
      },
      {
        say: [
        ...
        expect: { kind: "repeat", target: "die Vorwahl" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "das Wiederhören" },
      },
      {
        say: [
          tr("İlk kalıbımız:"),
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "der Brief" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "die E-Mail" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "die Anrede" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "wissen" },
      },
      {
        say: [
      ...
      },
      {
        say: [
          ...
          tr("'Randevuyu erteleyebilir miyiz?' demek. Lütfen"),
          de("Können wir den Termin verschieben"),
          tr("de."),
        ],
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "die Party", tr: "parti" },
          { de: "der Partner", tr: "partner" },
      { de: "die Partnerin", tr: "kadın partner" },
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "der Partner" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "die Partnerin" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "gehört", tr: "duymak / dinlemek fiilinin geçmiş biçimi" },
          { de: "erzählen", tr: "anlatmak" },
      { de: "denken", tr: "düşünmek" },
      { de: "die Welt", tr: "dünya" },
],
    patterns: [
    ...
    lecture: [
      ...
      {
        say: [
          tr("Beşinci kelimemiz 'duymak, dinlemek' fiilinin geçmiş biçimi:"),
          de("gehört"),
          tr("Lütfen"),
          de("gehört"),
          tr("de."),
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "erzählen" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "die Welt" },
      },
      {
        say: [
          tr(
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "wohin", tr: "nereye" },
          { de: "fliegen", tr: "uçmak" },
      { de: "das Flugzeug", tr: "uçak" },
      { de: "das Schiff", tr: "gemi" },
],
    patterns: [
    ...
    lecture: [
      {
        say: [
          tr(
            "Bir önceki konuşmada geçmiş zamanı kurduk. Bugün küçük ama önemli bir istisna var: bazı fiiller başka bir yardımcı fiil alıyor. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "fliegen" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "das Flugzeug" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "das Schiff" },
      },
      {
        say: [
          tr(
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "die Hausaufgabe", tr: "ev ödevi" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "die Hausaufgabe" },
      },
      {
        say: [
          tr(
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "das Hotel" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "übernachten" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "reisen" },
      },
      {
        say: [
          tr(
      ...
      {
        say: [tr("Sıra sende: 'Pazar günü ailemi ziyaret ettim.' demek için ne dersin?")],
        expect: {
          kind: "produce",
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "lange", tr: "uzun süre" },
      { de: "gemütlich", tr: "huzurlu" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "lange" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
    ...
    lecture: [
      {
        say: [
          tr(
            "Bu, A1'in son konuşması. Bugün yeni bir kural yok; öğrendiklerini anlatmayı öğreneceğiz. Geçmiş zamanı kendi hikâyen için kullanacaksın. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      {
        say: [
          tr(
            "Bir dili öğrenirken en çok unutulan şey ne kadar yol alındığı. Bu konuşma tam olarak onu söylemek için. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "der Test" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
      ...
      },
      {
        say: [
          ...
          tr("'Bundan sonra devam etmek istiyorum' demek. Lütfen"),
          de("Als Nächstes möchte ich weitermachen"),
          tr("de."),
        ],
