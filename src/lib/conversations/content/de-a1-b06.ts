 ...
 * geziliyor ve en sonunda danışmaya dönülüyor. Bir konuşmanın sahnesi bir
 * sonrakinin başlangıcı olduğu için kelimeler kendiliğinden tekrar ediyor.
 */
export const deA1B06: Conversation[] = [
  {
    id: "de-a1-weg",
    icon: "city",
    level: "A1",
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "fragen" },
      },
      {
        say: [
        ...
        expect: { kind: "repeat", target: "die Frage" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
      ...
      {
        say: [tr("Lütfen"), de("Entschuldigung, wo ist der Bahnhof"), tr("de.")],
      ...
      },
      {
        say: [
          ...
          tr(
            "Yani 'Dosdoğru gidin'. Türkçede emir ekini fiile yapıştırırız, 'gidin' deriz ve kime söylediğimiz ekten bellidir. Almancada ise fiil cümlenin başına fırlar ve hemen arkasına 'siz' konur. Kibar emirde kişi hiç atlanmaz.",
          ),
        ],
      },
      {
        say: [tr("Lütfen"), de("Gehen Sie geradeaus"), tr("de.")],
      ...
      },
      {
        ...
        expect: {
          ...
          answer: false,
          why: [
            tr("Almancada kibar emirde kişi düşmez; fiilin hemen arkasına 'siz' gelmeli. Doğrusu:"),
            de("Gehen Sie geradeaus."),
          ],
        },
      },
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Almanya'da toplu taşıma dakikası dakikasına işler, o yüzden herkes hangi araçla gittiğini net söyler. Bunun için tek bir küçük kelime var ve o kelime bu konuşmanın kalbi. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "die Bahn" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "die S-Bahn" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "die Straßenbahn" },
      },
      {
        say: [
          tr("İlk kalıbımız:"),
      ...
      {
        say: [tr("Lütfen"), de("Ich fahre mit dem Bus"), tr("de.")],
      ...
      },
      {
        say: [
          ...
          tr("Cevap çoğu zaman bir önceki konuşmadaki gibi gelir:"),
      ...
      {
        say: [tr("Lütfen"), de("Welche Linie fährt zum Bahnhof"), tr("de.")],
      ...
      },
      {
        ...
        expect: {
          ...
          answer: false,
          why: [
            tr("Araç bildiren edattan sonra artikel değişir; dişil kelimelerde die, der olur. Doğrusu:"),
            de("Ich fahre mit der U-Bahn."),
          ],
        },
      },
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "das Ticket" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "gültig" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
      ...
      {
        say: [tr("Lütfen"), de("Einmal nach Berlin, bitte"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich möchte eine Fahrkarte nach Berlin"), tr("de.")],
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "der Abflug", tr: "uçağın kalkışı" },
      { de: "der Anschluss", tr: "aktarma" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Almanya'da trenlerin dakikliği meşhurdur ama gecikince de herkes aynı iki kelimeyi kullanır. Bu konuşmada asıl mesele küçük bir fiil seçimi. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "die Ankunft" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
      ...
      {
        say: [tr("Lütfen"), de("Der Zug hat Verspätung"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Wann kommt der Zug"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Takside konuşma iki cümleden ibarettir: nereye ve ne kadar sürer. Bir de inerken söylenen iki kelimelik bir kalıp var. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "das Auto" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "die Autobahn" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "einsteigen" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Zum Flughafen, bitte"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Wie lange dauert es"), tr("de.")],
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "daneben", tr: "yanında" },
      { de: "laufen", tr: "yürümek" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "die Mitte" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "daneben" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "laufen" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Ist das weit"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Das Museum ist in der Nähe"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bu konuşmada küçük ama çok kullanışlı bir kelime var: herkesi birden anlatan bir özne. Türkçede o özneyi hiç söylemeyiz, Almancada söylemek zorundayız. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "die Sehenswürdigkeit" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "überall" },
      },
      {
        say: [
          tr("İlk kalıbımız:"),
      ...
      {
        say: [tr("Lütfen"), de("Was kann man hier sehen"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bu konuşmada bir cümleyi olduğu gibi ezberleyeceğiz: kaybolduğunu söyleyen cümle. İçindeki zaman kuralını ileride ayrıca göreceğiz, şimdilik hazır bir kalıp olarak kullan. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "hinten" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "oben" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "unten" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Ich habe mich verlaufen"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Biegen Sie an der Ampel rechts ab"), tr("de.")],
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "Rad fahren", tr: "bisiklete binmek" },
      { de: "die Vorsicht", tr: "dikkat" },
      { de: "erlauben", tr: "izin vermek" },
],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "Rad fahren" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "die Vorsicht" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "erlauben" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Ich fahre mit dem Fahrrad"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich möchte ein Fahrrad leihen"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bu konuşmanın bütün cümleleri soru. Almancada soru iki türlü kurulur ve ikisini de bugün göreceksin: soru kelimesiyle başlayanlar ve doğrudan fiille başlayanlar. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        expect: { kind: "repeat", target: "der Bahnsteig" },
      },
      {
        say: [
          tr("Yedinci kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "die Durchsage" },
      },
      {
        say: [
          tr("Son kelimemiz:"),
        ...
        expect: { kind: "repeat", target: "der Ausgang" },
      },
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Wann fährt der Zug nach Berlin"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Muss ich umsteigen"), tr("de.")],
