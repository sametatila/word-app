 ...
 */
export const deA2B02: Conversation[] = [
  {
    id: "de-a2-lebensweg",
    icon: "culture",
    level: "A2",
    ...
    lecture: [
      ...
      {
        say: [tr("Sıra sende: 'Hiç Almanca bilgim yoktu.' nasıl dersin?")],
        expect: {
          kind: "produce",
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Kip fiilleri geçmişte genellikle Perfekt'e girmez; olmak ve sahip olmak gibi kendi kısa biçimlerini kullanır. İstemek, yapabilmek ve zorunda olmak fiillerinin geçmişleri şöyle:",
          ),
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [
          tr("Geçen Konuşma adımında üç kip fiilinin geçmişini gördün. Bugün dördüncüsü geliyor: izin fiilinin geçmişi."),
          de("durfte"),
          tr(
    ...
    lecture: [
      {
        say: [
          tr(
            "Bugün bir taşınmayı anlatıyoruz. Taşınmak herkesin başına gelir ve bu hikâye her sohbette işe yarar. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Ich habe die Kartons in die Garage geschleppt"],
          hint: [
  ...
  },
  {
    ...
    titleTr: "Değişimler",
    summary: "Nelerin değiştiğini ve neleri hatırladığını anlatmayı öğretir.",
    minutes: 10,
    focusId: "Reflexivverben",
    vocab: [
      ...
      { de: "unzufrieden", tr: "memnun olmayan" },
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Ich möchte den Job wechseln", "Ich möchte meine Stelle wechseln", "Ich möchte die Arbeit wechseln"],
          hint: [
  ...
  },
  {
    ...
    summary: "Çocukluk anılarını anlatmayı öğretir: orası nasıldı, ne vardı, kim nasıldı.",
    minutes: 10,
    focusId: "Präteritum-sein-haben",
    vocab: [
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "auslachen", tr: "birine gülmek / alay etmek" },
      { de: "komisch", tr: "tuhaf" },
    ],
    patterns: [
    ...
    lecture: [
      ...
      {
        say: [tr("Sıra sende: 'Bu benim için gerçekten utanç vericiydi.' nasıl dersin?")],
        expect: {
          kind: "produce",
          target: "Das war mir wirklich peinlich",
          accept: ["Das war mir so peinlich", "Das war mir sehr peinlich"],
          hint: [
            tr("Duyguyu yaşayan kişi yönelme hâlinde durur:"),
            de("Das war mir wirklich peinlich."),
            tr("Tekrar dene."),
          ],
        },
      },
      ...
      {
        say: [tr("Sıra sende: 'Sonunda her şeyi itiraf ettim.' nasıl dersin?")],
        expect: {
          kind: "produce",
    ...
    lecture: [
      {
        say: [
          tr(
            "Modülün son Konuşma adımında başardığın bir şeyi anlatıyoruz. Bir başarı hikâyesi üç parçadan oluşur: emek, zorluk ve sonuç. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Ich habe es mehrmals versucht", "Ich habe es viele Male versucht"],
          hint: [
            de("versuchen"),
