 ...
 */
export const deA2B07: Conversation[] = [
  {
    id: "de-a2-reiseplan",
    icon: "map",
    level: "A2",
    ...
    vocab: [
      ...
      { de: "wegfahren", tr: "yola çıkıp gitmek" },
    ],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Türkçede her yere aynı ekle gideriz: denize, dağlara, şehre. Almancada ayrı edatlar var: denize ve dağlara giderken kullanılanlar belirtme hâlini getiriyor, çünkü hareket söz konusu. Şehir ve ülke adları ise kendi edatını alıyor. Bunu bu modül boyunca göreceğiz. Önce sekiz kelime.",
          ),
        ],
      },
      {
  ...
  },
  {
    ...
    lecture: [
      {
        say: [
          tr(
            "Bugün bavul hazırlıyoruz. Ayrılabilen fiiller bu Konuşma adımında bir kez daha karşına çıkacak, bu kez soru cümlesinde. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
    ...
    chat: {
      scene:
        "Yarın tatile çıkıyorsunuz ve bavulları hazırlıyorsunuz. Yol arkadaşın neyin alındığını soruyor; sen de neyin unutulduğunu hatırlatıyorsun.",
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "die Tour", tr: "tur" },
      { de: "bummeln", tr: "oyalanarak dolaşmak" },
    ],
    patterns: [
    ...
    lecture: [
      ...
      },
      {
        say: [
          ...
          tr(
            "Yaş söylerken sayı, zaman birimi ve sıfat bu sırayla gelir; sıfat en sonda durur ve hiç ek almaz.",
          ),
        ],
      },
      {
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Der Verkäufer hat mir das Wechselgeld gegeben"],
          hint: [
    ...
    lecture: [
      {
        say: [
          tr(
            "Modülün son Konuşma adımında yolculuk aksadı. Uçuş iptal oldu ve trenle devam ediyorsunuz. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
