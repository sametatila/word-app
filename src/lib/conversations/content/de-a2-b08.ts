 ...
 */
export const deA2B08: Conversation[] = [
  {
    id: "de-a2-geburtstag",
    icon: "cake",
    level: "A2",
    ...
    vocab: [
      ...
      { de: "naschen", tr: "tatlı atıştırmak" },
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Meine Schwester und ich sind Zwillinge"],
          hint: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Ich bringe der Gastgeberin einen Blumenstrauß mit"],
          hint: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Sie schenkt ihrer Freundin rote Rosen"],
          hint: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Meine beste Freundin ist meine Trauzeugin"],
          hint: [
      ...
      {
        say: [tr("Sıra sende: 'Bence tören çok ağırbaşlıydı.' nasıl dersin?")],
        expect: {
          kind: "produce",
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Dieses Jahr steht der Weihnachtsbaum im Wohnzimmer"],
          hint: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Am Wochenende gibt es in der Stadt ein Festival"],
          hint: [
    ...
    lecture: [
      {
        say: [
          tr(
            "Bugün bir daveti reddediyoruz. Almanya'da reddetmek kaba sayılmaz ama sebebini söylemek beklenir. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Treffen wir uns stattdessen nächste Woche", "Lass uns stattdessen nächste Woche treffen"],
          hint: [
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          accept: ["Sie hat das Glas nicht absichtlich kaputt gemacht", "Er hat das Glas nicht absichtlich zerbrochen"],
          hint: [
    ...
    lecture: [
      {
        say: [
          tr(
            "Modülün son Konuşma adımında yeni yıl kararlarını konuşuyoruz. Kararlı niyet bildiren kip fiili burada tekrar karşına çıkıyor. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      },
      {
        ...
        expect: {
          ...
          answer: false,
          why: [
            tr("Zaman ifadesi belirtme hâline girer, yönelme hâline değil. Doğrusu:"),
            de("Ich will dieses Jahr mehr Sport machen."),
          ],
        },
      },
