 ...
 */
export const deA1B09: Conversation[] = [
  {
    id: "de-a1-koerper",
    icon: "doctor",
    level: "A1",
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Bugün aynı zamanda bir alışkanlık kuracağız. Türkçede 'baş' dersin ve iş biter; Almancada kelimenin önündeki küçük kelime kelimenin bir parçasıdır. Onsuz öğrenilen kelime yarım öğrenilmiştir. Bugünkü beş vücut kelimesinde üç artikelin üçü de var, tam bir alıştırma. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      },
      {
        say: [
          ...
          de("Das ist der Arm."),
          tr("Bir şeyi gösterip adlandırırken artikel olduğu gibi kalır. Üç artikelin üçü de bu konuşmada var:"),
          de("der Kopf"),
          tr("eril,"),
          de("das Bein"),
          tr("nötr,"),
      ...
      {
        say: [tr("Lütfen"), de("Das ist der Arm"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich habe zwei Arme"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Wie heißt das auf Deutsch"), tr("de.")],
        expect: { kind: "repeat", target: "Wie heißt das auf Deutsch" },
      },
      {
        say: [
          tr("Küçük bir tavsiye: kelimeyi asla yalnız ezberleme, yani"),
          de("Kopf"),
          tr("değil,"),
          de("der Kopf"),
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Mein Kopf tut weh"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Mir tut der Rücken weh"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich habe seit gestern Schmerzen"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Türkçede 'çarşamba günü saat onda' dersin; Almancada ise gün için bir edat, saat için başka bir edat var ve yerlerini değiştirmek cümleyi bozar. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      {
        say: [tr("Lütfen"), de("Ich brauche einen Termin"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Geht es am Mittwoch"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Kommen Sie um zehn Uhr"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Bitte warten Sie einen Moment"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Ich muss arbeiten"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Du musst zum Arzt"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich bin krank und habe Fieber"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Musst du arbeiten"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Nehmen Sie die Tabletten"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("dreimal täglich vor dem Essen"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Haben Sie ein Rezept"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Ich bin krank und habe eine Erkältung"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich komme heute nicht"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Ich bleibe heute im Bett"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Gute Besserung"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Trink viel Wasser"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Bleib im Bett"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Mach dir keine Sorgen"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      {
        say: [
          tr(
            "Selam! Bugünkü konuşma umarım hiç işine yaramaz ama gerektiğinde saniyeler değerlidir. Acil durumda söylenecek cümleleri öğreneceğiz. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      {
        say: [tr("Lütfen"), de("Rufen Sie den Notarzt"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Bleiben Sie ruhig"), tr("de.")],
    ...
    chat: {
      ...
      openingTr: "Acil çağrı bir bir iki, iyi günler. Neredesiniz?",
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Man muss gesund essen"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Man muss mehr Obst essen"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Rauchen ist nicht gesund"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Das ist sehr wichtig"), tr("de.")],
    ...
    lecture: [
      {
        say: [
          tr(
            "Merhaba! Bu modülün son konuşmasındayız ve en korkulan koltuğa oturuyoruz: diş hekimi. Öğrendiğin ağrı kalıbı bugün gerçek bir sahnede işe yarayacak. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      {
        say: [tr("Lütfen"), de("Mir tut der Zahn weh"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Bitte den Mund öffnen"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Es zieht ein bisschen"), tr("de.")],
