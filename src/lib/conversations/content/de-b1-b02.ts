...
export const deB1B02: Conversation[] = [
  {
    id: "de-b1-wohnung",
    icon: "home",
    level: "B1",
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Bir tane daha: 'Çatının yeni olup olmadığını bilmek isterdim.' demek için ne dersin?")],
        expect: {
          kind: "produce",
    ...
    lecture: [
      ...
      },
      {
        say: [
          ...
          tr("'Sözleşme üç aylık ihbar süresiyle feshedilebilir' demek. Lütfen"),
          de("Man kann mit einer Frist von drei Monaten kündigen"),
          tr("de."),
        ],
        expect: {
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [
          tr("Örnek: 'Kaloriferin onarılması gerekiyor.' Almancası:"),
    ...
    lecture: [
      {
        say: [
          tr(
            "Bu, modülün son Konuşma adımı. Bugün geçici kiralamayı konuşacağız — Almanya'da öğrenciler ve yeni gelenler için çok yaygın bir yol. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
