 ...
 * sonra olumsuzu (keinen). Sarmal tekrar için önceki konuşmaların kelimeleri
 * (Kaffee, Tee, Wasser, Rechnung) örneklerde bilerek geri geliyor.
 */
export const deA1B03: Conversation[] = [
  {
    id: "de-a1-cafe",
    icon: "cafe",
    level: "A1",
    ...
    lecture: [
      ...
      {
        say: [
          tr("Bir püf noktası: sipariş verirken eril kelimelerde"),
          de("ein"),
          tr("değil"),
          de("einen"),
          tr("denir."),
      ...
      {
        say: [tr("Lütfen"), de("Ich möchte einen Kaffee"), tr("de.")],
  ...
  },
  {
    ...
    patterns: [
      ...
      { de: "… zum Frühstück", tr: "'kahvaltıda' diye eklerken kullanılır" },
    ],
    lecture: [
      {
        say: [
      ...
      {
        say: [tr("Lütfen"), de("Ich esse Käse zum Frühstück"), tr("de.")],
    ...
    lecture: [
      ...
      },
      {
        say: [
          ...
          de("die Pommes"),
          tr(
            "her zaman çoğuldur; Türkçede 'patates kızartması' tekil olsa da Almancada bu kelime çoğul. Çoğul bir şeyin fiyatını sorarken fiil de çoğula uyar ve",
          ),
          de("kosten"),
          tr("olur."),
        ],
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Restoranda ton büfedekinden biraz daha resmîdir: kısa emirler yerine tam cümle kurarsın. Önce kelimeleri öğrenelim.",
          ),
        ],
      },
      {
      ...
      {
        say: [tr("Lütfen"), de("Ich möchte bezahlen"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("Zusammen, bitte"), tr("de.")],
    ...
    lecture: [
      ...
      },
      {
        say: [
          ...
          de("Ich brauche …"),
          tr(
            "Yani '… lazım'. Türkçede bunu 'lazım' ya da 'ihtiyacım var' diye söylersin; Almancada ise tek bir fiil bütün işi görür.",
          ),
        ],
      },
      {
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("ein Kilo Tomaten"), tr("de.")],
      ...
      {
        say: [tr("Lütfen"), de("zwei Kilo Tomaten"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Ich esse kein Fleisch"), tr("de.")],
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [tr("Lütfen"), de("Das schmeckt sehr gut"), tr("de.")],
