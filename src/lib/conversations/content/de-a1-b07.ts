 ...
 * ev işleri, taşınma, balkon ve arıza bildirme. Her konuşma öncekilerin
 * kelimelerini yeniden kullanıyor.
 */
export const deA1B07: Conversation[] = [
  {
    ...
    vocab: [
      ...
      { de: "das Haus", tr: "bina / müstakil ev" },
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr("İkinci kalıbımız:"),
          de("Die Wohnung hat …"),
          tr("'Evin … var' demek. Örnek: 'Evin üç odası var.'"),
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          hint: [
            tr("Hareket varsa edattan sonra Dativ değil, belirtme hâli (Akkusativ) gelir:"),
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "die Nebenkosten", tr: "aidat ve ek giderler" },
    ...
    patterns: [
      ...
      { de: "warm oder kalt", tr: "kiraya aidatın dâhil olup olmadığını sorar" },
    ...
    lecture: [
      ...
      {
        say: [
          tr("Şimdi o garip ayrım. Aidat dâhil kiraya"),
          de("warm"),
      ...
      {
        say: [
          tr("Ev sahibine bunu şöyle sorarsın:"),
      ...
      {
        say: [tr("Şimdi sen sor: 'Aidat dâhil mi?' demek için ne dersin?")],
        expect: {
          kind: "produce",
    ...
    chat: {
      scene:
        "Bir daireye bakmaya gittin ve ev sahibiyle konuşuyorsun. Kirayı sor, aidatın dâhil olup olmadığını öğren ve fiyatı doğru anladığından emin ol.",
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [
          tr("Sıra sende. Elektrikli süpürgenin Almancası"),
          de("der Staubsauger"),
          tr("'Elektrikli süpürge bozuk.' demek için ne dersin?"),
        ],
        expect: {
          kind: "produce",
