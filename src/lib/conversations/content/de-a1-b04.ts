 ...
 * konuşmaları. Her konuşma öncekilerin kelimelerini yeniden kullanıyor.
 */
export const deA1B04: Conversation[] = [
  {
    id: "de-a1-mein-tag",
    icon: "calendar",
    level: "A1",
  ...
  },
  {
    ...
    chat: {
      scene:
        "İstasyonda beklerken biri sana saati soruyor. Saati söyle, sonra sen de ona trenin kaçta geldiğini sor. Yarım saatleri kullanmaya çalış.",
    ...
    lecture: [
      ...
      },
      {
        say: [
          ...
          de("um"),
          tr("kullanılır. Türkçede bu ayrım yok, o yüzden karıştırmak kolay: pazartesi günü, saat sekizde."),
        ],
      },
      {
        say: [
    ...
    lecture: [
      {
        say: [
          tr(
            "Bugün sabahını sırayla anlatmayı öğreneceğiz. Sıralama kelimeleri de cümlenin başına geliyor, yani bir önceki konuşmada öğrendiğin kuralı yeniden kullanacağız. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      {
        say: [tr("Bir tane daha: 'Ardından erken kahvaltı yapıyorum.' demek için ne dersin?")],
        expect: {
          kind: "produce",
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "aufhören", tr: "bitirmek / son vermek" },
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Almancada iş çıkışının kendine ait bir kelimesi var. Türkçedeki 'paydos'a benziyor ama işten sonraki serbest zamanın tamamını anlatıyor. Onunla başlayalım, sonra kalıplara geçeriz.",
          ),
        ],
      },
      {
