 ...
 * ve üstündeydi.
 */
export const deA2B03: Conversation[] = [
  {
    id: "de-a2-arzt",
    icon: "doctor",
    level: "A2",
  ...
  },
  {
    ...
    lecture: [
      ...
      {
        say: [
          tr("Örnek: 'Bugün kendimi çok kötü hissediyorum.' Almancası:"),
          de("Heute fühle ich mich sehr schlecht."),
          tr("Lütfen"),
          de("Heute fühle ich mich sehr schlecht"),
          tr("de."),
        ],
        expect: { kind: "repeat", target: "Heute fühle ich mich sehr schlecht" },
      },
      {
      ...
      },
      {
        ...
        expect: {
          ...
          why: [
            tr(
              "Bu belirtide kişi özne olmaz, yönelme hâlinde durur; Almanca bunu böyle söylemez. Doğrusu:",
            ),
            de("Mir ist schwindlig."),
          ],
        },
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Doktordaki Konuşma adımında doktorun ağzından katı bir tavsiye gördün. Aynı kip fiilinin bir de yumuşak biçimi var; arkadaşına akıl verirken onu kullanırsın. Türkçedeki 'içsen iyi olur' ile 'içmelisin' arasındaki fark gibi. Önce sekiz kelime.",
          ),
        ],
      },
      {
      ...
      },
      {
        say: [
          ...
          tr(
            "Kip fiilinin yumuşak biçimi. Fiile bir hece ekleniyor ve cümle emirden tavsiyeye dönüyor.",
          ),
        ],
      },
      {
  ...
  },
  {
    ...
    lecture: [
      ...
      },
      {
        say: [
          tr(
            "Kalıp şu: kendine zarar verdiğini söylerken dönüşlü zamir yönelme hâlinde durur ve incinen yerin önünde belirli artikel kullanılır. Türkçede 'bileğimi incittim' derken 'benim' deriz; Almanca 'kendime bileği incittim' der. Önce sekiz kelime.",
          ),
        ],
      },
      {
      ...
      },
      {
        say: [
          ...
          tr(
            "Dönüşlü zamir yönelme hâlinde ve incinen yerin önünde belirli artikel var. Türkçedeki iyelik ekinin yerini bu ikisi birlikte tutuyor.",
          ),
        ],
      },
      {
        say: [
          tr("Örnek: 'Futbolda ayak bileğimi incittim.' Almancası:"),
      ...
      {
        say: [tr("Sıra sende: 'Ayak bileğim şişti.' nasıl dersin?")],
        expect: {
          kind: "produce",
      ...
      },
      {
        ...
        expect: {
          ...
          why: [
            tr(
              "Dilbilgisi doğru ama Almanca bunu genellikle böyle söylemez: kendine zarar verirken dönüşlü zamir yönelme hâlinde durur ve iyelik yerine belirli artikel gelir. Doğrusu:",
            ),
  ...
  },
  {
    ...
    vocab: [
      ...
      { de: "der Bescheid", tr: "haber / resmî bildirim" },
    ...
    lecture: [
      ...
      },
      {
        ...
        expect: {
          ...
          hint: [
            tr("'Özel' anlamındaki kelime burada zarf gibi kullanılır ve ek almaz:"),
    ...
    lecture: [
      {
        say: [
          tr(
            "Bugün stresi konuşuyoruz. Dönüşlü fiiller bu Konuşma adımında bir kez daha karşına çıkacak, ama bu kez kip fiiliyle ve olumsuzla birlikte. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
    ...
    lecture: [
      {
        say: [
          tr(
            "Modülün son Konuşma adımında koruyucu sağlığı konuşuyoruz: düzenli kontroller, aşılar, tahliller. Bir de herkes için geçerli tavsiye kurmayı öğreneceğiz. Hazır mısın?",
          ),
        ],
        expect: { kind: "confirm" },
      },
      ...
      {
        say: [tr("Sıra sende: 'Her yıl aşı yaptırıyorum.' nasıl dersin?")],
        expect: {
          kind: "produce",
