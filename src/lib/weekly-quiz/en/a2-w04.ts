...
export const EN_A2_W04: QuizWeek = {
  ...
  items: [
    ...
    },
    {
      ...
      options: ["phone call", "cell phone", "phone number", "phone case"],
      answer: 1,
      ...
      byNative: {
        de: {
          options: ["handy", "cell phone", "phone call", "phone number"],
          answer: 1,
          why: "Almanca `Handy` İngilizce bir sözcük değil: İngilizce `handy` 'kullanışlı' demek. Cep telefonu `cell phone`.",
        },
      },
    },
  ],
