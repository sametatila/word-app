...
export const EN_A1_W01: QuizWeek = {
  ...
  items: [
    /* ── Okuduğunu anlama ──────────────────────────────────────────────── */
    {
      ...
      options: ["England", "Turkey", "Ireland", "Scotland"],
      answer: 2,
    ...
    /* ── Dinlediğini anlama ────────────────────────────────────────────── */
    {
      ...
      options: ["Turkey", "London", "Ireland", "Dublin"],
      answer: 0,
      why: "Deniz \"I am from Turkey\" diyor. London, Jack'in geldiği yer — iki kişi arka arkaya konuşurken hangi bilginin kime ait olduğunu takip etmek gerekiyor.",
    ...
    },
    {
      ...
      options: ["In Turkey", "In the city", "With Jack", "In Ireland"],
      answer: 1,
