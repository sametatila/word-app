...
export const EN_C1_W01: QuizWeek = {
  ...
  items: [
    ...
    },
    {
      ...
      options: ["can hardly been", "hardly can be", "can hardly be", "are hardly can be"],
      answer: 2,
      why: "Modal + edilgen: `can be checked`, ve `hardly` modal ile mastar arasına girer. `hardly can be` dilbilgisel olarak kurulabilir ama ölçülü dilin olağan sırası değildir; `been` ise `can`den sonra gelmez.",
    ...
    },
    {
      ...
      options: ["put into question", "called into question", "set into question", "taken into question"],
      answer: 1,
      why: "`call into question` sorgulamak anlamında sabit bir öbektir ve fiili değişmez. Anlamı parçalarından türetilemediği için, yakın anlamlı fiiller (`put`, `set`, `take`) öbeği bozar.",
      targets: ["collocation.fixed", "wordfield.evidence"],
      byNative: {
        de: {
          options: ["put into question", "called into question", "set into question", "taken into question"],
          answer: 1,
          why: "Almanca `in Frage stellen` öbeğindeki `stellen` İngilizcede `put` ya da `set` gibi görünüyor ve doğrudan aktarılıyor. İngilizcede öbeğin fiili `call`.",
        },
      },
    },
  ],
