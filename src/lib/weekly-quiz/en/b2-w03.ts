...
export const EN_B2_W03: QuizWeek = {
  ...
  items: [
    ...
    },
    {
      ...
      block: "listen",
      ref: "a1",
      stem: "What does Anna criticize at the end?",
      options: [
    ...
    },
    {
      ...
      options: ["didn't learn", "hadn't learned", "wouldn't have learned", "hasn't learned"],
      answer: 1,
      why: "Koşul geçmişte (`at fourteen`), sonuç bugünde (`today`): karma koşul. Koşul tarafı past perfect (`hadn't learned`), sonuç tarafı `wouldn't be`. Türkçe `-meseydi` geçmişi ve bugünü ayırmadığı için ikinci tip koşula (`didn't learn`) kayılıyor.",
      targets: ["conditional.mixed", "conditional.third"],
      byNative: {
        de: {
          options: ["wouldn't have learned", "didn't learn", "hasn't learned", "hadn't learned"],
          answer: 3,
          why: "Almanca `Wenn sie … nicht gelernt hätte` koşul tarafında da kip taşıdığı için `wouldn't have learned` kuruluyor. İngilizcede `if` tarafına `would` gelmez: `hadn't learned`.",
        },
      },
    },
    {
