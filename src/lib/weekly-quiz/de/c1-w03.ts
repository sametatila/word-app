...
export const DE_C1_W03: QuizWeek = {
  ...
  items: [
    ...
    },
    {
      ...
      options: ["stehen", "standen", "stünden", "gestanden"],
      answer: 2,
      why: "Başta `sollte` ile kurulan koşul gerçek dışıdır, yani ana cümle de Konjunktiv II ister: `stünden`. Indikativ `stehen` koşulu olgu gibi gösterir ve cümlenin kipini böler.",
      targets: ["konjunktiv2.irreal", "syntax.konditional-ohne-wenn"],
    },
    {
      id: "de-c1-w03-g5",
    ...
    /* ── Bağlamda kelime ───────────────────────────────────────────────── */
    {
      ...
      options: ["läuft", "folgt", "bleibt", "hinkt"],
      answer: 3,
