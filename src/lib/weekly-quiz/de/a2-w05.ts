...
export const DE_A2_W05: QuizWeek = {
  ...
  items: [
    ...
    },
    {
      ...
      options: ["Sie ist größer als auf den Fotos.", "Sie ist klein, aber hell.", "Sie ist dunkel und klein.", "Sie ist genau wie auf den Fotos."],
      answer: 1,
    ...
    // ── Dinleme ────────────────────────────────────────────────────────
    {
      ...
      options: ["Sein Zug hatte Verspätung.", "Er hat seinen Anschluss verpasst.", "Er war krank.", "Das Hotel war voll."],
      answer: 1,
    ...
    },
    {
      ...
      options: ["billiger als", "am billigsten", "mehr billig", "am billiger"],
      answer: 1,
