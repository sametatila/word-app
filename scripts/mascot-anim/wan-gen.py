...
ACTIONS = {
    ...
    "pull-enter-a": ("the cute meerkat turns its body to a three-quarter angle toward the camera, stretches both front arms out to its left side at chest height with paws curled downward and gripping, leans its whole body weight to the right away from its paws, hauling with great effort, and takes small slow steps backward to the right in place while its head faces the camera with a determined closed-mouth smile, the whole body including the tail stays fully inside the frame with clear empty margins on all sides", WIDE, False),
    "pull-enter-b": ("the cute meerkat turns to face left in side profile and settles into a pulling stance: both front arms outstretched forward at chest height, paws curled downward and gripping, body leaning backward, feet planted, taking slow heavy steps backward in place while it turns its head over its shoulder to glance at the camera with a closed-mouth smile, the whole body including the tail stays fully inside the frame with clear empty margins on all sides", WIDE, False),
    "pull-enter-c": ("the cute meerkat turns to face left in side profile, both front arms fully extended forward at chest height, straight and taut, paws curled downward and gripping tightly, and leans its whole body FAR backward at a 45 degree angle away from its paws, heels dug into the ground, straining backward with great effort like hauling, taking slow heavy steps backward in place, while it turns its head over its shoulder to glance at the camera with a determined closed-mouth smile, the whole body including the tail stays fully inside the frame with clear empty margins on all sides", WIDE, False),
    "pull-enter-d": ("the cute meerkat turns to face left in side profile and takes a hauling stance: both arms bent at the elbows and pulled in tight, fists clenched one in front of the other at chest height, elbows drawn back, body leaning slightly backward, heels planted firmly on the ground, straining and taking small slow steps backward in place, while its head turns over its shoulder to look at the camera with a determined closed-mouth smile, the whole body including the tail stays fully inside the frame with clear empty margins on all sides", WIDE, False),
    "pull-enter-e": ("the cute meerkat stands in side profile facing left with both front arms stretched straight out in front of it at chest height, arms taut and rigid, paws curled downward and gripping tightly, its torso leaning backward away from its paws, and it shuffles slowly toward the RIGHT side of the frame with small dragging steps, its whole body being hauled backward step by step, head turned over its shoulder to look at the camera with a determined closed-mouth smile, the whole body including the tail stays fully inside the frame with clear empty margins on all sides", WIDE, False),
    "pull-enter-f": ("the cute meerkat walks slowly toward the right in side profile, body leaning forward into each step, both front paws gripped together behind its head over its left shoulder, arms stretched back behind its body, straining hard with every step as it drags forward, face turned slightly toward the camera with a determined closed-mouth smile, the whole body including the tail stays fully inside the frame with clear empty margins on all sides", WIDE, False),
    "pull-enter-g": ("the cute meerkat faces the camera, both front arms fully extended out to its left side at chest height with paws clenched together, its whole body leaning hard to the right away from its paws, knees bent, feet dug into the ground, and it heaves rhythmically, jerking its body to the right again and again with great effort, looking at the camera with a determined closed-mouth smile, the whole body including the tail stays fully inside the frame with clear empty margins on all sides", WIDE, False),
    "pull-enter": ("the cute meerkat turns to face left and settles into a pulling stance: body leaning backward, both front arms outstretched forward at chest height, paws curled downward and gripping tightly, feet planted, its head turned toward the viewer looking straight at the camera with a friendly closed-mouth smile, then holds this stance while taking slow heavy steps backward in place, the whole body including the tail stays fully inside the frame with clear empty margins on all sides", WIDE, False),
    "pull-right": ("the cute meerkat, already in a pulling stance facing left with both front arms outstretched forward and paws curled downward, keeps its head turned toward the viewer looking straight at the camera with a friendly closed-mouth smile, takes slow heavy steps backward in place, straining with effort, its position on the ground never changes and it does not slide, and it finishes in exactly the same stance it started in, the whole body including the tail stays fully inside the frame with clear empty margins on all sides", "pull-base.png", True),
