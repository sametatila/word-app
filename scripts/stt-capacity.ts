 ...
 *   - HEDEF (WP-20 sonrası): telaffuz puanı her söyleyiş turunda, sohbet
...
async function main() {
  ...
  lines.push(`- Sohbet turu: ${rp.turns} (30 gün); konuşma egzersizi denemesi: ${sp.attempts}.`);
