...
const PLANS = [
  { key: "yearly", label: "Yıllık", price: "₺79/ay", note: "₺948 yıllık — 2 ay bedava", badge: "En avantajlı" },
  { key: "monthly", label: "Aylık", price: "₺99/ay", note: "İstediğin zaman iptal", badge: null },
] as const;
