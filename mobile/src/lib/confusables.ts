/**
 * Karıştırma çiftleri — web `src/lib/confusables.ts` ile BİREBİR aynı dosya.
 *
 * İçe aktarması yok, saf veri + iki işlev; kopyanın kelimesi kelimesine aynı
 * kalması `check:parity` "karistirma ciftleri" ile ölçülüyor.
 */
/**
