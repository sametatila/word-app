/**
 * Kural parçacıkları — web `src/lib/why-rules.ts` ile BİREBİR aynı gövde.
 *
 * Tek fark iki satırlık başlık: web `CefrLevel`i beceri tiplerinden alıyor,
 * mobilde o tip bu dosyada yazılı. `RULES` dizisi ve `ruleFor` gövdesi
 * kelimesi kelimesine aynı; `check:parity` ikisini karşılaştırıyor.
 */
...
export function ruleFor(errorType: ErrorType, context = "", lang: string = "de"): Rule | null {
