...
const BY_COURSE: Record<string, Record<string, string[]>> = {
  de: {
    ...
    /* 11-18 web `lib/conversations/modules.ts` ile birebir. Web B1'i 2026-09-05'te on
       sekiz modüle genişletmişti (kapsanmayan 1059 B1 maddesi kümelendi; plan git
       geçmişinde: docs/plan/b1-yeniden-kurgu.md); mobil listede on tema kalmıştı. Oysa
...
const NATIVE: Record<"en" | "de", Record<string, string>> = {
  en: {
    ...
    "Yolculuk ve ulaşım": "Travel and transportation",
    ...
    "Kültür, spor ve doğa": "Culture, sports and nature",
