/**
 * Yazılan ALMANCAYI çalışma anına bağlar: `node data/conversations/apply-de.mjs`
 *
 ...
 * ÜÇ SÖZLÜK, ÜÇ KAYNAK:
 *
 *   conversation  `data/conversations/prose-de/out/`      anahtar `tür + AYRAÇ + tr`
...
/** Bileşik anahtarların ayracı — `src/lib/conversations/native.ts` ile aynı olmak
...
const conversation = {};
for (const r of read(`${DIR}prose-de/out/`)) conversation[r.kind + SEP + r.tr] = value(r);
