 ...
 *   `npx tsx --tsconfig scripts/tsconfig.e2e.json data/conversations/exam-de/check.ts [paket|all]`
 *
 * Kardeşi `data/conversations/exam/check.ts` ile aynı kurallar, ters yön. İkisi de
