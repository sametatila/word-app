 ...
 * SARIYOR olabilir. Gerekçenin tamamı `data/conversations/lecture/check.mjs`te.
 */
import { readFileSync, readdirSync, existsSync } from "node:fs";
import { extractConversationProse } from "./make.mjs";
...
const src = new Map(extractConversationProse().map((r) => [r.kind + "|" + r.tr, r]));
