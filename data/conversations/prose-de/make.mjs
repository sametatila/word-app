 ...
 * hiç dokunmuyor (`resolveConversation` yalnız `target`, `hint` ve `why`
...
if (process.argv[1]?.endsWith("make.mjs")) {
  const rows = extractConversationProse();
  const SIZE = 150;
