...
| Sayfa görünürken **önce tarayıcı tanıyıcısı** | Kısa cevaplarda belirgin biçimde daha iyi anlıyor, anında ve bedava. Kayıt + sunucu yolu ise ekran kapalıyken çalışan tek yol. İkisi rakip değil: biri kaliteyi, diğeri kapsamı veriyor. Tanıyıcı üst üste iki kez boş dönerse o oturumda bırakılıyor — yoksa her cevap iki kez beklenirdi |
